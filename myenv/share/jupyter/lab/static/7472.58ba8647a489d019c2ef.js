...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [7472],
  {
    37472: (O, r, e) => {
      e.r(r);
      e.d(r, { globalCompletion: () => yO, localCompletionSource: () => gO, python: () => GO, pythonLanguage: () => hO });
      var a = e(11705);
      var i = e(6016);
      const x = 1,
        Q = 196,
      ...
      const N = 10,
        ...
        K = 34,
        OO = 92;
      const rO = new Set([d, b, V, k, v, j, u, R, E, G, _, U, Z, h, z, F, A]);
      function eO(O) {
        return O == N || O == C;
      }
      const aO = new a.Jq(
        (O, r) => {
          ...
          if (O.next < 0) {
            ...
            if (eO(O.next)) O.acceptToken(s, 1);
          } else if (((e = O.peek(-1)) < 0 || eO(e)) && r.canShift(t)) {
            let r = 0;
            while (O.next == I || O.next == L) {
              O.advance();
              r++;
            }
            if (O.next == N || O.next == C || O.next == D) O.acceptToken(t, -r);
          } else if (eO(O.next)) {
            O.acceptToken(S, 1);
          }
        },
      ...
      const iO = new a.Jq((O, r) => {
        let e = r.context.depth;
        if (e < 0) return;
        let a = O.peek(-1);
        if (a == N || a == C) {
          let r = 0,
          ...
          for (;;) {
            if (O.next == I) r++;
            else if (O.next == L) r += 8 - (r % 8);
            else break;
            O.advance();
            a++;
          }
          if (r != e && O.next != N && O.next != C && O.next != D) {
            if (r < e) O.acceptToken(o, -a);
            else O.acceptToken(Q);
          }
        }
      });
      function xO(O, r) {
        this.parent = O;
        this.depth = r;
        this.hash = (O ? (O.hash + O.hash) << 8 : 0) + r + (r << 4);
      }
      const QO = new xO(null, 0);
      function oO(O) {
        let r = 0;
        for (let e = 0; e < O.length; e++) r += O.charCodeAt(e) == L ? 8 - (r % 8) : 1;
        return r;
      }
      const SO = new a.IK({
        start: QO,
        reduce(O, r) {
          return O.depth < 0 && rO.has(r) ? O.parent : O;
        },
        shift(O, r, e, a) {
          if (r == Q) return new xO(O, oO(a.read(a.pos, e.pos)));
          if (r == o) return O.parent;
          if (r == Y || r == g || r == y) return new xO(O, -1);
          return O;
        },
        hash(O) {
          return O.hash;
      ...
      const tO = new a.Jq((O) => {
        ...
        for (let r = 0; ; r++) {
          let e = O.peek(r);
          if (e == I || e == L) continue;
          if (e != M && e != H && e != N && e != C && e != D) O.acceptToken(x);
          return;
        }
      });
      function sO(O, r, e, i, x) {
        return new a.Jq((a) => {
          let Q = a.pos;
          for (;;) {
            if (a.next < 0) {
              ...
              a.advance();
              if (a.next >= 0) a.advance();
            } else if (a.next == O && (r == 1 || (a.peek(1) == O && a.peek(2) == O))) {
              if (a.pos == Q) {
                a.acceptToken(x, r);
                return;
              }
          ...
          if (a.pos > Q) a.acceptToken(e);
        });
      }
      const TO = sO(J, 1, n, l, P);
      const nO = sO(K, 1, p, q, m);
      const lO = sO(J, 3, $, w, X);
      const PO = sO(K, 3, c, W, f);
      const pO = (0, i.styleTags)({
        'async "*" "**" FormatConversion FormatSpec': i.tags.modifier,
        ...
        "in not and or is del": i.tags.operatorKeyword,
        "from def class global nonlocal lambda": i.tags.definitionKeyword,
        import: i.tags.moduleKeyword,
        "with as print": i.tags.keyword,
        Boolean: i.tags.bool,
        None: i.tags["null"],
        VariableName: i.tags.variableName,
        "CallExpression/VariableName": i.tags["function"](i.tags.variableName),
        "FunctionDefinition/VariableName": i.tags["function"](i.tags.definition(i.tags.variableName)),
        "ClassDefinition/VariableName": i.tags.definition(i.tags.className),
        PropertyName: i.tags.propertyName,
        "CallExpression/MemberExpression/PropertyName": i.tags["function"](i.tags.propertyName),
        Comment: i.tags.lineComment,
        Number: i.tags.number,
        String: i.tags.string,
        FormatString: i.tags.special(i.tags.string),
        ...
        AssignOp: i.tags.definitionOperator,
        Ellipsis: i.tags.punctuation,
        At: i.tags.meta,
        "( )": i.tags.paren,
      ...
      const mO = a.WQ.deserialize({
        ...
        tokenizers: [tO, iO, aO, TO, nO, lO, PO, 0, 1, 2, 3, 4, 5, 6],
        topRules: { Script: [0, 7] },
        specialized: [{ term: 229, get: (O) => qO[O] || -1 }],
        tokenPrec: 7205,
      });
      var $O = e(24104);
      var wO = e(73265);
      var XO = e(1065);
      const cO = new wO.NodeWeakMap();
      const WO = new Set(["Script", "Body", "FunctionDefinition", "ClassDefinition", "LambdaExpression", "ForStatement", "MatchClause"]);
      function fO(O) {
        return (r, e, a) => {
          if (a) return false;
          let i = r.node.getChild("VariableName");
          if (i) e(i, O);
          return true;
        };
      }
      const YO = {
        FunctionDefinition: fO("function"),
        ClassDefinition: fO("class"),
        ForStatement(O, r, e) {
          if (e)
        ...
        ImportStatement(O, r) {
          var e, a;
          let { node: i } = O;
          let x = ((e = i.firstChild) === null || e === void 0 ? void 0 : e.name) == "from";
          for (let Q = i.getChild("import"); Q; Q = Q.nextSibling) {
            if (Q.name == "VariableName" && ((a = Q.nextSibling) === null || a === void 0 ? void 0 : a.name) != "as")
              r(Q, x ? "variable" : "namespace");
          }
        },
        AssignStatement(O, r) {
          for (let e = O.node.firstChild; e; e = e.nextSibling) {
            if (e.name == "VariableName") r(e, "variable");
            else if (e.name == ":" || e.name == "AssignOp") break;
          }
        },
        ParamList(O, r) {
          for (let e = null, a = O.node.firstChild; a; a = a.nextSibling) {
            if (a.name == "VariableName" && (!e || !/\*|AssignOp/.test(e.name))) r(a, "variable");
            e = a;
          }
        },
        CapturePattern: fO("variable"),
        AsPattern: fO("variable"),
        __proto__: null,
      };
      function dO(O, r) {
        let e = cO.get(r);
        ...
        let a = [],
          i = true;
        function x(r, e) {
          let i = O.sliceString(r.from, r.to);
          a.push({ label: i, type: e });
        }
        r.cursor(wO.IterMode.IncludeAnonymous).iterate((r) => {
          if (r.name) {
            let O = YO[r.name];
            if ((O && O(r, x, i)) || (!i && WO.has(r.name))) return false;
            i = false;
          } else if (r.to - r.from > 8192) {
            for (let e of dO(O, r.node)) a.push(e);
            return false;
          }
        });
        cO.set(r, a);
      ...
      const VO = ["String", "FormatString", "Comment", "PropertyName"];
      function gO(O) {
        let r = (0, $O.syntaxTree)(O.state).resolveInner(O.pos, -1);
        if (VO.indexOf(r.name) > -1) return null;
        let e = r.name == "VariableName" || (r.to - r.from < 20 && bO.test(O.state.sliceDoc(r.from, r.to)));
        if (!e && !O.explicit) return null;
        let a = [];
        for (let i = r; i; i = i.parent) {
          if (WO.has(i.name)) a = a.concat(dO(O.state.doc, i));
        }
        return { options: a, from: e ? r.from : O.pos, validFor: bO };
      }
      const uO = [
        "__annotations__",
        "__builtins__",
      ...
      const RO = [
        ...
        (0, XO.Gn)("import ${module}", { label: "import", detail: "statement", type: "keyword" }),
        (0, XO.Gn)("from ${module} import ${names}", { label: "from", detail: "import", type: "keyword" }),
      ];
      const yO = (0, XO.eC)(VO, (0, XO.Mb)(uO.concat(RO)));
      function ZO(O, r) {
        let e = O.baseIndentFor(r);
        let a = O.lineAt(O.pos, -1),
          i = a.from + a.text.length;
        if (/^\s*($|#)/.test(a.text) && O.node.to < i + 100 && !/\S/.test(O.state.sliceDoc(i, O.node.to)) && O.lineIndent(O.pos, -1) <= e)
          return null;
        if (/^\s*(else:|elif |except |finally:)/.test(O.textAfter) && O.lineIndent(O.pos, -1) > e) return null;
        return e + O.unit;
      }
      const hO = $O.LRLanguage.define({
        name: "python",
        parser: mO.configure({
          props: [
            $O.indentNodeProp.add({
              Body: (O) => {
                var r;
                return (r = ZO(O, O.node)) !== null && r !== void 0 ? r : O.continue();
              },
              ...
              "TupleExpression ComprehensionExpression ParamList ArgList ParenthesizedExpression": (0, $O.delimitedIndent)({ closing: ")" }),
              "DictionaryExpression DictionaryComprehensionExpression SetExpression SetComprehensionExpression": (0, $O.delimitedIndent)({
                closing: "}",
              }),
              "ArrayExpression ArrayComprehensionExpression": (0, $O.delimitedIndent)({ closing: "]" }),
              "String FormatString": () => null,
              Script: (O) => {
                if (O.pos + /\s*/.exec(O.textAfter)[0].length >= O.node.to) {
                  let r = null;
                  for (let e = O.node, a = e.to; ; ) {
                    e = e.lastChild;
                    if (!e || e.to != a) break;
                    if (e.type.name == "Body") r = e;
                  }
                  if (r) {
                    let e = ZO(O, r);
                    if (e != null) return e;
            ...
            $O.foldNodeProp.add({
              "ArrayExpression DictionaryExpression SetExpression TupleExpression": $O.foldInside,
      ...
      function GO() {
        return new $O.LanguageSupport(hO, [hO.data.of({ autocomplete: gO }), hO.data.of({ autocomplete: yO })]);
      }
    },
  },
]);
