/*! For license information please see 4008.0fa1019b19f98b38b784.js.LICENSE.txt */
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [4008, 4155, 2990, 2812],
  {
    ...
    94008: (e, t, r) => {
      "use strict";
      r.r(t);
      r.d(t, { DEFAULT_ACTIONS: () => Ca, default: () => Va, guessMode: () => Ga, vega: () => Ra, vegaLite: () => Da, version: () => Ta });
      var n = {};
      r.r(n);
      r.d(n, {
        JsonPatchError: () => b,
      ...
      var i = {};
      r.r(i);
      r.d(i, { compare: () => U, generate: () => M, observe: () => _, unobserve: () => P });
      var a = {};
      r.r(a);
      r.d(a, {
        dark: () => Le,
      ...
      const B = Object.assign({}, n, i, { JsonPatchError: y, deepClone: u, escapePathComponent: h, unescapePathComponent: p });
      var G = r(51127);
      var X = r.n(G);
      var W = r(56498);
      function $(e, t, r) {
      ...
      var J = { "+": (e) => +e, "-": (e) => -e, "~": (e) => ~e, "!": (e) => !e };
      const Y = Array.prototype.slice;
      const q = (e, t, r) => {
        const n = r ? r(t[0]) : t[0];
        return n[e].apply(n, Y.call(t, 1));
      };
      ...
      const Z = ["view", "item", "group", "xy", "x", "y"];
      ...
      const te = {
        ...
        Identifier: (e, t) => {
          const r = t.name;
          return e.memberDepth > 0 ? r : r === "datum" ? e.datum : r === "event" ? e.event : r === "item" ? e.item : V[r] || e.params["$" + r];
        },
        ...
        CallExpression: (e, t) => {
          ...
          return n === "if" ? (e(r[0]) ? e(r[1]) : e(r[2])) : (e.fn[n] || K[n]).apply(e.fn, r.map(e));
        },
        ArrayExpression: (e, t) => t.elements.map(e),
        BinaryExpression: (e, t) => H[t.operator](e(t.left), e(t.right)),
        UnaryExpression: (e, t) => J[t.operator](e(t.argument)),
      ...
      const Ue = 22;
      const Be = "normal";
      const Ge = "Benton Gothic, sans-serif";
      const Xe = 11.5;
      const We = "normal";
      const $e = "#82c6df";
      const Ve = "Benton Gothic Bold, sans-serif";
      const He = "normal";
      const Je = 13;
      const Ye = {
      ...
      const qe = {
        background: "#ffffff",
        title: { anchor: "start", color: "#000000", font: Ve, fontSize: Ue, fontWeight: Be },
        arc: { fill: $e },
        area: { fill: $e },
        ...
        axis: { labelFont: Ge, labelFontSize: Xe, labelFontWeight: We, titleFont: Ve, titleFontSize: Je, titleFontWeight: He },
        ...
        legend: { labelFont: Ge, labelFontSize: Xe, symbolType: "square", titleFont: Ve, titleFontSize: Je, titleFontWeight: He },
        range: { category: Ye["category-6"], diverging: Ye["fireandice-6"], heatmap: Ye["fire-7"], ordinal: Ye["fire-7"], ramp: Ye["fire-7"] },
      };
      const Qe = "#ab5787";
      const Ke = "#979797";
      const Ze = {
        ...
        axis: { domainColor: Ke, domainWidth: 0.5, gridWidth: 0.2, labelColor: Ke, tickColor: Ke, tickWidth: 0.2, titleColor: Ke },
        axisBand: { grid: false },
      ...
      var Bt = "vega-tooltip";
      var Gt = "0.30.1";
      var Xt = "A tooltip plugin for Vega-Lite and Vega visualizations.";
      var Wt = ["vega-lite", "vega", "tooltip"];
      var $t = { type: "git", url: "https://github.com/vega/vega-tooltip.git" };
      var Vt = { name: "UW Interactive Data Lab", url: "https://idl.cs.washington.edu" };
      var Ht = ["Dominik Moritz", "Sira Horradarn", "Zening Qu", "Kanit Wongsuphasawat", "Yuri Astrakhan", "Jeffrey Heer"];
      var Jt = "BSD-3-Clause";
      var Yt = { url: "https://github.com/vega/vega-tooltip/issues" };
      var qt = "https://github.com/vega/vega-tooltip#readme";
      var Qt = "build/vega-tooltip.js";
      var Kt = "build/vega-tooltip.module.js";
      var Zt = "build/vega-tooltip.min.js";
      ...
      function lr(e, t, r) {
        if ((0, Ut.kJ)(e)) {
          return `[${e.map((e) => t((0, Ut.HD)(e) ? e : ur(e, r))).join(", ")}]`;
        }
        if ((0, Ut.Kn)(e)) {
          let n = "";
          const i = e,
      ...
      function Fr(e, t, r, n) {
        var i = t && t.prototype instanceof Br ? t : Br;
      ...
      var Vr = $r && $r($r(sn([])));
      if (Vr && Vr !== Sr && Lr.call(Vr, Dr)) {
        Wr = Vr;
      }
      var Hr = (Xr.prototype = Br.prototype = Object.create(Wr));
      Gr.prototype = Hr.constructor = Xr;
      Xr.constructor = Gr;
      Xr[Cr] = Gr.displayName = "GeneratorFunction";
      function Jr(e) {
      ...
      function Yr(e) {
        ...
        return t ? t === Gr || (t.displayName || t.name) === "GeneratorFunction" : false;
      }
      function qr(e) {
        if (Object.setPrototypeOf) {
          Object.setPrototypeOf(e, Xr);
        } else {
          e.__proto__ = Xr;
          if (!(Cr in e)) {
      ...
      Jr(Kr.prototype);
      Kr.prototype[kr] = function () {
        return this;
      };
      function Zr(e, t, r, n, i) {
        if (i === void 0) i = Promise;
        var a = new Kr(Fr(e, t, r, n), i);
        return Yr(t)
          ? a
      ...
      var cn = { wrap: Fr, isGeneratorFunction: Yr, AsyncIterator: Kr, mark: qr, awrap: Qr, async: Zr, keys: on, values: sn };
      var un;
      var fn;
      function hn() {
        if (fn) return un;
      ...
      var Wn = "2.0.0";
      var $n = 256;
      var Vn = Number.MAX_SAFE_INTEGER || 9007199254740991;
      var Hn = 16;
      var Jn = { SEMVER_SPEC_VERSION: Wn, MAX_LENGTH: $n, MAX_SAFE_INTEGER: Vn, MAX_SAFE_COMPONENT_LENGTH: Hn };
      var Yn =
      ...
      var qn = Yn;
      (function (e, t) {
        var r = Jn.MAX_SAFE_COMPONENT_LENGTH;
        var n = qn;
        t = e.exports = {};
        var i = (t.re = []);
        var a = (t.src = []);
      ...
      var Zn = (e, t) => Kn(t, e);
      var ei = { compareIdentifiers: Kn, rcompareIdentifiers: Zn };
      var ti = qn;
      var ri = Jn.MAX_LENGTH,
        ni = Jn.MAX_SAFE_INTEGER;
      var ii = Gn.re,
        ai = Gn.t;
      var oi = Bn;
      ...
      function Gi(e, t) {
        ...
        if (!r) {
          if (Array.isArray(e) || (r = Xi(e)) || (t && e && typeof e.length === "number")) {
            if (r) e = r;
            var n = 0;
            var i = function e() {};
            return {
      ...
      function Xi(e, t) {
        ...
        if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return Wi(e, t);
      }
      function Wi(e, t) {
      ...
      function Hi() {
        ...
        var s = Gn.re,
          l = Gn.t,
          c = Gn.comparatorTrimReplace,
          u = Gn.tildeTrimReplace,
          f = Gn.caretTrimReplace;
              ...
              while (1)
                switch ((v.prev = v.next)) {
                  ...
                  case 11:
                    ...
                    c = l.loader;
                    if (!s || c) {
                      s = Wa((u = a.loader) !== null && u !== void 0 ? u : c);
                    }
                    v.next = 16;
                    return Ja(l, s);
                  case 16:
                ...
                while (1)
                  switch ((se.prev = se.next)) {
                    case 0:
                      ...
                      p = f.theme ? (0, W.mergeConfig)(a[f.theme], (n = f.config) !== null && n !== void 0 ? n : {}) : f.config;
                      d = (0, W.isBoolean)(f.actions) ? f.actions : Zi({}, Ca, (i = f.actions) !== null && i !== void 0 ? i : {});
                      v = La(La({}, Fa), f.i18n);
                    ...
                    case 12:
                      if (f.defaultStyle !== false) {
                        ...
                        if (!x.getElementById(E)) {
                          ...
                          A.id = E;
                          A.innerHTML = f.defaultStyle === undefined || f.defaultStyle === true ? Ki.toString() : f.defaultStyle;
                          O.appendChild(A);
                        }
                      }
                      N = Ga(r, f.mode);
                      ...
                      if (f.tooltip !== false) {
                        _ = Ua(f.tooltip) ? f.tooltip : new mr(f.tooltip === true ? {} : f.tooltip).call;
                        P.tooltip(_);
                      }
                      M = f.hover;
                      if (M === undefined) {
                      ...
                      if (M) {
                        (z = typeof M === "boolean" ? {} : M), (U = z.hoverSet), (B = z.updateSet);
                        P.hover(U, B);
                      }
                      if (f) {
                        if (f.width != null) {
                    ...
                    case 37:
                      ...
                      $ = b;
                      if (f.defaultStyle !== false) {
                        V = document.createElement("details");
                        V.title = v.CLICK_TO_VIEW_ACTIONS;
                        b.append(V);
                        $ = V;
                            ...
                            switch ((a.prev = a.next)) {
                              case 0:
                                ...
                                if (d === true || d.export === true || d.export[t]) {
                                  ...
                                  i = (0, W.isObject)(f.scaleFactor) ? f.scaleFactor[t] : f.scaleFactor;
                                  n.text = r;
                                  n.href = "#";
                                  n.target = "_blank";
                    ...
                    case 60:
                      ...
                      if (d === true || d.editor !== false) {
                        ...
                        re.addEventListener("click", function (e) {
                          Qi(window, te, { config: p, mode: N, renderer: g, spec: X()(r) });
                          e.preventDefault();
                        });
                        J.append(re);
                      }
    ...
    48823: (e, t, r) => {
      ...
      function $(e, t, r) {
        ...
        return X(e, t, r, F(n), C(n));
      }
      function V(e, t, r, n) {
        return X(e, t, r, _(n), _(1 / n));
      }
      function H(e, t, r, n) {
        return X(e, t, r, j(n), P(n));
      }
      function J(e) {
      ...
      function Ne(e) {
        ...
        return {
          clear: i,
          has: (e) => fe(t, e) || fe(r, e),
          get: (e) => (fe(t, e) ? t[e] : fe(r, e) ? a(e, r[e]) : undefined),
          set: (e, r) => (fe(t, e) ? (t[e] = r) : a(e, r)),
        };
      }
      function Se(e, t, r, n) {
        const i = t.length,
      ...
      function Te(e, t, r, n) {
        const i = r || " ",
          a = e + "",
          o = t - a.length;
        return o <= 0 ? a : n === "left" ? Le(i, o) + a : n === "center" ? Le(i, ~~(o / 2)) + a + Le(i, Math.ceil(o / 2)) : a + Le(i, o);
      }
      function Re(e) {
        return (e && D(e) - e[0]) || 0;
      }
      function De(e) {
        return I(e) ? "[" + e.map(De) + "]" : N(e) || xe(e) ? JSON.stringify(e).replace("\u2028", "\\u2028").replace("\u2029", "\\u2029") : e;
      }
      function ke(e) {
        return e == null || e === "" ? null : !e || e === "false" || e === "0" ? false : !!e;
      }
      const Ce = (e) => (Ee(e) ? e : ye(e) ? e : Date.parse(e));
      function Fe(e, t) {
        t = t || Ce;
