    ...
    909: (e, t, s) => {
      s.r(t),
        s.d(t, {
          ...
          DOMWidgetView: () => I,
          ErrorWidgetView: () => F,
          IJupyterWidgetRegistry: () => G,
          JUPYTER_WIDGETS_VERSION: () => x,
          JupyterLuminoPanelWidget: () => N,
          JupyterLuminoWidget: () => A,
          JupyterPhosphorPanelWidget: () => V,
          ...
          WidgetView: () => W,
          assign: () => a,
          createErrorWidgetModel: () => q,
          createErrorWidgetView: () => K,
          difference: () => r,
          isEqual: () => l,
          isObject: () => m,
          isSerializable: () => _,
            ...
            if ((_(i) && (i = i.toJSON()), Array.isArray(i))) {
              ...
              for (let r = 0; r < i.length; r++) {
                ...
                if (l)
                  if (l instanceof ArrayBuffer || ArrayBuffer.isView(l))
                    o || ((i = i.slice()), (o = !0)), t.push(ArrayBuffer.isView(l) ? l.buffer : l), s.push(n.concat([r])), (i[r] = null);
                  else {
              ...
              for (const o in i) {
                ...
                if (Object.prototype.hasOwnProperty.call(i, o)) {
                  ...
                  if (l)
                    if (l instanceof ArrayBuffer || ArrayBuffer.isView(l))
                      r || ((i = Object.assign({}, i)), (r = !0)), t.push(ArrayBuffer.isView(l) ? l.buffer : l), s.push(n.concat([o])), delete i[o];
                    else {
                      const t = e(l, n.concat([o]));
                      t !== l && (r || ((i = Object.assign({}, i)), (r = !0)), (i[o] = t));
                    }
                }
              }
            return i;
      ...
      function p(e, t, s) {
        ...
        let n;
        if ((i.JSONExt.isObject(e) ? ((n = e), (s = t)) : ((n = {})[e] = t), s || (s = {}), !this._validate(n, s))) return !1;
        const o = s.unset,
          r = s.silent,
          a = [],
          c = this._changing;
        this._changing = !0;
        try {
          c || ((this._previousAttributes = Object.assign({}, this.attributes)), (this.changed = {}));
          const e = this.attributes,
            i = this.changed,
            h = this._previousAttributes;
          for (const s in n) (t = n[s]), l(e[s], t) || a.push(s), l(h[s], t) ? delete i[s] : (i[s] = t), o ? delete e[s] : (e[s] = t);
          if (((this.id = this.get(this.idAttribute)), !r)) {
            a.length && (this._pending = s);
            for (let t = 0; t < a.length; t++) this.trigger("change:" + a[t], this, e[a[t]], s);
          }
          if (c) return this;
          if (!r) for (; this._pending; ) (s = this._pending), (this._pending = !1), this.trigger("change", this, s);
        } finally {
      ...
      const k =
        (w && (w.matches || w.webkitMatchesSelector || w.mozMatchesSelector || w.msMatchesSelector || w.oMatchesSelector)) ||
        function (e) {
      ...
      class j extends v.View {
        ...
        delegate(e, t, s) {
          "string" != typeof t && ((s = t), (t = null)), void 0 === this._domEvents && (this._domEvents = []);
          const i = this.el,
            n = t
              ? function (e) {
                  let n = e.target || e.srcElement;
                  for (; n && n !== i; n = n.parentNode) if (k.call(n, t)) return (e.delegateTarget = n), s.handleEvent ? s.handleEvent(e) : s(e);
                }
              : s;
          return this.el.addEventListener(e, n, !1), this._domEvents.push({ eventName: e, handler: n, listener: s, selector: t }), n;
        }
        undelegate(e, t, s) {
          if (("function" == typeof t && ((s = t), (t = null)), this.el && this._domEvents)) {
            const i = this._domEvents.slice();
            let n = i.length;
            for (; n--; ) {
              const o = i[n];
              !(o.eventName !== e || (s && o.listener !== s) || (t && o.selector !== t)) &&
                (this.el.removeEventListener(o.eventName, o.handler, !1), this._domEvents.splice(n, 1));
            }
          }
          return this;
        }
      ...
      function M(e, t) {
        if (Array.isArray(e)) {
          const s = [];
          for (const i of e) s.push(M(i, t));
          return Promise.all(s);
        }
        if (e instanceof Object && "string" != typeof e) {
          const s = {};
          for (const [i, n] of Object.entries(e)) s[i] = M(n, t);
          return h(s);
        }
        return "string" == typeof e && e.slice(0, 10) === P ? t.get_model(e.slice(10, e.length)) : Promise.resolve(e);
      }
      function L(e, t) {
        if (Array.isArray(e)) {
          const s = [];
        ...
        if (e instanceof C) return `${P}${e.model_id}`;
        if (e instanceof Object && "string" != typeof e) {
          const s = {};
      ...
      class C extends v.Model {
        ...
        initialize(e, t) {
          ...
          (this.views = Object.create(null)),
            ...
            s
              ? ((this.comm = s), s.on_close(this._handle_comm_closed.bind(this)), s.on_msg(this._handle_comm_msg.bind(this)), (this.comm_live = !0))
              : (this.comm_live = !1);
        }
        get comm_live() {
                ...
                (this.state_change = this.state_change
                  .then(() => {
                    ...
                    const r = t.state,
                      ...
                      a = null !== (o = null === (n = e.buffers) || void 0 === n ? void 0 : n.slice(0, l.length)) && void 0 !== o ? o : [];
                        ...
                        .forEach((e) => {
                          this._expectedEchoMsgIds.get(e) !== t
                            ...
                            : (this._expectedEchoMsgIds.delete(e),
                              null !== this._msg_buffer && Object.prototype.hasOwnProperty.call(this._msg_buffer, e) && delete r[e]);
                        });
                    }
                  ...
                  .catch(d(`Could not process update msg for model id: ${this.model_id}`, !0))),
                this.state_change
              );
            case "custom":
        ...
        set(e, t, s) {
          ...
          if (void 0 !== this._buffered_state_diff) {
            ...
            if (this._state_lock) for (const t of Object.keys(this._state_lock)) e[t] === this._state_lock[t] && delete e[t];
        ...
        sync(e, t, s = {}) {
          ...
          if (this._state_lock) for (const e of Object.keys(this._state_lock)) i[e] === this._state_lock[e] && delete i[e];
        ...
        serialize(e) {
          ...
          for (const s of Object.keys(e))
            try {
              t[s] && t[s].serialize ? (e[s] = t[s].serialize(e[s], this)) : (e[s] = JSON.parse(JSON.stringify(e[s]))),
        ...
        send_sync_message(e, t = {}) {
          if (!this.comm) return "";
          try {
            const s = (t = { shell: Object.assign({}, t.shell), iopub: Object.assign({}, t.iopub), input: t.input }).iopub.status;
            t.iopub.status = (e) => {
              this._handle_status(e), s && s(e);
            };
            const i = g(e),
              n = this.comm.send({ method: "update", state: i.state, buffer_paths: i.buffer_paths }, t, {}, i.buffers);
        ...
        save_changes(e) {
          if (this.comm_live) {
            ...
            e && (t.callbacks = e),
              ...
              this._changing && a(this._buffered_state_diff_synced, this._buffered_state_diff),
              (this._buffered_state_diff = {});
          }
        }
      ...
      class z extends C {
        defaults() {
          return a(super.defaults(), { _dom_classes: [], tabbable: null, tooltip: null });
        }
      }
      z.serializers = Object.assign(Object.assign({}, C.serializers), { layout: { deserialize: M }, style: { deserialize: M } });
      class W extends j {
        constructor(e) {
          super(e);
        }
          ...
          this.listenTo(this.model, "change", (e, t) => {
            ...
            this.once("remove", () => {
              "number" == typeof this.model.get("_view_count") &&
                (this.model.set("_view_count", this.model.get("_view_count") - 1), this.model.save_changes());
            }),
            this.once("displayed", () => {
              "number" == typeof this.model.get("_view_count") &&
                (this.model.set("_view_count", this.model.get("_view_count") + 1), this.model.save_changes());
        ...
        create_child_view(e, t = {}) {
          return (t = Object.assign({ parent: this }, t)), this.model.widget_manager.create_view(e, t).catch(d("Could not create child view", !0));
        }
        callbacks() {
      ...
      class I extends W {
                    ...
                    this.displayed.then(
                      () => (
                        ...
                        this.listenTo(e.model, "change", () => {
                          O.MessageLoop.postMessage(this.luminoWidget, E.Widget.ResizeMessage.UnknownSize);
                        }),
                        O.MessageLoop.postMessage(this.luminoWidget, E.Widget.ResizeMessage.UnknownSize),
          ...
          e &&
            (this.stylePromise = this.stylePromise.then(
              (t) => (
                ...
                this.create_child_view(e)
                  .then((e) => this.displayed.then(() => (e.trigger("displayed"), this.trigger("style-changed"), e)))
        ...
        update_classes(e, t, s) {
          void 0 === s && (s = this.el),
            r(e, t).map(function (e) {
              s.classList ? s.classList.remove(e) : s.setAttribute("class", s.getAttribute("class").replace(e, ""));
            }),
            r(t, e).map(function (e) {
              s.classList ? s.classList.add(e) : s.setAttribute("class", s.getAttribute("class").concat(" ", e));
            });
        }
        ...
        _setElement(e) {
          this.luminoWidget && this.luminoWidget.dispose(),
            ...
            (this.el = this.$el[0]),
            (this.luminoWidget = new A({ node: e, view: this }));
        }
        remove() {
      ...
      class D extends C {
        defaults() {
          return a(super.defaults(), { _model_name: "LayoutModel", _view_name: "LayoutView" }, J);
        }
      }
      class U extends W {
        initialize(e) {
          (this._traitNames = []), super.initialize(e);
          for (const e of Object.keys(J)) this.registerTrait(e);
        }
        registerTrait(e) {
      ...
      class R extends W {
        ...
        handleChange(e, t) {
          ...
          if (s) {
            ...
            if (null === t) for (let e = 0; e !== r.length; ++e) r[e].style.removeProperty(n);
            ...
            register_target(e, s) {
              const i = this.jsServicesKernel.registerCommTarget(e, (e, i) => {
                ...
                try {
                  ...
                  n.close(), console.error(e), console.error(new Error("Exception opening new comm"));
                }
              });
              this.targets[e] = i;
            }
              ...
              t &&
                ...
                (e.onIOPub = function (e) {
                  if (t.iopub)
                    ...
                    else if (t.iopub.clear_output && "clear_output" === e.header.msg_type) t.iopub.clear_output(e);
      ...
      class H {
        ...
        update(e, t, s, i) {
          ...
          let r = 0;
          for (; r < e.length && !(r >= this._models.length || e[r] !== this._models[r]); r++);
          const l = r,
          ...
          for (; r < e.length; r++) this.views.push(Promise.resolve(o.call(i, e[r], r)));
      ...
      const G = new i.Token("jupyter.extensions.jupyterWidgetRegistry");
      function q(e, t) {
      ...
      class F extends I {
        generateErrorMessage() {
          return { msg: this.model.get("msg"), stack: String(this.model.get("error").stack) };
        }
        render() {
          const { msg: e, stack: t } = this.generateErrorMessage();
          this.el.classList.add("jupyter-widgets");
          const s = document.createElement("div");
          s.classList.add("jupyter-widgets-error-widget", "icon-error"), (s.innerHTML = f);
