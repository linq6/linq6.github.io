    ...
    3586: (e, t, s) => {
      s.r(t),
        s.d(t, {
          ...
          ComboboxModel: () => bs,
          ComboboxView: () => vs,
          ControllerAxisModel: () => Qe,
          ControllerAxisView: () => Xe,
          ...
          IntsInputModel: () => Yt,
          IntsInputView: () => Qt,
          JUPYTER_CONTROLS_VERSION: () => n.A,
          JupyterLuminoAccordionWidget: () => Lt,
          JupyterLuminoTabPanelWidget: () => At,
          LabelModel: () => rs,
          LabelStyleModel: () => ts,
          LabelView: () => hs,
      ...
      class o extends i.StyleModel {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), {
            ...
            _model_module_version: n.A,
          });
        }
      }
      o.styleProperties = { description_width: { selector: ".widget-label", attribute: "width", default: null } };
      ...
      class h extends i.DOMWidgetView {
        ...
        typeset(e, t) {
          this.displayed.then(() => {
            var s, i, l;
            if (null === (i = null === (s = window.MathJax) || void 0 === s ? void 0 : s.Hub) || void 0 === i ? void 0 : i.Queue) return a(e, t);
            const d = null === (l = this.model.widget_manager._rendermime) || void 0 === l ? void 0 : l.latexTypesetter;
            d && (void 0 !== t && (e.textContent = t), d.typeset(e));
          });
        }
        updateDescription() {
      ...
      class _ extends p {
        ...
        initialize(e, t) {
          super.initialize(e, t), this.on("change", this.updateBindings, this), this.updateBindings();
        }
        updateValue(e, t, s, i) {
          if (!this._updating) {
            this._updating = !0;
        ...
        updateBindings() {
          this.cleanup(),
            ...
            this.targetModel && this.listenToOnce(this.targetModel, "destroy", this.cleanup);
        }
        cleanup() {
          this.sourceModel &&
            (this.stopListening(this.sourceModel, "change:" + this.sourceAttr, void 0), this.stopListening(this.sourceModel, "destroy", void 0)),
      ...
      class b extends _ {
        ...
        cleanup() {
          super.cleanup(), this.targetModel && this.stopListening(this.targetModel, "change:" + this.targetAttr, void 0);
        }
      }
      class v extends o {
        defaults() {
      ...
      class f extends m {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), { value: !1, disabled: !1, _model_name: "BoolModel" });
        }
      }
      class w extends m {
        defaults() {
      ...
      class y extends h {
        ...
        updateDescription() {
          ...
          const e = this.model.get("description");
          this.model.get("description_allow_html")
            ? (this.descriptionSpan.innerHTML = this.model.widget_manager.inline_sanitize(e))
        ...
        updateTooltip() {
          ...
          e ? 0 === this.model.get("description").length && this.checkbox.setAttribute("title", e) : this.checkbox.removeAttribute("title");
        }
        events() {
        ...
        update(e) {
          return (
            ...
            (void 0 !== e && e.updated_view == this) || (this.checkbox.disabled = this.model.get("disabled")),
            super.update()
          );
        }
        handle_message(e) {
          "focus" == e.do ? this.checkbox.focus() : "blur" == e.do && this.checkbox.blur();
        }
      }
      class C extends f {
        defaults() {
      ...
      class M extends i.DOMWidgetView {
        ...
        update(e) {
          if (
            (this.model.get("value") ? this.el.classList.add("mod-active") : this.el.classList.remove("mod-active"),
            ...
            if (0 === e.trim().length && 0 === t.trim().length) this.el.innerHTML = "&nbsp;";
            else {
              if (((this.el.textContent = ""), t.trim().length)) {
                const e = document.createElement("i");
                this.el.appendChild(e), e.classList.add("fa"), e.classList.add("fa-" + t);
              }
      ...
      M.class_map = { primary: ["mod-primary"], success: ["mod-success"], info: ["mod-info"], warning: ["mod-warning"], danger: ["mod-danger"] };
      class j extends f {
        defaults() {
        ...
        update() {
          this.el.classList.remove("mod-valid"),
            ...
            this.model.get("value")
              ? (this.el.classList.add("mod-valid"), this.icon.classList.add("fa-check"))
              : (this.el.classList.add("mod-invalid"), this.icon.classList.add("fa-times"));
        }
      }
      ...
      class k extends i.DOMWidgetView {
        ...
        update() {
          ...
          if ((this.el.setAttribute("title", null != e ? e : t), t.length || s.length)) {
      ...
      k.class_map = { primary: ["mod-primary"], success: ["mod-success"], info: ["mod-info"], warning: ["mod-warning"], danger: ["mod-danger"] };
      var L = s(4053),
        V = s(6230),
        I = s(5256),
        A = s(8596),
      ...
      E.serializers = Object.assign(Object.assign({}, g.serializers), { children: { deserialize: i.unpack_models } });
      class B extends E {
        defaults() {
      ...
      class D extends i.DOMWidgetView {
        _createElement(e) {
          return (this.luminoWidget = new i.JupyterLuminoPanelWidget({ view: this })), this.luminoWidget.node;
        }
        _setElement(e) {
          if (this.el || e !== this.luminoWidget.node) throw new Error("Cannot reset the DOM element.");
          (this.el = this.luminoWidget.node), (this.$el = W()(this.luminoWidget.node));
        }
        initialize(e) {
          super.initialize(e),
        ...
        update_children() {
          ...
          null === (e = this.children_views) ||
            ...
            e.update(this.model.get("children")).then((e) => {
              e.forEach((e) => {
                V.MessageLoop.postMessage(e.luminoWidget, I.Widget.ResizeMessage.UnknownSize);
              });
            });
        }
        update_box_style() {
          ...
          return (
            ...
            this.create_child_view(e)
              .then((e) => {
                ...
                return this.luminoWidget.insertWidget(s, e.luminoWidget), t.dispose(), e;
              })
      ...
      class F extends D {
        initialize(e) {
          super.initialize(e), this.luminoWidget.addClass("widget-gridbox"), this.luminoWidget.removeClass("widget-box");
        }
      }
      class R extends E {
        defaults() {
      ...
      $.serializers = Object.assign(Object.assign({}, g.serializers), { value: { serialize: (e) => new DataView(e.buffer.slice(0)) } });
      class N extends i.DOMWidgetView {
        render() {
          super.render(), this.luminoWidget.addClass("jupyter-widgets"), this.luminoWidget.addClass("widget-image"), this.update();
        }
        update() {
          let e;
          ...
          void 0 !== a && a.length > 0 ? this.el.setAttribute("width", a) : this.el.removeAttribute("width");
          const l = this.model.get("height");
          return void 0 !== l && l.length > 0 ? this.el.setAttribute("height", l) : this.el.removeAttribute("height"), super.update();
        }
        remove() {
      ...
      H.serializers = Object.assign(Object.assign({}, g.serializers), { value: { serialize: (e) => new DataView(e.buffer.slice(0)) } });
      class K extends i.DOMWidgetView {
        render() {
          super.render(), this.luminoWidget.addClass("jupyter-widgets"), this.luminoWidget.addClass("widget-image"), this.update();
        }
        update() {
          ...
          const l = this.model.get("height");
          return (
            void 0 !== l && l.length > 0 ? this.el.setAttribute("height", l) : this.el.removeAttribute("height"),
      ...
      q.serializers = Object.assign(Object.assign({}, g.serializers), { value: { serialize: (e) => new DataView(e.buffer.slice(0)) } });
      ...
      class Q extends h {
        ...
        events() {
          return this._picker_change, this._text_change, { 'change [type="color"]': "_picker_change", 'change [type="text"]': "_text_change" };
        }
        _update_value() {
          const e = this.model.get("value");
          var t, s;
          (this._colorpicker.value =
            J[(t = e).toLowerCase()] ||
            (7 === (s = t).length ? s : "#" + s.charAt(1) + s.charAt(1) + s.charAt(2) + s.charAt(2) + s.charAt(3) + s.charAt(3))),
        ...
        _validate_color(e, t) {
          return e.match(/#[a-fA-F0-9]{3}(?:[a-fA-F0-9]{3})?$/) || J[e.toLowerCase()] ? e : t;
        }
      }
      function X(e) {
        return null === e ? null : { year: e.getUTCFullYear(), month: e.getUTCMonth(), date: e.getUTCDate() };
      }
      function Z(e) {
        if (null === e) return null;
        {
          const t = new Date();
          return t.setUTCFullYear(e.year, e.month, e.date), t.setUTCHours(0, 0, 0, 0), t;
        }
      }
      class ee extends m {
        defaults() {
      ...
      ee.serializers = Object.assign(Object.assign({}, m.serializers), { value: { serialize: X, deserialize: Z } });
      class te extends h {
        render() {
          super.render(),
            this.el.classList.add("jupyter-widgets"),
        ...
        update(e) {
          return (void 0 !== e && e.updated_view === this) || (this._datepicker.disabled = this.model.get("disabled")), super.update();
        }
        events() {
          return (
            this._picker_change, this._picker_focusout, { 'change [type="date"]': "_picker_change", 'focusout [type="date"]': "_picker_focusout" }
          );
        }
        _update_value() {
          const e = this.model.get("value");
        ...
        _picker_change() {
          this._datepicker.validity.badInput || (this.model.set("value", this._datepicker.valueAsDate), this.touch());
        }
        _picker_focusout() {
          this._datepicker.validity.badInput && (this.model.set("value", null), this.touch());
        }
      }
      ...
      function ae(e) {
        if (null === e) return null;
        {
          const t = [`${e.hours.toString().padStart(2, "0")}:${e.minutes.toString().padStart(2, "0")}`];
          return (
            (e.seconds > 0 || e.milliseconds > 0) &&
              (t.push(`:${e.seconds.toString().padStart(2, "0")}`), e.milliseconds > 0 && t.push(`.${e.milliseconds.toString().padStart(3, "0")}`)),
            t.join("")
          );
        }
      }
      ...
      (de.serializers = Object.assign(Object.assign({}, m.serializers), { value: le, min: le, max: le })),
      ...
      class ne extends h {
        ...
        events() {
          return (
            this._picker_change, this._picker_focusout, { 'change [type="time"]': "_picker_change", 'focusout [type="time"]': "_picker_focusout" }
          );
        }
        _update_value(e, t, s) {
          (void 0 !== s && s.updated_view === this) || (this._timepicker.value = this.model.get("value"));
        }
        _picker_change() {
          this._timepicker.validity.badInput || (this.model.set("value", this._timepicker.value, { updated_view: this }), this.touch());
        }
        _picker_focusout() {
          this._timepicker.validity.badInput && (this.model.set("value", null, { updated_view: this }), this.touch());
        }
      }
      function oe(e) {
        return null === e
      ...
      function re(e) {
        ...
        {
          const t = new Date();
          return t.setUTCFullYear(e.year, e.month, e.date), t.setUTCHours(e.hours, e.minutes, e.seconds, e.milliseconds), t;
        }
      }
      ...
      ue.serializers = Object.assign(Object.assign({}, m.serializers), { value: he, min: he, max: he });
      class ce extends h {
        render() {
          super.render(),
            this.el.classList.add("jupyter-widgets"),
        ...
        _update_value(e, t, s) {
          if (void 0 === s || s.updated_view !== this) {
            ...
            this._datetimepicker
              ...
              : ((this._datepicker.valueAsDate = e), (this._timepicker.value = pe.dt_as_time_string(e)));
          }
        }
        _picker_change() {
          if (this._datetimepicker) {
            if (!this._datetimepicker.validity.badInput) {
              ...
              t && isNaN(t.valueOf()) && (t = null), this.model.set("value", t, { updated_view: this }), this.touch();
            }
          } else if (!this._datepicker.validity.badInput && !this._timepicker.validity.badInput) {
            const e = this._datepicker.valueAsDate,
              t = ie(this._timepicker.value);
            null !== e && null !== t && e.setHours(t.hours, t.minutes, t.seconds, t.milliseconds),
              this.model.set("value", null !== t && e, { updated_view: this }),
              this.touch();
          }
        }
        _picker_focusout() {
          [this._datetimepicker, this._datepicker, this._timepicker].some((e) => e && e.validity.badInput) &&
      ...
      function me(e) {
        ...
        {
          const t = new Date();
          return t.setFullYear(e.year, e.month, e.date), t.setHours(e.hours, e.minutes, e.seconds, e.milliseconds), t;
        }
      }
      !(function (e) {
        function t(e) {
          ...
          return (
            ...
            (e.getSeconds() > 0 || e.getMilliseconds() > 0) &&
              ...
              e.getMilliseconds() > 0 && t.push(`.${e.getMilliseconds().toString().padStart(3, "0")}`)),
            t.join("")
          );
        }
        (e.dt_as_dt_string = t),
      ...
      be.serializers = Object.assign(Object.assign({}, m.serializers), { value: _e, min: _e, max: _e });
      var ve = s(7102),
        xe = s(5715),
        fe = s.n(xe);
      class we extends m {
      ...
      Ce.styleProperties = Object.assign(Object.assign({}, o.styleProperties), {
        handle_color: { selector: ".noUi-handle", attribute: "background-color", default: null },
      });
      class Me extends ye {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), {
        ...
        initialize(e, t) {
          super.initialize(e, t), this.on("change:readout_format", this.update_readout_format, this), this.update_readout_format();
        }
        update_readout_format() {
          this.readout_formatter = (0, ve.GP)(this.get("readout_format"));
        }
      }
      class je extends Me {}
      class Te extends h {
          ...
          return (
            (void 0 !== e && e.updated_view === this) ||
              (this.model.get("disabled")
                ? ((this.readout.contentEditable = "false"), this.$slider.setAttribute("disabled", !0))
                : ((this.readout.contentEditable = "true"), this.$slider.removeAttribute("disabled")),
              ...
              this.model.get("readout")
                ? ((this.readout.style.display = ""),
                  this.displayed.then(() => {
                    this.readout_overflow() ? this.readout.classList.add("overflow") : this.readout.classList.remove("overflow");
                  }))
                : (this.readout.style.display = "none")),
            super.update()
          );
        ...
        events() {
          return { "blur [contentEditable=true]": "handleTextChange", "keydown [contentEditable=true]": "handleKeyDown" };
        }
        handleKeyDown(e) {
        ...
        createSlider() {
          ...
          fe().create(this.$slider, {
            ...
            format: { from: (e) => Number(e), to: (e) => this._validate_slide_value(e) },
          }),
      ...
      class Se extends Te {
        constructor() {
          super(...arguments), (this._range_regex = /^\s*([+-]?\d+)\s*[-:–]\s*([+-]?\d+)/);
        }
        update(e) {
          super.update(e);
          const t = this.model.get("value");
          (this.readout.textContent = this.valueToString(t)),
            this.model.get("value") !== t && (this.model.set("value", t, { updated_view: this }), this.touch());
        }
        valueToString(e) {
          ...
          null === e || isNaN(e[0]) || isNaN(e[1]) || e[0] > e[1]
            ...
            : ((e = [Math.max(Math.min(e[0], s), t), Math.max(Math.min(e[1], s), t)]),
              e[0] !== this.model.get("value")[0] || e[1] !== this.model.get("value")[1]
                ? ((this.readout.textContent = this.valueToString(e)), this.model.set("value", e), this.touch())
                : (this.readout.textContent = this.valueToString(this.model.get("value"))));
        }
        handleSliderChangeEvent(e, t) {
          const s = e.map(this._validate_slide_value);
          (this.readout.textContent = this.valueToString(s)), this.handleSliderChanged(e, t);
        }
        handleSliderUpdateEvent(e, t) {
          const s = e.map(this._validate_slide_value);
          (this.readout.textContent = this.valueToString(s)), this.model.get("continuous_update") && this.handleSliderChanged(e, t);
        }
      ...
      class Oe extends Te {
        update(e) {
          ...
          i > s ? (i = s) : i < t && (i = t),
            ...
            this.model.get("value") !== i && (this.model.set("value", i, { updated_view: this }), this.touch());
        }
        valueToString(e) {
        ...
        handleTextChange() {
          var e;
          let t = this.stringToValue(null !== (e = this.readout.textContent) && void 0 !== e ? e : "");
          ...
          isNaN(t)
            ...
            : ((t = Math.max(Math.min(t, i), s)),
              t !== this.model.get("value")
                ? ((this.readout.textContent = this.valueToString(t)), this.model.set("value", t), this.touch())
                : (this.readout.textContent = this.valueToString(this.model.get("value"))));
        }
        handleSliderChangeEvent(e, t) {
          const s = e.map(this._validate_slide_value);
        ...
        handleSliderChanged(e, t) {
          ...
          parseFloat(i) !== s && (this.model.set("value", s, { updated_view: this }), this.touch());
        }
        updateSliderOptions(e) {
          this.$slider.noUiSlider.updateOptions({
            start: this.model.get("value"),
      ...
      class Ve extends h {
        constructor() {
          super(...arguments), (this._parse_value = parseInt), (this._default_step = "1");
        }
        render() {
          super.render(),
            this.el.classList.add("jupyter-widgets"),
        ...
        update(e) {
          if (void 0 === e || e.updated_view !== this) {
            const e = this.model.get("value");
            this._parse_value(this.textbox.value) !== e && (this.textbox.value = e.toString()),
              void 0 !== this.model.get("min") && (this.textbox.min = this.model.get("min")),
              void 0 !== this.model.get("max") && (this.textbox.max = this.model.get("max")),
        ...
        handleChanging(e) {
          ...
          "" === t || ["-", "-.", ".", "+.", "+"].indexOf(t) >= 0 || (this.model.get("continuous_update") && this.handleChanged(e));
        }
        handleChanged(e) {
          const t = e.target;
          ...
          if (isNaN(s)) t.value = this.model.get("value");
            ...
            let e = s;
            void 0 !== this.model.get("max") && (e = Math.min(this.model.get("max"), e)),
              void 0 !== this.model.get("min") && (e = Math.max(this.model.get("min"), e)),
              e !== s && ((t.value = e), (s = e)),
              s !== this.model.get("value") && (this.model.set("value", s, { updated_view: this }), this.touch());
          }
        }
      }
      class Ie extends o {
      ...
      Ie.styleProperties = Object.assign(Object.assign({}, o.styleProperties), {
        bar_color: { selector: ".progress-bar", attribute: "background-color", default: null },
      });
      class Ae extends ye {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), {
      ...
      class We extends h {
        initialize(e) {
          super.initialize(e), this.listenTo(this.model, "change:bar_style", this.update_bar_style), this.luminoWidget.addClass("jupyter-widgets");
        }
        render() {
          super.render();
          const e = "horizontal" === this.model.get("orientation") ? "widget-hprogress" : "widget-vprogress";
        ...
        update_bar_style() {
          this.update_mapped_classes(We.class_map, "bar_style", this.bar);
        }
        set_bar_style() {
          this.set_mapped_classes(We.class_map, "bar_style", this.bar);
        }
      }
      We.class_map = {
      ...
      class Ee extends ye {
        ...
        pause() {
          window.clearTimeout(this._timerId), (this._timerId = void 0), this.set("playing", !1), this.save_changes();
        }
        animate() {
          void 0 === this._timerId &&
            (this.get("value") === this.get("max") ? (this.set("value", this.get("min")), this.schedule_next(), this.save_changes()) : this.loop(),
            this.save_changes());
        }
        play() {
      ...
      class Be extends i.DOMWidgetView {
        ...
        update() {
          const e = this.model.get("disabled");
          (this.playPauseButton.disabled = e), (this.stopButton.disabled = e), (this.repeatButton.disabled = e), this.updatePlaying();
        }
        onPlayingChanged() {
          this.updatePlaying();
        ...
        updatePlaying() {
          ...
          this.playPauseButton.getElementsByTagName("i")[0].className = e ? "fa fa-pause" : "fa fa-play";
        }
        updateRepeat() {
          ...
          (this.repeatButton.style.display = this.model.get("show_repeat") ? this.playPauseButton.style.display : "none"),
            e ? this.repeatButton.classList.add("mod-active") : this.repeatButton.classList.remove("mod-active");
        }
      }
      class ze extends m {
        defaults() {
      ...
      class $e extends Te {
        ...
        handleSliderUpdateEvent(e, t) {
          ...
          (this.readout.textContent = this.valueToString(i)), this.model.get("continuous_update") && this.handleSliderChanged(e, t);
        }
        handleSliderChangeEvent(e, t) {
          const s = this.model.get("base"),
            i = Math.pow(s, this._validate_slide_value(e[0]));
          (this.readout.textContent = this.valueToString(i)), this.handleSliderChanged(e, t);
        }
        handleSliderChanged(e, t) {
      ...
      class qe extends Ve {
        constructor() {
          super(...arguments), (this._parse_value = parseFloat), (this._default_step = "any");
        }
        handleKeypress(e) {
          e.stopPropagation();
        }
      ...
      class Xe extends i.DOMWidgetView {
        render() {
          this.el.classList.add("jupyter-widgets"),
      ...
      class Ze extends g {
        ...
        initialize(e, t) {
          super.initialize(e, t),
            void 0 === navigator.getGamepads
              ? ((this.readout = "This browser does not support gamepads."), console.error(this.readout))
              : ((this.readout = "Connect gamepad and press any button."), this.get("connected") ? this.update_loop() : this.wait_loop());
        }
        wait_loop() {
          ...
          t
            ? this.setup(t).then((e) => {
                this.set(e), this.save_changes(), window.requestAnimationFrame(this.update_loop.bind(this));
              })
            : window.requestAnimationFrame(this.wait_loop.bind(this));
        }
        setup(e) {
          return (
            this.set({ name: e.id, mapping: e.mapping, connected: e.connected, timestamp: e.timestamp }),
            i.resolvePromisesDict({
              buttons: Promise.all(e.buttons.map((e, t) => this._create_button_model(t))),
          ...
          s && e === s.index && t === s.id
            ? (this.set({ timestamp: s.timestamp, connected: s.connected }),
              ...
              this.get("buttons").forEach(function (e, t) {
                e.set({ value: s.buttons[t].value, pressed: s.buttons[t].pressed }), e.save_changes();
              }),
        ...
        reset_gamepad() {
          this.get("buttons").forEach(function (e) {
            ...
            this.set({ name: "", mapping: "", connected: !1, timestamp: 0, buttons: [], axes: [] }),
            this.save_changes(),
            window.requestAnimationFrame(this.wait_loop.bind(this));
        }
      ...
      Ze.serializers = Object.assign(Object.assign({}, g.serializers), {
      ...
      class tt extends m {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), { _model_name: "SelectionModel", index: "", _options_labels: [], disabled: !1 });
        }
      }
      class st extends h {
        render() {
          super.render(), this.el.classList.add("jupyter-widgets"), this.el.classList.add("widget-inline-hbox");
        }
        update() {
          super.update(), this.listbox && (this.listbox.disabled = this.model.get("disabled")), this.updateTabindex(), this.updateTooltip();
        }
        updateTabindex() {
        ...
        updateTooltip() {
          if (!this.listbox) return;
          const e = this.model.get("tooltip");
          e ? 0 === this.model.get("description").length && this.listbox.setAttribute("title", e) : this.listbox.removeAttribute("title");
        }
      }
      class it extends tt {
        defaults() {
      ...
      class at extends st {
        ...
        update(e) {
          (null == e ? void 0 : e.updated_view) !== this && this.model.hasChanged("_options_labels") && this._updateOptions();
        ...
        _updateOptions() {
          ...
          for (let t = 0; t < e.length; t++) {
            ...
            (i.textContent = s.replace(/ /g, " ")), i.setAttribute("data-value", encodeURIComponent(s)), (i.value = s), this.listbox.appendChild(i);
          }
        }
        events() {
        ...
        _handle_change() {
          this.model.set("index", -1 === this.listbox.selectedIndex ? null : this.listbox.selectedIndex, { updated_view: this }), this.touch();
        }
        handle_message(e) {
          "focus" === e.do ? this.listbox.focus() : "blur" === e.do && this.listbox.blur();
        }
      }
      class lt extends tt {
        defaults() {
      ...
      class dt extends st {
        ...
        updateSelection(e) {
          (e = e || this.model.get("index")), (this.listbox.selectedIndex = null === e ? -1 : e);
        }
        _updateOptions() {
          this.listbox.textContent = "";
          const e = this.model.get("_options_labels");
        ...
        _handle_change() {
          this.model.set("index", this.listbox.selectedIndex, { updated_view: this }), this.touch();
        }
        handle_message(e) {
          "focus" == e.do ? this.listbox.focus() : "blur" == e.do && this.listbox.blur();
        }
      ...
      class ot extends h {
        ...
        update(e) {
          "vertical" === this.model.get("orientation")
            ? (this.container.classList.remove("widget-radio-box-horizontal"), this.container.classList.add("widget-radio-box-vertical"))
            : (this.container.classList.remove("widget-radio-box-vertical"), this.container.classList.add("widget-radio-box-horizontal"));
          const t = this.model.get("_options_labels"),
            s = Array.from(this.container.querySelectorAll('input[type="radio"]')).map((e) => e.value);
          ...
          return (
            !i ||
              ...
              t.forEach((e, t) => {
                ...
                i.setAttribute("type", "radio"), (i.value = t.toString()), i.setAttribute("data-value", encodeURIComponent(e)), s.appendChild(i);
              })),
            t.forEach((e, t) => {
              ...
              if (i.length > 0) {
                const e = i[0];
                (e.checked = this.model.get("index") === t), (e.disabled = this.model.get("disabled"));
              }
            }),
        ...
        _handle_click(e) {
          const t = e.target;
          this.model.set("index", parseInt(t.value, 10), { updated_view: this }), this.touch();
        }
        handle_message(e) {
          if ("focus" == e.do) this.container.firstElementChild.focus();
          else if ("blur" == e.do) for (let e = 0; e < this.container.children.length; e++) this.container.children[e].blur();
        }
      }
      class rt extends o {
        defaults() {
      ...
      rt.styleProperties = Object.assign(Object.assign({}, o.styleProperties), {
        button_width: { selector: ".widget-toggle-button", attribute: "width", default: null },
        font_weight: { selector: ".widget-toggle-button", attribute: "font-weight", default: "" },
      });
      class ht extends tt {
        defaults() {
      ...
      class ut extends h {
        initialize(e) {
          (this._css_state = {}), super.initialize(e), this.listenTo(this.model, "change:button_style", this.update_button_style);
        }
        render() {
          super.render(),
        ...
        update(e) {
          ...
          return (
            !h ||
              ...
              t.forEach((e, t) => {
                let i;
                i = 0 !== e.trim().length || (s[t] && 0 !== s[t].trim().length) ? l(e) : "&nbsp;";
            ...
            t.forEach((e, t) => {
              ...
              this.model.get("index") === t ? i.classList.add("mod-active") : i.classList.remove("mod-active");
            }),
        ...
        update_button_style() {
          const e = this.buttongroup.querySelectorAll("button");
          for (let t = 0; t < e.length; t++) this.update_mapped_classes(ut.classMap, "button_style", e[t]);
        }
        set_button_style() {
          const e = this.buttongroup.querySelectorAll("button");
          for (let t = 0; t < e.length; t++) this.set_mapped_classes(ut.classMap, "button_style", e[t]);
        }
        events() {
        ...
        _handle_click(e) {
          const t = e.target;
          this.model.set("index", parseInt(t.value, 10), { updated_view: this }), this.touch(), this.send({ event: "click" });
        }
      }
      !(function (e) {
        e.classMap = { primary: ["mod-primary"], success: ["mod-success"], info: ["mod-info"], warning: ["mod-warning"], danger: ["mod-danger"] };
      })(ut || (ut = {}));
      class ct extends tt {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), {
      ...
      class pt extends h {
        ...
        handleSliderUpdateEvent(e, t) {
          const s = e[0];
          this.updateReadout(s), this.model.get("continuous_update") && this.handleSliderChanged(e, t);
        }
        handleSliderChangeEvent(e, t) {
          const s = e[0];
        ...
        handleSliderChanged(e, t) {
          const s = e[0];
          this.updateReadout(s), this.model.set("index", s, { updated_view: this }), this.touch();
        }
        updateSliderOptions(e) {
          const t = this.model.get("_options_labels").length - 1;
          this.$slider.noUiSlider.updateOptions({ start: this.model.get("index"), range: { min: 0, max: t }, step: 1 });
        }
        updateSliderValue(e, t, s) {
          if (s.updated_view === this) return;
          const i = this.$slider.noUiSlider.get(),
      ...
      class _t extends dt {
        ...
        _handle_change() {
          const e = Array.prototype.map.call(this.listbox.selectedOptions || [], function (e) {
            return e.index;
          });
      ...
      class vt extends pt {
        ...
        handleSliderChanged(e, t) {
          ...
          this.updateReadout(s), this.model.set("index", s.slice(), { updated_view: this }), this.touch();
        }
        updateSliderValue(e, t, s) {
          if (s.updated_view === this) return;
      ...
      class yt extends I.Widget {
        ...
        insertWidget(e, t) {
          t !== this.currentWidget && t.hide(), this.tabContents.insertWidget(e, t), this.tabBar.insertTab(e, t.title);
        }
        _onCurrentChanged(e, t) {
          const { previousIndex: s, previousTitle: i, currentIndex: a, currentTitle: l } = t,
            d = i ? i.owner : null,
            n = l ? l.owner : null;
          d && d.hide(),
            n && n.show(),
            this._currentChanged.emit({ previousIndex: s, previousWidget: d, currentIndex: a, currentWidget: n }),
      ...
      class Ct {
        ...
        adjustSelectionForSet(e) {
          ...
          const i = this.value;
          (this._previousValue = null),
            s !== i && this._selectionChanged.emit({ previousIndex: t, previousValue: s, currentIndex: t, currentValue: i });
        }
        get value() {
          return this._value;
        }
        set value(e) {
          null === e || null === this._array ? (this.index = null) : (this.index = L.ArrayExt.firstIndexOf(this._array, e));
        }
        get index() {
          return this._index;
        }
        set index(e) {
          let t;
          if (
            (null !== e && null !== this._array ? ((t = Math.floor(e)), (t < 0 || t >= this._array.length) && (t = null)) : (t = null),
            this._index === t)
          )
            return;
          const s = this._index,
          ...
          (this._index = t),
            ...
            this._selectionChanged.emit({ previousIndex: s, previousValue: i, currentIndex: t, currentValue: this._value });
        }
        get insertBehavior() {
        ...
        adjustSelectionForInsert(e, t) {
          ...
          if ("select-item" === a || ("select-item-if-needed" === a && null === i))
            return (
              ...
              void this._selectionChanged.emit({ previousIndex: i, previousValue: s, currentIndex: e, currentValue: t })
            );
        ...
        clearSelection() {
          ...
          (this._index = null),
            (this._value = null),
            (this._previousValue = null),
            null !== e && this._selectionChanged.emit({ previousIndex: e, previousValue: t, currentIndex: this._index, currentValue: this._value });
        }
          ...
          if (s === e) {
            if (!this._array || 0 === this._array.length)
              return (
                ...
                (this._value = null),
                (this._previousValue = null),
                void this._selectionChanged.emit({ previousIndex: e, previousValue: t, currentIndex: this._index, currentValue: this._value })
              );
            ...
            if ("select-previous-item" === i)
              return (
                this._previousValue
                  ...
                  : ((this._index = Math.min(e, this._array.length - 1)), this._updateSelectedValue()),
                (this._previousValue = null),
                void this._selectionChanged.emit({ previousIndex: e, previousValue: t, currentIndex: this._index, currentValue: this.value })
              );
            (this._index = null),
              (this._value = null),
              (this._previousValue = null),
              this._selectionChanged.emit({ previousIndex: e, previousValue: t, currentIndex: this._index, currentValue: this._value });
      ...
      class jt extends I.Widget {
        constructor(e) {
          ...
          (this.layout = s), s.addWidget(this._header), s.addWidget(this._content), e.widget && (this.widget = e.widget), (this.collapsed = !1);
        }
        dispose() {
          this.isDisposed || (super.dispose(), (this._header = null), (this._widget = null), (this._content = null));
        }
        get widget() {
          return this._widget;
        }
        set widget(e) {
          ...
          t && (t.disposed.disconnect(this._onChildDisposed, this), t.title.changed.disconnect(this._onTitleChanged, this), (t.parent = null)),
            (this._widget = e),
      ...
      class St extends I.Panel {
        ...
        addWidget(e) {
          ...
          return (t.collapsed = !0), super.addWidget(t), this._selection.adjustSelectionForInsert(this.widgets.length - 1, t), t;
        }
        insertWidget(e, t) {
          const s = this._wrapWidget(t);
          (s.collapsed = !0), super.insertWidget(e, s), this._selection.adjustSelectionForInsert(e, s);
        }
        removeWidget(e) {
          const t = this.indexOf(e);
          if (t >= 0) {
            const s = this.collapseWidgets[t];
            (e.parent = null), s.dispose(), this._selection.adjustSelectionForRemove(t, null);
          }
        }
        _wrapWidget(e) {
          const t = new jt({ widget: e });
          return t.addClass("jupyter-widget-Accordion-child"), t.collapseChanged.connect(this._onCollapseChange, this), t;
        }
        _onCollapseChange(e) {
          e.collapsed ? this._selection.value === e && e.collapsed && (this._selection.value = null) : (this._selection.value = e);
        }
        _onSelectionChanged(e, t) {
          const s = t.previousValue,
            i = t.currentValue;
          s && ((s.collapsed = !0), s.removeClass(Tt)), i && ((i.collapsed = !1), i.addClass(Tt));
        }
      }
      class Ot extends E {
        defaults() {
      ...
      class Lt extends St {
        ...
        processMessage(e) {
          var t;
          super.processMessage(e), null === (t = this._view) || void 0 === t || t.processLuminoMessage(e);
        }
        dispose() {
      ...
      class Vt extends i.DOMWidgetView {
        ...
        initialize(e) {
          super.initialize(e),
            (this.children_views = new i.ViewList(this.add_child_view, this.remove_child_view, this)),
        ...
        render() {
          ...
          t.addClass("jupyter-widgets"),
            ...
            t.selection.selectionChanged.connect((e) => {
              this.updatingChildren || (this.model.set("selected_index", t.selection.index), this.touch());
            }),
            null === (e = this.children_views) || void 0 === e || e.update(this.model.get("children")),
            this.update_titles(),
        ...
        update_titles() {
          ...
          for (let s = 0; s < e.length; s++) void 0 !== t[s] && (e[s].widget.title.label = t[s]);
        }
          ...
          return (
            ...
            this.create_child_view(e)
              .then((e) => {
                ...
                return (t.title.label = a.title.label), (s.collapseWidgets[s.indexOf(a)].widget = t), a.dispose(), e;
              })
              .catch((0, i.reject)("Could not add child view to box", !0))
          );
        }
      ...
      class At extends yt {
        constructor(e) {
          ...
          delete e.view,
            super(e),
            (this._view = t),
            V.MessageLoop.installMessageHook(this.tabContents, (e, t) => (this._view.processLuminoMessage(t), !0));
        }
        dispose() {
          this.isDisposed || (super.dispose(), this._view.remove(), (this._view = null));
        }
      }
      class Wt extends i.DOMWidgetView {
        constructor() {
          super(...arguments), (this.updatingTabs = !1);
        }
        _createElement(e) {
          return (this.luminoWidget = new At({ view: this })), this.luminoWidget.node;
        }
        _setElement(e) {
          if (this.el || e !== this.luminoWidget.node) throw new Error("Cannot reset the DOM element.");
          (this.el = this.luminoWidget.node), (this.$el = W()(this.luminoWidget.node));
        ...
        updateTabs() {
          ...
          (this.updatingTabs = !0),
            ...
            null === (e = this.childrenViews) || void 0 === e || e.update(this.model.get("children")),
        ...
        _onTabMoved(e, t) {
          ...
          L.ArrayExt.move(s, t.fromIndex, t.toIndex), this.model.set("children", s), this.touch();
        }
      }
      class Et extends Ot {
        defaults() {
      ...
      class Bt extends D {
        initialize(e) {
          super.initialize(e), this.listenTo(this.model, "change:selected_index", this.update_children);
        }
        update_children() {
          var e;
          let t;
          (t = null === this.model.get("selected_index") ? [] : [this.model.get("children")[this.model.get("selected_index")]]),
            null === (e = this.children_views) ||
              void 0 === e ||
              e.update(t).then((e) => {
                e.forEach((e) => {
      ...
      class Pt {
        ...
        isSelected(e) {
          let t, s;
          return this.dx >= 0 ? ((t = this.start), (s = this.start + this.dx)) : ((t = this.start + this.dx), (s = this.start)), t <= e && e < s;
        }
        updateSelection(e) {
          (this.dx += e), this.start + this.dx > this.max && (this.dx = this.max - this.start), this.start + this.dx < 0 && (this.dx = -this.start);
        }
      }
      class Ut extends g {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), { value: [], placeholder: "​", allowed_tags: null, allow_duplicates: !0 });
        }
      }
      class Ft extends i.DOMWidgetView {
        ...
        render() {
          super.render(),
            ...
            this.model.get("value").length ? (this.taginputWrapper.style.display = "none") : (this.taginputWrapper.style.display = "inline-block"),
            ...
            (this.el.ondrop = (e) => {
              const t = null == this.hoveredTagIndex ? this.tags.length : this.hoveredTagIndex;
        ...
        update() {
          ...
          for (const t in e) {
            const s = parseInt(t),
              i = this.createTag(e[s], s, null != this.selection && this.selection.isSelected(s));
            (i.draggable = !0),
              (i.ondragstart = ((e, t) => (s) => {
        ...
        updatePlaceholder() {
          (this.taginput.placeholder = this.model.get("placeholder")), this.resizeInput();
        }
        updateTags() {
          const e = this.model.get("value");
          for (const t in this.tags) {
            const s = parseInt(t);
            this.updateTag(this.tags[s], e[s], s, null != this.selection && this.selection.isSelected(s));
          }
        }
        handleValueAdded(e) {
          const t = this.taginput.value.replace(/^\s+|\s+$/g, ""),
            s = this.inputIndex;
          "" != t && (this.inputIndex++, this.addTag(s, t) && ((this.taginput.value = ""), this.resizeInput(), this.focus()));
        }
        addTag(e, t) {
          ...
          this.selection = null;
          const l = [...s];
          return l.splice(e, 0, i), this.model.set("value", l), this.model.save_changes(), !0;
        }
        resizeInput() {
          let e;
          e = 0 != this.taginput.value.length ? this.taginput.value : this.model.get("placeholder");
          const t = e.length + 1;
        ...
        handleKeyEvent(e) {
          ...
          switch (e.key) {
            ...
            case "ArrowRight":
              ...
              break;
            case "Backspace":
              this.selection ? this.removeSelectedTags() : this.removeTag(this.inputIndex - 1);
              break;
            case "Delete":
              this.selection ? this.removeSelectedTags() : this.removeTag(this.inputIndex);
              break;
            default:
              return;
          }
          ...
          e.shiftKey || (this.selection = null),
            (this.inputIndex = ((i = this.inputIndex), 0, (a = t), Math.min(Math.max(i, 0), a))),
            this.update(),
            this.focus();
        }
        ondragstart(e, t, s, i) {
          null != e.dataTransfer &&
            (e.dataTransfer.setData("index", String(t)), e.dataTransfer.setData("tagValue", String(s)), e.dataTransfer.setData("origin", i));
        }
        ondrop(e, t) {
          ...
          if (!isNaN(i)) {
            if (a) {
              const e = [...this.model.get("value")];
              return i < t && t--, e.splice(i, 1), e.splice(t, 0, s), this.model.set("value", e), void this.model.save_changes();
            }
            this.addTag(t, s);
          }
        }
        ...
        ondragenter(e, t) {
          null != this.hoveredTag && this.hoveredTag != this.tags[t] && (this.hoveredTag.style.marginLeft = "1px"),
            (this.hoveredTag = this.tags[t]),
            (this.hoveredTagIndex = t),
            (this.hoveredTag.style.marginLeft = "30px");
        }
        ondragend() {
          null != this.hoveredTag && (this.hoveredTag.style.marginLeft = "1px"), (this.hoveredTag = null), (this.hoveredTagIndex = null);
        }
        select(e, t) {
          const s = this.model.get("value").length;
          this.selection ? this.selection.updateSelection(t) : (this.selection = new Pt(e, t, s));
        }
        removeSelectedTags() {
          const e = [...this.model.get("value")];
          for (let t = e.length - 1; t >= 0; t--)
            null != this.selection && this.selection.isSelected(t) && (e.splice(t, 1), t < this.inputIndex && this.inputIndex--);
          this.model.set("value", e), this.model.save_changes();
        }
        removeTag(e) {
          const t = [...this.model.get("value")];
          t.splice(e, 1), e < this.inputIndex && this.inputIndex--, this.model.set("value", t), this.model.save_changes();
        }
        focus() {
        ...
        loseFocus() {
          this.preventLoosingFocus ||
            (this.model.get("value").length && (this.taginputWrapper.style.display = "none"), (this.selection = null), this.updateTags());
        }
        preinitialize() {
          this.tagName = "div";
        }
      ...
      $t.class_map = { primary: "mod-primary", success: "mod-success", info: "mod-info", warning: "mod-warning", danger: "mod-danger" };
      class Nt extends Ut {
        defaults() {
      ...
      class Ht extends Ft {
        createTag(e, t, s) {
          const i = document.createElement("div"),
            a = e,
            l = zt.Ay(e).darker().toString();
          i.classList.add("jupyter-widget-tag"),
            i.classList.add("jupyter-widget-colortag"),
            s ? (i.classList.add("mod-active"), (i.style.backgroundColor = l)) : (i.style.backgroundColor = a);
        ...
        updateTag(e, t, s, i) {
          const a = t,
            l = zt.Ay(t).darker().toString();
          i ? (e.classList.add("mod-active"), (e.style.backgroundColor = l)) : (e.classList.remove("mod-active"), (e.style.backgroundColor = a));
        }
        validateValue(e) {
          if (null == zt.Ay(e)) throw e + " is not a valid Color";
          return e;
        }
      }
      class Kt extends Rt {
      ...
      class qt extends $t {
        render() {
          this.model.on("change:format", () => {
            (this.formatter = ve.GP(this.model.get("format"))), this.update();
          }),
            (this.formatter = ve.GP(this.model.get("format"))),
            super.render();
        }
        getTagText(e) {
        ...
        validateValue(e) {
          ...
          if (isNaN(t) || (null != s && t < s) || (null != i && t > i))
            throw e + " is not a valid number, it should be in the range [" + s + ", " + i + "]";
          return t;
        }
      }
      class Gt extends Kt {
      ...
      Xt.styleProperties = Object.assign(Object.assign({}, o.styleProperties), {
        background: { selector: "", attribute: "background", default: null },
        font_size: { selector: "", attribute: "font-size", default: "" },
        text_color: { selector: "", attribute: "color", default: "" },
      });
      ...
      Zt.styleProperties = Object.assign({}, Xt.styleProperties);
      class es extends Xt {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), {
      ...
      es.styleProperties = Object.assign({}, Xt.styleProperties);
      class ts extends Xt {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), {
      ...
      ts.styleProperties = Object.assign(Object.assign({}, Xt.styleProperties), {
        font_family: { selector: "", attribute: "font-family", default: "" },
        font_style: { selector: "", attribute: "font-style", default: "" },
        font_variant: { selector: "", attribute: "font-variant", default: "" },
        font_weight: { selector: "", attribute: "font-weight", default: "" },
      ...
      ss.styleProperties = Object.assign(Object.assign({}, o.styleProperties), {
        background: { selector: ".widget-input", attribute: "background", default: null },
        font_size: { selector: ".widget-input", attribute: "font-size", default: "" },
        text_color: { selector: ".widget-input", attribute: "color", default: "" },
      });
      class is extends m {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), { value: "", disabled: !1, placeholder: "​", _model_name: "StringModel" });
        }
      }
      class as extends h {
        render() {
      ...
      class ds extends as {
        ...
        handle_message(e) {
          "focus" === e.do ? this.content.focus() : "blur" === e.do && this.content.blur();
        }
      }
      class ns extends is {
        defaults() {
      ...
      class os extends as {
        ...
        update() {
          return (this.content.innerHTML = this.model.get("value")), this.typeset(this.content), super.update();
        }
        handle_message(e) {
          "focus" === e.do ? this.content.focus() : "blur" === e.do && this.content.blur();
        }
      ...
      class cs extends as {
        ...
        update(e) {
          if (void 0 === e || e.updated_view !== this) {
            ...
            null === e && (e = ""), this.textbox.setAttribute("rows", e), (this.textbox.disabled = this.model.get("disabled"));
          }
        ...
        updateTooltip() {
          if (!this.textbox) return;
          const e = this.model.get("tooltip");
          e ? 0 === this.model.get("description").length && this.textbox.setAttribute("title", e) : this.textbox.removeAttribute("title");
        }
        events() {
          return {
            "keydown input": "handleKeyDown",
        ...
        handle_message(e) {
          "focus" === e.do ? this.textbox.focus() : "blur" === e.do && this.textbox.blur();
        }
      }
      class ps extends is {
        defaults() {
          return Object.assign(Object.assign({}, super.defaults()), { _view_name: "TextView", _model_name: "TextModel", continuous_update: !0 });
        }
      }
      class gs extends as {
        constructor() {
        ...
        update(e) {
          return (
            (void 0 !== e && e.updated_view === this) ||
              (this.textbox.value !== this.model.get("value") && (this.textbox.value = this.model.get("value")),
              (this.textbox.disabled = this.model.get("disabled"))),
            super.update()
          );
        }
      ...
      class vs extends gs {
        ...
        update(e) {
          ...
          if ((this.highlightValidState(t), (void 0 !== e && e.updated_view) || (!this.model.hasChanged("options") && !this.isInitialRender))) return;
        ...
        isValid(e) {
          return !0 !== this.model.get("ensure_option") || -1 !== this.model.get("options").indexOf(e);
        }
        handleChanging(e) {
          const t = e.target,
      ...
      xs.serializers = Object.assign(Object.assign({}, g.serializers), { value: { serialize: (e) => e } });
      class fs extends i.DOMWidgetView {
        ...
        render() {
          super.render(),
            ...
            this.fileInput.addEventListener("change", () => {
              var e;
              const t = [];
              Array.from(null !== (e = this.fileInput.files) && void 0 !== e ? e : []).forEach((e) => {
                t.push(
                  new Promise((t, s) => {
                    const i = new FileReader();
                    (i.onload = () => {
                      const s = i.result;
                      t({ content: s, name: e.name, type: e.type, size: e.size, last_modified: e.lastModified });
                    }),
                      (i.onerror = () => {
                        s();
                      }),
                ...
                Promise.all(t)
                  ...
                  .catch((e) => {
                    console.error("error in file upload: %o", e), this.model.set({ error: e }), this.touch();
                  });
            }),
            this.listenTo(this.model, "change:button_style", this.update_button_style),
            this.set_button_style(),
        ...
        update() {
          ...
          if (t.length || s.length) {
            if (((this.el.textContent = ""), s.length)) {
              const e = document.createElement("i");
              e.classList.add("fa"), e.classList.add("fa-" + s), 0 === t.length && e.classList.add("center"), this.el.appendChild(e);
            }
            this.el.appendChild(document.createTextNode(t));
          }
      ...
      fs.class_map = { primary: ["mod-primary"], success: ["mod-success"], info: ["mod-info"], warning: ["mod-warning"], danger: ["mod-danger"] };
      const ws = s(5394).rE;
    },
    5394: (e) => {
      e.exports = { rE: "5.0.11" };
