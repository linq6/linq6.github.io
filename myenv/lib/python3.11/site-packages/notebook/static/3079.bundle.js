  ...
  [3079],
  {
    33079: (e, t, n) => {
      ...
      function f(e, t) {
        ...
        const n = {
          replace: (t, s) => ((s = (s = "object" == typeof s && "source" in s ? s.source : s).replace(k, "$1")), (e = e.replace(t, s)), n),
      ...
      class _ {
        ...
        html(e) {
          ...
          if (t) return { type: "html", block: !0, raw: t[0], pre: "pre" === t[1] || "script" === t[1] || "style" === t[1], text: t[0] };
        }
        def(e) {
        ...
        table(e) {
          ...
          if (t) {
            ...
            const e = {
              type: "table",
              raw: t[0],
              header: b(t[1]).map((e) => ({ text: e, tokens: [] })),
        ...
        autolink(e) {
          ...
          if (t) {
            let e, n;
            return (
              "@" === t[2] ? ((e = u(t[1])), (n = "mailto:" + e)) : ((e = u(t[1])), (n = e)),
      ...
      class z {
        ...
        constructor(e) {
          ...
          this.options.pedantic
            ? ((t.block = y.pedantic), (t.inline = $.pedantic))
            : this.options.gfm && ((t.block = y.gfm), this.options.breaks ? (t.inline = $.breaks) : (t.inline = $.gfm)),
      ...
      class T {
        ...
        code(e, t, n) {
          ...
          return (
            (e = e.replace(/\n$/, "") + "\n"),
            s
              ? '<pre><code class="language-' + u(s) + '">' + (n ? e : u(e, !0)) + "</code></pre>\n"
            ...
            switch (r.type) {
              ...
              case "heading": {
                ...
                n += this.renderer.heading(
                  ...
                  e.depth,
                  this.parseInline(e.tokens, this.textRenderer).replace(g, (e, t) =>
      ...
      (Z.options = Z.setOptions =
        function (e) {
          return E.setOptions(e), (Z.defaults = E.defaults), i(Z.defaults), Z;
        }),
        (Z.getDefaults = s),
        (Z.defaults = r),
        (Z.use = function (...e) {
          return E.use(...e), (Z.defaults = E.defaults), i(Z.defaults), Z;
        }),
        (Z.walkTokens = function (e, t) {
          return E.walkTokens(e, t);
        }),
        (Z.parseInline = E.parseInline),
        (Z.Parser = S),
        (Z.parser = S.parse),
        (Z.Renderer = T),
        (Z.TextRenderer = R),
