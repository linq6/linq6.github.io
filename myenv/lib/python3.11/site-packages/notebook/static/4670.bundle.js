...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    44670: (O, e, t) => {
      t.r(e), t.d(e, { json: () => c, jsonLanguage: () => Q, jsonParseLinter: () => o });
      var r = t(49906),
        a = t(92209);
      ...
      const o = () => (O) => {
          try {
            ...
            const t = (function (O, e) {
              let t;
              return (t = O.message.match(/at position (\d+)/))
                ? Math.min(+t[1], e.length)
                : (t = O.message.match(/at line (\d+) column (\d+)/))
        ...
        Q = P.LRLanguage.define({
          name: "json",
          parser: s.configure({
            props: [
              P.indentNodeProp.add({ Object: (0, P.continuedIndent)({ except: /^\s*\}/ }), Array: (0, P.continuedIndent)({ except: /^\s*\]/ }) }),
      ...
      function c() {
        return new P.LanguageSupport(Q);
      }
    },
  },
]);
