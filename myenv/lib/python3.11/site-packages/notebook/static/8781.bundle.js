    ...
    60880: (e, n, t) => {
      ...
      t(72761),
        ...
        window.addEventListener("load", async function () {
          const e = [t(56357), t(51542), t(98215), t(67025)],
          ...
          let r = [
            ...
            t(7146).default.filter(({ id: e }) => ["@jupyterlab/documentsearch-extension:plugin"].includes(e)),
            t(63327).default.filter(({ id: e }) =>
              ["@jupyterlab/filebrowser-extension:factory", "@jupyterlab/filebrowser-extension:default-file-browser"].includes(e)
            ),
            t(46926).default.filter(({ id: e }) => ["@jupyterlab/fileeditor-extension:plugin"].includes(e)),
            t(22886).default.filter(({ id: e }) => ["@jupyterlab/help-extension:resources"].includes(e)),
            t(58237),
            t(27949),
            t(27862),
            t(80053).default.filter(({ id: e }) => ["@jupyterlab/mainmenu-extension:plugin"].includes(e)),
            t(73589),
            t(77403),
            t(3881),
            t(24126).default.filter(({ id: e }) =>
              [
          ...
          switch (`/${o.PageConfig.getOption("notebookPage")}`) {
            case "/tree":
              r = r.concat([
                ...
                t(89334),
                t(84217).default.filter(({ id: e }) => ["@jupyterlab/running-extension:plugin"].includes(e)),
                t(57318),
              ]);
              break;
            case "/notebooks":
              r = r.concat([
                ...
                t(15221).default.filter(({ id: e }) => ["@jupyterlab/toc-extension:registry", "@jupyterlab/toc-extension:tracker"].includes(e)),
                t(23792).default.filter(({ id: e }) =>
            ...
            case "/edit":
              r = r.concat([
                t(46926).default.filter(({ id: e }) =>
                  ["@jupyterlab/fileeditor-extension:completer", "@jupyterlab/fileeditor-extension:search"].includes(e)
                ),
                t(59278),
              ]);
          }
          ...
          function* s(e) {
            ...
            for (let n of t) {
              const t = o.PageConfig.Extension.isDisabled(n.id);
              l.push({
                id: n.id,
          ...
          (
                  ...
                  await (async function (e, n) {
                    await (function (e) {
                      return new Promise((n, t) => {
                        ...
                        (o.onerror = t), (o.onload = n), (o.async = !0), document.head.appendChild(o), (o.src = e);
                      });
                    })(e),
                      await t.I("default");
                    const o = window._JUPYTERLAB[n];
                    await o.init(t.S.default);
                  })(`${o.URLExt.join(o.PageConfig.getOption("fullLabextensionsUrl"), e.name, e.load)}`, e.name),
                  e
                )
              )
            )
            ...
            const n = e.value;
            n.extension && b.push(a(n.name, n.extension)),
              n.mimeExtension && d.push(a(n.name, n.mimeExtension)),
              n.style && !o.PageConfig.Extension.isDisabled(n.name) && c.push(a(n.name, n.style));
          }),
            (await Promise.all(r)).forEach((e) => {
              for (let n of s(e)) u.push(n);
            }),
            (await Promise.allSettled(b)).forEach((e) => {
              if ("fulfilled" === e.status) for (let n of s(e.value)) u.push(n);
              else console.error(e.reason);
            }),
            (await Promise.allSettled(d)).forEach((e) => {
              if ("fulfilled" === e.status) for (let t of s(e.value)) n.push(t);
              else console.error(e.reason);
            }),
            (await Promise.allSettled(c))
              .filter(({ status: e }) => "rejected" === e)
              .forEach(({ reason: e }) => {
                console.error(e);
              }),
            o.PageConfig.setOption(
              "allPlugins",
          ...
          const j = new (0, t(69867).NotebookApp)({ mimeExtensions: n, availablePlugins: l });
          j.registerPluginModules(u),
            "true" === (o.PageConfig.getOption("exposeAppInBrowser") || "").toLowerCase() && (window.jupyterapp = j),
            await j.start();
        });
    },
    72761: (e, n, t) => {
