...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    54002: (e, t, n) => {
      n.r(t), n.d(t, { clojure: () => g });
      var r = ["false", "nil", "true"],
        a = [".", "catch", "def", "do", "if", "monitor-enter", "monitor-exit", "new", "quote", "recur", "set!", "throw", "try", "var"],
        s = [
          "*",
          "*'",
          "*1",
      ...
      function f(e, t) {
        ...
        if (e.match(p)) return [null, "string.special"];
        ...
        token: function (e, t) {
          ...
          return (
            "space" !== r &&
              ...
              (t.lastToken = s)),
            "open" === r ? (t.ctx = { prev: t.ctx, start: e.column(), indentTo: null }) : "close" === r && (t.ctx = t.ctx.prev || t.ctx),
            a
          );
        },
        indent: function (e) {
