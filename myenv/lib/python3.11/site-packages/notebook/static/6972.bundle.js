...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    58879: (O, Q, P) => {
      P.r(Q), P.d(Q, { rust: () => z, rustLanguage: () => Y });
      var $ = P(49906),
        X = P(92209);
      function i(O) {
        return O >= 48 && O <= 57;
      ...
      const n = new $.Jq((O, Q) => {
          if (i(O.next)) {
            ...
            if (46 == O.next)
              if (((Q = !0), O.advance(), i(O.next)))
                do {
                  O.advance();
                } while (e(O.next));
              else if (46 == O.next || O.next > 127 || /\w/.test(String.fromCharCode(O.next))) return;
            if (101 == O.next || 69 == O.next) {
              if (((Q = !0), O.advance(), (43 != O.next && 45 != O.next) || O.advance(), !e(O.next))) return;
              do {
                O.advance();
              } while (e(O.next));
            }
            if (102 == O.next) {
              let P = O.peek(1);
              if (!((51 == P && 50 == O.peek(2)) || (54 == P && 52 == O.peek(2)))) return;
              O.advance(3), (Q = !0);
            }
            Q && O.acceptToken(5);
          } else if (98 == O.next || 114 == O.next) {
            if ((98 == O.next && O.advance(), 114 != O.next)) return;
            O.advance();
            let Q = 0;
            for (; 35 == O.next; ) Q++, O.advance();
            if (34 != O.next) return;
            O.advance();
            O: for (;;) {
              if (O.next < 0) return;
              ...
              if ((O.advance(), P)) {
                for (let P = 0; P < Q; P++) {
                  if (35 != O.next) continue O;
                  O.advance();
                }
                return void O.acceptToken(4);
              }
            }
          }
        }),
        a = new $.Jq((O) => {
          124 == O.next && O.acceptToken(1, 1);
        }),
        S = new $.Jq((O) => {
          60 == O.next ? O.acceptToken(2, 1) : 62 == O.next && O.acceptToken(3, 1);
        }),
        s = (0, X.styleTags)({
          "const macro_rules struct union enum type fn impl trait let static": X.tags.definitionKeyword,
          "mod use crate": X.tags.moduleKeyword,
          "pub unsafe async mut extern default move": X.tags.modifier,
          "for if else loop while match continue break return await": X.tags.controlKeyword,
          ...
          "FunctionItem/BoundIdentifier": X.tags.function(X.tags.definition(X.tags.variableName)),
          ...
          "MacroInvocation/Identifier MacroInvocation/ScopedIdentifier/Identifier": X.tags.macroName,
          "MacroInvocation/TypeIdentifier MacroInvocation/ScopedIdentifier/TypeIdentifier": X.tags.macroName,
          '"!"': X.tags.macroName,
        ...
        t = $.WQ.deserialize({
          ...
          tokenizers: [a, S, n, 0, 1, 2, 3],
          topRules: { SourceFile: [0, 8] },
          specialized: [{ term: 281, get: (O) => r[O] || -1 }],
          tokenPrec: 15596,
        });
      var W = P(17592);
      const Y = W.LRLanguage.define({
        name: "rust",
        parser: t.configure({
          props: [
            W.indentNodeProp.add({
              IfExpression: (0, W.continuedIndent)({ except: /^\s*({|else\b)/ }),
              "String BlockComment": () => null,
              AttributeItem: (O) => O.continue(),
              "Statement MatchArm": (0, W.continuedIndent)(),
            }),
            W.foldNodeProp.add((O) =>
              /(Block|edTokens|List)$/.test(O.name) ? W.foldInside : "BlockComment" == O.name ? (O) => ({ from: O.from + 2, to: O.to - 2 }) : void 0
            ),
          ],
        }),
        languageData: {
      ...
      function z() {
        return new W.LanguageSupport(Y);
      }
    },
  },
]);
