...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    14810: (e, O, o) => {
      o.r(O), o.d(O, { wast: () => n, wastLanguage: () => P });
      var b = o(17592),
        t = o(92209),
        a = o(49906);
      const s = {
        ...
        r = a.WQ.deserialize({
          ...
          tokenizers: [0],
          topRules: { Module: [0, 3] },
          specialized: [{ term: 9, get: (e) => s[e] || -1 }],
          tokenPrec: 0,
        }),
        P = b.LRLanguage.define({
          name: "wast",
          parser: r.configure({
            props: [
              b.indentNodeProp.add({ App: (0, b.delimitedIndent)({ closing: ")", align: !1 }) }),
              b.foldNodeProp.add({ App: b.foldInside, BlockComment: (e) => ({ from: e.from + 2, to: e.to - 2 }) }),
              (0, t.styleTags)({
                Keyword: t.tags.keyword,
                Type: t.tags.typeName,
                Number: t.tags.number,
                String: t.tags.string,
                Identifier: t.tags.variableName,
                LineComment: t.tags.lineComment,
      ...
      function n() {
        return new b.LanguageSupport(P);
      }
    },
  },
]);
