              ...
              (e.FitAddon = class {
                ...
                proposeDimensions() {
                  ...
                  const r = 0 === this._terminal.options.scrollback ? 0 : e.viewport.scrollBarWidth,
                    ...
                    i = parseInt(s.getPropertyValue("height")),
                    n = Math.max(0, parseInt(s.getPropertyValue("width"))),
                    l = window.getComputedStyle(this._terminal.element),
                    a = i - (parseInt(l.getPropertyValue("padding-top")) + parseInt(l.getPropertyValue("padding-bottom"))),
                    o = n - (parseInt(l.getPropertyValue("padding-right")) + parseInt(l.getPropertyValue("padding-left"))) - r;
                  return { cols: Math.max(2, Math.floor(o / t.css.cell.width)), rows: Math.max(1, Math.floor(a / t.css.cell.height)) };
                }
              }),
              t
            );
