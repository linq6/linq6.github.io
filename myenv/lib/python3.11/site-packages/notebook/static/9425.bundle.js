  ...
  [9425],
  {
    49425: (e, t, n) => {
      function r(e, t, n, r, a, o) {
        (this.indented = e), (this.column = t), (this.type = n), (this.info = r), (this.align = a), (this.prev = o);
      }
      function a(e, t, n, a) {
        var o = e.indented;
        return (
          e.context && "statement" == e.context.type && "statement" != n && (o = e.context.indented), (e.context = new r(o, t, n, a, null, e.context))
        );
      }
      function o(e) {
      ...
      function s(e) {
        var t,
          ...
          y = e.atoms || {},
          g = e.hooks || {},
          k = e.multiLineStrings,
          b = !1 !== e.indentStatements,
          v = !1 !== e.indentSwitch,
          w = e.namespaceSeparator,
          _ = e.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
          x = e.numberStart || /[\d\.]/,
          S = e.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
          T = e.isOperatorChar || /[+\-*&%=<>!?|\/]/,
          C = e.isIdentifierChar || /[\w\$_\xa1-\uffff]/,
          N = e.isReservedIdentifier || !1;
        function I(e, r) {
          var a,
            o = e.next();
          if (g[o]) {
          ...
          if (_.test(o)) return (t = o), null;
          if ("/" == o) {
            if (e.eat("*")) return (r.tokenize = D), D(e, r);
          ...
          if ((e.eatWhile(C), w)) for (; e.match(w); ) e.eatWhile(C);
          var l = e.current();
          return u(d, l)
            ? (u(m, l) && (t = "newstatement"), u(h, l) && (n = !0), "keyword")
            : u(f, l)
              ? "type"
              : u(p, l) || (N && N(l))
                ? (u(m, l) && (t = "newstatement"), "builtin")
                : u(y, l)
                  ? "atom"
                  : "variable";
        }
        ...
        function L(t, n) {
          e.typeFirstDefinitions && t.eol() && l(n.context) && (n.typeAtEndOfLine = i(t, n, t.pos));
        }
        return {
          name: e.name,
          startState: function (e) {
            return { tokenize: null, context: new r(-e, 0, "top", null, !1), indented: 0, startOfLine: !0, prevToken: null };
          },
          token: function (r, s) {
            var c = s.context;
            if ((r.sol() && (null == c.align && (c.align = !1), (s.indented = r.indentation()), (s.startOfLine = !0)), r.eatSpace()))
              return L(r, s), null;
            t = n = null;
            var u = (s.tokenize || I)(r, s);
            if ("comment" == u || "meta" == u) return u;
            if ((null == c.align && (c.align = !0), ";" == t || ":" == t || ("," == t && r.match(/^\s*(?:\/\/.*)?$/, !1))))
              for (; "statement" == s.context.type; ) o(s);
            else if ("{" == t) a(s, r.column(), "}");
            else if ("[" == t) a(s, r.column(), "]");
            else if ("(" == t) a(s, r.column(), ")");
            else if ("}" == t) {
              for (; "statement" == c.type; ) c = o(s);
              for ("}" == c.type && (c = o(s)); "statement" == c.type; ) c = o(s);
            } else
              t == c.type
                ? o(s)
                : b &&
                  ((("}" == c.type || "top" == c.type) && ";" != t) || ("statement" == c.type && "newstatement" == t)) &&
                  a(s, r.column(), "statement", r.current());
            if (
              ("variable" == u &&
                ("def" == s.prevToken || (e.typeFirstDefinitions && i(r, s, r.start) && l(s.context) && r.match(/^\s*\(/, !1))) &&
                (u = "def"),
              g.token)
            ) {
              var d = g.token(r, s, u);
            ...
            return "def" == u && !1 === e.styleDefs && (u = "variable"), (s.startOfLine = !1), (s.prevToken = n ? "def" : u || t), L(r, s), u;
          },
          indent: function (t, n, r) {
            if ((t.tokenize != I && null != t.tokenize) || (t.typeAtEndOfLine && l(t.context))) return null;
            var a = t.context,
              o = n && n.charAt(0),
              i = o == a.type;
            if (("statement" == a.type && "}" == o && (a = a.prev), e.dontIndentStatements))
              for (; "statement" == a.type && e.dontIndentStatements.test(a.info); ) a = a.prev;
            if (g.indent) {
              var u = g.indent(t, a, n, r.unit);
              if ("number" == typeof u) return u;
            }
            var d = a.prev && "switch" == a.prev.info;
            if (e.allmanIndentation && /[{(]/.test(o)) {
              for (; "top" != a.type && "}" != a.type; ) a = a.prev;
              return a.indented;
            }
            return "statement" == a.type
              ? a.indented + ("{" == o ? 0 : s || r.unit)
              : !a.align || (c && ")" == a.type)
                ? ")" != a.type || i
                  ? a.indented + (i ? 0 : r.unit) + (i || !d || /^(?:case|default)\b/.test(n) ? 0 : r.unit)
                  : a.indented + (s || r.unit)
                : a.column + (i ? 0 : 1);
          },
          languageData: {
            indentOnInput: v ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
            commentTokens: { line: "//", block: { open: "/*", close: "*/" } },
            autocomplete: Object.keys(d).concat(Object.keys(f)).concat(Object.keys(p)).concat(Object.keys(y)),
            ...e.languageData,
          },
        };
      }
      ...
      var d =
        ...
        h = c("int long char short double float unsigned signed void bool"),
        y = c("SEL instancetype id Class Protocol BOOL");
      function g(e) {
      ...
      function T(e, t) {
        if ((e.backUp(1), e.match(/^(?:R|u8R|uR|UR|LR)/))) {
          ...
          return !!n && ((t.cpp11RawStringDelim = n[1]), (t.tokenize = I), I(e, t));
        }
      ...
      const D = s({
        ...
        L = s({
          ...
          defKeywords: c(v + " class namespace"),
          typeFirstDefinitions: !0,
          ...
          hooks: {
            ...
            token: function (e, t, n) {
              if ("variable" == n && "(" == e.peek() && (";" == t.prevToken || null == t.prevToken || "}" == t.prevToken) && C(e.current()))
                return "def";
            },
          },
          namespaceSeparator: "::",
      ...
      function P(e) {
        return function (t, n) {
          for (var r; (r = t.next()); ) {
            ...
            if ("/" == r && t.eat("*")) return (n.tokenize = P(e + 1)), n.tokenize(t, n);
          }
          return "comment";
        };
      }
      const R = s({
          ...
          hooks: {
            ...
            "=": function (e, t) {
              var n = t.context;
              return (
                !("}" != n.type || !n.align || !e.eat(">")) && ((t.context = new r(n.indented, n.column, n.type, n.info, null, n.prev)), "operator")
              );
            },
            "/": function (e, t) {
              return !!e.eat("*") && ((t.tokenize = P(1)), t.tokenize(e, t));
            },
          },
          ...
          hooks: {
                ...
                (t.tokenize =
                  ...
                  function (e, t) {
                    for (var r, a = !1, o = !1; !e.eol(); ) {
                      ...
                      (r = e.next()), !a && "$" == r && e.match("{") && e.skipTo("}"), (a = !a && "\\" == r && !n);
                    }
            ...
            indent: function (e, t, n, r) {
              ...
              return ("}" != e.prevToken && ")" != e.prevToken) || "" != n
                ? ("operator" == e.prevToken && "}" != n && "}" != e.context.type) ||
                  ("variable" == e.prevToken && "." == a) ||
        ...
        A = s({
          ...
          defKeywords: c(v + " @interface @implementation @protocol @class"),
        ...
        j = s({
          ...
          defKeywords: c(v + " @interface @implementation @protocol @class class namespace"),
          dontIndentStatements: /^@.*$|^template$/,
          typeFirstDefinitions: !0,
          atoms: c("YES NO NULL Nil nil true false nullptr"),
          isReservedIdentifier: x,
      ...
      function K(e) {
        return function (t, n) {
          for (var r, a = !1, o = !1; !t.eol(); ) {
            if (!a && t.match('"') && ("single" == e || t.match('""'))) {
              o = !0;
              break;
            }
            if (!a && t.match("``")) {
      ...
      const q = s({
        ...
        hooks: {
          ...
          "`": function (e, t) {
            return !(!$ || !e.match("`")) && ((t.tokenize = $), ($ = null), t.tokenize(e, t));
          },
          "'": function (e) {
      ...
      function G(e, t, n, r) {
        ...
        function o(t, n) {
          for (var o = !1; !t.eol(); ) {
            if (!r && !o && "$" == t.peek()) return V(n), (n.tokenize = Y), "string";
            var i = t.next();
            if (i == e && !o && (!a || t.match(e + e))) {
              n.tokenize = null;
              break;
            }
            o = !r && !o && "\\" == i;
        ...
        return (n.tokenize = o), o(t, n);
      }
      function Y(e, t) {
        return e.eat("$"), e.eat("{") ? (t.tokenize = null) : (t.tokenize = Z), null;
      }
      function Z(e, t) {
        return e.eatWhile(/[\w_]/), (t.tokenize = W(t)), "variable";
      }
      const J = s({
        name: "dart",
        keywords: c(
