          ...
          (function () {
            var t = function (t, i, n, s) {
              ...
              n = {
                ...
                performAction: function (t, i, n, s, e, r, h) {
                  switch ((r.length, e)) {
                    case 1:
                      return s;
                    case 4:
                  ...
                  for (var g, _, m, d, k, x, b, v, E, w = {}; ; ) {
                    if (
                      ...
                      this.defaultActions[_]
                        ...
                        : (null == g &&
                            ((E = void 0),
                            "number" != typeof (E = n.pop() || a.lex() || 1) &&
                              (E instanceof Array && (E = (n = E).pop()), (E = this.symbols_[E] || E)),
                            (g = E)),
                          (m = r[_] && r[_][g])),
                      ...
                      (I = a.showPosition
                        ...
                        this.parseError(I, { text: a.match, token: this.terminals_[g] || g, line: a.yylineno, loc: p, expected: v });
                    }
                    ...
                    switch (m[0]) {
                      ...
                      case 2:
                        if (
                          ...
                          f && (w._$.range = [e[e.length - (x || 1)].range[0], e[e.length - 1].range[1]]),
                          void 0 !== (d = this.performAction.apply(w, [h, l, o, y.yy, m[1], s, e].concat(c))))
                        )
                          return d;
                        x && ((i = i.slice(0, -1 * x * 2)), (s = s.slice(0, -1 * x)), (e = e.slice(0, -1 * x))),
              ...
              s = {
                ...
                unput: function (t) {
                  ...
                  return (
                    ...
                    this.options.ranges && (this.yylloc.range = [e[0], e[0] + this.yyleng - i]),
                ...
                next: function () {
                  ...
                  for (var e = this._currentRules(), r = 0; r < e.length; r++)
                    if ((n = this._input.match(this.rules[e[r]])) && (!i || n[0].length > i[0].length)) {
                      if (((i = n), (s = r), this.options.backtrack_lexer)) {
                        if (!1 !== (t = this.test_match(n, e[r]))) return t;
                        if (this._backtrack) {
                          i = !1;
                          continue;
                        }
                ...
                performAction: function (t, i, n, s) {
                  switch (n) {
                    case 0:
                      return 4;
                    case 1:
            ...
            return (n.lexer = s), (e.prototype = n), (n.Parser = e), new e();
          })());
      e.parser = e;
      let r = false;
      const h = {
        ...
        renderer: {
          draw: (t, i, n) => {
            s.l.debug("rendering info diagram\n" + t);
            const e = (0, s.z)(i);
            (0, s.i)(e, 100, 400, !0),
              e
                .append("g")
