  ...
  [5115, 4971],
  {
      ...
      var h = (function () {
        ...
        return (
          ...
          (t.prototype.getPackage = function (t) {
            var e = o.get(t);
            if (e && this.parsers.indexOf(e.parser) < 0) throw Error("Package ".concat(t, " doesn't target the proper parser"));
            return e;
          }),
          ...
          try {
            for (var a = n(Object.keys(r)), s = a.next(); !s.done; s = a.next()) {
              ...
              "texClass" === l
                ...
                : "movablelimits" === l
                  ? (t.setProperty("movablelimits", u), (t.isKind("mo") || t.isKind("mstyle")) && t.attributes.set("movablelimits", u))
    ...
    55038: function (t, e, r) {
      ...
      !(function (t) {
          ...
          return i
            ? (function (t) {
                var e = n(t, 3),
                  ...
                  o = e[1],
                  a = e[2];
                return "mu" !== o ? [i, o, a] : [y(r[o](parseFloat(i || "1"))).slice(0, -2), "em", a];
        ...
        function m(t, e, r) {
          if ((r.match(/^[a-z]/i) && e.match(/(^|[^\\])(\\\\)*\\[a-z]+$/i) && (e += " "), e.length + r.length > t.configuration.options.maxBuffer))
          ...
          for (var r = t.length, n = 0, i = "", o = 0, a = 0, s = !0, l = !1; o < r; ) {
            ...
            switch (u) {
              ...
              case "}":
                ...
                break;
              default:
                if (!n && -1 !== e.indexOf(u)) return [l ? "true" : b(i, a), u, t.slice(o)];
                (s = !1), (l = !1);
            }
            i += u;
          }
          if (n) throw new c.default("ExtraOpenMissingClose", "Extra open brace or missing close brace");
        ...
        (t.matchDimen = d),
          ...
          (t.fenced = function (t, e, r, n, i, o) {
            ...
            var a,
              c = t.nodeFactory,
              f = c.create("node", "mrow", [], { open: e, close: n, texClass: s.TEXCLASS.INNER });
            if (i) a = new u.default("\\" + i + "l" + e, t.parser.stack.env, t).mml();
            else {
              var h = c.create("text", e);
              a = c.create("node", "mo", [], { fence: !0, stretchy: !0, symmetric: !0, texClass: s.TEXCLASS.OPEN }, h);
            }
            if ((l.default.appendChildren(f, [a, r]), i)) a = new u.default("\\" + i + "r" + n, t.parser.stack.env, t).mml();
            else {
              var p = c.create("text", n);
              a = c.create("node", "mo", [], { fence: !0, stretchy: !0, symmetric: !0, texClass: s.TEXCLASS.CLOSE }, p);
            }
            return o && a.attributes.set("mathcolor", o), l.default.appendChildren(f, [a]), f;
          }),
          (t.fixedFence = function (t, e, r, n) {
            var i = t.nodeFactory.create("node", "mrow", [], { open: e, close: n, texClass: s.TEXCLASS.ORD });
            return (
              e && l.default.appendChildren(i, [g(t, e, "l")]),
              l.default.isType(r, "mrow") ? l.default.appendChildren(i, l.default.getChildren(r)) : l.default.appendChildren(i, [r]),
              n && l.default.appendChildren(i, [g(t, n, "r")]),
              i
            );
          }),
          (t.mathPalette = g),
          (t.fixInitialMO = function (t, e) {
            for (var r = 0, n = e.length; r < n; r++) {
              ...
              if (
                ...
                (!l.default.isType(i, "TeXAtom") || (l.default.getChildren(i)[0] && l.default.getChildren(l.default.getChildren(i)[0]).length))
              ) {
          ...
          (t.internalMath = function (t, e, r, n) {
            if (t.configuration.options.internalMath) return t.configuration.options.internalMath(t, e, r, n);
            var i,
              o,
            ...
            if (e.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/)) {
              for (; f < e.length; )
                if ("$" === (i = e.charAt(f++)))
                  "$" === p && 0 === d
                    ? ((o = t.create("node", "TeXAtom", [new u.default(e.slice(h, f - 1), {}, t.configuration).mml()])), l.push(o), (p = ""), (h = f))
                    : "" === p && (h < f - 1 && l.push(v(t, e.slice(h, f - 1), s)), (p = "$"), (h = f));
                else if ("{" === i && "" !== p) d++;
                else if ("}" === i)
                  if ("}" === p && 0 === d) {
                    var y = new u.default(e.slice(h, f), {}, t.configuration).mml();
                    (o = t.create("node", "TeXAtom", [y], s)), l.push(o), (p = ""), (h = f);
                  } else "" !== p && d && d--;
                else if ("\\" === i)
                  if ("" === p && e.substr(f).match(/^(eq)?ref\s*\{/)) {
                    var g = RegExp["$&"].length;
                    h < f - 1 && l.push(v(t, e.slice(h, f - 1), s)), (p = "}"), (h = f - 1), (f += g);
                  } else
                    "(" === (i = e.charAt(f++)) && "" === p
                      ? (h < f - 2 && l.push(v(t, e.slice(h, f - 2), s)), (p = ")"), (h = f))
                      : ")" === i && ")" === p && 0 === d
                        ? ((o = t.create("node", "TeXAtom", [new u.default(e.slice(h, f - 2), {}, t.configuration).mml()])),
                          l.push(o),
                          (p = ""),
                          (h = f))
                        : i.match(/[${}\\]/) && "" === p && (f--, (e = e.substr(0, f - 1) + e.substr(f)));
              if ("" !== p) throw new c.default("MathNotTerminated", "Math not terminated in text box");
            }
            return (
              h < e.length && l.push(v(t, e.slice(h), s)),
              null != r
                ? (l = [t.create("node", "mstyle", l, { displaystyle: !1, scriptlevel: r })])
          ...
          (t.underOver = function (e, r, n, i, o) {
            if ((t.checkMovableLimits(r), l.default.isType(r, "munderover") && l.default.isEmbellished(r))) {
              l.default.setProperties(l.default.getCoreMO(r), { lspace: 0, rspace: 0 });
            ...
            var c = u;
            return (
              o && (c = e.create("node", "TeXAtom", [u], { texClass: s.TEXCLASS.OP, movesupsub: !0 })), l.default.setProperty(c, "subsupOK", !0), c
            );
          }),
          (t.checkMovableLimits = function (t) {
            var e = l.default.isType(t, "mo") ? l.default.getForm(t) : null;
            (l.default.getProperty(t, "movablelimits") || (e && e[3] && e[3].movablelimits)) && l.default.setProperties(t, { movablelimits: !1 });
          }),
            ...
            for (var n = "", i = "", o = 0; o < r.length; ) {
              ...
              if ("\\" === a) n += a + r.charAt(o++);
                ...
                if ("#" === (a = r.charAt(o++))) n += a;
                  ...
                  if (!a.match(/[1-9]/) || parseInt(a, 10) > e.length) throw new c.default("IllegalMacroParam", "Illegal macro parameter reference");
                  (i = m(t, m(t, i, n), e[parseInt(a, 10) - 1])), (n = "");
                }
              else n += a;
            }
            return m(t, i, n);
          ...
          (t.checkEqnEnv = function (t) {
            if (t.stack.global.eqnenv) throw new c.default("ErroneousNestingEq", "Erroneous nesting of equation structures");
          ...
          (t.keyvalOptions = function (t, e, r) {
            ...
            var s = (function (t) {
              for (var e, r, i, o, a, s = {}, l = t; l; )
                (o = (e = n(w(l, ["=", ","]), 3))[0]),
                  (i = e[1]),
                  (l = e[2]),
                  "=" === i
                    ? ((a = (r = n(w(l, [","]), 3))[0]), (i = r[1]), (l = r[2]), (a = "false" === a || "true" === a ? JSON.parse(a) : a), (s[o] = a))
                    : o && (s[o] = !0);
              return s;
            })(t);
            if (e)
              try {
                for (var l = i(Object.keys(s)), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if (!e.hasOwnProperty(f)) {
                    if (r) throw new c.default("InvalidOption", "Invalid option: %1", f);
                    delete s[f];
                  }
                }
              } catch (t) {
        ...
        l = (function () {
          ...
          return (
            ...
            (t.prototype.Push = function () {
              for (var t, e, r = [], a = 0; a < arguments.length; a++) r[a] = arguments[a];
              try {
                for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if (c) {
                    ...
                    var h = i(this.stack.length ? this.Top().checkItem(f) : [null, !0], 2),
                      p = h[0];
                    h[1] &&
                      (p
                        ? (this.Pop(), this.Push.apply(this, o([], i(p), !1)))
                        : (this.stack.push(f), f.env ? (f.copyEnv && Object.assign(f.env, this.env), (this.env = f.env)) : (f.env = this.env)));
                  }
                }
              } catch (e) {
                t = { error: e };
        ...
        function e(e, r, n) {
          ...
          try {
            for (var c = a(Object.keys(n)), f = c.next(); !f.done; f = c.next()) {
              var h = f.value,
                p = n[h],
                d = o("string" == typeof p ? [p, null] : p, 2),
                y = d[0],
                g = d[1],
                v = new l.Symbol(h, y, g);
              u.add(h, v);
            }
          } catch (t) {
            i = { error: t };
        ...
        function e(e, r, n) {
          ...
          try {
            for (var c = a(Object.keys(r)), f = c.next(); !f.done; f = c.next()) {
              var h = f.value,
                p = r[h],
                d = o("string" == typeof p ? [p] : p),
                y = d[0],
                g = d.slice(1),
                v = new l.Macro(h, n[y], g);
              u.add(h, v);
            }
          } catch (t) {
            i = { error: t };
    ...
    75723: function (t, e, r) {
      ...
      (e.AllTags = y),
        ...
        (d = "none"),
        (h.OPTIONS = { tags: d, tagSide: "right", tagIndent: "0.8em", useLabelIds: !0, ignoreDuplicateLabels: !1 }),
        (h.add = function (t, e) {
          p.set(t, e);
        }),
        (h.addTags = function (t) {
          var e, r;
          try {
            for (var n = o(Object.keys(t)), i = n.next(); !i.done; i = n.next()) {
              var a = i.value;
              h.add(a, t[a]);
            }
          } catch (t) {
        ...
        (h.create = function (t) {
          var e = p.get(t) || p.get(d);
          if (!e) throw Error("Unknown tags class");
          return new e();
        }),
        (h.setDefault = function (t) {
          d = t;
        }),
        ...
        f = (function () {
          ...
          return (
            ...
            (t.prototype.Parse = function () {
              for (var t; this.i < this.string.length; ) (t = this.getCodePoint()), (this.i += t.length), this.parse("character", [this, t]);
            }),
            ...
            (t.prototype.GetArgument = function (t, e) {
              switch (this.GetNext()) {
                case "":
                  if (!e) throw new u.default("MissingArgFor", "Missing argument for %1", this.currentCS);
                  return null;
                case "}":
                  if (!e) throw new u.default("ExtraCloseMissingOpen", "Extra close brace or missing open brace");
                  return null;
                case "\\":
              ...
              for (var r = ++this.i, n = 0; this.i < this.string.length; )
                switch (this.string.charAt(this.i++)) {
                  ...
                  case "\\":
                    ...
                    break;
                  case "}":
                    if (n-- <= 0) throw new u.default("ExtraCloseLooking", "Extra close brace while looking for %1", "']'");
                    break;
                  case "]":
                    if (0 === n) return this.string.slice(r, this.i - 1);
                }
            ...
            (t.prototype.GetDelimiter = function (t, e) {
              ...
              if (
                ...
                this.i <= this.string.length &&
                  ("\\" === r ? (r += this.GetCS()) : "{" === r && e && (this.i--, (r = this.GetArgument(t).trim())), this.contains("delimiter", r)))
              )
              ...
              for (var r = this.i, n = 0; this.i < this.string.length; ) {
                ...
                switch (((this.i += o.length), o)) {
                  ...
                  case "{":
                    ...
                    break;
                  case "}":
                    if (0 === n) throw new u.default("ExtraCloseLooking", "Extra close brace while looking for %1", e);
                    n--;
                }
    ...
    61051: (t, e, r) => {
      ...
      function a(t, r) {
        ...
        if (e.options.loadMissingEntities) {
          ...
          o[a] || ((o[a] = !0), (0, n.retryAfter)((0, i.asyncLoad)("./util/entities/" + a + ".js")));
        }
        return t;
      }
      function s(t) {
      ...
      (e.add = function (t, r) {
        Object.assign(e.entities, t), (o[r] = !0);
      }),
        (e.remove = function (t) {
          delete e.entities[t];
        }),
          ...
          (e.prototype.execute = function () {
            ...
            try {
              for (var i = o(this), l = i.next(); !l.done; l = i.next()) {
                var u = l.value;
                if (!1 === u.item.apply(u, s([], a(r), !1))) return !1;
              }
            } catch (e) {
              t = { error: e };
            } finally {
              ...
              !(function o() {
                for (var l; ++r < n.length; ) {
                  ...
                  if (u instanceof Promise)
                    return void u.then(o).catch(function (t) {
                      return i(t);
                    });
