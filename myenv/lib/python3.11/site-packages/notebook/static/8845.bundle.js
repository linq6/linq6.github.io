  ...
  [8845],
  {
    ...
    70049: function (t, e, r) {
      ...
      (e.ActionMethods = {}),
        ...
        (e.ActionMethods.Toggle = function (t, e) {
          for (var r, n = []; "\\endtoggle" !== (r = t.GetArgument(e)); ) n.push(new a.default(r, t.stack.env, t.configuration).mml());
        ...
        (e.ActionConfiguration = o.Configuration.create("action", { handler: { macro: ["action-macros"] } }));
    },
    64296: function (t, e, r) {
      var n,
        o,
        a =
          (this && this.__extends) ||
      ...
      (e.AmsTags = d),
        (e.AmsConfiguration = i.Configuration.create("ams", {
          ...
          items: ((o = {}), (o[s.MultlineItem.prototype.kind] = s.MultlineItem), (o[s.FlalignItem.prototype.kind] = s.FlalignItem), o),
          tags: { ams: d },
          init: function (t) {
            new u.CommandMap(c.NEW_OPS, {}, {}), t.append(i.Configuration.local({ handler: { macro: [c.NEW_OPS] }, priority: -1 }));
          },
          config: function (t, e) {
            ...
            (e.prototype.EndTable = function () {
              if ((t.prototype.EndTable.call(this), this.table.length)) {
                ...
                if (n) {
                  ...
                  var o = this.table[r],
                    a = this.create("node", "mlabeledtr", [n].concat(c.default.getChildren(o)));
      ...
      var f = (function (t) {
        ...
        return (
          ...
          (e.prototype.EndEntry = function () {
            ...
            if (e && this.row.length > e) throw new u.default("XalignOverflow", "Extra %1 in row of %2", "&", this.name);
          }),
          (e.prototype.EndRow = function () {
            for (var e, r = this.row, n = this.getProperty("xalignat"); r.length < n; ) r.push(this.create("node", "mtd"));
    ...
    27798: function (t, e, r) {
      ...
      var s = r(14880),
        ...
        p = r(83045),
        f = r(56780);
      new l.CharacterMap("AMSmath-mathchar0mo", u.default.mathchar0mo, { iiiint: ["⨌", { texClass: p.TEXCLASS.OP }] }),
        ...
        new l.EnvironmentMap(
          ...
          u.default.environment,
          {
            ...
            "eqnarray*": ["EqnArray", null, !1, !0, "rcl", d.default.cols(0, f.MATHSPACE.thickmathspace), ".5em"],
      ...
      (e.AmsMethods = {}),
        ...
        (e.AmsMethods.AlignAt = function (t, r, n, o) {
          var a,
            ...
            c = "",
            u = [];
          if ((o || (s = t.GetBrackets("\\begin{" + l + "}")), (a = t.GetArgument("\\begin{" + l + "}")).match(/[^0-9]/)))
            throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + l + "}");
          for (var p = parseInt(a, 10); p > 0; ) (c += "rl"), u.push("0em 0em"), p--;
          var f = u.join(" ");
          if (o) return e.AmsMethods.EqnArray(t, r, n, o, c, f);
          var m = e.AmsMethods.EqnArray(t, r, n, o, c, f);
        ...
        (e.AmsMethods.XalignAt = function (t, r, n, o) {
          ...
          if (a.match(/[^0-9]/))
            throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + r.getName() + "}");
          var i = o ? "crl" : "rlc",
        ...
        (e.AmsMethods.FlalignArray = function (t, e, r, n, o, a, s, l) {
          void 0 === l && (l = !1),
            ...
            (a = a.split("").join(" ").replace(/r/g, "right").replace(/l/g, "left").replace(/c/g, "center"));
        ...
        (e.AmsMethods.HandleDeclareOp = function (t, r) {
          ...
          t.configuration.handlers.retrieve(e.NEW_OPS).add(o, new p.Macro(o, e.AmsMethods.Macro, ["\\operatorname".concat(n, "{").concat(a, "}")]));
        }),
        (e.AmsMethods.HandleOperatorName = function (t, e) {
          var r = t.GetStar(),
            ...
            a = new u.default(
              o,
              n(n({}, t.stack.env), { font: c.TexConstant.Variant.NORMAL, multiLetterIdentifiers: /^[-*a-z]+/i, operatorLetters: !0 }),
              t.configuration
            ).mml();
          if (
            (a.isKind("mi") || (a = t.create("node", "TeXAtom", [a])),
            l.default.setProperties(a, { movesupsub: r, movablelimits: !0, texClass: m.TEXCLASS.OP }),
            !r)
          ) {
            var s = t.GetNext(),
              d = t.i;
        ...
        (e.AmsMethods.SideSet = function (t, e) {
          var r = o(h(t.ParseArg(e)), 2),
            n = r[0],
            a = r[1],
            s = o(h(t.ParseArg(e)), 2),
            c = s[0],
            u = s[1],
            d = t.ParseArg(e),
            p = d;
          n &&
            (a
              ? n.replaceChild(
                  t.create("node", "mphantom", [t.create("node", "mpadded", [i.default.copyNode(d, t)], { width: 0 })]),
          ...
          var f = t.create("node", "TeXAtom", [], { texClass: m.TEXCLASS.OP, movesupsub: !0, movablelimits: !0 });
          a && (n && f.appendChild(n), f.appendChild(a)), f.appendChild(p), u && f.appendChild(u), t.Push(f);
        }),
        ...
        (e.AmsMethods.MultiIntegral = function (t, e, r) {
          ...
          if ("\\" === n) {
            ...
            (n = t.GetArgument(e)),
              (t.i = o),
              "\\limits" === n && (r = "\\idotsint" === e ? "\\!\\!\\mathop{\\,\\," + r + "}" : "\\!\\!\\!\\mathop{\\,\\,\\," + r + "}");
          }
          (t.string = r + " " + t.string.slice(t.i)), (t.i = 0);
        }),
        (e.AmsMethods.xArrow = function (t, e, r, n, o) {
          var a = { width: "+" + i.default.Em((n + o) / 18), lspace: i.default.Em(n / 18) },
            s = t.GetBrackets(e),
            c = t.ParseArg(e),
            d = t.create("node", "mspace", [], { depth: ".25em" }),
            p = t.create("token", "mo", { stretchy: !0, texClass: m.TEXCLASS.REL }, String.fromCodePoint(r));
          p = t.create("node", "mstyle", [p], { scriptlevel: 0 });
          var f = t.create("node", "munderover", [p]),
            h = t.create("node", "mpadded", [c, d], a);
          if ((l.default.setAttribute(h, "voffset", "-.2em"), l.default.setAttribute(h, "height", "-.2em"), l.default.setChild(f, f.over, h), s)) {
            var g = new u.default(s, t.stack.env, t.configuration).mml(),
              v = t.create("node", "mspace", [], { height: ".75em" });
            (h = t.create("node", "mpadded", [g, v], a)),
        ...
        (e.AmsMethods.HandleShove = function (t, e, r) {
          var n = t.stack.Top();
          if ("multline" !== n.kind) throw new d.default("CommandOnlyAllowedInEnv", "%1 only allowed in %2 environment", t.currentCS, "multline");
          if (n.Size()) throw new d.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", t.currentCS);
        ...
        (e.AmsMethods.CFrac = function (t, e) {
          var r = i.default.trimSpaces(t.GetBrackets(e, "")),
            n = t.GetArgument(e),
            o = t.GetArgument(e),
            a = { l: c.TexConstant.Align.LEFT, r: c.TexConstant.Align.RIGHT, "": "" },
            s = new u.default("\\strut\\textstyle{" + n + "}", t.stack.env, t.configuration).mml(),
            p = new u.default("\\strut\\textstyle{" + o + "}", t.stack.env, t.configuration).mml(),
            f = t.create("node", "mfrac", [s, p]);
          if (null == (r = a[r])) throw new d.default("IllegalAlign", "Illegal alignment specified in %1", t.currentCS);
        ...
        (e.AmsMethods.Genfrac = function (t, e, r, n, o, a) {
          ...
          if (
            ...
            (r || n) && (l.default.setProperty(u, "withDelims", !0), (u = i.default.fixedFence(t.configuration, r, u, n))),
            "" !== a)
          ) {
            var p = parseInt(a, 10),
              f = ["D", "T", "S", "SS"][p];
            if (null == f) throw new d.default("BadMathStyleFor", "Bad math style for %1", t.currentCS);
            (u = t.create("node", "mstyle", [u])),
              "D" === f
                ? l.default.setProperties(u, { displaystyle: !0, scriptlevel: 0 })
                : l.default.setProperties(u, { displaystyle: !1, scriptlevel: p - 1 });
          }
          t.Push(u);
        }),
        (e.AmsMethods.HandleTag = function (t, e) {
          if (!t.tags.currentTag.taggable && t.tags.env)
            throw new d.default("CommandNotAllowedInEnv", "%1 not allowed in %2 environment", t.currentCS, t.tags.env);
          if (t.tags.currentTag.tag) throw new d.default("MultipleCommand", "Multiple %1", t.currentCS);
          var r = t.GetStar(),
    ...
    53974: (t, e, r) => {
      ...
      r(52410),
        (e.AmsCdConfiguration = n.Configuration.create("amscd", {
          ...
          options: { amscd: { colspace: "5pt", rowspace: "5pt", harrowsize: "2.75em", varrowsize: "1.75em", hideHorizontalLabels: !1 } },
        }));
    },
    52410: function (t, e, r) {
      var n =
          (this && this.__createBinding) ||
          (Object.create
            ? function (t, e, r, n) {
      ...
      new s.EnvironmentMap("amscd_environment", l.default.environment, { CD: "CD" }, c.default),
        new s.CommandMap("amscd_macros", { minCDarrowwidth: "minCDarrowwidth", minCDarrowheight: "minCDarrowheight" }, c.default),
      ...
      var o = n(r(94032)),
        ...
        l = {
          CD: function (t, e) {
            ...
            return (
              r.setProperties({ minw: t.stack.env.CD_minw || n.harrowsize, minh: t.stack.env.CD_minh || n.varrowsize }),
              (r.arraydef = { columnalign: "center", columnspacing: n.colspace, rowspacing: n.rowspace, displaystyle: !0 }),
              r
            );
          },
          arrow: function (t, e) {
            ...
            for (var c, u = n, d = u.table.length % 2 == 1, p = (u.row.length + (d ? 0 : 1)) % 2; p; ) l.cell(t, e), p--;
            var f = { minsize: u.getProperty("minw"), stretchy: !0 },
              m = { minsize: u.getProperty("minh"), stretchy: !0, symmetric: !0, lspace: 0, rspace: 0 };
            if ("." === r);
              ...
              if (">" === r || "<" === r) {
                if (((c = t.create("token", "mo", f, h)), g || (g = "\\kern " + u.getProperty("minw")), g || v)) {
                  ...
                  if (v) {
                    var _ = new o.default(v, t.stack.env, t.configuration).mml();
                    s.default.setChild(c, c.under, t.create("node", "mpadded", [_], y));
                  }
                  t.configuration.options.amscd.hideHorizontalLabels && (c = t.create("node", "mpadded", c, { depth: 0, height: ".67em" }));
                }
              } else {
                var w = t.create("token", "mo", m, h);
                (c = w),
                  (g || v) &&
                    ((c = t.create("node", "mrow")),
                    g && s.default.appendChildren(c, [new o.default("\\scriptstyle\\llap{" + g + "}", t.stack.env, t.configuration).mml()]),
                    (w.texClass = i.TEXCLASS.ORD),
                    s.default.appendChildren(c, [w]),
                    v && s.default.appendChildren(c, [new o.default("\\scriptstyle\\rlap{" + v + "}", t.stack.env, t.configuration).mml()]));
              }
            }
    ...
    39613: function (t, e, r) {
      ...
      (e.BboxMethods = {}),
        (e.BboxMethods.BBox = function (t, e) {
          for (var r, n, o, a = t.GetBrackets(e, ""), c = t.ParseArg(e), u = a.split(/,/), d = 0, p = u.length; d < p; d++) {
            var f = u[d].trim(),
              m = f.match(/^(\.\d+|\d+(\.\d*)?)(pt|em|ex|mu|px|in|cm|mm)$/);
            if (m) {
              if (r) throw new i.default("MultipleBBoxProperty", "%1 specified twice in %2", "Padding", e);
              var h = l(m[1] + m[3]);
              h && (r = { height: "+" + h, depth: "+" + h, lspace: h, width: "+" + 2 * parseInt(m[1], 10) + m[3] });
            } else if (f.match(/^([a-z0-9]+|\#[0-9a-f]{6}|\#[0-9a-f]{3})$/i)) {
              if (n) throw new i.default("MultipleBBoxProperty", "%1 specified twice in %2", "Background", e);
              n = f;
            } else if (f.match(/^[-a-z]+:/i)) {
              if (o) throw new i.default("MultipleBBoxProperty", "%1 specified twice in %2", "Style", e);
              o = s(f);
            } else if ("" !== f) throw new i.default("InvalidBBoxProperty", '"%1" doesn\'t look like a color, a padding dimension, or a style', f);
          }
          r && (c = t.create("node", "mpadded", [c], r)),
            (n || o) &&
              ((r = {}), n && Object.assign(r, { mathbackground: n }), o && Object.assign(r, { style: o }), (c = t.create("node", "mstyle", [c], r))),
            t.Push(c);
        });
      var s = function (t) {
          return t;
        ...
        try {
          for (var o = n(t.data.getList("fixBold")), a = o.next(); !a.done; a = o.next()) {
            ...
            if (i.default.getProperty(l, "fixBold")) {
              ...
              null == c ? i.default.setAttribute(l, "mathvariant", s.TexConstant.Variant.BOLD) : i.default.setAttribute(l, "mathvariant", u[c] || c),
          ...
          return (
            ...
            (e.prototype.checkItem = function (e) {
              return e.isKind("close")
                ...
                : e.isKind("mml")
                  ? (this.Push(e.toMml()), this.getProperty("single") ? [[this.toMml()], !0] : i.BaseItem.fail)
            ...
            (e.prototype.toMml = function () {
              ...
              if (this.getProperty("stretchy")) return l.default.fenced(this.factory.configuration, r, e, n);
              var o = { fence: !0, stretchy: !1, symmetric: !0, texClass: s.TEXCLASS.OPEN },
                a = this.create("token", "mo", o, r);
              o.texClass = s.TEXCLASS.CLOSE;
              var i = this.create("token", "mo", o, n);
              return this.create("node", "mrow", [a, e, i], { open: r, close: n, texClass: s.TEXCLASS.INNER });
            }),
            e
          );
        })(i.BaseItem);
    ...
    55833: function (t, e, r) {
      ...
      (s.Macro = o.default.Macro),
        (s.Braket = function (t, e, r, n, o, a) {
          ...
          var l = !0;
          "{" === s && (t.i++, (l = !1)),
            t.Push(t.itemFactory.create("braket").setProperties({ barmax: a, barcount: 0, open: r, close: n, stretchy: o, single: l }));
        }),
        (s.Bar = function (t, e) {
          var r = "|" === e ? "|" : "∥",
            n = t.stack.Top();
          if ("braket" !== n.kind || n.getProperty("barcount") >= n.getProperty("barmax")) {
            ...
            t.Push(o);
          } else if (("|" === r && "|" === t.GetNext() && (t.i++, (r = "∥")), n.getProperty("stretchy"))) {
        ...
        f = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkItem = function (t) {
              ...
              if (t.isKind("stop")) throw new c.default("EnvMissingEnd", "Missing \\end{%1}", this.getName());
    ...
    74836: function (t, e, r) {
      ...
      new i.CommandMap(
        ...
        new i.EnvironmentMap("Bussproofs-environments", a.default.environment, { prooftree: ["Prooftree", null, !1] }, o.default);
    },
    43118: function (t, e, r) {
      ...
      var c = l(r(54420)),
        ...
        f = {
          Prooftree: function (t, e) {
            return (
              t.Push(e), t.itemFactory.create("proofTree").setProperties({ name: e.getName(), line: "solid", currentLine: "solid", rootAtTop: !1 })
            );
          },
          Axiom: function (t, e) {
            var r = t.stack.Top();
            if ("proofTree" !== r.kind) throw new c.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
      ...
      function h(t, e, r, n, o, a, i) {
        var s,
          ...
          m = t.create("node", "mtable", i ? [f, d] : [d, f], { align: "top 2", rowlines: a, framespacing: "0 0" });
        if (
          (p.setProperty(m, "inferenceRule", i ? "up" : "down"),
          n &&
            ((s = t.create("node", "mpadded", [n], { height: "+.5em", width: "+.5em", voffset: "-.15em" })), p.setProperty(s, "prooflabel", "left")),
          o &&
            ((l = t.create("node", "mpadded", [o], { height: "+.5em", width: "+.5em", voffset: "-.15em" })), p.setProperty(l, "prooflabel", "right")),
          n && o)
        )
          (c = [s, m, l]), (u = "both");
      ...
      function g(t, e) {
        if ("$" !== t.GetNext()) throw new c.default("IllegalUseOfCommand", "Use of %1 does not match it's definition.", e);
        t.i++;
        var r = t.GetUpTo(e, "$");
        if (-1 === r.indexOf("\\fCenter")) throw new c.default("IllegalUseOfCommand", "Missing \\fCenter in %1.", e);
      ...
      (f.Inference = function (t, e, r) {
        var n = t.stack.Top();
        if ("proofTree" !== n.kind) throw new c.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
        if (n.Size() < r) throw new c.default("BadProofTree", "Proof tree badly specified.");
        var o = n.getProperty("rootAtTop"),
          a = 1 !== r || n.Peek()[0].childNodes.length ? r : 0,
          i = [];
        do {
          i.length && i.unshift(t.create("node", "mtd", [], {})),
            i.unshift(t.create("node", "mtd", [n.Pop()], { rowalign: o ? "top" : "bottom" })),
            r--;
        } while (r > 0);
        ...
        var f = h(t, l, [u], n.getProperty("left"), n.getProperty("right"), d, o);
        n.setProperty("left", null),
          n.setProperty("right", null),
          p.setProperty(f, "inference", a),
        ...
        (f.Label = function (t, e, r) {
          var n = t.stack.Top();
          if ("proofTree" !== n.kind) throw new c.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
          var o = d.default.internalMath(t, t.GetArgument(e), 0),
            a = o.length > 1 ? t.create("node", "mrow", o, {}) : o[0];
          n.setProperty(r, a);
        }),
        (f.SetLine = function (t, e, r, n) {
          var o = t.stack.Top();
          if ("proofTree" !== o.kind) throw new c.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
    ...
    32943: function (t, e, r) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.clearDocument = e.saveDocument = e.makeBsprAttributes = e.removeProperty = e.getProperty = e.setProperty = e.balanceRules = void 0);
      var s = i(r(53972)),
        l = i(r(55038)),
        c = null,
        u = null,
        ...
        _ = function (t, e, r) {
          ...
          if (t !== e.parent) {
            var o = t.childNodes,
              a = r ? o.length - 1 : 0;
            s.default.isType(o[a], "mspace") && (n += d(o[a])), (t = e.parent);
          }
          if (t === e) return n;
          var i = t.childNodes,
            l = r ? i.length - 1 : 0;
        ...
        w = function (t, r) {
          void 0 === r && (r = !1);
          var n = p(t),
            o = v(n, (0, e.getProperty)(n, "inferenceRule"));
          return _(t, n, r) + (d(n) - d(o)) / 2;
        },
        M = function (t, r, n, o) {
          if ((void 0 === o && (o = !1), (0, e.getProperty)(r, "inferenceRule") || (0, e.getProperty)(r, "labelledRule"))) {
          ...
          s.default.isType(c, "mspace")
            ? s.default.setAttribute(c, "width", l.default.Em(l.default.dimen2em(s.default.getAttribute(c, "width")) + n))
            : ((c = t.nodeFactory.create("node", "mspace", [], { width: l.default.Em(n) })),
        ...
        C = function (t, r, n, o, a) {
          var i = t.nodeFactory.create("node", "mspace", [], { width: l.default.Em(a) });
          if ("left" === o) {
        ...
        P = function (t, r) {
          for (var n = r.pop(); r.length; ) {
            var a = r.pop(),
              ...
              s = i[0],
              l = i[1];
            (0, e.getProperty)(n.parent, "axiom") && (C(t, s < 0 ? n : a, 0, "left", Math.abs(s)), C(t, l < 0 ? n : a, 2, "right", Math.abs(l))),
              (n = a);
          }
        },
        S = function (t, e) {
      ...
      e.balanceRules = function (t) {
        ...
        !(function (t) {
          ...
          if (r)
            for (var n = r.length - 1, o = void 0; (o = r[n]); n--)
              if ((0, e.getProperty)(o, "sequentProcessed")) (0, e.removeProperty)(o, "sequentProcessed");
              else {
                var a = [],
                  i = x(o);
                if (1 === (0, e.getProperty)(i, "inference")) {
                  for (a.push(o); 1 === (0, e.getProperty)(i, "inference"); ) {
                    ...
                    var s = h(f(i, (0, e.getProperty)(i, "inferenceRule"))),
                      l = (0, e.getProperty)(s, "inferenceRule") ? v(s, (0, e.getProperty)(s, "inferenceRule")) : s;
                    (0, e.getProperty)(l, "sequent") && ((o = l.childNodes[0]), a.push(o), (0, e.setProperty)(o, "sequentProcessed", !0)), (i = s);
                  }
                  P(t, a);
                }
              }
        ...
        try {
          for (var s = a(i), l = s.next(); !l.done; l = s.next()) {
            ...
            var O = g(A);
            if (null != (0, e.getProperty)(O, "inference")) {
              var q = w(O, !0);
              M(o, O, -q, !0);
              var T = _(c, m, !0),
              ...
              if (!d && (I = y(c))) {
                var D = b(I);
                if (D) {
                  var N = o.nodeFactory.create("node", "mspace", [], { width: q - T + "em" });
                  D.appendChild(N), c.removeProperty("maxAdjust");
                } else {
                  var G = x(I);
                  G &&
                    ((q = (0, e.getProperty)(G, "maxAdjust") ? Math.max((0, e.getProperty)(G, "maxAdjust"), q) : q),
                    (0, e.setProperty)(G, "maxAdjust", q));
                }
              } else M(o, (0, e.getProperty)(c, "proof") ? c : c.parent, q - T, !0);
            }
          }
        } catch (t) {
          r = { error: t };
      ...
      (e.setProperty = function (t, e, r) {
        s.default.setProperty(t, k + e, r);
      }),
        (e.getProperty = function (t, e) {
          return s.default.getProperty(t, k + e);
        }),
        (e.removeProperty = function (t, e) {
          t.removeProperty(k + e);
        }),
        (e.makeBsprAttributes = function (t) {
          t.data.root.walkTree(function (t, e) {
            var r = [];
            t.getPropertyNames().forEach(function (e) {
              !O[e] && e.match(RegExp("^" + k)) && r.push(e + ":" + t.getProperty(e));
            }),
              r.length && s.default.setAttribute(t, "semantics", r.join(";"));
          });
        }),
        (e.saveDocument = function (t) {
          if (!("getBBox" in (c = t.document).outputJax)) throw Error("The bussproofs extension requires an output jax with a getBBox() method");
        }),
        (e.clearDocument = function (t) {
          c = null;
        });
    },
    61767: function (t, e, r) {
      var n =
        (this && this.__importDefault) ||
        function (t) {
          return t && t.__esModule ? t : { default: t };
      ...
      (e.CancelMethods = {}),
        ...
        (e.CancelMethods.CancelTo = function (t, e) {
          ...
          (i.notation = [a.TexConstant.Notation.UPDIAGONALSTRIKE, a.TexConstant.Notation.UPDIAGONALARROW, a.TexConstant.Notation.NORTHEASTARROW].join(
            " "
          )),
            (n = t.create("node", "mpadded", [n], { depth: "-.1em", height: "+.1em", voffset: ".1em" })),
        ...
        (e.CancelConfiguration = o.Configuration.create("cancel", { handler: { macro: ["cancel"] } }));
    },
    99341: function (t, e, r) {
      var n,
        o,
        a =
          (this && this.__extends) ||
      ...
      var s = r(63401),
        ...
        h = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkItem = function (e) {
              return e.isKind("end") && e.getName() === this.getName() && this.getProperty("end")
      ...
      var g = (function (t) {
        ...
        return (
          ...
          (e.prototype.autoTag = function () {
            null == this.currentTag.tag &&
              ("subnumcases" === this.currentTag.env
                ? (0 === this.subcounter && this.counter++, this.subcounter++, this.tag(this.formatNumber(this.counter, this.subcounter), !1))
          ...
          (e.prototype.formatNumber = function (t, e) {
            return void 0 === e && (e = null), t.toString() + (null === e ? "" : String.fromCharCode(96 + e));
          }),
          e
        );
      })(f.AmsTags);
        ...
        (e.CasesMethods = {
          NumCases: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              ...
              return (
                m.EmpheqUtil.left(n, o, a + "\\empheqlbrace\\,", t, "numcases-left"),
                t.Push(t.itemFactory.create("end").setProperty("name", e.getName())),
                null
              );
            }
            (a = t.GetArgument("\\begin{" + e.getName() + "}")), e.setProperty("left", a);
          ...
          Entry: function (t, e) {
            if (!t.stack.Top().getProperty("numCases")) return u.default.Entry(t, e);
            t.Push(t.itemFactory.create("cell").setProperties({ isEntry: !0, name: e }));
            for (var r = t.string, n = 0, o = t.i, a = r.length; o < a; ) {
              ...
              if ("{" === i) n++, o++;
                ...
                if ("&" === i && 0 === n) throw new d.default("ExtraCasesAlignTab", "Extra alignment tab in text for numcase environment");
                if ("\\" === i && 0 === n) {
                  var s = (r.slice(o + 1).match(/^[a-z]+|./i) || [])[0];
                  if ("\\" === s || "cr" === s || "end" === s || "label" === s) break;
                  o += s.length;
                } else o++;
              }
            }
    ...
    61961: function (t, e, r) {
      ...
      new l.CommandMap(
          ...
          CenterOver: function (t, e) {
            var r = "{" + t.GetArgument(e) + "}",
              ...
              a = t.create("node", "TeXAtom", [
                ...
                t.create("node", "mpadded", [t.create("node", "mpadded", [n], { width: 0, lspace: "-.5width" }), t.create("node", "mphantom", [o])], {
                  width: 0,
                  lspace: "-.5width",
                }),
              ]);
        ...
        (e.CenternotConfiguration = a.Configuration.create("centernot", { handler: { macro: ["centernot"] }, postprocessors: [u] }));
    },
    80449: (t, e, r) => {
      ...
      (e.ColorMethods = {}),
        ...
        (e.ColorMethods.ColorBox = function (t, e) {
          var r = t.GetArgument(e),
            ...
            l = t.create("node", "mpadded", n, { mathbackground: s.getColor("named", r) });
      ...
      (e.ColorModel = l),
        s.set("rgb", function (t) {
          var e,
            ...
            o = t.trim().split(/\s*,\s*/),
            i = "#";
          if (3 !== o.length) throw new a.default("ModelArg1", "Color values for the %1 model require 3 numbers", "rgb");
          try {
            for (var s = n(o), l = s.next(); !l.done; l = s.next()) {
              var c = l.value;
              if (!c.match(/^(\d+(\.\d*)?|\.\d+)$/)) throw new a.default("InvalidDecimalNumber", "Invalid decimal number");
              var u = parseFloat(c);
              if (u < 0 || u > 1) throw new a.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "rgb", "0", "1");
        ...
        s.set("RGB", function (t) {
          ...
          try {
            for (var s = n(o), l = s.next(); !l.done; l = s.next()) {
              ...
              var u = parseInt(c);
              if (u > 255) throw new a.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "RGB", "0", "255");
              var d = u.toString(16);
              d.length < 2 && (d = "0" + d), (i += d);
            }
          } catch (t) {
        ...
        s.set("gray", function (t) {
          if (!t.match(/^\s*(\d+(\.\d*)?|\.\d+)\s*$/)) throw new a.default("InvalidDecimalNumber", "Invalid decimal number");
          var e = parseFloat(t);
          if (e < 0 || e > 1) throw new a.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "gray", "0", "1");
          var r = Math.floor(255 * e).toString(16);
          return r.length < 2 && (r = "0" + r), "#".concat(r).concat(r).concat(r);
        });
    },
    65744: function (t, e, r) {
      var n,
        o =
          (this && this.__extends) ||
          ((n = function (t, e) {
      ...
      (e.ColorArrayItem = u),
        new l.CommandMap(
          ...
          { cellcolor: ["TableColor", "cell"], rowcolor: ["TableColor", "row"], columncolor: ["TableColor", "col"] },
          {
            TableColor: function (t, e, r) {
              ...
              if ("col" === r) {
                if (i.table.length) throw new c.default("ColumnColorNotTop", "%1 must be in the top row", e);
        ...
        (e.ColortblConfiguration = s.Configuration.create("colortbl", {
          ...
          config: [
            function (t, e) {
              e.parseOptions.packageData.has("color") || s.ConfigurationHandler.get("color").config(t, e);
            },
            10,
          ],
        }));
    ...
    83370: (t, e, r) => {
      ...
      (e.ColorV2Methods = {
        ...
        (e.ColorConfiguration = o.Configuration.create("colorv2", { handler: { macro: ["colorv2"] } }));
    },
    53948: function (t, e, r) {
      var n,
        o =
          (this && this.__values) ||
          function (t) {
      ...
      e.ConfigMacrosConfiguration = i.Configuration.create("configmacros", {
        init: function (t) {
          new l.CommandMap(f, {}, {}),
            ...
            t.append(i.Configuration.local({ handler: { macro: [f], environment: [m] }, priority: 3 }));
        },
        config: function (t, e) {
          !(function (t) {
            var e,
            ...
            try {
              for (var i = o(Object.keys(a)), s = i.next(); !s.done; s = i.next()) {
                var l = s.value,
                  ...
                  p = Array.isArray(c[2])
                    ? new u.Macro(l, d.default.MacroWithTemplate, c.slice(0, 2).concat(c[2]))
            ...
            (function (t) {
              ...
              try {
                for (var i = o(Object.keys(a)), s = i.next(); !s.done; s = i.next()) {
                  var l = s.value;
                  n.add(l, new u.Macro(l, d.default.BeginEnv, [!0].concat(a[l])));
                }
              } catch (t) {
                e = { error: t };
              } finally {
          ...
          Empheq: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              ...
              var n = t.GetBrackets("\\begin{" + e.getName() + "}") || "",
                o = i((t.GetArgument("\\begin{" + e.getName() + "}") || "").split(/=/), 2),
                a = o[0],
                s = o[1];
              if (!f.EmpheqUtil.checkEnv(a)) throw new d.default("UnknownEnv", 'Unknown environment "%1"', a);
              n && e.setProperties(f.EmpheqUtil.splitOptions(n, { left: 1, right: 1 })),
                (t.stack.global.empheq = a),
                (t.string = "\\begin{" + a + "}" + (s ? "{" + s + "}" : "") + t.string.slice(t.i)),
                (t.i = 0),
                t.Push(e);
            }
          },
    ...
    14034: function (t, e, r) {
      ...
      e.EmpheqUtil = {
        environment: function (t, e, r, a) {
          var i = a[0],
            s = t.itemFactory.create(i + "-begin").setProperties({ name: e, end: i });
        ...
        cellBlock: function (t, e, r, n) {
          var o,
            i,
            s = r.create("node", "mpadded", [], { height: 0, depth: 0, voffset: "-1height" }),
          ...
          try {
            for (var d = a(u.isInferred ? u.childNodes : [u]), p = d.next(); !p.done; p = d.next()) {
              var f = p.value;
              s.appendChild(f);
            }
          } catch (t) {
          ...
          return s.appendChild(r.create("node", "mphantom", [r.create("node", "mpadded", [e], { width: 0 })])), s;
        },
        topRowTable: function (t, e) {
          ...
          return (
            ...
            t.factory.create("mphantom", {}, [e.create("node", "mpadded", [r], { width: 0 })])
          );
        },
        rowspanCell: function (t, e, r, n, o) {
          t.appendChild(
            n.create("node", "mpadded", [this.cellBlock(e, s.default.copyNode(r, n), n, o), this.topRowTable(r, n)], {
              height: 0,
              depth: 0,
              voffset: "height",
            })
        ...
        left: function (t, e, r, n, o) {
          var i, s, l;
          void 0 === o && (o = ""),
            t.attributes.set("columnalign", "right " + (t.attributes.get("columnalign") || "")),
        ...
        right: function (t, r, n, o, a) {
          ...
          for (var i = e.EmpheqUtil.columnCount(t), s = t.childNodes[0]; s.childNodes.length < i; ) s.appendChild(o.create("node", "mtd"));
        ...
        allowEnv: { equation: !0, align: !0, gather: !0, flalign: !0, alignat: !0, multline: !0 },
        checkEnv: function (t) {
          return this.allowEnv.hasOwnProperty(t.replace(/\*$/, "")) || !1;
        },
      };
    },
    17915: function (t, e, r) {
      var n =
        (this && this.__importDefault) ||
        function (t) {
          return t && t.__esModule ? t : { default: t };
      ...
      var o = r(63401),
        a = r(65695),
        i = n(r(55038));
      (e.ENCLOSE_OPTIONS = { "data-arrowhead": 1, color: 1, mathcolor: 1, background: 1, mathbackground: 1, "data-padding": 1, "data-thickness": 1 }),
        (e.EncloseMethods = {}),
        ...
        (e.EncloseConfiguration = o.Configuration.create("enclose", { handler: { macro: ["enclose"] } }));
    },
    74927: function (t, e, r) {
      var n =
        (this && this.__importDefault) ||
        function (t) {
          return t && t.__esModule ? t : { default: t };
      ...
      (e.ExtpfeilMethods = {}),
        ...
        (e.ExtpfeilMethods.NewExtArrow = function (t, r) {
          var n = t.GetArgument(r),
            o = t.GetArgument(r),
            a = t.GetArgument(r);
          if (!n.match(/^\\([a-z]+|.)$/i)) throw new c.default("NewextarrowArg1", "First argument to %1 must be a control sequence name", r);
          if (!o.match(/^(\d+),(\d+)$/)) throw new c.default("NewextarrowArg2", "Second argument to %1 must be two integers separated by a comma", r);
          if (!a.match(/^(\d+|0x[0-9A-F]+)$/i)) throw new c.default("NewextarrowArg3", "Third argument to %1 must be a unicode character number", r);
          n = n.substr(1);
          var i = o.split(",");
    ...
    48689: (t, e, r) => {
      ...
      new (r(65695).CharacterMap)(
        ...
        { ohm: "Ω", degree: "°", celsius: "℃", perthousand: "‰", micro: "µ" }
      ),
        (e.GensymbConfiguration = n.Configuration.create("gensymb", { handler: { macro: ["gensymb-symbols"] } }));
    },
    966: function (t, e, r) {
      var n =
        (this && this.__importDefault) ||
      ...
      new a.CommandMap("html_macros", { href: "Href", class: "Class", style: "Style", cssId: "Id" }, i.default),
        (e.HtmlConfiguration = o.Configuration.create("html", { handler: { macro: ["html_macros"] } }));
    },
    34034: function (t, e, r) {
      var n =
        (this && this.__importDefault) ||
        function (t) {
          return t && t.__esModule ? t : { default: t };
      ...
      var o = n(r(53972)),
        a = {
          ...
          Style: function (t, e) {
            ...
            a && (";" !== r.charAt(r.length - 1) && (r += ";"), (r = a + " " + r)), o.default.setAttribute(n, "style", r), t.Push(n);
          },
          Id: function (t, e) {
            var r = t.GetArgument(e),
              n = i(t, e);
    ...
    73414: function (t, e, r) {
      ...
      function f(t) {
        var e,
          ...
          c = t.data;
        try {
          for (var u = o(c.getList("mmultiscripts")), d = u.next(); !d.done; d = u.next()) {
            var p = d.value;
            if (p.getProperty("fixPrescript")) {
              var f = l.default.getChildren(p),
                m = 0;
              try {
                for (var h = ((n = void 0), o([1, 2])), g = h.next(); !g.done; g = h.next())
                  f[(b = g.value)] || (l.default.setChild(p, b, c.nodeFactory.create("node", "none")), m++);
              } catch (t) {
                n = { error: t };
              } finally {
                try {
              ...
              try {
                for (var v = ((i = void 0), o([4, 5])), y = v.next(); !y.done; y = v.next()) {
                  var b = y.value;
                  l.default.isType(f[b], "mrow") &&
                    0 === l.default.getChildren(f[b]).length &&
                    l.default.setChild(p, b, c.nodeFactory.create("node", "none"));
                }
              } catch (t) {
                i = { error: t };
              } finally {
      ...
      (e.PAIREDDELIMS = "mathtools-paired-delims"),
        ...
        (e.MathtoolsConfiguration = i.Configuration.create("mathtools", {
          ...
          init: function (t) {
            new s.CommandMap(e.PAIREDDELIMS, {}, {}), t.append(i.Configuration.local({ handler: { macro: [e.PAIREDDELIMS] }, priority: -5 }));
          },
          config: function (t, e) {
            var r,
              n,
          ...
          return (
            ...
            (e.prototype.EndTable = function () {
              if (((this.Size() || this.row.length) && (this.EndEntry(), this.EndRow()), this.table.length > 1)) {
                ...
                s.default.getAttribute(a, "columnalign") !== l.TexConstant.Align.RIGHT &&
                  a.appendChild(this.create("node", "mspace", [], { width: n }));
    ...
    655: function (t, e, r) {
      ...
      new a.CommandMap(
        ...
        new a.DelimiterMap("mathtools-delimiters", o.default.delimiter, { "\\lparen": "(", "\\rparen": ")" }),
        new a.CommandMap("mathtools-characters", { ":": ["CenterColon", !0] }, s.MathtoolsMethods);
    },
    81274: function (t, e, r) {
      var n =
          (this && this.__assign) ||
          function () {
            return (
      ...
      e.MathtoolsMethods = {
        ...
        MtSmallMatrix: function (t, r, n, o, a) {
          return (
            a || (a = t.GetBrackets("\\begin{".concat(r.getName(), "}"), t.options.mathtools["smallmatrix-align"])),
        ...
        MtMultlined: function (t, e) {
          ...
          return (
            (l.arraydef = { displaystyle: !0, rowspacing: ".5em", width: i || "auto", columnwidth: "100%" }), s.default.setArrayAlign(l, a || "c")
          );
        },
        HandleShove: function (t, e, r) {
          ...
          if (n.Size()) throw new d.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", e);
          n.setProperty("shove", r);
        ...
        SpreadLines: function (t, e) {
          ...
          if (t.stack.env.closing === e.getName()) {
            ...
            if (i.isInferred)
              try {
                for (var l = a(p.default.getChildren(i)), c = l.next(); !c.done; c = l.next()) {
                  var u = c.value;
            ...
            t.Push(i);
          } else (s = t.GetDimen("\\begin{".concat(e.getName(), "}"))), e.setProperty("spread", s), t.Push(e);
        },
        Cases: function (t, e, r, n, o) {
          var a = t.itemFactory.create("array").setProperty("casesEnv", e.getName());
          return (
            (a.arraydef = { rowspacing: ".2em", columnspacing: "1em", columnalign: "left" }),
        ...
        MathLap: function (t, e, r, o) {
          var a = t.GetBrackets(e, "").trim(),
            i = t.create(
              "node",
              "mstyle",
              [t.create("node", "mpadded", [t.ParseArg(e)], n({ width: 0 }, "r" === r ? {} : { lspace: "l" === r ? "-1width" : "-.5width" }))],
              { "data-cramped": o }
            );
          y.MathtoolsUtil.setDisplayLevel(i, a), t.Push(t.create("node", "TeXAtom", [i]));
        },
        ...
        MtLap: function (t, e, r) {
          ...
          "r" !== r && p.default.setAttribute(o, "lspace", "l" === r ? "-1width" : "-.5width"), t.Push(o);
        },
        MathMakeBox: function (t, e) {
          ...
          var a = (0, h.lookup)(n, { c: "center", r: "right" }, "");
        ...
        UnderOverBracket: function (t, e) {
          var r = (0, m.length2em)(t.GetBrackets(e, ".1em"), 0.1),
            ...
            a = t.GetArgument(e),
            i = o("o" === e.charAt(1) ? ["over", "accent", "bottom"] : ["under", "accentunder", "top"], 3),
            l = i[0],
            c = i[1],
            d = i[2],
            f = (0, m.em)(r),
            h = new u.default(a, t.stack.env, t.configuration).mml(),
            ...
            b = p.default.getChildAt(p.default.getChildAt(y, 0), 0);
          p.default.setAttribute(b, c, !0), t.Push(y);
        },
        Aboxed: function (t, e) {
          ...
          var l = s.default.substituteArgs(t, [a, i], "\\rlap{\\boxed{#1{}#2}}\\kern.267em\\phantom{#1}&\\phantom{{}#2}\\kern.267em");
          (t.string = l + o), (t.i = 0);
        },
        ArrowBetweenLines: function (t, e) {
          var r = y.MathtoolsUtil.checkAlignment(t, e);
          if (r.Size() || r.row.length) throw new d.default("BetweenLines", "%1 must be on a row by itself", e);
          var n = t.GetStar(),
        ...
        PairedDelimiters: function (t, e, r, n, a, i, l, c) {
          ...
          var u = t.GetStar(),
            d = u ? "" : t.GetBrackets(e),
            p = o(u ? ["\\left", "\\right"] : d ? [d + "l", d + "r"] : ["", ""], 2),
            f = p[0],
            m = p[1],
            h = u ? "\\middle" : d || "";
          if (i) {
            for (var g = [], v = g.length; v < i; v++) g.push(t.GetArgument(e));
            (l = s.default.substituteArgs(t, g, l)), (a = s.default.substituteArgs(t, g, a)), (c = s.default.substituteArgs(t, g, c));
          }
          (a = a.replace(/\\delimsize/g, h)),
            (t.string = [l, f, r, a, m, n, c, t.string.substr(t.i)].reduce(function (e, r) {
        ...
        DeclarePairedDelimiterXPP: function (t, e) {
          var r = g.default.GetCsNameArgument(t, e),
            ...
            s = t.GetArgument(e),
            l = t.GetArgument(e);
          y.MathtoolsUtil.addPairedDelims(t.configuration, r, [a, i, l, n, o, s]);
        },
        CenterColon: function (t, e, r, o, a) {
          ...
          if (r && (i.centercolon || o)) {
            ...
            s = t.create(
              ...
              "mpadded",
              [s],
              n({ voffset: l, height: "+".concat(l), depth: "-".concat(l) }, a ? { width: i["thincolon-dw"], lspace: i["thincolon-dx"] } : {})
            );
          }
          t.Push(s);
        },
                ...
                t.create(
                  ...
                  [
                    t.create(
                      ...
                      "mpadded",
                      [
                        t.create("node", "menclose", [t.create("node", "mspace", [], { height: ".2em", depth: 0, width: ".4em" })], {
            ...
            t.create(
              ...
              [
                t.create(
                  ...
                  "mfrac",
                  [
                    t.create("node", "mstyle", [n, t.create("token", "mi"), t.create("token", "mspace", { width: "1em" })], { scriptlevel: 0 }),
                    t.create("node", "mstyle", [t.create("token", "mspace", { width: "1em" }), t.create("token", "mi"), o], { scriptlevel: 0 }),
                  ],
          ...
          (n = y.MathtoolsUtil.plusOrMinus(e, n)),
            ...
            t.Push(
              t.create(
                ...
                "TeXAtom",
                [
                  t.create("node", "mpadded", [t.create("node", "mphantom", [t.create("token", "mo", { stretchy: !1 }, "(")])], {
                    width: 0,
                    height: n + "height",
                    depth: r + "depth",
                  }),
        ...
        Prescript: function (t, e) {
          ...
          if (p.default.isType(r, "none") && p.default.isType(n, "none")) t.Push(o);
          else {
            var a = t.create("node", "mmultiscripts", [o]);
            p.default.getChildren(a).push(null, null),
              p.default.appendChildren(a, [t.create("node", "mprescripts"), n, r]),
        ...
        NewTagForm: function (t, e, r) {
          void 0 === r && (r = !1);
          var n = t.tags;
          if (!("mtFormats" in n)) throw new d.default("TagsNotMT", "%1 can only be used with ams or mathtools tags", e);
          var o = t.GetArgument(e).trim();
          if (!o) throw new d.default("InvalidTagFormID", "Tag form name can't be empty");
          var a = t.GetBrackets(e, ""),
            i = t.GetArgument(e),
            s = t.GetArgument(e);
          if (!r && n.mtFormats.has(o)) throw new d.default("DuplicateTagForm", "Duplicate tag form: %1", o);
          n.mtFormats.set(o, [i, s, a]);
        },
        UseTagForm: function (t, e) {
          var r = t.tags;
          if (!("mtFormats" in r)) throw new d.default("TagsNotMT", "%1 can only be used with ams or mathtools tags", e);
          var n = t.GetArgument(e).trim();
          if (n) {
            if (!r.mtFormats.has(n)) throw new d.default("UndefinedTagForm", "Undefined tag form: %1", n);
        ...
        SetOptions: function (t, e) {
          ...
          if (!o["allow-mathtoolsset"]) throw new d.default("ForbiddenMathtoolsSet", "%1 is disabled", e);
          var i = {};
          Object.keys(o).forEach(function (t) {
            "pariedDelimiters" !== t && "tagforms" !== t && "allow-mathtoolsset" !== t && (i[t] = 1);
          });
          var l = t.GetArgument(e),
            c = s.default.keyvalOptions(l, i, !0);
          try {
            for (var u = a(Object.keys(c)), p = u.next(); !p.done; p = u.next()) {
              var f = p.value;
              o[f] = c[f];
            }
          } catch (t) {
              ...
              try {
                for (var s = a(Object.keys(i)), c = s.next(); !c.done; c = s.next()) {
                  ...
                  if (!Array.isArray(i[u]) || 3 !== i[u].length)
                    throw new l.default("InvalidTagFormDef", 'The tag form definition for "%1" should be an array fo three strings', u);
              ...
              (r.prototype.formatTag = function (e) {
                if (this.mtCurrent) {
                  var r = i(this.mtCurrent, 3),
                    ...
                    o = r[1],
                    a = r[2];
                  return a ? "".concat(n).concat(a, "{").concat(e, "}").concat(o) : "".concat(n).concat(e).concat(o);
                }
    ...
    53946: function (t, e, r) {
      ...
      e.MathtoolsUtil = {
        setDisplayLevel: function (t, e) {
          if (e) {
            var r = n(
                (0, u.lookup)(e, { "\\displaystyle": [!0, 0], "\\textstyle": [!1, 0], "\\scriptstyle": [!1, 1], "\\scriptscriptstyle": [!1, 2] }, [
                  null,
                  null,
                ]),
                2
        ...
        checkAlignment: function (t, e) {
          var r = t.stack.Top();
          if (r.kind !== a.EqnArrayItem.prototype.kind) throw new l.default("NotInAlignment", "%1 can only be used in aligment environments", e);
          return r;
        },
        ...
        plusOrMinus: function (t, e) {
          if (!(e = e.trim()).match(/^[-+]?(?:\d+(?:\.\d*)?|\.\d+)$/)) throw new l.default("NotANumber", "Argument to %1 is not a number", t);
          return e.match(/^[-+]/) ? e : "+" + e;
        },
    ...
    33289: function (t, e, r) {
      ...
      (u.Macro = s.default.Macro),
        ...
        (e.MhchemConfiguration = o.Configuration.create("mhchem", { handler: { macro: ["mhchem"] } }));
    },
    37515: function (t, e, r) {
      var n,
        o =
          (this && this.__createBinding) ||
          (Object.create
      ...
      var i = a(r(54420)),
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkItem = function (e) {
              if (e.isKind("end")) {
                if (e.getName() !== this.getName()) throw new i.default("EnvBadEnd", "\\begin{%1} ended with \\end{%2}", this.getName(), e.getName());
                return [[this.factory.create("mml", this.toMml())], !0];
              }
              if (e.isKind("stop")) throw new i.default("EnvMissingEnd", "Missing \\end{%1}", this.getName());
        ...
        p = {
          NewCommand: function (t, e) {
            var r = d.default.GetCsNameArgument(t, e),
              ...
              o = t.GetBrackets(e),
              a = t.GetArgument(e);
            d.default.addMacro(t, r, p.Macro, [a, n, o]);
          },
          NewEnvironment: function (t, e) {
            var r = u.default.trimSpaces(t.GetArgument(e)),
              ...
              a = t.GetArgument(e),
              i = t.GetArgument(e);
            d.default.addEnvironment(t, r, p.BeginEnv, [!0, a, i, n, o]);
          },
          MacroDef: function (t, e) {
            var r = d.default.GetCSname(t, e),
              n = d.default.GetTemplate(t, e, "\\" + r),
              o = t.GetArgument(e);
            n instanceof Array ? d.default.addMacro(t, r, p.MacroWithTemplate, [o].concat(n)) : d.default.addMacro(t, r, p.Macro, [o, n]);
          },
          Let: function (t, e) {
            var r = d.default.GetCSname(t, e),
              n = t.GetNext();
            ...
            if ("\\" !== n) {
              ...
              a ? d.default.addDelimiter(t, "\\" + r, a.char, a.attributes) : d.default.addMacro(t, r, p.Macro, [n]);
            } else {
              e = d.default.GetCSname(t, e);
              var i = o.get("delimiter").lookup("\\" + e);
              if (i) return void d.default.addDelimiter(t, "\\" + r, i.char, i.attributes);
              ...
              d.default.addMacro(
                ...
                function (t, e) {
                  ...
                  var o = d.default.assembleSymbol(r);
                  return s.parser(t, o);
                },
                u
              );
          ...
          MacroWithTemplate: function (t, e, r, n) {
            ...
            if (i) {
              var l = [];
              if ((t.GetNext(), o[0] && !d.default.MatchParam(t, o[0])))
                throw new s.default("MismatchUseDef", "Use of %1 doesn't match its definition", e);
              for (var c = 0; c < i; c++) l.push(d.default.GetParameter(t, e, o[c + 1]));
          ...
          BeginEnv: function (t, e, r, n, o, a) {
            if (e.getProperty("end") && t.stack.env.closing === e.getName()) {
              ...
              return (t.string = n), (t.i = 0), t.Parse(), (t.string = i), (t.i = 0), t.itemFactory.create("end").setProperty("name", e.getName());
            }
            if (o) {
              var s = [];
              if (null != a) {
              ...
              for (var c = s.length; c < o; c++) s.push(t.GetArgument("\\begin{" + e.getName() + "}"));
    ...
    87357: function (t, e, r) {
      ...
      !(function (t) {
        function e(t, e) {
          return t.string.substr(t.i, e.length) !== e || (e.match(/\\[a-z]+$/i) && t.string.charAt(t.i + e.length).match(/[a-z]/i))
            ? 0
            : ((t.i += e.length), 1);
        }
        (t.disassembleSymbol = function (t, e) {
          ...
          (t.assembleSymbol = function (t) {
            for (var e = t[0], r = t[1], n = {}, o = 2; o < t.length; o += 2) n[t[o]] = t[o + 1];
            return new s.Symbol(e, r, n);
          }),
          (t.GetCSname = function (t, e) {
            if ("\\" !== t.GetNext()) throw new i.default("MissingCS", "%1 must be followed by a control sequence", e);
          ...
          (t.GetCsNameArgument = function (t, e) {
            ...
            if (("\\" === r.charAt(0) && (r = r.substr(1)), !r.match(/^(.|[a-z]+)$/i)))
              throw new i.default("IllegalControlSequenceName", "Illegal control sequence name for %1", e);
            return r;
          }),
          (t.GetArgCount = function (t, e) {
            var r = t.GetBrackets(e);
            if (r && !(r = a.default.trimSpaces(r)).match(/^[0-9]+$/))
              throw new i.default("IllegalParamNumber", "Illegal number of parameters specified in %1", e);
            return r;
          }),
          (t.GetTemplate = function (t, e, r) {
            for (var n = t.GetNext(), o = [], a = 0, s = t.i; t.i < t.string.length; ) {
              if ("#" === (n = t.GetNext())) {
                if ((s !== t.i && (o[a] = t.string.substr(s, t.i - s)), !(n = t.string.charAt(++t.i)).match(/^[1-9]$/)))
                  throw new i.default("CantUseHash2", "Illegal use of # in template for %1", r);
                if (parseInt(n) !== ++a) throw new i.default("SequentialParam", "Parameters for %1 must be numbered sequentially", r);
                s = t.i + 1;
              } else if ("{" === n) return s !== t.i && (o[a] = t.string.substr(s, t.i - s)), o.length > 0 ? [a.toString()].concat(o) : a;
              t.i++;
            }
            throw new i.default("MissingReplacementString", "Missing replacement string for definition of %1", e);
          }),
          (t.GetParameter = function (t, r, n) {
            ...
            for (var o = t.i, a = 0, s = 0; t.i < t.string.length; ) {
              ...
              if ("{" === l) t.i === o && (s = 1), t.GetArgument(r), (a = t.i - o);
              else {
          ...
          (t.addMacro = function (e, r, n, o, a) {
            void 0 === a && (a = ""), e.configuration.handlers.retrieve(t.NEW_COMMAND).add(r, new s.Macro(a || r, n, o));
          }),
      ...
      e.NoErrorsConfiguration = n.Configuration.create("noerrors", {
        nodes: {
          error: function (t, e, r, n) {
            ...
            return t.create("node", "merror", [o], { "data-mjx-error": e, title: e });
          },
        },
      });
    },
    31664: function (t, e, r) {
      var n =
        (this && this.__values) ||
        function (t) {
          var e = "function" == typeof Symbol && Symbol.iterator,
      ...
      var i = r(26539),
        ...
        u = (function (t) {
          ...
          return (
            ...
            (e.prototype.toMml = function () {
              ...
              if (this.getProperty("smash")) {
                var n = t.prototype.toMml.call(this),
                  o = e.create("node", "mpadded", [n], { height: 0, depth: 0 });
            ...
            (e.errors = Object.assign(Object.create(i.BaseItem.errors), { stop: ["ExtraOrMissingDelims", "Extra open or missing close delimiter"] })),
            e
          );
        })(i.BaseItem);
      e.AutoOpen = u;
    ...
    38125: function (t, e, r) {
      ...
      new o.CommandMap(
        ...
        new o.MacroMap("Physics-characters", { "|": ["AutoClose", l.TEXCLASS.ORD], ")": "AutoClose", "]": "AutoClose" }, a.default);
    },
    92909: function (t, e, r) {
      var n =
          (this && this.__read) ||
          function (t, e) {
            var r = "function" == typeof Symbol && t[Symbol.iterator];
      ...
      var a = o(r(76914)),
        ...
        f = { "(": ")", "[": "]", "{": "}", "|": "|" },
        m = /^(b|B)i(g{1,2})$/;
      (p.Quantity = function (t, e, r, n, o, a, d) {
        void 0 === r && (r = "("), void 0 === n && (n = ")"), void 0 === o && (o = !1), void 0 === a && (a = ""), void 0 === d && (d = "");
        var p = !!o && t.GetStar(),
          h = t.GetNext(),
          g = t.i,
          v = null;
        ...
        var b = f[h];
        if (o && "{" !== h) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
        if (!b) return (y = t.create("node", "mrow")), t.Push(c.default.fenced(t.configuration, r, y, n)), void (t.i = g);
        if (a) {
          var x = t.create("token", "mi", { texClass: l.TEXCLASS.OP }, a);
          d && u.default.setAttribute(x, "mathvariant", d), t.Push(t.itemFactory.create("fn", x));
        }
        if ("{" === h) {
          ...
          return (
            (h = o ? r : "\\{"),
            (b = o ? n : "\\}"),
            (_ = p ? h + " " + _ + " " + b : v ? "\\" + v + "l" + h + " " + _ + " \\" + v + "r" + b : "\\left" + h + " " + _ + " \\right" + b),
            void t.Push(new i.default(_, t.stack.env, t.configuration).mml())
          );
        }
        o && ((h = r), (b = n)), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({ open: h, close: b, big: v }));
      }),
        (p.Eval = function (t, e) {
          var r = t.GetStar(),
            n = t.GetNext();
          if ("{" !== n) {
            if ("(" === n || "[" === n)
              return (
                t.i++, void t.Push(t.itemFactory.create("auto open").setProperties({ open: n, close: "|", smash: r, right: "\\vphantom{\\int}" }))
              );
            throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          }
          var o = t.GetArgument(e),
            a = "\\left. " + (r ? "\\smash{" + o + "}" : o) + " \\vphantom{\\int}\\right|";
        ...
        (p.Commutator = function (t, e, r, n) {
          ...
          var o = t.GetStar(),
            ...
            l = null;
          if ("\\" === a) {
            if ((t.i++, !(l = t.GetCS()).match(m))) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
            a = t.GetNext();
          }
          if ("{" !== a) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          var c = t.GetArgument(e) + "," + t.GetArgument(e);
          (c = o ? r + " " + c + " " + n : l ? "\\" + l + "l" + r + " " + c + " \\" + l + "r" + n : "\\left" + r + " " + c + " \\right" + n),
      ...
      function _(t, e, r, n) {
        var o = t.configuration.parser,
          a = d.NodeFactory.createToken(t, e, r, n),
          i = n.codePointAt(0);
        return (
          1 === n.length &&
            !o.stack.env.font &&
            o.stack.env.vectorFont &&
            (x(i, h) || x(i, g) || x(i, v) || x(i, b) || (x(i, y) && o.stack.env.vectorStar) || u.default.getAttribute(a, "accent")) &&
      ...
      (p.VectorBold = function (t, e) {
        ...
        (p.StarMacro = function (t, e, r) {
          ...
          var l = n.join(a ? "*" : "");
          (l = c.default.substituteArgs(t, i, l)), (t.string = c.default.addArgs(t, l, t.string.slice(t.i))), (t.i = 0), c.default.checkMaxMacros(t);
        });
      ...
      function M(t, e, r) {
        ...
        return e && r
          ...
          : e
            ? "\\langle{".concat(a, "}\\vert{").concat(i, "}\\vert{").concat(s, "}\\rangle")
      ...
      (p.OperatorApplication = function (t, e, r) {
          ...
          if (a || s)
            s
              ? ((c += t.GetArgument(e)),
                ...
                t.Push(t.create("node", "TeXAtom", [u], { texClass: l.TEXCLASS.OP })))
              : (t.Push(new i.default(c, t.stack.env, t.configuration).mml()),
                t.i++,
        ...
        (p.Derivative = function (t, e, r, n) {
          var o = t.GetStar(),
            ...
            s = 1,
            l = [];
          for (l.push(t.GetArgument(e)); "{" === t.GetNext() && s < r; ) l.push(t.GetArgument(e)), s++;
          var c = !1,
            u = " ",
            d = " ";
          r > 2 && l.length > 2
            ? ((u = "^{" + (l.length - 1) + "}"), (c = !0))
            : null != a && (r > 2 && l.length > 1 && (c = !0), (d = u = "^{" + a + "}"));
          for (
            var p = o ? "\\flatfrac" : "\\frac", f = l.length > 1 ? l[0] : "", m = l.length > 1 ? l[1] : l[0], h = "", g = 2, v = void 0;
            (v = l[g]);
            g++
          )
            h += n + " " + v;
          ...
          t.Push(new i.default(y, t.stack.env, t.configuration).mml()),
            "(" === t.GetNext() && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({ open: "(", close: ")", ignore: c })));
        }),
        (p.Bra = function (t, e) {
          var r = t.GetStar(),
            n = t.GetArgument(e),
          ...
          if ("\\" === t.GetNext()) {
            ...
            var c = t.GetCS(),
              u = t.lookup("macro", c);
            u && "ket" === u.symbol
              ? ((a = !0), (l = t.i), (s = t.GetStar()), "{" === t.GetNext() ? (o = t.GetArgument(c, !0)) : ((t.i = l), (s = !1)))
              : (t.i = l);
          }
          var d;
          (d = a
        ...
        (p.KetBra = function (t, e) {
          ...
          (a =
            null == o
              ? r
                ? "\\vert{".concat(n, "}\\rangle\\!\\langle{").concat(n, "}\\vert")
                : "\\left\\vert{".concat(n, "}\\middle\\rangle\\!\\middle\\langle{").concat(n, "}\\right\\vert")
              : r
                ? "\\vert{".concat(n, "}\\rangle\\!\\langle{").concat(o, "}\\vert")
        ...
        (p.Expectation = function (t, e) {
          ...
          var s = o && a ? M([a, o, a], r, n) : r ? "\\langle {".concat(o, "} \\rangle") : "\\left\\langle {".concat(o, "} \\right\\rangle");
          t.Push(new i.default(s, t.stack.env, t.configuration).mml());
        }),
        (p.MatrixElement = function (t, e) {
          var r = t.GetStar(),
            n = r && t.GetStar(),
            o = M([t.GetArgument(e), t.GetArgument(e), t.GetArgument(e)], r, n);
          t.Push(new i.default(o, t.stack.env, t.configuration).mml());
        }),
        (p.MatrixQuantity = function (t, e, r) {
          ...
          var c = (s ? "\\left" : "") + s + "\\begin{" + o + "}{} " + a + "\\end{" + o + "}" + (s ? "\\right" : "") + l;
          t.Push(new i.default(c, t.stack.env, t.configuration).mml());
        }),
        ...
        (p.XMatrix = function (t, e) {
          var r = t.GetStar(),
            ...
            i = parseInt(o, 10),
            l = parseInt(a, 10);
          if (isNaN(i) || isNaN(l) || l.toString() !== a || i.toString() !== o) throw new s.default("InvalidNumber", "Invalid number");
          ...
          if (1 === i && 1 === l) d = n;
            ...
            for (c = [], p = 1; p <= i; p++) c.push("".concat(n, "_{").concat(p, "}"));
            d = c.join("\\\\ ");
          } else {
            var f = [];
            for (p = 1; p <= i; p++) {
              c = [];
              for (var m = 1; m <= l; m++) c.push("".concat(n, "_{{").concat(p, "}{").concat(m, "}}"));
              f.push(c.join(" & "));
            }
            d = f.join("\\\\ ");
          }
        ...
        (p.DiagonalMatrix = function (t, e, r) {
          if ("{" === t.GetNext()) {
            ...
            (t.string =
              (function (t, e) {
                for (var r = t.length, n = [], o = 0; o < r; o++) n.push(Array(e ? r - o : o + 1).join("&") + "\\mqty{" + t[o] + "}");
                return n.join("\\\\ ");
      ...
      e.SetOptionsUtil = {
        ...
        filterOption: function (t, e, r) {
          var n,
            ...
            a = o.allowOptions[e] || {},
            i = a.hasOwnProperty(r) && !(0, d.isObject)(a[r]) ? a[r] : null;
          if (!1 === i || (null === i && !o.allowOptionsDefault)) throw new s.default("OptionNotSettable", 'Option "%1" is not allowed to be set', r);
            ...
            if (s.filterPackage(t, a))
              try {
                for (var c = n(Object.keys(i)), u = c.next(); !u.done; u = c.next()) {
                  var d = u.value;
                  s.filterOption(t, a, d) && (("tex" === a ? t.options : t.options[a])[d] = s.filterValue(t, a, d, i[d]));
                }
              } catch (t) {
                r = { error: t };
              } finally {
        ...
        options: {
          setoptions: {
            ...
            allowOptions: (0, d.expandable)({
              tex: { FindTeX: !1, formatError: !1, package: !1, baseURL: !1, tags: !1, maxBuffer: !1, maxMaxros: !1, macros: !1, environments: !1 },
              setoptions: !1,
              autoload: !1,
              require: !1,
              configmacros: !1,
    ...
    67689: (t, e, r) => {
      ...
      var n = r(63401);
      r(44438), (e.TextcompConfiguration = n.Configuration.create("textcomp", { handler: { macro: ["textcomp-macros"] } }));
    },
    44438: function (t, e, r) {
      ...
      new o.CommandMap(
        "textcomp-macros",
        {
          ...
          textdivorced: ["Insert", "⚮"],
          textmarried: ["Insert", "⚭"],
          textcentoldstyle: ["Insert", "¢", a.TexConstant.Variant.OLDSTYLE],
    ...
    54687: function (t, e, r) {
      ...
      function d(t, e, r, n) {
        ...
        return t instanceof c.TextParser || (o.texParser = t), [new c.TextParser(e, n ? { mathvariant: n } : {}, o.parseOptions, r).mml()];
      }
      r(13922),
        ...
        (e.TextMacrosConfiguration = a.Configuration.create("textmacros", {
          config: function (t, e) {
            ...
            (n.options = e.parseOptions.options),
              ...
              n.packageData.set("textmacros", { parseOptions: n, jax: e, texParser: null }),
              ...
              case "$":
                if (0 === i && e === n) {
                  var s = t.texParser.configuration,
                    l = new o.default(t.string.substr(a, r - a), t.stack.env, s).mml();
          ...
          return (
            ...
            (e.prototype.mml = function () {
              return null != this.level
                ? this.create("node", "mstyle", this.nodes, { displaystyle: !1, scriptlevel: this.level })
                : 1 === this.nodes.length
                  ? this.nodes[0]
            ...
            (e.prototype.saveText = function () {
              if (this.text) {
                var t = this.stack.env.mathvariant,
                  e = d.default.internalText(this, this.text, t ? { mathvariant: t } : {});
                (this.text = ""), this.Push(e);
              }
            }),
            (e.prototype.Push = function (e) {
              if ((this.text && this.saveText(), e instanceof m.StopItem)) return t.prototype.Push.call(this, e);
    ...
    36229: function (t, e, r) {
      ...
      (e.UnicodeMethods.Unicode = function (t, e) {
        ...
        if (!i.match(/^(x[0-9A-Fa-f]+|[0-9]+)$/)) throw new a.default("BadUnicode", "Argument to \\unicode must be a number");
        var d = parseInt(i.match(/^x/) ? "0" + i : i);
        u[d] ? o || (o = u[d][2]) : (u[d] = [800, 200, o, d]),
          n && ((u[d][0] = Math.floor(1e3 * parseFloat(n[0]))), (u[d][1] = Math.floor(1e3 * parseFloat(n[1]))));
        var p = t.stack.env.font,
          f = {};
        o
          ? ((u[d][2] = f.fontfamily = o.replace(/'/g, "'")),
            p && (p.match(/bold/) && (f.fontweight = "bold"), p.match(/italic|-mathit/) && (f.fontstyle = "italic")))
          : p && (f.mathvariant = p);
        ...
        (e.UnicodeConfiguration = o.Configuration.create("unicode", { handler: { macro: ["unicode"] } }));
    },
    63892: (t, e, r) => {
      ...
      new o.CharacterMap(
        ...
        (e.UpgreekConfiguration = n.Configuration.create("upgreek", { handler: { macro: ["upgreek"] } }));
    },
    95729: function (t, e, r) {
      ...
      (e.VerbMethods = {}),
        (e.VerbMethods.Verb = function (t, e) {
          var r = t.GetNext(),
            n = ++t.i;
          if ("" === r) throw new s.default("MissingArgFor", "Missing argument for %1", e);
          for (; t.i < t.string.length && t.string.charAt(t.i) !== r; ) t.i++;
          if (t.i === t.string.length) throw new s.default("NoClosingDelim", "Can't find closing delimiter for %1", t.currentCS);
          var o = t.string.slice(n, t.i).replace(/ /g, " ");
        ...
        (e.VerbConfiguration = o.Configuration.create("verb", { handler: { macro: ["verb"] } }));
    },
    84752: (t, e) => {
        ...
        for (e in t)
          for (r in t[e])
            for (o = t[e][r].stateArray || [], a = 0; a < o.length; a++) {
              ...
              for (var s = 0; s < i.action_.length; s++) "string" == typeof i.action_[s] && (i.action_[s] = { type_: i.action_[s] });
      ...
      var o = {
          go: function (t, e) {
            ...
            for (var i = 10, s = []; ; ) {
              ...
              t: for (var u = 0; u < c.length; u++) {
                var d = o.patterns.match_(c[u].pattern, t);
                if (d) {
                  for (var p = c[u].task, f = 0; f < p.action_.length; f++) {
                    var m = void 0;
                    if (l.actions[p.action_[f].type_]) m = l.actions[p.action_[f].type_](a, d.match_, p.action_[f].option);
                    else {
                      if (!o.actions[p.action_[f].type_]) throw ["MhchemBugA", "mhchem bug A. Please report. (" + p.action_[f].type_ + ")"];
                      m = o.actions[p.action_[f].type_](a, d.match_, p.action_[f].option);
                    }
                    o.concatArray(s, m);
                  }
          ...
          patterns: {
            patterns: {
              ...
              "state of aggregation $": function (t) {
                var e = o.patterns.findObserveGroups(t, "", /^\([a-z]{1,3}(?=[\),])/, ")", "");
            ...
            findObserveGroups: function (t, e, r, n, o, a, i, s, l, c) {
              ...
              var p = (function (t, e, r) {
                for (var n = 0; e < t.length; ) {
                  var o = t.charAt(e),
                    a = u(t.substr(e), r);
                  if (null !== a && 0 === n) return { endMatchBegin: e, endMatchEnd: e + a.length };
                  if ("{" === o) n++;
                  else if ("}" === o) {
                    if (0 === n) throw ["ExtraCloseMissingOpen", "Extra close brace or missing open brace"];
                    n--;
                  }
                  e++;
                }
              ...
              if (a || i) {
                var m = this.findObserveGroups(t.substr(p.endMatchEnd), a, i, s, l);
          ...
          stateMachines: {
              ...
              actions: {
                ...
                "- after o/d": function (t, e, r) {
                  var n = o.patterns.match_("orbital", t.o || ""),
                    a = o.patterns.match_("one lowercase greek letter $", t.o || ""),
                  ...
                  return (
                    l
                      ? (o.concatArray(c, this.output(t)), c.push({ type_: "hyphen" }))
                ...
                comma: function (t, e) {
                  var r = e.replace(/\s*$/, "");
                  return r !== e && 0 === t.parenthesisLevel ? { type_: "comma enumeration L", p1: r } : { type_: "comma enumeration M", p1: r };
                },
                output: function (t, e, r) {
                  var n;
                  if (t.r) {
                    var a;
                    a = "M" === t.rdt ? o.go(t.rd, "tex-math") : "T" === t.rdt ? [{ type_: "text", p1: t.rd || "" }] : o.go(t.rd, "ce");
                    var i;
                    (i = "M" === t.rqt ? o.go(t.rq, "tex-math") : "T" === t.rqt ? [{ type_: "text", p1: t.rq || "" }] : o.go(t.rq, "ce")),
                ...
                "frac-output": function (t, e) {
                  return { type_: "frac-ce", p1: o.go(e[0], "ce"), p2: o.go(e[1], "ce") };
                },
                "overset-output": function (t, e) {
                  return { type_: "overset", p1: o.go(e[0], "ce"), p2: o.go(e[1], "ce") };
                },
                "underset-output": function (t, e) {
                  return { type_: "underset", p1: o.go(e[0], "ce"), p2: o.go(e[1], "ce") };
                },
                "underbrace-output": function (t, e) {
                  return { type_: "underbrace", p1: o.go(e[0], "ce"), p2: o.go(e[1], "ce") };
                },
                "color-output": function (t, e) {
                  return { type_: "color", color1: e[0], color2: o.go(e[1], "ce") };
                },
                "r=": function (t, e) {
                  t.r = e;
                },
            ...
            pq: {
              ...
              actions: {
                "state of aggregation": function (t, e) {
                  return { type_: "state of aggregation subscript", p1: o.go(e, "o") };
                },
                "color-output": function (t, e) {
                  return { type_: "color", color1: e[0], color2: o.go(e[1], "pq") };
                },
              },
            },
            bd: {
              ...
              actions: {
                "color-output": function (t, e) {
                  return { type_: "color", color1: e[0], color2: o.go(e[1], "bd") };
                },
              },
            },
            oxidation: {
              transitions: n({
                ...
                "pm-operator": { "*": { action_: { type_: "o=+p1", option: "\\pm" } } },
                else: { "*": { action_: "o=" } },
              }),
              actions: {
            ...
            "9,9": {
              transitions: n({ empty: { "*": { action_: [] } }, ",": { "*": { action_: "comma" } }, else: { "*": { action_: "copy" } } }),
              actions: {
                comma: function () {
              ...
              actions: {
                ...
                output: function (t) {
                  ...
                  if (
                    ...
                    t.d && ((t.d = t.d.replace(/\u00B0C|\^oC|\^{o}C/g, "{}^{\\circ}C")), (t.d = t.d.replace(/\u00B0F|\^oF|\^{o}F/g, "{}^{\\circ}F"))),
                    t.q)
                  ) {
                    ...
                    "//" === t.o
                      ...
                      : ((e = a.d), a.d.length > 1 || a.q.length > 1 ? e.push({ type_: " / " }) : e.push({ type_: "/" }), o.concatArray(e, a.q));
              ...
              actions: {
                ...
                "output-0": function (t) {
                  ...
                  if (((t.text_ = t.text_ || ""), t.text_.length > 4)) {
                    ...
                    0 === r && (r = 3);
                    for (var n = t.text_.length - 3; n > 0; n -= 3) e.push(t.text_.substr(n, 3)), e.push({ type_: "1000 separator" });
                ...
                "output-o": function (t) {
                  ...
                  if (((t.text_ = t.text_ || ""), t.text_.length > 4)) {
                    var r = t.text_.length - 3,
                      n = void 0;
                    for (n = 0; n < r; n += 3) e.push(t.text_.substr(n, 3)), e.push({ type_: "1000 separator" });
        ...
        a = {
          ...
          _go2: function (t) {
            ...
            switch (t.type_) {
              case "chemfive":
                e = "";
                var r = { a: a._goInner(t.a), b: a._goInner(t.b), p: a._goInner(t.p), o: a._goInner(t.o), q: a._goInner(t.q), d: a._goInner(t.d) };
                r.a && (r.a.match(/^[+\-]/) && (r.a = "{" + r.a + "}"), (e += r.a + "\\,")),
                  ...
                  "kv" === t.dType
                    ? ((r.d || r.q) && (e += "{\\vphantom{A}}"), r.d && (e += "^{" + r.d + "}"), r.q && (e += "_{\\smash[t]{" + r.q + "}}"))
                    : "oxidation" === t.dType
              ...
              case "state of aggregation subscript":
                ...
                break;
              case "bond":
                if (!(e = a._getBond(t.kind_))) throw ["MhchemErrorBond", "mhchem Error. Unknown bond type (" + t.kind_ + ")"];
                break;
              case "frac":
                ...
                i.rd || i.rq
                  ? "<=>" === t.r || "<=>>" === t.r || "<<=>" === t.r || "<--\x3e" === t.r
                    ? ((s = "\\long" + s),
                      ...
                      i.rq &&
                        (s =
                          "<--\x3e" === t.r ? "\\underset{\\lower2mu{" + i.rq + "}}{" + s + "}" : "\\underset{\\lower6mu{" + i.rq + "}}{" + s + "}"),
                      (s = " {}\\mathrel{" + s + "}{} "))
