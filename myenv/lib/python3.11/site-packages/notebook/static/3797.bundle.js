...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [3797],
  {
    23797: (t, e, a) => {
      ...
      class s {
        constructor(t, e, a) {
          (this.set = t), (this.base = e), (this.modified = a), (this.id = r++);
        }
        static define(t) {
      ...
      class n {
        ...
        static get(t, e) {
          ...
          let a = e[0].instances.find((a) => {
            return a.base == t && ((i = e), (r = a.modified), i.length == r.length && i.every((t, e) => t == r[e]));
            var i, r;
          });
          if (a) return a;
          let i = [],
          ...
          for (let e of t.set) if (!e.modified.length) for (let t of o) i.push(n.get(e, t));
          return r;
        }
      }
      function l(t) {
        ...
        for (let a in t) {
          ...
          for (let t of a.split(" "))
            if (t) {
              ...
              let l = new c(i, r, o > 0 ? a.slice(0, o) : null);
              e[n] = l.sort(e[n]);
            }
        }
        return h.add(e);
      }
      const h = new i.NodeProp();
      class c {
        constructor(t, e, a, i) {
      ...
      function f(t, e, a, i = 0, r = t.length) {
        let s = new p(i, Array.isArray(e) ? e : [e], a);
        s.highlightRange(t.cursor(), i, r, "", s.highlighters), s.flush(r);
      }
      function d(t, e, a, i, r, s = 0, o = t.length) {
        let n = s;
        function l(e, a) {
          if (!(e <= n)) {
            for (let s = t.slice(n, e), o = 0; ; ) {
              let t = s.indexOf("\n", o),
                e = t < 0 ? s.length : t;
              if ((e > o && i(s.slice(o, e), a), t < 0)) break;
              r(), (o = t + 1);
            }
            n = e;
          }
      ...
      class p {
        constructor(t, e, a) {
          (this.at = t), (this.highlighters = e), (this.span = a), (this.class = "");
        }
        startSpan(t, e) {
        ...
        highlightRange(t, e, a, r, s) {
          let { type: o, from: n, to: l } = t;
          if (n >= a || l <= e) return;
          ...
          if ((f && (h && (h += " "), (h += f), 1 == g.mode && (r += (r ? " " : "") + f)), this.startSpan(Math.max(e, n), h), g.opaque)) return;
          let d = t.tree && t.tree.prop(i.NodeProp.mounted);
          if (d && d.overlay) {
            let i = t.node.enter(d.overlay[0].from + n, 1),
              o = this.highlighters.filter((t) => !t.scope || t.scope(d.tree.type)),
              c = t.firstChild();
            for (let g = 0, f = n; ; g++) {
              let p = g < d.overlay.length ? d.overlay[g] : null,
                m = p ? p.from + n : l,
                u = Math.max(e, f),
                k = Math.min(a, m);
              if (u < k && c)
                for (; t.from < k && (this.highlightRange(t, u, k, r, s), this.startSpan(Math.min(k, t.to), h), !(t.to >= m) && t.nextSibling()); );
              if (!p || m > a) break;
              (f = p.to + n),
                f > e && (this.highlightRange(i.cursor(), Math.max(e, p.from + n), Math.min(a, f), "", o), this.startSpan(Math.min(a, f), h));
            }
            c && t.parent();
            ...
            do {
              if (!(t.to <= e)) {
                if (t.from >= a) break;
                this.highlightRange(t, e, a, r, s), this.startSpan(Math.min(a, t.to), h);
              }
            } while (t.nextSibling());
            t.parent();
          }
      ...
      const u = s.define,
        ...
        E = {
          ...
          operatorKeyword: u(C),
          controlKeyword: u(C),
          definitionKeyword: u(C),
          moduleKeyword: u(C),
          operator: R,
          derefOperator: u(R),
          arithmeticOperator: u(R),
          logicOperator: u(R),
          bitwiseOperator: u(R),
          compareOperator: u(R),
          updateOperator: u(R),
          definitionOperator: u(R),
          typeOperator: u(R),
          controlOperator: u(R),
          punctuation: S,
          separator: u(S),
