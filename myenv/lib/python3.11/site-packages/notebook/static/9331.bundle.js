...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [9331],
  {
    69331: (e, n, t) => {
      ...
      function r(e, n) {
        for (var t = 0; t < e.length; t++) if (n(e[t], t)) return !0;
        return !1;
      }
      t.r(n), t.d(n, { dylan: () => k });
      var a = {
      ...
      var o = "[-_a-zA-Z?!*@<>$%]+",
        l = new RegExp("^" + o),
        f = { symbolKeyword: o + ":", symbolClass: "<" + o + ">", symbolGlobal: "\\*" + o + "\\*", symbolConstant: "\\$" + o },
        c = { symbolKeyword: "atom", symbolClass: "tag", symbolGlobal: "variableName.standard", symbolConstant: "variableName.constant" };
      for (var s in f) f.hasOwnProperty(s) && (f[s] = new RegExp("^" + f[s]));
      f.keyword = [/^with(?:out)?-[-_a-zA-Z?!*@<>$%]+/];
      var u = { keyword: "keyword", definition: "def", simpleDefinition: "def", signalingCalls: "builtin" },
        m = {},
        d = {};
      function p(e, n, t) {
      ...
      function b(e, n) {
        var t = e.peek();
        if ("'" == t || '"' == t) return e.next(), p(e, n, y(t, "string"));
        if ("/" == t) {
          if ((e.next(), e.eat("*"))) return p(e, n, h);
          ...
          if ("~" == t) return e.next(), "=" == (t = e.peek()) ? (e.next(), "=" == (t = e.peek()) ? (e.next(), "operator") : "operator") : "operator";
          if (":" == t) {
            if ((e.next(), "=" == (t = e.peek()))) return e.next(), "operator";
            if (":" == t) return e.next(), "punctuation";
          } else {
            if (-1 != "[](){}".indexOf(t)) return e.next(), "bracket";
            if (-1 != ".,".indexOf(t)) return e.next(), "punctuation";
        ...
        return /[+\-*\/^=<>&|]/.test(t)
          ...
          : e.match("define")
            ? "def"
            : (e.eatWhile(/[\w\-]/),
              m.hasOwnProperty(e.current()) ? d[e.current()] : e.current().match(l) ? "variable" : (e.next(), "variableName.standard"));
      }
      function h(e, n) {
      ...
      function y(e, n) {
        return function (t, i) {
          for (var r, a = !1, o = !1; null != (r = t.next()); ) {
            if (r == e && !a) {
              o = !0;
              break;
            }
