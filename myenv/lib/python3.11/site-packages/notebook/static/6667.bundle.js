      ...
      var n = i(24028),
        ...
        r =
          ...
          (function () {
                ...
                performAction: function (t, e, i, n, s, r, l) {
                  ...
                  switch (s) {
                    ...
                    case 6:
                      ...
                      break;
                    case 8:
                      n.addSection(r[a - 1], n.cleanupValue(r[a]));
                      break;
                    case 9:
                      (this.$ = r[a].trim()), n.setDiagramTitle(this.$);
                      break;
                    case 10:
                      (this.$ = r[a].trim()), n.setAccTitle(this.$);
                      break;
                    case 11:
                    case 12:
                      (this.$ = r[a].trim()), n.setAccDescription(this.$);
                      break;
                    case 13:
                      n.addSection(r[a].substr(8)), (this.$ = r[a].substr(8));
                  }
                },
                table: [
                  ...
                  t(a, [2, 16]),
                  { 1: [2, 1] },
                  t(c, o, { 8: 10, 9: 11, 1: [2, 2], 10: h, 12: u, 14: y, 16: p, 18: d, 19: g }),
                  t(r, l, { 6: 18 }),
                  t(r, [2, 5]),
                  { 4: 19, 20: i, 21: n, 22: s },
                  { 11: [1, 20] },
                  ...
                  t(c, [2, 12]),
                  t(c, [2, 13]),
                  t(c, o, { 8: 10, 9: 11, 1: [2, 3], 10: h, 12: u, 14: y, 16: p, 18: d, 19: g }),
                  t(r, [2, 6]),
                  t(c, [2, 8]),
                  t(c, [2, 9]),
                  t(c, [2, 10]),
                ...
                parse: function (t) {
                  ...
                  for (var g, _, f, m, b, k, x, v, S, w = {}; ; ) {
                    if (
                      ...
                      var $;
                      for (b in ((v = []), r[_])) this.terminals_[b] && b > 2 && v.push("'" + this.terminals_[b] + "'");
                      ($ = h.showPosition
                        ? "Parse error on line " +
                          (a + 1) +
                          ":\n" +
                          ...
                          (this.terminals_[g] || g) +
                          "'"
                        : "Parse error on line " + (a + 1) + ": Unexpected " + (1 == g ? "end of input" : "'" + (this.terminals_[g] || g) + "'")),
                        this.parseError($, { text: h.match, token: this.terminals_[g] || g, line: h.yylineno, loc: p, expected: v });
                    }
                    ...
                    switch (f[0]) {
                      ...
                      case 2:
                        if (
                          ...
                          d && (w._$.range = [s[s.length - (k || 1)].range[0], s[s.length - 1].range[1]]),
                          void 0 !== (m = this.performAction.apply(w, [l, c, a, u.yy, f[1], n, s].concat(o))))
                        )
                          return m;
                        k && ((e = e.slice(0, -1 * k * 2)), (n = n.slice(0, -1 * k)), (s = s.slice(0, -1 * k))),
            ...
            return (_.lexer = f), (m.prototype = _), (_.Parser = m), new m();
          })());
      r.parser = r;
      const l = r,
        a = n.A.pie,
      ...
      const u = structuredClone(a),
        y = {
          ...
          db: {
            ...
            clear: () => {
              (o = structuredClone(c)), (h = false), (0, n.t)();
            },
            setDiagramTitle: n.q,
            getDiagramTitle: n.r,
            setAccTitle: n.s,
          ...
          renderer: {
            draw: (t, e, i, r) => {
              ...
              const l = r.db,
                a = (0, n.c)(),
                c = (0, n.B)(l.getConfig(), a.pie),
                o = (0, n.z)(e),
                h = o.append("g"),
                u = l.getSections();
              h.attr("transform", "translate(225,225)");
              const { themeVariables: y } = a;
              let [p] = (0, n.C)(y.pieOuterStrokeWidth);
              p ?? (p = 2);
              const d = c.textPosition,
                g = Math.min(450, 450) / 2 - 40,
                _ = (0, s.Nb1)().innerRadius(0).outerRadius(g),
                f = (0, s.Nb1)()
                  .innerRadius(g * d)
                  .outerRadius(g * d);
              h.append("circle")
              ...
              const m = ((t) => {
                ...
                b = [y.pie1, y.pie2, y.pie3, y.pie4, y.pie5, y.pie6, y.pie7, y.pie8, y.pie9, y.pie10, y.pie11, y.pie12],
                k = (0, s.PKp)(b);
              h.selectAll("mySlices")
                .data(m)
                .enter()
                .append("path")
                .attr("d", _)
              ...
              Object.keys(u).forEach((t) => {
                ...
                h
                  ...
                  .enter()
                  .append("text")
                  .text((t) => ((t.data.value / x) * 100).toFixed(0) + "%")
                  .attr("transform", (t) => "translate(" + f.centroid(t) + ")")
                  .style("text-anchor", "middle")
                  .attr("class", "slice"),
                h.append("text").text(l.getDiagramTitle()).attr("x", 0).attr("y", -200).attr("class", "pieTitleText");
              const v = h
                .selectAll(".legend")
                .data(k.domain())
                .enter()
                .append("g")
                .attr("class", "legend")
                .attr("transform", (t, e) => "translate(216," + (22 * e - (22 * k.domain().length) / 2) + ")");
              v.append("rect").attr("width", 18).attr("height", 18).style("fill", k).style("stroke", k),
                v
                  .data(m)
                  .append("text")
                  .attr("x", 22)
              ...
              const S =
                ...
                Math.max(
                  ...v
                    .selectAll("text")
                    .nodes()
                    .map((t) => (null == t ? void 0 : t.getBoundingClientRect().width) ?? 0)
                );
              o.attr("viewBox", `0 0 ${S} 450`), (0, n.i)(o, 450, S, c.useMaxWidth);
            },
          },
          styles: (t) =>
