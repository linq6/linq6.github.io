    ...
    27054: (e, t, r) => {
      ...
      function _(e, t) {
        ...
        if (((t.block = !1), r && /[<\/\*{}\-]/.test(i))) {
          if (e.match(s)) return (t.block = !0), b(e, t, w);
        ...
        if ("/" == i) {
          if (e.eat("%")) return b(e, t, $);
          if (e.eat("/")) return b(e, t, z);
        }
        if ("_" == i && e.eat("_")) return b(e, t, W);
        if ("-" == i && e.eat("-")) {
          if (" " != e.peek()) return b(e, t, g);
        ...
        return "'" == i && e.eat("'")
          ...
          : "<" == i && e.eat("<")
            ? b(e, t, x)
            : (e.eatWhile(/[\w\$_]/), n.propertyIsEnumerable(e.current()) ? "keyword" : null);
      }
      function $(e, t) {
      ...
      function w(e, t) {
        ...
        return r && e.current()
          ? "comment"
          : (!r && e.match(p)) || (r && e.sol() && e.match(d))
            ? ((t.tokenize = _), "comment")
            : (e.next(), "comment");
      }
      function z(e, t) {
        for (var r, n = !1; (r = e.next()); ) {
      ...
      function x(e, t) {
        ...
        return r
          ? ">" == r && ">" == e.peek()
            ? (e.next(), (t.tokenize = _), "meta")
            : (e.eatWhile(/[\w\$_]/), i.propertyIsEnumerable(e.current()) ? "keyword" : null)
          : ((t.tokenize = _), null);
      }
      const T = {
        name: "tiddlywiki",
