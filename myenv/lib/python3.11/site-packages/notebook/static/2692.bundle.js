    ...
    22692: (t, e, r) => {
          ...
          if (
            ...
            (n = (function (t) {
              ...
              for (let t = 0; t < a; ++t) {
                ...
                (r[0] = (r[0] + a) >>> 0), (r[1] = (r[1] + s) >>> 0), (r[2] = (r[2] + o) >>> 0), (r[3] = (r[3] + c) >>> 0), (r[4] = (r[4] + l) >>> 0);
              }
              return [
                (r[0] >> 24) & 255,
                (r[0] >> 16) & 255,
      ...
      var u = (function () {
        var t = function (t, e, r, i) {
          ...
          d = [1, 24],
          y = [1, 25],
          u = [6, 8, 10, 13, 15, 18, 19, 20, 22, 24, 26, 27, 28, 41, 42, 43, 44, 45],
          p = [1, 34],
          _ = [27, 28, 46, 47],
          f = [41, 42, 43, 44, 45],
          E = [17, 34],
          ...
          b = {
            ...
            performAction: function (t, e, r, i, a, n, s) {
              ...
              switch (a) {
                ...
                case 11:
                  ...
                  break;
                case 12:
                  i.addEntity(n[o - 6], n[o - 4]), i.addAttributes(n[o - 6], n[o - 1]);
                  break;
                case 13:
                  i.addEntity(n[o - 5], n[o - 3]);
                  break;
                case 14:
                  i.addEntity(n[o - 3], n[o - 1]);
                  break;
                case 15:
                case 16:
                ...
                case 23:
                  ...
                  break;
                case 24:
                  this.$ = { attributeType: n[o - 2], attributeName: n[o - 1], attributeKeyTypeList: n[o] };
                  break;
                case 25:
                  this.$ = { attributeType: n[o - 2], attributeName: n[o - 1], attributeComment: n[o] };
                  break;
                case 26:
                  this.$ = { attributeType: n[o - 3], attributeName: n[o - 2], attributeKeyTypeList: n[o - 1], attributeComment: n[o] };
                  break;
                case 30:
            ...
            table: [
              ...
              { 1: [3] },
              t(e, [2, 2], { 5: 3 }),
              { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: 9, 20: r, 22: i, 24: a, 26: n, 27: s, 28: o },
              t(e, [2, 7], { 1: [2, 1] }),
              t(e, [2, 3]),
              { 9: 16, 11: 9, 20: r, 22: i, 24: a, 26: n, 27: s, 28: o },
              t(e, [2, 5]),
              t(e, [2, 6]),
              t(e, [2, 11], { 12: 17, 39: 20, 15: [1, 18], 18: [1, 19], 41: c, 42: l, 43: h, 44: d, 45: y }),
              { 21: [1, 26] },
              { 23: [1, 27] },
              { 25: [1, 28] },
              t(e, [2, 18]),
              ...
              t(e, [2, 4]),
              { 11: 29, 27: s, 28: o },
              { 16: 30, 17: [1, 31], 29: 32, 30: 33, 34: p },
              { 11: 35, 27: s, 28: o },
              ...
              { 17: [1, 40] },
              t(e, [2, 10]),
              { 16: 41, 17: [2, 21], 29: 32, 30: 33, 34: p },
              { 31: 42, 34: [1, 43] },
              { 34: [2, 27] },
              { 19: [1, 44] },
              { 39: 45, 41: c, 42: l, 43: h, 44: d, 45: y },
              t(f, [2, 39]),
              t(f, [2, 40]),
              ...
              t(E, [2, 32]),
              t(O, [2, 31]),
              { 16: 58, 17: [1, 59], 29: 32, 30: 33, 34: p },
              t(E, [2, 26]),
              { 35: 60, 37: m },
              { 17: [1, 61] },
              t(e, [2, 13]),
              ...
              for (var _, f, E, m, g, O, b, k, R, N = {}; ; ) {
                if (
                  ...
                  this.defaultActions[f]
                    ...
                    : (null == _ &&
                        ((R = void 0),
                        "number" != typeof (R = r.pop() || h.lex() || 1) && (R instanceof Array && (R = (r = R).pop()), (R = this.symbols_[R] || R)),
                        (_ = R)),
                      (E = n[f] && n[f][_])),
                  void 0 === E || !E.length || !E[0])
                ) {
                  var T;
                  for (g in ((k = []), n[f])) this.terminals_[g] && g > 2 && k.push("'" + this.terminals_[g] + "'");
                  (T = h.showPosition
                    ? "Parse error on line " +
                      (o + 1) +
                      ":\n" +
                    ...
                    this.parseError(T, { text: h.match, token: this.terminals_[_] || _, line: h.yylineno, loc: u, expected: k });
                }
                if (E[0] instanceof Array && E.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + f + ", token: " + _);
                switch (E[0]) {
                  case 1:
                    e.push(_),
                      i.push(h.yytext),
                  ...
                  case 2:
                    if (
                      ...
                      void 0 !== (m = this.performAction.apply(N, [s, c, o, d.yy, E[1], i, a].concat(l))))
                    )
                      return m;
                    O && ((e = e.slice(0, -1 * O * 2)), (i = i.slice(0, -1 * O)), (a = a.slice(0, -1 * O))),
                      e.push(this.productions_[E[1]][0]),
                      i.push(N.$),
                      a.push(N._$),
        ...
        return (b.lexer = k), (R.prototype = b), (b.Parser = R), new R();
      })();
      u.parser = u;
      const p = u;
      let _ = {},
        f = [];
      const E = function (t, e = void 0) {
          return (
            void 0 === _[t]
              ? ((_[t] = { attributes: [], alias: e }), i.l.info("Added new entity :", t))
              : _[t] && !_[t].alias && e && ((_[t].alias = e), i.l.info(`Add alias '${e}' to entity '${t}'`)),
            _[t]
          );
        },
        m = {
          ...
          draw: function (t, e, r, o) {
            ...
            (function (t, e) {
              ...
              (d = new a.k({ multigraph: !0, directed: !0, compound: !1 })
                .setGraph({ rankdir: k.layoutDirection, marginx: 20, marginy: 20, nodesep: 100, edgesep: 100, ranksep: 100 })
                  ...
                  Object.keys(e).forEach(function (n) {
                    ...
                    const c = "text-" + s,
                      ...
                      { width: h, height: d } = ((t, e, r) => {
                        ...
                        r.forEach((t) => {
                          ...
                          r.forEach((r) => {
                            ...
                            const b = m.node().getBBox(),
                              k = g.node().getBBox();
                            if (((d = Math.max(d, b.width)), (y = Math.max(y, k.width)), (o = Math.max(b.height, k.height)), l)) {
                              ...
                              (u = Math.max(u, c.width)), (o = Math.max(o, c.height));
                            }
                            if (h) {
                              const e = t
                                .append("text")
                        ...
                        const m = d + y + u + p,
                          g = {
                            width: Math.max(k.minEntityWidth, Math.max(o.width + 2 * k.entityPadding, m + n * E)),
                            height: r.length > 0 ? _ : Math.max(k.minEntityHeight, o.height + 2 * k.entityPadding),
                          };
                        if (r.length > 0) {
                          const r = Math.max(0, (g.width - m - n * E) / (E / 2));
                          e.attr("transform", "translate(" + g.width / 2 + "," + (a + o.height / 2) + ")");
                          let i = o.height + 2 * a,
                            s = "attributeBoxOdd";
                          c.forEach((e) => {
                            ...
                            const f = t
                              ...
                              .attr("width", y + 2 * n + r)
                              .attr("height", e.height + 2 * a);
                            let E = parseFloat(f.attr("x")) + parseFloat(f.attr("width"));
                            if (l) {
                              e.kn.attr("transform", "translate(" + (E + n) + "," + o + ")");
                              const c = t
                            ...
                            h &&
                              (e.cn.attr("transform", "translate(" + (E + n) + "," + o + ")"),
                              t
                          ...
                          (g.height = Math.max(k.minEntityHeight, _)), e.attr("transform", "translate(" + g.width / 2 + "," + g.height / 2 + ")");
                        return g;
                      })(o, l, e[n].attributes),
                      u = o
                        .insert("rect", "#" + c)
                        ...
                        .node()
                        .getBBox();
                    r.setNode(s, { width: u.width, height: u.height, shape: "rect", id: s });
                  }),
                  a
                );
              ...
              p.forEach(function (t) {
                !(function (t, e, r, a, s) {
                  ...
                  const d = l.node().getTotalLength(),
                    y = l.node().getPointAtLength(0.5 * d),
                    u = "rel" + T,
                    p = t
                      .append("text")
                  ...
                  t.insert("rect", "#" + u)
                    ...
                    .attr("x", y.x - p.width / 2)
                    .attr("y", y.y - p.height / 2)
                    .attr("width", p.width)
            ...
            const m = h.node().getBBox(),
              M = m.width + 2 * E,
              w = m.height + 2 * E;
            (0, i.i)(h, w, M, k.useMaxWidth), h.attr("viewBox", `${m.x - E} ${m.y - E} ${M} ${w}`);
          },
        },
        styles: (t) =>
