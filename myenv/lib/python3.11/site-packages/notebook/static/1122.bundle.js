...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [1122],
  {
    21122: (e, t, n) => {
      ...
      var o = [];
      function a(e) {
        if (e) for (var t in e) e.hasOwnProperty(t) && o.push(t);
      }
      a(i.keywords), a(i.builtin), a(i.timerOps), a(i.portOps);
      var s,
        l = i.keywords || {},
        c = i.builtin || {},
        u = i.timerOps || {},
        ...
        v = i.otherConsts || {},
        g = i.types || {},
        x = i.visibilityModifiers || {},
        k = i.templateMatch || {},
        O = i.multiLineStrings,
        E = !1 !== i.indentStatements,
        w = /[+\-*&@=<>!\/]/;
      function I(e, t) {
        var n,
          r = e.next();
            ...
            (t.tokenize =
              ...
              function (e, t) {
                for (var r, i = !1, o = !1; null != (r = e.next()); ) {
                  if (r == n && !i) {
                    var a = e.peek();
                    a && (("b" != (a = a.toLowerCase()) && "h" != a && "o" != a) || e.next()), (o = !0);
                    break;
                  }
                  i = !i && "\\" == r;
                }
                return (o || (!i && !O)) && (t.tokenize = null), "string";
              })),
            t.tokenize(e, t)
          );
        if (/[\[\]{}\(\),;\\:\?\.]/.test(r)) return (s = r), "punctuation";
        if ("#" == r) return e.skipToEnd(), "atom";
        if ("%" == r) return e.eatWhile(/\b/), "atom";
        if (/\d/.test(r)) return e.eatWhile(/[\w\.]/), "number";
        if ("/" == r) {
          if (e.eat("*")) return (t.tokenize = C), C(e, t);
          if (e.eat("/")) return e.skipToEnd(), "comment";
        }
        if (w.test(r)) return "@" == r && (e.match("try") || e.match("catch") || e.match("lazy")) ? "keyword" : (e.eatWhile(w), "operator");
        e.eatWhile(/[\w\$_\xa1-\uffff]/);
        var i = e.current();
        return l.propertyIsEnumerable(i)
          ...
          : c.propertyIsEnumerable(i)
            ...
            : u.propertyIsEnumerable(i) ||
              ...
              ? "def"
              : h.propertyIsEnumerable(i) || y.propertyIsEnumerable(i) || v.propertyIsEnumerable(i)
                ? "string"
                : g.propertyIsEnumerable(i)
                  ? "typeName.standard"
                  : x.propertyIsEnumerable(i)
                    ? "modifier"
      ...
      function z(e, t, n) {
        var r = e.indented;
        return e.context && "statement" == e.context.type && (r = e.context.indented), (e.context = new L(r, t, n, null, e.context));
      }
      function T(e) {
      ...
      const U = {
        name: "ttcn",
        startState: function () {
          return { tokenize: null, context: new L(0, 0, "top", !1), indented: 0, startOfLine: !0 };
        },
        token: function (e, t) {
          var n = t.context;
          ...
          if ((null == n.align && (n.align = !0), (";" != s && ":" != s && "," != s) || "statement" != n.type))
            if ("{" == s) z(t, e.column(), "}");
            else if ("[" == s) z(t, e.column(), "]");
            else if ("(" == s) z(t, e.column(), ")");
            else if ("}" == s) {
              for (; "statement" == n.type; ) n = T(t);
              for ("}" == n.type && (n = T(t)); "statement" == n.type; ) n = T(t);
            } else
              s == n.type
                ? T(t)
                : E &&
                  ((("}" == n.type || "top" == n.type) && ";" != s) || ("statement" == n.type && "newstatement" == s)) &&
                  z(t, e.column(), "statement");
          else T(t);
