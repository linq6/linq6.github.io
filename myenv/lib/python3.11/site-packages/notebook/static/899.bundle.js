...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [899],
  {
    20899: (e, t, n) => {
      ...
      function v(e, t) {
        return !0 === t && e.backUp(1), e.match(x);
      }
      function y(e) {
        return e.match(g);
      }
      ...
      const E = {
        ...
        token: function (e, t) {
          ...
          switch (t.mode) {
            case "string":
              w(e, { token: '"', state: t }), (n = a);
              break;
            case "symbol":
              w(e, { token: "|", state: t }), (n = i);
              break;
            case "comment":
              for (var o, m = !1; null != (o = e.next()); ) {
                if ("#" == o && m) {
                  t.mode = !1;
                  break;
                }
            ...
            default:
              var f = e.next();
              if ('"' == f) (t.mode = "string"), (n = a);
              else if ("'" == f)
                "(" == e.peek() || "[" == e.peek()
                  ? ("number" != typeof t.sExprQuote && (t.sExprQuote = 0), (n = s))
                  : (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/), (n = s));
              else if ("|" == f) (t.mode = "symbol"), (n = i);
              else if ("#" == f)
                if (e.eat("|")) (t.mode = "comment"), (n = r);
                else if (e.eat(/[tf]/i)) n = s;
                else if (e.eat(";")) (t.mode = "s-expr-comment"), (n = r);
                else {
                  var h = null,
                    g = !1,
                    x = !0;
                  e.eat(/[ei]/i) ? (g = !0) : e.backUp(1),
                    e.match(/^#b/i)
                      ? (h = b)
                      : e.match(/^#o/i)
                        ? (h = k)
                        : e.match(/^#x/i)
                          ...
                          : e.match(/^#d/i)
                            ...
                            : e.match(/^[-+0-9.]/, !1)
                              ? ((x = !1), (h = v))
                              : g || e.eat("#"),
                    null != h && (x && !g && e.match(/^#[ei]/i), h(e) && (n = c));
                }
              else if (/^[-+0-9.]/.test(f) && v(e, !0)) n = c;
              else if (";" == f) e.skipToEnd(), (n = r);
              else if ("(" == f || "[" == f) {
                for (var E, S = "", q = e.column(); null != (E = e.eat(/[^\s\(\[\;\)\]]/)); ) S += E;
                S.length > 0 && u.propertyIsEnumerable(S)
                  ? p(t, q + 2, f)
                  : (e.eatSpace(), e.eol() || ";" == e.peek() ? p(t, q + 1, f) : p(t, q + e.current().length, f)),
                ...
                ")" == f || "]" == f
                  ? ((n = l),
                    null != t.indentStack &&
                      t.indentStack.type == (")" == f ? "(" : "[") &&
                      ((function (e) {
                        e.indentStack = e.indentStack.prev;
                      })(t),
                      "number" == typeof t.sExprComment && 0 == --t.sExprComment && ((n = r), (t.sExprComment = !1)),
                      "number" == typeof t.sExprQuote && 0 == --t.sExprQuote && ((n = s), (t.sExprQuote = !1))))
                  : (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/), (n = d && d.propertyIsEnumerable(e.current()) ? "builtin" : "variable"));
          }
          return "number" == typeof t.sExprComment ? r : "number" == typeof t.sExprQuote ? s : n;
        },
        indent: function (e) {
