    ...
    22955: (t, e, i) => {
      i.r(e),
        i.d(e, {
          ...
          WidgetType: () => ut,
          __test: () => dn,
          closeHoverTooltips: () => Ao,
          crosshairCursor: () => no,
          drawSelection: () => Cs,
          dropCursor: () => Hs,
          getDrawSelectionConfig: () => ks,
          getPanel: () => Eo,
          getTooltip: () => Mo,
          gutter: () => Wo,
          gutterLineClass: () => Vo,
          gutters: () => Ko,
          hasHoverTooltips: () => Co,
          highlightActiveLine: () => Us,
          highlightActiveLineGutter: () => on,
          highlightSpecialChars: () => qs,
          highlightTrailingWhitespace: () => cn,
          highlightWhitespace: () => hn,
          hoverTooltip: () => xo,
          keymap: () => as,
          layer: () => Ss,
          lineNumberMarkers: () => Go,
          lineNumbers: () => Zo,
          logException: () => ee,
          panels: () => Oo,
          placeholder: () => Zs,
          rectangularSelection: () => io,
          repositionTooltips: () => Do,
          runScopeHandlers: () => us,
          scrollPastEnd: () => Gs,
          showPanel: () => Po,
          showTooltip: () => mo,
      ...
      for (
        var s = i(89843),
          ...
          h = "undefined" != typeof navigator && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent),
          a = 0;
        a < 10;
        a++
      )
        n[48 + a] = n[96 + a] = String(a);
      for (a = 1; a <= 24; a++) n[a + 111] = "F" + a;
      for (a = 65; a <= 90; a++) (n[a] = String.fromCharCode(a + 32)), (r[a] = String.fromCharCode(a));
      ...
      function p(t) {
        return 3 == t.nodeType ? D(t, 0, t.nodeValue.length).getClientRects() : 1 == t.nodeType ? t.getClientRects() : [];
      }
      function g(t, e, i, s) {
        return !!i && (v(t, e, i, s, -1) || v(t, e, i, s, 1));
      }
      function m(t) {
      ...
      function x(t, e) {
        ...
        return (
          ((i > 0.995 && i < 1.005) || !isFinite(i) || Math.abs(e.width - t.offsetWidth) < 1) && (i = 1),
          ((s > 0.995 && s < 1.005) || !isFinite(s) || Math.abs(e.height - t.offsetHeight) < 1) && (s = 1),
          { scaleX: i, scaleY: s }
        );
      }
      class M {
        ...
        setRange(t) {
          ...
          this.set(e, Math.min(t.anchorOffset, e ? b(e) : 0), i, Math.min(t.focusOffset, i ? b(i) : 0));
        }
        set(t, e, i, s) {
      ...
      function D(t, e, i = e) {
        let s = C || (C = document.createRange());
      ...
      function R(t, e) {
        for (let i = t, s = e; ; ) {
          ...
          if (1 == i.nodeType && s > 0) {
            ...
            (i = i.childNodes[s - 1]), (s = b(i));
          } else {
            if (!i.parentNode || w(i)) return null;
            (s = m(i)), (i = i.parentNode);
          }
        }
      }
      function B(t, e) {
        for (let i = t, s = e; ; ) {
          if (3 == i.nodeType && s < i.nodeValue.length) return { node: i, offset: s };
          if (1 == i.nodeType && s < i.childNodes.length) {
            if ("false" == i.contentEditable) return null;
            (i = i.childNodes[s]), (s = 0);
          } else {
            if (!i.parentNode || w(i)) return null;
            (s = m(i) + 1), (i = i.parentNode);
          }
        }
      }
      class L {
        ...
        static before(t, e) {
          return new L(t.parentNode, m(t), e);
        }
        static after(t, e) {
          return new L(t.parentNode, m(t) + 1, e);
        }
      }
      const P = [];
      class H {
        ...
        sync(t, e) {
          if (2 & this.flags) {
            ...
            for (i = o ? o.nextSibling : s.firstChild, i && e && e.node == s && (e.written = !0); i; ) i = V(i);
        ...
        childCursor(t = this.length) {
          return new N(this.children, t, this.children.length);
        }
        childPos(t, e = 1) {
        ...
        toString() {
          ...
          return (
            t +
            (this.children.length ? "(" + this.children.join() + ")" : this.length ? "[" + ("Text" == t ? this.text : this.length) + "]" : "") +
            (this.breakAfter ? "#" : "")
          );
        }
        static get(t) {
            ...
            t && (o < t.length || (t.breakAfter && (null == d ? void 0 : d.breakAfter)))
              ? (e == s && ((t = t.split(o)), (o = 0)),
                !u && d && t.merge(0, o, d, !0, 0, h)
                  ? (n[n.length - 1] = t)
                  : ((o || (t.children.length && !t.children[0].length)) && t.merge(0, o, null, !1, 0, h), n.push(t)))
          ...
          for (
            ...
            i > 0 &&
              (!r && n.length && c.merge(i, c.length, n[0], !1, l, 0)
                ...
                : (i < c.length || (c.children.length && 0 == c.children[c.children.length - 1].length)) && c.merge(i, c.length, null, !1, l, 0),
              e++));
            e < s && n.length;
      ...
      function W(t, e, i, s, o, n) {
        let r = t.childCursor(),
          { i: l, off: h } = r.findPos(i, 1),
          { i: a, off: c } = r.findPos(e, -1),
          d = e - i;
        for (let t of s) d += t.length;
        (t.length += d), F(t, a, c, l, h, s, 0, o, n);
      }
      let z = "undefined" != typeof navigator ? navigator : { userAgent: "", vendor: "", platform: "" },
        K = "undefined" != typeof document ? document : { documentElement: { style: {} } };
      const I = /Edge\/(\d+)/.exec(z.userAgent),
        q = /MSIE \d/.test(z.userAgent),
        Y = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(z.userAgent),
        _ = !!(q || Y || I),
        X = !_ && /gecko\/(\d+)/i.test(z.userAgent),
        j = !_ && /Chrome\/(\d+)/.exec(z.userAgent),
        G = "webkitFontSmoothing" in K.documentElement.style,
        U = !_ && /Apple Computer/.test(z.vendor),
        $ = U && (/Mobile\/\w+/.test(z.userAgent) || z.maxTouchPoints > 2);
      var Q = {
        mac: $ || /Mac/.test(z.platform),
        windows: /Win/.test(z.platform),
        linux: /Linux|X11/.test(z.platform),
        ie: _,
        ie_version: q ? K.documentMode || 6 : Y ? +Y[1] : I ? +I[1] : 0,
        gecko: X,
        gecko_version: X ? +(/Firefox\/(\d+)/.exec(z.userAgent) || [0, 0])[1] : 0,
        chrome: !!j,
        chrome_version: j ? +j[1] : 0,
        ios: $,
        android: /Android\b/.test(z.userAgent),
        webkit: G,
        safari: U,
        webkit_version: G ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0,
        tabSize: null != K.documentElement.style.tabSize ? "tab-size" : "-moz-tab-size",
      };
      class J extends H {
        constructor(t) {
          super(), (this.text = t);
        ...
        sync(t, e) {
          this.dom || this.createDOM(),
            this.dom.nodeValue != this.text && (e && e.node == this.dom && (e.written = !0), (this.dom.nodeValue = this.text));
        }
        reuseDOM(t) {
        ...
        merge(t, e, i) {
          return !(
            8 & this.flags ||
            (i && (!(i instanceof J) || this.length - (e - t) + i.length > 256 || 8 & i.flags)) ||
        ...
        coordsAt(t, e) {
          return (function (t, e, i) {
            ...
            let o = e,
              ...
              r = 0;
            (0 == e && i < 0) || (e == s && i >= 0)
              ? Q.chrome || Q.gecko || (e ? (o--, (r = 1)) : n < s && (n++, (r = -1)))
              : i < 0
                ? o--
                : n < s && n++;
            let l = D(t, o, n).getClientRects();
            if (!l.length) return null;
            let h = l[(r ? r < 0 : i >= 0) ? 0 : l.length - 1];
            return Q.safari && !r && 0 == h.width && (h = Array.prototype.find.call(l, (t) => t.width) || h), r ? y(h, r < 0) : h || null;
          })(this.dom, t, e);
        }
      }
      class Z extends H {
        ...
        setAttrs(t) {
          if ((O(t), this.mark.class && (t.className = this.mark.class), this.mark.attrs))
        ...
        merge(t, e, i, s, o, n) {
          return !(
            (i && (!(i instanceof Z && i.mark.eq(this.mark)) || (t && o <= 0) || (e < this.length && n <= 0))) ||
            (W(this, t, e, i ? i.children.slice() : [], o - 1, n - 1), this.markDirty(), 0)
          );
        }
        split(t) {
          let e = [],
          ...
          let n = this.length - t;
          return (this.length = t), s > -1 && ((this.children.length = s), this.markDirty()), new Z(this.mark, e, n);
        }
        domAtPos(t) {
          return it(this, t);
        }
      ...
      class tt extends H {
        ...
        split(t) {
          let e = tt.create(this.widget, this.length - t, this.side);
        ...
        merge(t, e, i, s, o, n) {
          return !(
            (i && (!(i instanceof tt && this.widget.compare(i.widget)) || (t > 0 && o <= 0) || (e < this.length && n <= 0))) ||
        ...
        get overrideDOMText() {
          if (0 == this.length) return s.Text.empty;
          let t = this;
        ...
        domAtPos(t) {
          return (this.length ? 0 == t : this.side > 0) ? L.before(this.dom) : L.after(this.dom, t == this.length);
        }
        domBoundsAround() {
          return null;
        }
      ...
      class et extends H {
        ...
        domAtPos(t) {
          return this.side > 0 ? L.before(this.dom) : L.after(this.dom);
        }
        localPosFromDOM() {
          return 0;
        }
      ...
      function st(t, e, i) {
        let s,
          { children: o } = t;
        i > 0 && e instanceof Z && o.length && (s = o[o.length - 1]) instanceof Z && s.mark.eq(e.mark)
          ? st(s, e.children[0], i - 1)
          : (o.push(e), e.setParent(t)),
          (t.length += e.length);
      }
      function ot(t, e, i) {
        let s = null,
        ...
        !(function t(e, l) {
          for (let h = 0, a = 0; h < e.children.length && a <= l; h++) {
            ...
            d >= l &&
              (c.children.length
                ? t(c, l - a)
                : (!n || (n.isHidden && i > 0)) && (d > l || (a == d && c.getSide() > 0))
                  ? ((n = c), (r = l - a))
                  : (a < l || (a == d && c.getSide() < 0 && !c.isHidden)) && ((s = c), (o = l - a))),
              (a = d);
          }
        })(t, e);
        let l = (i < 0 ? s : n) || s || n;
      ...
      J.prototype.children = tt.prototype.children = et.prototype.children = P;
      ...
      class ct extends H {
        ...
        merge(t, e, i, s, o, n) {
          if (i) {
            if (!(i instanceof ct)) return !1;
            this.dom || i.transferDOM(this);
          }
          return s && this.setDeco(i ? i.attrs : null), W(this, t, e, i ? i.children.slice() : [], o, n), !0;
        }
        split(t) {
          let e = new ct();
        ...
        setDeco(t) {
          lt(this.attrs, t) || (this.dom && ((this.prevAttrs = this.attrs), this.markDirty()), (this.attrs = t));
        }
        append(t, e) {
          st(this, t, e);
        }
        addLineDeco(t) {
          let e = t.spec.attributes,
            i = t.spec.class;
          e && (this.attrs = nt(e, this.attrs || {})), i && (this.attrs = nt({ class: i }, this.attrs || {}));
        }
        domAtPos(t) {
          return it(this, t);
        }
        ...
        sync(t, e) {
          var i;
          this.dom
            ? 4 & this.flags && (O(this.dom), (this.dom.className = "cm-line"), (this.prevAttrs = this.attrs ? null : void 0))
            : (this.setDOM(document.createElement("div")), (this.dom.className = "cm-line"), (this.prevAttrs = this.attrs ? null : void 0)),
            void 0 !== this.prevAttrs && (ht(this.dom, this.prevAttrs, this.attrs), this.dom.classList.add("cm-line"), (this.prevAttrs = void 0)),
            super.sync(t, e);
          let s = this.dom.lastChild;
          for (; s && H.get(s) instanceof Z; ) s = s.lastChild;
          if (
            !(
              s &&
              this.length &&
              ("BR" == s.nodeName ||
                0 != (null === (i = H.get(s)) || void 0 === i ? void 0 : i.isEditable) ||
                (Q.ios && this.children.some((t) => t instanceof J)))
            )
          ) {
        ...
        measureTextSize() {
          ...
          let t,
            e = 0;
          for (let i of this.children) {
            if (!(i instanceof J) || /[^ -~]/.test(i.text)) return null;
            let s = p(i.dom);
      ...
      class dt extends H {
        ...
        merge(t, e, i, s, o, n) {
          return !(
            (i && (!(i instanceof dt && this.widget.compare(i.widget)) || (t > 0 && o <= 0) || (e < this.length && n <= 0))) ||
            ((this.length = t + (i ? i.length : 0) + (this.length - e)), 0)
          );
        }
        domAtPos(t) {
          return 0 == t ? L.before(this.dom) : L.after(this.dom, t == this.length);
        }
        split(t) {
          let e = this.length - t;
          this.length = t;
          let i = new dt(this.widget, e, this.deco);
      ...
      class pt extends s.RangeValue {
        ...
        static replace(t) {
          ...
          if (t.isBlockGap) (e = -5e8), (i = 4e8);
            ...
            let { start: o, end: n } = vt(t, s);
            (e = (o ? (s ? -3e8 : -1) : 5e8) - 1), (i = 1 + (n ? (s ? 2e8 : 1) : -6e8));
          }
          return new wt(t, e, i, s, t.widget || null, !0);
        }
        static line(t) {
          return new mt(t);
        }
      ...
      pt.none = s.RangeSet.empty;
      class gt extends pt {
        constructor(t) {
          let { start: e, end: i } = vt(t);
        ...
        eq(t) {
          ...
          return (
            ...
            (t instanceof gt &&
              ...
              (this.class || (null === (e = this.attrs) || void 0 === e ? void 0 : e.class)) ==
                (t.class || (null === (i = t.attrs) || void 0 === i ? void 0 : i.class)) &&
              lt(this.attrs, t.attrs, "class"))
          );
        }
        range(t, e = t) {
      ...
      class mt extends pt {
        ...
        eq(t) {
          return t instanceof mt && this.spec.class == t.spec.class && lt(this.spec.attributes, t.spec.attributes);
        }
        range(t, e = t) {
      ...
      (mt.prototype.mapMode = s.MapMode.TrackBefore), (mt.prototype.point = !0);
      class wt extends pt {
        constructor(t, e, i, o, n, r) {
          super(e, i, n, t),
            (this.block = o),
            (this.isReplace = r),
            (this.mapMode = o ? (e <= 0 ? s.MapMode.TrackBefore : s.MapMode.TrackAfter) : s.MapMode.TrackDel);
        }
        get type() {
          return this.startSide != this.endSide ? ft.WidgetRange : this.startSide <= 0 ? ft.WidgetBefore : ft.WidgetAfter;
        }
        get heightRelevant() {
        ...
        eq(t) {
          return (
            t instanceof wt &&
            ((e = this.widget) == (i = t.widget) || !!(e && i && e.compare(i))) &&
            this.block == t.block &&
      ...
      function vt(t, e = !1) {
        ...
        return null == i && (i = t.inclusive), null == s && (s = t.inclusive), { start: null != i ? i : e, end: null != s ? s : e };
      }
      ...
      class yt {
        ...
        posCovered() {
          ...
          return !(t.breakAfter || (t instanceof dt && t.deco.endSide < 0));
        }
        getLine() {
          return this.curLine || (this.content.push((this.curLine = new ct())), (this.atCursorPos = !0)), this.curLine;
        }
        flushBuffer(t = this.bufferMarks) {
          this.pendingBuffer && (this.curLine.append(St(new et(-1), t), t.length), (this.pendingBuffer = 0));
        }
        addBlockWidget(t) {
        ...
        finish(t) {
          this.pendingBuffer && t <= this.bufferMarks.length ? this.flushBuffer() : (this.pendingBuffer = 0),
            this.posCovered() || (t && this.content.length && this.content[this.content.length - 1] instanceof dt) || this.getLine();
        }
        buildText(t, e, i) {
          for (; t > 0; ) {
            ...
            this.flushBuffer(e.slice(e.length - i)),
              this.getLine().append(St(new J(this.text.slice(this.textOff, this.textOff + s)), e), i),
              (this.atCursorPos = !0),
              (this.textOff += s),
              (t -= s),
              (i = 0);
        ...
        point(t, e, i, s, o, n) {
          if (this.disallowBlockEffectsFor[n] && i instanceof wt) {
            if (i.block) throw new RangeError("Block decorations may not be specified via plugins");
            if (e > this.doc.lineAt(this.pos).to) throw new RangeError("Decorations that replace line breaks may not be specified via plugins");
          }
          let r = e - t;
          if (i instanceof wt)
            if (i.block) i.startSide > 0 && !this.posCovered() && this.getLine(), this.addBlockWidget(new dt(i.widget || xt.block, r, i));
            else {
              let n = tt.create(i.widget || xt.inline, r, r ? 0 : i.startSide),
              ...
              2 != this.pendingBuffer || l || n.isEditable || (this.pendingBuffer = 0),
                this.flushBuffer(s),
                l && (a.append(St(new et(1), s), o), (o = s.length + Math.max(0, o - s.length))),
                a.append(St(n, s), o),
                (this.atCursorPos = h),
          ...
          r &&
            (this.textOff + r <= this.text.length
              ? (this.textOff += r)
              : ((this.skip += r - (this.text.length - this.textOff)), (this.text = ""), (this.textOff = 0)),
            (this.pos = e)),
            this.openStart < 0 && (this.openStart = o);
        }
        static build(t, e, i, o, n) {
          let r = new yt(t, e, i, n);
          return (r.openEnd = s.RangeSet.spans(o, e, i, r)), r.openStart < 0 && (r.openStart = r.openEnd), r.finish(r.openEnd), r;
        }
      }
      function St(t, e) {
        for (let i of e) t = new Z(i, [t], t.length);
        return t;
      }
      class xt extends ut {
        constructor(t) {
      ...
      (xt.inline = new xt("span")), (xt.block = new xt("div"));
      var Mt = (function (t) {
      ...
      function Pt(t, e) {
        ...
        for (let i = 0; i < t.length; i++) {
          let s = t[i],
            o = e[i];
          if (s.from != o.from || s.to != o.to || s.direction != o.direction || !Pt(s.inner, o.inner)) return !1;
        }
        return !0;
      }
      const Ht = [];
      function Vt(t, e, i, s, o, n, r) {
        let l = s % 2 ? 2 : 1;
        if (s % 2 == o % 2)
          for (let h = e, a = 0; h < i; ) {
            let e = !0,
            ...
            t: for (;;)
              if (a < n.length && f == n[a].from) {
                ...
                a++,
                  d
                    ? d.push(p)
                    : (p.from > h && r.push(new Lt(h, p.from, u)),
                      Nt(t, (p.direction == Ct) != !(u % 2) ? s + 1 : s, o, p.inner, p.from, p.to, r),
                      (h = p.to)),
                  (f = p.to);
              } else {
                if (f == i || (e ? Ht[f] != l : Ht[f] == l)) break;
                f++;
              }
            d ? Vt(t, h, f, s + 1, o, d, r) : h < f && r.push(new Lt(h, f, u)), (h = f);
          }
        else
          for (let h = i, a = n.length; h > e; ) {
            ...
            t: for (;;)
              if (a && f == n[a - 1].to) {
                ...
                d
                  ? d.push(p)
                  : (p.to < h && r.push(new Lt(p.to, h, u)),
                    Nt(t, (p.direction == Ct) != !(u % 2) ? s + 1 : s, o, p.inner, p.from, p.to, r),
                    (h = p.from)),
                  (f = p.from);
              } else {
                if (f == e || (i ? Ht[f - 1] != l : Ht[f - 1] == l)) break;
                f--;
              }
            d ? Vt(t, f, h, s + 1, o, d, r) : f < h && r.push(new Lt(f, h, u)), (h = f);
          }
      }
      function Nt(t, e, i, s, o, n, r) {
        let l = e % 2 ? 2 : 1;
        !(function (t, e, i, s, o) {
          for (let n = 0; n <= s.length; n++) {
            ...
            for (let e = r, i = h, s = h; e < l; e++) {
              let o = Rt(t.charCodeAt(e));
              512 == o ? (o = i) : 8 == o && 4 == s && (o = 16), (Ht[e] = 4 == o ? 2 : o), 7 & o && (s = o), (i = o);
            }
            for (let t = r, e = h, s = h; t < l; t++) {
              let o = Ht[t];
              if (128 == o) t < l - 1 && e == Ht[t + 1] && 24 & e ? (o = Ht[t] = e) : (Ht[t] = 256);
              else if (64 == o) {
                let o = t + 1;
                for (; o < l && 64 == Ht[o]; ) o++;
                let n = (t && 8 == e) || (o < i && 8 == Ht[o]) ? (1 == s ? 1 : 8) : 256;
                for (let e = t; e < o; e++) Ht[e] = n;
                t = o - 1;
              } else 8 == o && 1 == s && (Ht[t] = 1);
              (e = o), 7 & o && (s = o);
            }
          ...
          (function (t, e, i, s, o) {
            ...
            for (let r = 0, l = 0, h = 0; r <= s.length; r++) {
              ...
              for (let e, i, s, r = a; r < c; r++)
                if ((i = Ot[(e = t.charCodeAt(r))]))
                  if (i < 0) {
                    for (let t = l - 3; t >= 0; t -= 3)
                      if (Et[t + 1] == -i) {
                        let e = Et[t + 2],
                          i = 2 & e ? o : 4 & e ? (1 & e ? n : o) : 0;
                        i && (Ht[r] = Ht[Et[t]] = i), (l = t);
                        break;
                      }
                  } else {
                    if (189 == Et.length) break;
                    (Et[l++] = r), (Et[l++] = e), (Et[l++] = h);
                  }
                else if (2 == (s = Ht[r]) || 1 == s) {
                  let t = s == o;
                  h = t ? 0 : 1;
            ...
            for (let o = 0, n = s; o <= i.length; o++) {
              ...
              for (let h = r; h < l; ) {
                ...
                if (256 == r) {
                  ...
                  let a = 1 == n,
                    c = a == (1 == (r < e ? Ht[r] : s)) ? (a ? 1 : 2) : s;
                  for (let e = r, s = o, n = s ? i[s - 1].to : t; e > h; ) e == n && ((e = i[--s].from), (n = s ? i[s - 1].to : t)), (Ht[--e] = c);
                  h = r;
                } else (n = r), h++;
              }
            }
      ...
      function Ft(t, e, i) {
        if (!t) return [new Lt(0, 0, e == kt ? 1 : 0)];
        if (e == Ct && !i.length && !Bt.test(t)) return Wt(t.length);
        if (i.length) for (; t.length > Ht.length; ) Ht[Ht.length] = 256;
        let s = [],
          o = e == Ct ? 0 : 1;
        return Nt(t, o, o, i, 0, t.length, s), s;
      }
      function Wt(t) {
        return [new Lt(0, t, 0)];
      }
      ...
      function Kt(t, e, i, o, n) {
        var r;
        let l = o.head - t.from,
          h = Lt.find(e, l, null !== (r = o.bidiLevel) && void 0 !== r ? r : -1, o.assoc),
          a = e[h],
          c = a.side(n, i);
        if (l == c) {
          let t = (h += n ? 1 : -1);
        ...
        let d = (0, s.findClusterBreak)(t.text, l, a.forward(n, i));
        (d < a.from || d > a.to) && (d = c), (zt = t.text.slice(Math.min(l, d), Math.max(l, d)));
        let u = h == (n ? e.length - 1 : 0) ? null : e[h + (n ? 1 : -1)];
        return u && d == c && u.level + (n ? 0 : 1) < a.level
          ? s.EditorSelection.cursor(u.side(!n, i) + t.from, u.forward(n, i) ? 1 : -1, u.level)
          : s.EditorSelection.cursor(d + t.from, a.forward(n, i) ? -1 : 1, a.level);
      }
      function It(t, e, i) {
        for (let s = e; s < i; s++) {
          let e = Rt(t.charCodeAt(s));
          if (1 == e) return Ct;
          if (2 == e || 4 == e) return kt;
        }
        return Ct;
      }
      const qt = s.Facet.define(),
        Yt = s.Facet.define(),
        _t = s.Facet.define(),
        Xt = s.Facet.define(),
        jt = s.Facet.define(),
        Gt = s.Facet.define(),
        Ut = s.Facet.define(),
        $t = s.Facet.define({ combine: (t) => t.some((t) => t) }),
        Qt = s.Facet.define({ combine: (t) => t.some((t) => t) }),
        Jt = s.Facet.define();
      class Zt {
        ...
        map(t) {
          return t.empty ? this : new Zt(this.range.map(t), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
        }
        clip(t) {
          return this.range.to <= t.doc.length
            ? this
            : new Zt(s.EditorSelection.cursor(t.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
        }
      }
      const te = s.StateEffect.define({ map: (t, e) => t.map(e) });
      function ee(t, e, i) {
        let s = t.facet(Xt);
        s.length ? s[0](e) : window.onerror ? window.onerror(String(e), i, void 0, void 0, e) : i ? console.error(i + ":", e) : console.error(e);
      }
      const ie = s.Facet.define({ combine: (t) => !t.length || t[0] });
      let se = 0;
        ...
        update(t) {
          if (this.value) {
            if (this.mustUpdate) {
              ...
              if (((this.mustUpdate = null), this.value.update))
                try {
                  ...
                  if ((ee(t.state, e, "CodeMirror plugin crashed"), this.value.destroy))
                    try {
                      this.value.destroy();
                    } catch (t) {}
                  this.deactivate();
            ...
            try {
              ...
              ee(t.state, e, "CodeMirror plugin crashed"), this.deactivate();
            }
          return this;
        }
        destroy(t) {
          ...
          if (null === (e = this.value) || void 0 === e ? void 0 : e.destroy)
            try {
              ...
              ee(t.state, e, "CodeMirror plugin crashed");
            }
        }
        deactivate() {
          ...
          s.RangeSet.spans(o, e.from, e.to, {
            ...
            span(t, i, s, o) {
              ...
              for (let t = s.length - 1; t >= 0; t--, o--) {
                ...
                if ((null == n && (n = It(e.text, r, l)), o > 0 && h.length && (i = h[h.length - 1]).to == r && i.direction == n))
                  (i.to = l), (h = i.inner);
                else {
      ...
      class we {
        ...
        join(t) {
          return new we(Math.min(this.fromA, t.fromA), Math.max(this.toA, t.toA), Math.min(this.fromB, t.fromB), Math.max(this.toB, t.toB));
        }
        addToSet(t) {
          let e = t.length,
            i = this;
          ...
          for (let s = 0, o = 0, n = 0, r = 0; ; s++) {
            ...
            for (; o < e.length && e[o] < a; ) {
              let t = e[o],
                ...
                n = Math.max(r, t),
                l = Math.min(a, s);
              if ((n <= l && new we(n + h, l + h, n, l).addToSet(i), s > a)) break;
              o += 2;
            }
            if (!l) return i;
            new we(l.fromA, l.toA, l.fromB, l.toB).addToSet(i), (n = l.toA), (r = l.toB);
          }
        }
      }
      class ve {
        constructor(t, e, i) {
          ...
          let o = [];
          this.changes.iterChangedRanges((t, e, i, s) => o.push(new we(t, e, i, s))), (this.changedRanges = o);
        }
        static create(t, e, i) {
          return new ve(t, e, i);
        }
      ...
      class be extends H {
        ...
        constructor(t) {
          super(),
            ...
            (this.compositionBarrier = pt.none),
            ...
            this.updateDeco(),
            this.updateInner([new we(0, 0, 0, t.state.doc.length)], 0, null);
        }
        update(t) {
          var e;
            ...
            o > -1
              ? (function (t, e, i) {
                  ...
                  let h = e.invertedDesc,
                    a = new we(h.mapPos(n), h.mapPos(r), n, r),
                    c = [];
                  for (let e = o.parentNode; ; e = e.parentNode) {
                    let i = H.get(e);
                    if (i instanceof Z) c.push({ node: e, deco: i.mark });
                    else {
                      if (i instanceof ct || ("DIV" == e.nodeName && e.parentNode == t.contentDOM)) return { range: a, text: o, marks: c, line: e };
                      if (e == t.contentDOM) return null;
                      c.push({ node: e, deco: new gt({ inclusive: !0, attributes: at(e), tagName: e.tagName.toLowerCase() }) });
                    }
                  }
                })(this.view, t.changes, o)
              : null;
          if (((this.domChanged = null), this.hasComposition)) {
            this.markedForComposition.clear();
            let { from: e, to: s } = this.hasComposition;
            i = new we(e, s, t.changes.mapPos(e, -1), t.changes.mapPos(s, 1)).addToSet(i.slice());
          }
          (this.hasComposition = n ? { from: n.range.fromB, to: n.range.toB } : null),
            (Q.ie || Q.chrome) && !n && t && t.state.doc.lines != t.startState.doc.lines && (this.forceSelection = !0);
          let r = (function (t, e, i) {
            let o = new Me();
            return s.RangeSet.compare(t, e, i, o), o.changes;
          })(this.decorations, this.updateDeco(), t.changes);
          return (
            (i = we.extendWithRanges(i, r)),
            !!(7 & this.flags || 0 != i.length) &&
              (this.updateInner(i, t.startState.doc.length, n), t.transactions.length && (this.lastUpdate = Date.now()), !0)
          );
        }
        updateInner(t, e, i) {
          ...
          s.ignore(() => {
            ...
            let t = Q.chrome || Q.ios ? { node: s.selectionRange.focusNode, written: !1 } : void 0;
            this.sync(this.view, t),
              (this.flags &= -8),
              t && (t.written || s.selectionRange.focusNode != t.node) && (this.forceSelection = !0),
              (this.dom.style.height = "");
          }),
            this.markedForComposition.forEach((t) => (t.flags &= -9));
          let o = [];
          if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
            for (let t of this.children) t instanceof dt && t.widget instanceof Se && o.push(t.dom);
          s.updateGaps(o);
        }
        updateChildren(t, e, i) {
          ...
          for (let t = s.length - 1; ; t--) {
            ...
            let n,
              ...
              l,
              h,
              { fromA: a, toA: c, fromB: d, toB: u } = e;
            if (i && i.range.fromB < u && i.range.toB > d) {
              let t = yt.build(this.view.state.doc, d, i.range.fromB, this.decorations, this.dynamicDecorationMap),
                e = yt.build(this.view.state.doc, i.range.toB, u, this.decorations, this.dynamicDecorationMap);
              (r = t.breakAtStart), (l = t.openStart), (h = e.openEnd);
              let s = this.compositionView(i);
              e.breakAtStart
                ? (s.breakAfter = 1)
                : e.content.length &&
                  s.merge(s.length, s.length, e.content[0], !1, e.openStart, 0) &&
                  ((s.breakAfter = e.content[0].breakAfter), e.content.shift()),
                t.content.length && s.merge(0, 0, t.content[t.content.length - 1], !0, 0, t.openEnd) && t.content.pop(),
              ...
              ({
                ...
                openStart: l,
                openEnd: h,
              } = yt.build(this.view.state.doc, d, u, this.decorations, this.dynamicDecorationMap));
            let { i: f, off: p } = o.findPos(c, 1),
              { i: g, off: m } = o.findPos(a, -1);
            F(this, g, m, f, p, n, r, l, h);
          }
          i && this.fixCompositionDOM(i);
        }
        compositionView(t) {
          let e = new J(t.text.nodeValue);
          e.flags |= 8;
          for (let { deco: i } of t.marks) e = new Z(i, [e], e.length);
          let i = new ct();
        ...
        updateSelection(t = !1, e = !1) {
          ...
          let i = this.view.root.activeElement,
            s = i == this.dom,
            o = !s && f(this.dom, this.view.observer.selectionRange) && !(i && this.dom.contains(i));
          if (!(s || e || o)) return;
          let n = this.forceSelection;
          this.forceSelection = !1;
          let r = this.view.state.selection.main,
            l = this.moveToLine(this.domAtPos(r.anchor)),
            h = r.empty ? l : this.moveToLine(this.domAtPos(r.head));
          if (
            Q.gecko &&
            r.empty &&
            !this.hasComposition &&
            1 == (a = l).node.nodeType &&
            a.node.firstChild &&
            (0 == a.offset || "false" == a.node.childNodes[a.offset - 1].contentEditable) &&
            (a.offset == a.node.childNodes.length || "false" == a.node.childNodes[a.offset].contentEditable)
          ) {
            let t = document.createTextNode("");
            this.view.observer.ignore(() => l.node.insertBefore(t, l.node.childNodes[l.offset] || null)), (l = h = new L(t, 0)), (n = !0);
          }
          var a;
          let c = this.view.observer.selectionRange;
          (!n &&
            c.focusNode &&
            ((g(l.node, l.offset, c.anchorNode, c.anchorOffset) && g(h.node, h.offset, c.focusNode, c.focusOffset)) ||
              this.suppressWidgetCursorChange(c, r))) ||
                ...
                if (r.empty) {
                  if (Q.gecko) {
                    let t =
                      ...
                      1 != e.nodeType
                        ? 0
                        : (s && "false" == e.childNodes[s - 1].contentEditable ? 1 : 0) |
                          (s < e.childNodes.length && "false" == e.childNodes[s].contentEditable ? 2 : 0));
                    if (t && 3 != t) {
                      let e = (1 == t ? R : B)(l.node, l.offset);
                      e && (l = new L(e.node, e.offset));
                    }
                  }
                  ...
                  try {
                    t.extend(h.node, h.offset);
                  } catch (t) {}
                } else {
                  let e = document.createRange();
                  r.anchor > r.head && ([l, h] = [h, l]),
                    e.setEnd(h.node, h.offset),
            ...
            (this.impreciseAnchor = l.precise ? null : new L(c.anchorNode, c.anchorOffset)),
            (this.impreciseHead = h.precise ? null : new L(c.focusNode, c.focusOffset));
        }
        suppressWidgetCursorChange(t, e) {
          return (
            ...
            g(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) &&
        ...
        moveToLine(t) {
          ...
          for (let s = t.offset; !e && s < i.childNodes.length; s++) {
            let t = H.get(i.childNodes[s]);
            t instanceof ct && (e = t.domAtPos(0));
          }
          for (let s = t.offset - 1; !e && s >= 0; s--) {
            let t = H.get(i.childNodes[s]);
            t instanceof ct && (e = t.domAtPos(t.length));
          }
          return e ? new L(e.node, e.offset, !0) : t;
        }
        nearest(t) {
          for (let e = t; e; ) {
            let t = H.get(e);
        ...
        domAtPos(t) {
          ...
          for (; e < this.children.length - 1; ) {
            ...
            if (i < t.length || t instanceof ct) break;
            e++, (i = 0);
          }
        ...
        coordsAt(t, e) {
          ...
          for (let o = this.length, n = this.children.length - 1; n >= 0; n--) {
            ...
            h <= t &&
              (h < t || r.covers(-1)) &&
              (l > t || r.covers(1)) &&
              (!i || (r instanceof ct && !(i instanceof ct && e >= 0))) &&
              ((i = r), (s = h)),
              (o = h);
          }
        ...
        coordsForChar(t) {
          let { i: e, off: i } = this.childPos(t, 1),
            o = this.children[e];
          if (!(o instanceof ct)) return null;
          ...
          if (!(o instanceof J)) return null;
          let n = (0, s.findClusterBreak)(o.text, i);
          if (n == i) return null;
          let r = D(o.dom, i, n).getClientRects();
        ...
        measureVisibleLineHeights(t) {
          let e = [],
            ...
            r = -1,
            l = this.view.textDirection == Mt.LTR;
        ...
        textDirectionAt(t) {
          ...
          return "rtl" == getComputedStyle(this.children[e].dom).direction ? Mt.RTL : Mt.LTR;
        }
        measureTextSize() {
        ...
        childCursor(t = this.length) {
          ...
          return e && (t -= this.children[--e].length), new N(this.children, t, e);
        }
        computeBlockGapDeco() {
          let t = [],
          ...
          for (let i = 0, s = 0; ; s++) {
            ...
            if (n > i) {
              ...
              t.push(pt.replace({ widget: new Se(s), block: !0, inclusive: !0, isBlockGap: !0 }).range(i, n));
            }
            if (!o) break;
            i = o.to + 1;
          }
        ...
        updateDeco() {
          let t = 1,
            e = this.view.state.facet(ae).map((e) => ((this.dynamicDecorationMap[t++] = "function" == typeof e) ? e(this.view) : e)),
            i = !1,
            o = this.view.state.facet(ce).map((t, e) => {
              let s = "function" == typeof t;
              return s && (i = !0), s ? t(this.view) : t;
            });
          for (
            o.length && ((this.dynamicDecorationMap[t++] = i), e.push(s.RangeSet.join(o))),
        ...
        maybeCreateCompositionBarrier() {
          ...
          if (!e) return !1;
          let i = null;
          for (let e of this.decorations)
            if (
              (e.between(t, t, (e, s, o) => {
                o.point ? (i = !1) : o.endSide < 0 && e < t && s == t && (i = !0);
              }),
              !1 === i)
            )
              break;
          return (this.compositionBarrier = i ? pt.set(ye.range(t)) : pt.none), !!i;
        }
        ...
        scrollIntoView(t) {
          ...
          for (let e of this.view.state.facet(Jt))
            try {
              if (e(this.view, t.range, t)) return !0;
            } catch (t) {
              ee(this.view.state, t, "scroll handler");
            }
          let e,
            { range: i } = t,
          ...
          let o = ge(this.view),
            n = { left: s.left - o.left, top: s.top - o.top, right: s.right + o.right, bottom: s.bottom + o.bottom },
          ...
          !(function (t, e, i, s, o, n, r, l) {
            ...
            for (let c = t, d = !1; c && !d; )
              if (1 == c.nodeType) {
                ...
                if (u) t = S(a);
                  ...
                  if (
                    (/^(fixed|sticky)$/.test(getComputedStyle(c).position) && (d = !0),
                  ...
                  ({ scaleX: f, scaleY: p } = x(c, e)),
                    (t = { left: e.left, right: e.left + c.clientWidth * f, top: e.top, bottom: e.top + c.clientHeight * p });
                }
                let g = 0,
                  m = 0;
                if ("nearest" == o)
                  e.top < t.top
                    ? ((m = -(t.top - e.top + r)), i > 0 && e.bottom > t.bottom + m && (m = e.bottom - t.bottom + m + r))
                    : e.bottom > t.bottom && ((m = e.bottom - t.bottom + r), i < 0 && e.top - m < t.top && (m = -(t.top + m - e.top + r)));
                else {
                  let s = e.bottom - e.top,
                    n = t.bottom - t.top;
                  m =
                    ("center" == o && s <= n ? e.top + s / 2 - n / 2 : "start" == o || ("center" == o && i < 0) ? e.top - r : e.bottom - n + r) -
                    t.top;
                }
                if (
                  ("nearest" == s
                    ? e.left < t.left
                      ? ((g = -(t.left - e.left + n)), i > 0 && e.right > t.right + g && (g = e.right - t.right + g + n))
                      : e.right > t.right && ((g = e.right - t.right + n), i < 0 && e.left < t.left + g && (g = -(t.left + g - e.left + n)))
                    : (g =
                        ("center" == s
            ...
            this.view.textDirection == Mt.LTR
          );
        }
      }
      const ye = pt.widget({ side: -1, widget: xt.inline });
      class Se extends ut {
        constructor(t) {
          super(), (this.height = t);
        }
      ...
      function xe(t, e) {
        ...
        let s = R(i.focusNode, i.focusOffset),
          o = B(i.focusNode, i.focusOffset),
          n = s || o;
        if (o && s && o.node != s.node) {
          let e = H.get(o.node);
          if (!e || (e instanceof J && e.text != o.node.nodeValue)) n = o;
          else if (t.docView.lastCompositionAfterCursor) {
            let t = H.get(s.node);
            !t || (t instanceof J && t.text != s.node.nodeValue) || (n = o);
          }
        }
      ...
      function Oe(t, e, i) {
        ...
        for (let u = t.firstChild; u; u = u.nextSibling) {
          ...
          for (let f = 0; f < t.length; f++) {
            let p = t[f];
            o && Ae(o, p) && (p = De(Te(p, o.bottom), o.top));
            let g = Ce(e, p),
              m = ke(i, p);
            if (0 == g && 0 == m) return 3 == u.nodeType ? Ee(u, e, i) : Oe(u, e, i);
            if (!s || r > m || (r == m && n > g)) {
              (s = u), (o = p), (n = g), (r = m);
              let l = m ? (i < p.top ? -1 : 1) : g ? (e < p.left ? -1 : 1) : 0;
              d = !l || (l > 0 ? f < t.length - 1 : f > 0);
            }
            0 == g
              ? i > p.bottom && (!a || a.bottom < p.bottom)
                ? ((l = u), (a = p))
                : i < p.top && (!c || c.top > p.top) && ((h = u), (c = p))
              : a && Ae(a, p)
                ? (a = Te(a, p.bottom))
                : c && Ae(c, p) && (c = De(c, p.top));
          }
        }
        if ((a && a.bottom >= i ? ((s = l), (o = a)) : c && c.top <= i && ((s = h), (o = c)), !s)) return { node: t, offset: 0 };
        let u = Math.max(o.left, Math.min(o.right, e));
        return 3 == s.nodeType
          ? Ee(s, u, i)
          : d && "false" != s.contentEditable
            ? Oe(s, u, i)
            : { node: t, offset: Array.prototype.indexOf.call(t.childNodes, s) + (e >= (o.left + o.right) / 2 ? 1 : 0) };
      }
      function Ee(t, e, i) {
        let s = t.nodeValue.length,
          o = -1,
          ...
          r = 0;
        for (let l = 0; l < s; l++) {
          let s = D(t, l, l + 1).getClientRects();
          for (let h = 0; h < s.length; h++) {
            ...
            if (a.left - 1 <= e && a.right + 1 >= e && c < n) {
              let i = e >= (a.left + a.right) / 2,
                s = i;
              if (((Q.chrome || Q.gecko) && D(t, l).getBoundingClientRect().left == a.right && (s = !i), c <= 0))
      ...
      function Re(t, e, i, s = -1) {
        ...
        for (let e = t.viewState.heightOracle.textHeight / 2, o = !1; (r = t.elementAtHeight(u)), r.type != ft.Text; )
          for (; (u = s > 0 ? r.bottom + e : r.top - e), !(u >= 0 && u <= a); ) {
            if (o) return i ? null : 0;
            (o = !0), (s = -s);
          }
        d = h + u;
        let f = r.from;
        if (f < t.viewport.from) return 0 == t.viewport.from ? 0 : i ? null : Be(t, l, r, c, d);
        if (f > t.viewport.to) return t.viewport.to == t.state.doc.length ? t.state.doc.length : i ? null : Be(t, l, r, c, d);
        let p = t.dom.ownerDocument,
          g = t.root.elementFromPoint ? t.root : p,
          m = g.elementFromPoint(c, d);
        m && !t.contentDOM.contains(m) && (m = null),
          m || ((c = Math.max(l.left + 1, Math.min(l.right - 1, c))), (m = g.elementFromPoint(c, d)), m && !t.contentDOM.contains(m) && (m = null));
        let w,
          v = -1;
              ...
              (!t.contentDOM.contains(w) ||
                (Q.safari &&
                  (function (t, e, i) {
                    ...
                    return D(t, s - 1, s).getBoundingClientRect().left > i;
                  })(w, v, c)) ||
                (Q.chrome &&
                  (function (t, e, i) {
                    if (0 != e) return !1;
                    ...
                    return (
                      i - (1 == t.nodeType ? t.getBoundingClientRect() : D(t, 0, Math.max(t.nodeValue.length, 1)).getBoundingClientRect()).left > 5
                    );
                  })(w, v, c))) &&
                (w = void 0));
          }
        if (!w || !t.docView.dom.contains(w)) {
          let e = ct.find(t.docView, f);
          if (!e) return u > r.top + r.height / 2 ? r.to : r.from;
          ({ node: w, offset: v } = Oe(e.dom, c, d));
        }
      ...
      function Be(t, e, i, o, n) {
        ...
        if (t.lineWrapping && i.height > 1.5 * t.defaultLineHeight) {
          ...
          r += Math.floor((n - i.top - 0.5 * (t.defaultLineHeight - e)) / e) * t.viewState.heightOracle.lineLength;
        }
      ...
      function Le(t, e) {
        ...
        if (Array.isArray(i.type)) for (let t of i.type) if (t.to > e || (t.to == e && (t.to == i.to || t.type == ft.Text))) return t;
        return i;
      }
      function Pe(t, e, i, s) {
      ...
      class Ne {
        ...
        handleEvent(t) {
          (function (t, e) {
            ...
            for (let i, s = e.target; s != t.contentDOM; s = s.parentNode)
              if (!s || 11 == s.nodeType || ((i = H.get(s)) && i.ignoreEvent(e))) return !1;
            return !0;
          })(this.view, t) &&
            !this.ignoreDuringComposition(t) &&
            (("keydown" == t.type && this.keydown(t)) || this.runHandlers(t.type, t));
        }
        runHandlers(t, e) {
          ...
          for (let t in e)
            if ("scroll" != t) {
              let o = !e[t].handlers.length,
                n = i[t];
              n && o != !n.handlers.length && (s.removeEventListener(t, this.handleEvent), (n = null)),
        ...
        keydown(t) {
          if (((this.lastKeyCode = t.keyCode), (this.lastKeyTime = Date.now()), 9 == t.keyCode && Date.now() < this.lastEscPress + 2e3)) return !0;
          if (
            (27 != t.keyCode && Ie.indexOf(t.keyCode) < 0 && (this.view.inputState.lastEscPress = 0),
            Q.android && Q.chrome && !t.synthetic && (13 == t.keyCode || 8 == t.keyCode))
          )
          ...
          return !Q.ios ||
            ...
            t.altKey ||
            t.metaKey ||
            !(((e = ze.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) || (Ke.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
        ...
        flushIOSKey(t) {
          ...
          return (
            !!e &&
            !("Enter" == e.key && t && t.from < t.to && /^\S+$/.test(t.insert.toString())) &&
            ((this.pendingIOSKey = void 0), T(this.view.contentDOM, e.key, e.keyCode, e instanceof KeyboardEvent ? e : void 0))
          );
        }
        ignoreDuringComposition(t) {
          return (
            !!/^key/.test(t.type) &&
            (this.composing > 0 ||
              (!!(Q.safari && !Q.ios && this.compositionPendingKey && Date.now() - this.compositionEndedAt < 100) &&
        ...
        for (let e of t) {
          ...
          if (t && t.domEventHandlers)
            for (let s in t.domEventHandlers) {
              let o = t.domEventHandlers[s];
              o && i(s).handlers.push(Fe(e.value, o));
            }
          if (t && t.domEventObservers)
            for (let s in t.domEventObservers) {
              let o = t.domEventObservers[s];
              o && i(s).observers.push(Fe(e.value, o));
            }
        }
        for (let t in _e) i(t).handlers.push(_e[t]);
        for (let t in Xe) i(t).observers.push(Xe[t]);
        return e;
      }
      const ze = [
      ...
      class Ye {
        constructor(t, e, i, o) {
          ...
          n.addEventListener("mousemove", (this.move = this.move.bind(this))),
            ...
            (this.multiple =
              t.state.facet(s.EditorState.allowMultipleSelections) &&
              (function (t, e) {
                let i = t.state.facet(qt);
                return i.length ? i[0](e) : Q.mac ? e.metaKey : e.ctrlKey;
              })(t, e)),
            (this.dragging =
              !(
                !(function (t, e) {
        ...
        move(t) {
          ...
          if (
            this.dragging ||
            (null == this.dragging &&
              ((i = this.startEvent), (s = t), Math.max(Math.abs(i.clientX - s.clientX), Math.abs(i.clientY - s.clientY)) < 10))
          )
            return;
          ...
          let o = 0,
            ...
            l = ge(this.view);
          t.clientX - l.left <= r.left + 6 ? (o = -qe(r.left - t.clientX)) : t.clientX + l.right >= r.right - 6 && (o = qe(t.clientX - r.right)),
            t.clientY - l.top <= r.top + 6 ? (n = -qe(r.top - t.clientY)) : t.clientY + l.bottom >= r.bottom - 6 && (n = qe(t.clientY - r.bottom)),
        ...
        skipAtoms(t) {
          ...
          for (let i = 0; i < t.ranges.length; i++) {
            let o = t.ranges[i],
              n = null;
            if (o.empty) {
              let t = He(this.atoms, o.from, 0);
              t != o.from && (n = s.EditorSelection.cursor(t, -1));
            } else {
              let t = He(this.atoms, o.from, -1),
                e = He(this.atoms, o.to, 1);
              (t == o.from && e == o.to) || (n = s.EditorSelection.range(o.from == o.anchor ? t : e, o.from == o.head ? t : e));
            }
        ...
        select(t) {
          ...
          (!this.mustSelect && i.eq(e.state.selection, !1 === this.dragging)) || this.view.dispatch({ selection: i, userEvent: "select.pointer" }),
            (this.mustSelect = !1);
        }
        update(t) {
      ...
      const _e = Object.create(null),
        ...
        je = (Q.ie && Q.ie_version < 15) || (Q.ios && Q.webkit_version < 604);
      function Ge(t, e) {
        let i,
          { state: o } = t,
          n = 1,
        ...
        if (null != ri && o.selection.ranges.every((t) => t.empty) && ri == r.toString()) {
          let t = -1;
          i = o.changeByRange((i) => {
            ...
            return { changes: { from: h.from, insert: a }, range: s.EditorSelection.cursor(i.from + a.length) };
          });
        } else
          i = l
            ? o.changeByRange((t) => {
      ...
      function Ue(t, e, i, o) {
        if (1 == o) return s.EditorSelection.cursor(e, i);
        if (2 == o)
          return (function (t, e, i = 1) {
            let o = t.charCategorizer(e),
              n = t.doc.lineAt(e),
              r = e - n.from;
            if (0 == n.length) return s.EditorSelection.cursor(e);
            0 == r ? (i = 1) : r == n.length && (i = -1);
            let l = r,
              h = r;
            i < 0 ? (l = (0, s.findClusterBreak)(n.text, r, !1)) : (h = (0, s.findClusterBreak)(n.text, r));
            let a = o(n.text.slice(l, h));
            for (; l > 0; ) {
              let t = (0, s.findClusterBreak)(n.text, l, !1);
              if (o(n.text.slice(t, l)) != a) break;
              l = t;
            }
            for (; h < n.length; ) {
              let t = (0, s.findClusterBreak)(n.text, h);
              if (o(n.text.slice(h, t)) != a) break;
              h = t;
            }
            return s.EditorSelection.range(l + n.from, h + n.from);
          })(t.state, e, i);
        {
          let i = ct.find(t.docView, e),
            ...
            r = i ? i.posAtEnd : o.to;
          return r < t.state.doc.length && r == o.to && r++, s.EditorSelection.range(n, r);
        }
      }
      (Xe.scroll = (t) => {
        (t.inputState.lastScrollTop = t.scrollDOM.scrollTop), (t.inputState.lastScrollLeft = t.scrollDOM.scrollLeft);
      }),
        (_e.keydown = (t, e) => (t.inputState.setSelectionOrigin("select"), 27 == e.keyCode && (t.inputState.lastEscPress = Date.now()), !1)),
        (Xe.touchstart = (t, e) => {
        ...
        (_e.mousedown = (t, e) => {
          ...
          let i = null;
          for (let s of t.state.facet(_t)) if (((i = s(t, e)), i)) break;
          if (
            (i ||
              0 != e.button ||
              (i = (function (t, e) {
                ...
                return {
                  ...
                  get(e, r, l) {
                    let h,
                      a = Ze(t, e),
                      c = Ue(t, a.pos, a.bias, o);
                    if (i.pos != a.pos && !r) {
                      let e = Ue(t, i.pos, i.bias, o),
            ...
            let s = !t.hasFocus;
            t.inputState.startMouseSelection(new Ye(t, e, i, s)), s && t.observer.ignore(() => A(t.contentDOM));
            let o = t.inputState.mouseSelection;
            if (o) return o.start(e), !1 === o.dragging;
          }
          return !1;
        });
      let $e = (t, e) => t >= e.top && t <= e.bottom,
        Qe = (t, e, i) => $e(e, i) && t >= i.left && t <= i.right;
      function Je(t, e, i, s) {
        let o = ct.find(t.docView, e);
        if (!o) return 1;
        let n = e - o.posAtStart;
        if (0 == n) return 1;
        if (n == o.length) return -1;
        let r = o.coordsAt(n, -1);
        if (r && Qe(i, s, r)) return -1;
        let l = o.coordsAt(n, 1);
        return l && Qe(i, s, l) ? 1 : r && $e(s, r) ? -1 : 1;
      }
      function Ze(t, e) {
        let i = t.posAtCoords({ x: e.clientX, y: e.clientY }, !1);
        return { pos: i, bias: Je(t, i, e.clientX, e.clientY) };
      }
      const ti = Q.ie && Q.ie_version <= 11;
      let ei = null,
        ii = 0,
        si = 0;
      function oi(t) {
        ...
        return (
          (ei = t),
          (si = Date.now()),
          (ii = !e || (i > Date.now() - 400 && Math.abs(e.clientX - t.clientX) < 2 && Math.abs(e.clientY - t.clientY) < 2) ? (ii + 1) % 3 : 1)
        );
      }
      function ni(t, e, i, s) {
        if (!i) return;
        let o = t.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
          { draggedContent: n } = t.inputState,
          r =
            s &&
            n &&
            (function (t, e) {
              let i = t.state.facet(Yt);
              return i.length ? i[0](e) : Q.mac ? !e.altKey : !e.ctrlKey;
            })(t, e)
              ? { from: n.from, to: n.to }
              : null,
          l = { from: o, insert: i },
        ...
        t.focus(),
          t.dispatch({ changes: h, selection: { anchor: h.mapPos(o, -1), head: h.mapPos(o, 1) }, userEvent: r ? "move.drop" : "input.drop" }),
      ...
      (_e.dragstart = (t, e) => {
        ...
        if (e.target.draggable) {
          ...
          if (o && o.isWidget) {
            let t = o.posAtStart,
              e = t + o.length;
            (t >= i.to || e <= i.from) && (i = s.EditorSelection.range(t, e));
          }
        }
        let { inputState: o } = t;
        return (
          ...
          (o.draggedContent = i),
          e.dataTransfer && (e.dataTransfer.setData("Text", t.state.sliceDoc(i.from, i.to)), (e.dataTransfer.effectAllowed = "copyMove")),
          !1
        );
      }),
        (_e.dragend = (t) => ((t.inputState.draggedContent = null), !1)),
        (_e.drop = (t, e) => {
          ...
          if (i && i.length) {
            let s = Array(i.length),
              o = 0,
              n = () => {
                ++o == i.length && ni(t, e, s.filter((t) => null != t).join(t.state.lineBreak), !1);
              };
        ...
        (_e.paste = (t, e) => {
          ...
          return i
            ? (Ge(t, i.getData("text/plain") || i.getData("text/uri-list")), !0)
            : ((function (t) {
      ...
      _e.copy = _e.cut = (t, e) => {
        let {
          ...
          if (!e.length) {
            ...
            for (let { from: s } of t.selection.ranges) {
              ...
              n.number > o && (e.push(n.text), i.push({ from: n.from, to: Math.min(t.doc.length, n.to + 1) })), (o = n.number);
            }
            s = !0;
          }
        ...
        if (!i && !o) return !1;
        (ri = o ? i : null), "cut" != e.type || t.state.readOnly || t.dispatch({ changes: s, scrollIntoView: !0, userEvent: "delete.cut" });
      ...
      const li = s.Annotation.define();
      function hi(t, e) {
        let i = [];
        for (let s of t.facet(Ut)) {
          let o = s(t, e);
          o && i.push(o);
        }
        return i ? t.update({ effects: i, annotations: li.of(!0) }) : null;
      }
      function ai(t) {
        setTimeout(() => {
          let e = t.hasFocus;
      ...
      (Xe.focus = (t) => {
        ...
        (Xe.blur = (t) => {
          t.observer.clearSelectionRange(), ai(t);
        }),
        (Xe.compositionstart = Xe.compositionupdate =
          (t) => {
            null == t.inputState.compositionFirstChange && (t.inputState.compositionFirstChange = !0),
              t.inputState.composing < 0 &&
                ((t.inputState.composing = 0), t.docView.maybeCreateCompositionBarrier() && (t.update([]), t.docView.clearCompositionBarrier()));
          }),
        (Xe.compositionend = (t) => {
        ...
        (_e.beforeinput = (t, e) => {
          ...
          if (
            Q.chrome &&
            Q.android &&
            (s = ze.find((t) => t.inputType == e.inputType)) &&
            (t.observer.delayAndroidKey(s.key, s.keyCode), "Backspace" == s.key || "Delete" == s.key)
          ) {
          ...
          return (
            Q.ios && "deleteContentForward" == e.inputType && t.observer.flushSoon(),
            Q.safari && "insertText" == e.inputType && t.inputState.composing >= 0 && setTimeout(() => Xe.compositionend(t, e), 20),
            !1
          );
        });
      const ci = new Set(),
        di = ["pre-wrap", "normal", "pre-line", "break-spaces"];
      class ui {
        constructor(t) {
          (this.lineWrapping = t),
        ...
        mustRefreshForWrapping(t) {
          return di.indexOf(t) > -1 != this.lineWrapping;
        }
      ...
      class pi {
        ...
        get type() {
          return "number" == typeof this._content ? ft.Text : Array.isArray(this._content) ? this._content : this._content.type;
        }
        get to() {
        ...
        join(t) {
          ...
          return new pi(this.from, this.length + t.length, this.top, this.height + t.height, e);
        }
      }
      var gi = (function (t) {
      ...
      class wi {
        ...
        setHeight(t, e) {
          this.height != e && (Math.abs(this.height - e) > mi && (t.heightChanged = !0), (this.height = e));
        }
        replace(t, e, i) {
          return wi.of(i);
        }
        ...
        applyChanges(t, e, i, s) {
          ...
          for (let r = s.length - 1; r >= 0; r--) {
            let { fromA: l, toA: h, fromB: a, toB: c } = s[r],
              d = o.lineAt(l, gi.ByPosNoHeight, i.setDoc(e), 0, 0),
              u = d.to >= h ? d : o.lineAt(h, gi.ByPosNoHeight, i, 0, 0);
            for (c += u.to - h, h = u.to; r > 0 && d.from <= s[r - 1].toA; )
              (l = s[r - 1].fromA), (a = s[r - 1].fromB), r--, l < d.from && (d = o.lineAt(l, gi.ByPosNoHeight, i, 0, 0));
            (a += d.from - l), (l = d.from);
            let f = Mi.build(i.setDoc(n), t, a, c);
            o = o.replace(l, h, f);
          }
        ...
        static of(t) {
          ...
          let n = 0;
          return null == t[e - 1] ? ((n = 1), e--) : null == t[e] && ((n = 1), i++), new Si(wi.of(t.slice(0, e)), n, wi.of(t.slice(i)));
        }
      }
      wi.prototype.size = 1;
      class vi extends wi {
        ...
        blockAt(t, e, i, s) {
          return new pi(s, this.length, i, this.height, this.deco || 0);
        }
        lineAt(t, e, i, s, o) {
      ...
      class bi extends vi {
        ...
        blockAt(t, e, i, s) {
          return new pi(s, this.length, i, this.height, this.breaks);
        }
        replace(t, e, i) {
          let s = i[0];
          return 1 == i.length && (s instanceof bi || (s instanceof yi && 4 & s.flags)) && Math.abs(this.length - s.length) < 10
            ? (s instanceof yi ? (s = new bi(s.length, this.height)) : (s.height = this.height), this.outdated || (s.outdated = !1), s)
            : wi.of(i);
        }
        updateHeight(t, e = 0, i = !1, s) {
          return (
      ...
      class yi extends wi {
        ...
        heightMetrics(t, e) {
          ...
          return { firstLine: s, lastLine: o, perLine: i, perChar: r };
        }
        blockAt(t, e, i, s) {
          ...
          if (e.lineWrapping) {
            let o = s + (t < e.lineHeight ? 0 : Math.round(Math.max(0, Math.min(1, (t - i) / this.height)) * this.length)),
              ...
              h = r + n.length * l,
              a = Math.max(i, t - h / 2);
            return new pi(n.from, n.length, a, h, 0);
          }
          {
            let s = Math.max(0, Math.min(n - o, Math.floor((t - i) / r))),
              { from: l, length: h } = e.doc.line(o + s);
            return new pi(l, h, i + r * s, r, 0);
          }
        }
        lineAt(t, e, i, s, o) {
          if (e == gi.ByHeight) return this.blockAt(t, i, s, o);
          if (e == gi.ByPosNoHeight) {
            let { from: e, to: s } = i.doc.lineAt(t);
            return new pi(e, s - e, 0, 0, 0);
          }
          ...
          return new pi(h.from, h.length, Math.max(s, Math.min(d, s + this.height - a)), a, 0);
        }
        forEachLine(t, e, i, s, o, n) {
          ...
          for (let a = t, c = s; a <= e; ) {
            ...
            let s = l + h * e.length;
            n(new pi(e.from, e.length, c, s, 0)), (c += s), (a = e.to + 1);
          }
        }
        replace(t, e, i) {
          let s = this.length - e;
          if (s > 0) {
            let t = i[i.length - 1];
            t instanceof yi ? (i[i.length - 1] = new yi(t.length + s)) : i.push(null, new yi(s - 1));
          }
          if (t > 0) {
            let e = i[0];
            e instanceof yi ? (i[0] = new yi(t + e.length)) : i.unshift(new yi(t - 1), null);
          }
          return wi.of(i);
        }
        decomposeLeft(t, e) {
        ...
        updateHeight(t, e = 0, i = !1, s) {
          ...
          if (s && s.from <= e + this.length && s.more) {
            let i = [],
              n = Math.max(e, s.from),
              r = -1;
            for (s.from > e && i.push(new yi(s.from - e - 1).updateHeight(t, e)); n <= o && s.more; ) {
              let e = t.doc.lineAt(n).length;
              i.length && i.push(null);
              let o = s.heights[s.index++];
              -1 == r ? (r = o) : Math.abs(o - r) >= mi && (r = -2);
              let l = new bi(e, o);
              (l.outdated = !1), i.push(l), (n += e + 1);
            }
            n <= o && i.push(null, new yi(o - n).updateHeight(t, n));
            let l = wi.of(i);
            return (
              (r < 0 || Math.abs(l.height - this.height) >= mi || Math.abs(r - this.heightMetrics(t, e).perLine) >= mi) && (t.heightChanged = !0), l
            );
          }
      ...
      class Si extends wi {
        ...
        forEachLine(t, e, i, s, o, n) {
          ...
          if (this.break) t < l && this.left.forEachLine(t, e, i, s, o, n), e >= l && this.right.forEachLine(t, e, i, r, l, n);
            ...
            let h = this.lineAt(l, gi.ByPos, i, s, o);
        ...
        replace(t, e, i) {
          ...
          if ((t > 0 && xi(o, n - 1), e < this.length)) {
            let t = o.length;
            this.decomposeRight(e, o), xi(o, t);
          }
          return wi.of(o);
        }
        decomposeLeft(t, e) {
        ...
        updateHeight(t, e = 0, i = !1, s) {
          let { left: o, right: n } = this,
            ...
            l = null;
          return (
            s && s.from <= e + o.length && s.more ? (l = o = o.updateHeight(t, e, i, s)) : o.updateHeight(t, e, i),
            s && s.from <= r + n.length && s.more ? (l = n = n.updateHeight(t, r, i, s)) : n.updateHeight(t, r, i),
            l ? this.balanced(o, n) : ((this.height = this.left.height + this.right.height), (this.outdated = !1), this)
          );
        }
        toString() {
      ...
      function xi(t, e) {
        let i, s;
        null == t[e] && (i = t[e - 1]) instanceof yi && (s = t[e + 1]) instanceof yi && t.splice(e - 1, 3, new yi(i.length + 1 + s.length));
      }
      class Mi {
        constructor(t, e) {
          (this.pos = t),
        ...
        span(t, e) {
          if (this.lineStart > -1) {
            ...
            i instanceof bi ? (i.length += t - this.pos) : (t > this.pos || !this.isCovered) && this.nodes.push(new bi(t - this.pos, -1)),
              (this.writtenTo = t),
        ...
        point(t, e, i) {
          if (t < e || i.heightRelevant) {
            ...
            let n = e - t;
            i.block ? this.addBlock(new vi(n, s, i)) : (n || o || s >= 5) && this.addLineDeco(s, o, n);
        ...
        enterLine() {
          ...
          (this.lineStart = t),
            (this.lineEnd = e),
            this.writtenTo < t &&
              ((this.writtenTo < t - 1 || null == this.nodes[this.nodes.length - 1]) && this.nodes.push(this.blankContent(this.writtenTo, t - 1)),
              this.nodes.push(null)),
            this.pos > t && this.nodes.push(new bi(this.pos - t, -1)),
        ...
        finish(t) {
          ...
          !(this.lineStart > -1) || e instanceof bi || this.isCovered
            ? (this.writtenTo < this.pos || null == e) && this.nodes.push(this.blankContent(this.writtenTo, this.pos))
            : this.nodes.push(new bi(0, -1));
          let i = t;
          for (let t of this.nodes) t instanceof bi && t.updateHeight(this.oracle, i), (i += t ? t.length : 1);
          return this.nodes;
        }
        static build(t, e, i, o) {
          let n = new Mi(i, t);
          return s.RangeSet.spans(e, i, o, n, 0), n.finish(i);
        }
      }
      class Ci {
        constructor() {
        ...
        comparePoint(t, e, i, s) {
          (t < e || (i && i.heightRelevant) || (s && s.heightRelevant)) && bt(t, e, this.changes, 5);
        }
      }
      function ki(t, e) {
        ...
        return { left: n - i.left, right: Math.max(n, r) - i.left, top: l - (i.top + e), bottom: Math.max(l, h) - (i.top + e) };
      }
      function Ai(t, e) {
        let i = t.getBoundingClientRect();
      ...
      class Di {
        ...
        draw(t, e) {
          return pt.replace({ widget: new Ti(this.size * (e ? t.scaleY : t.scaleX), e) }).range(this.from, this.to);
        }
      }
      class Ti extends ut {
        constructor(t, e) {
      ...
      class Oi {
        constructor(t) {
          (this.state = t),
            ...
            (this.defaultTextDirection = Mt.LTR),
            (this.visibleRanges = []),
            (this.mustEnforceCursorAssoc = !1);
          let e = t.facet(he).some((t) => "function" != typeof t && "cm-lineWrapping" == t.class);
          (this.heightOracle = new ui(e)),
            (this.stateDeco = t.facet(ae).filter((t) => "function" != typeof t)),
            (this.heightMap = wi
              .empty()
              .applyChanges(this.stateDeco, s.Text.empty, this.heightOracle.setDoc(t.doc), [new we(0, 0, 0, t.doc.length)])),
            (this.viewport = this.getViewport(0, null)),
            this.updateViewportLines(),
            this.updateForViewport(),
            (this.lineGaps = this.ensureLineGaps([])),
            (this.lineGapDeco = pt.set(this.lineGaps.map((t) => t.draw(this, !1)))),
        ...
        updateForViewport() {
          ...
          (this.viewports = t.sort((t, e) => t.from - e.from)),
            (this.scaler = this.heightMap.height <= 7e6 ? Pi : new Hi(this.heightOracle, this.heightMap, this.viewports));
        }
        updateViewportLines() {
          (this.viewportLines = []),
            this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (t) => {
              this.viewportLines.push(1 == this.scaler.scale ? t : Vi(t, this.scaler));
            });
        }
        update(t, e = null) {
          this.state = t.state;
          let i = this.stateDeco;
          this.stateDeco = this.state.facet(ae).filter((t) => "function" != typeof t);
          let o = t.changedRanges,
            n = we.extendWithRanges(
              o,
              (function (t, e, i) {
                let o = new Ci();
                return s.RangeSet.compare(t, e, i, o, 0), o.changes;
              })(i, this.stateDeco, t ? t.changes : s.ChangeSet.empty(this.state.doc.length))
            ),
          ...
          (this.heightMap = this.heightMap.applyChanges(this.stateDeco, t.startState.doc, this.heightOracle.setDoc(this.state.doc), n)),
            ...
            l
              ? ((this.scrollAnchorPos = t.changes.mapPos(l.from, -1)), (this.scrollAnchorHeight = l.top))
        ...
        measure(t) {
          let e = t.contentDOM,
            ...
            o = this.heightOracle,
            n = i.whiteSpace;
          this.defaultTextDirection = "rtl" == i.direction ? Mt.RTL : Mt.LTR;
          ...
          let a = 0,
            c = 0;
          if (l.width && l.height) {
            let { scaleX: t, scaleY: i } = x(e, l);
            ((t > 0.005 && Math.abs(this.scaleX - t) > 0.005) || (i > 0.005 && Math.abs(this.scaleY - i) > 0.005)) &&
              ((this.scaleX = t), (this.scaleY = i), (a |= 8), (r = h = !0));
          }
          let d = (parseInt(i.paddingTop) || 0) * this.scaleY,
            u = (parseInt(i.paddingBottom) || 0) * this.scaleY;
          (this.paddingTop == d && this.paddingBottom == u) || ((this.paddingTop = d), (this.paddingBottom = u), (a |= 10)),
            this.editorWidth != t.scrollDOM.clientWidth && (o.lineWrapping && (h = !0), (this.editorWidth = t.scrollDOM.clientWidth), (a |= 8));
          let f = t.scrollDOM.scrollTop * this.scaleY;
          this.scrollTop != f && ((this.scrollAnchorHeight = -1), (this.scrollTop = f)), (this.scrolledToBottom = E(t.scrollDOM));
          let p = (this.printing ? Ai : ki)(e, this.paddingTop),
          ...
          let v = l.width;
          if (
            ((this.contentDOMWidth == v && this.editorHeight == t.scrollDOM.clientHeight) ||
              ((this.contentDOMWidth = l.width), (this.editorHeight = t.scrollDOM.clientHeight), (a |= 8)),
            h)
          ) {
            let e = t.docView.measureVisibleLineHeights(this.viewport);
            if ((o.mustRefreshForHeights(e) && (r = !0), r || (o.lineWrapping && Math.abs(v - this.contentDOMWidth) > o.charWidth))) {
              let { lineHeight: i, charWidth: s, textHeight: l } = t.docView.measureTextSize();
              (r = i > 0 && o.refresh(n, i, s, l, v / s, e)), r && ((t.docView.minWidth = 0), (a |= 8));
            }
            g > 0 && m > 0 ? (c = Math.max(g, m)) : g < 0 && m < 0 && (c = Math.min(g, m)), (o.heightChanged = !1);
            for (let i of this.viewports) {
              let n = i.from == this.viewport.from ? e : t.docView.measureVisibleLineHeights(i);
              this.heightMap = (
                r ? wi.empty().applyChanges(this.stateDeco, s.Text.empty, this.heightOracle, [new we(0, 0, 0, t.state.doc.length)]) : this.heightMap
              ).updateHeight(o, 0, r, new fi(i.from, n));
            }
            o.heightChanged && (a |= 2);
          }
          let b =
          ...
          return (
            ...
            this.updateForViewport(),
            (2 & a || b) && this.updateViewportLines(),
            (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
        ...
        getViewport(t, e) {
          let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)),
            ...
            l = new Ei(s.lineAt(n - 1e3 * i, gi.ByHeight, o, 0, 0).from, s.lineAt(r + 1e3 * (1 - i), gi.ByHeight, o, 0, 0).to);
          if (e) {
            let { head: t } = e.range;
            if (t < l.from || t > l.to) {
              let i,
                n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top),
                r = s.lineAt(t, gi.ByPos, o, 0, 0);
              (i = "center" == e.y ? (r.top + r.bottom) / 2 - n / 2 : "start" == e.y || ("nearest" == e.y && t < l.from) ? r.top : r.bottom - n),
                (l = new Ei(s.lineAt(i - 500, gi.ByHeight, o, 0, 0).from, s.lineAt(i + n + 500, gi.ByHeight, o, 0, 0).to));
            }
          }
          return l;
        }
        mapViewport(t, e) {
          let i = e.mapPos(t.from, -1),
            s = e.mapPos(t.to, 1);
          return new Ei(
            this.heightMap.lineAt(i, gi.ByPos, this.heightOracle, 0, 0).from,
            this.heightMap.lineAt(s, gi.ByPos, this.heightOracle, 0, 0).to
          );
        }
        viewportIsAppropriate({ from: t, to: e }, i = 0) {
          if (!this.inView) return !0;
          let { top: s } = this.heightMap.lineAt(t, gi.ByPos, this.heightOracle, 0, 0),
            { bottom: o } = this.heightMap.lineAt(e, gi.ByPos, this.heightOracle, 0, 0),
            { visibleTop: n, visibleBottom: r } = this;
          return (
        ...
        mapLineGaps(t, e) {
          ...
          let i = [];
          for (let s of t) e.touchesRange(s.from, s.to) || i.push(new Di(e.mapPos(s.from), e.mapPos(s.to), s.size));
          return i;
        }
        ensureLineGaps(t, e) {
          let i = this.heightOracle.lineWrapping,
            ...
            n = o >> 1,
            r = o << 1;
          if (this.defaultTextDirection != Mt.LTR && !i) return [];
          let l = [],
            h = (o, r, a, c) => {
              if (r - o < n) return;
              let d = this.state.selection.main,
                u = [d.from];
              d.empty || u.push(d.to);
              for (let t of u) if (t > o && t < r) return h(o, t - 10, a, c), void h(t + 10, r, a, c);
              let f = (function (t, e) {
                for (let i of t) if (e(i)) return i;
              })(
                t,
                (t) =>
                  t.from >= a.from && t.to <= a.to && Math.abs(t.from - o) < n && Math.abs(t.to - r) < n && !u.some((e) => t.from < e && t.to > e)
              );
              if (!f) {
                if (r < a.to && e && i && e.visibleRanges.some((t) => t.from <= r && t.to >= r)) {
                  let t = e.moveToLineBoundary(s.EditorSelection.cursor(r), !1, !0).head;
                  t > o && (r = t);
                }
                f = new Di(o, r, this.gapSize(a, o, r, c));
              }
              l.push(f);
            };
          for (let t of this.viewportLines) {
            if (t.length < r) continue;
            let e = Ri(t.from, t.to, this.stateDeco);
            if (e.total < r) continue;
            let s,
              n,
            ...
            if (i) {
              let i,
                r,
                h = (o / this.heightOracle.lineLength) * this.heightOracle.lineHeight;
              if (null != l) {
                let s = Li(e, l),
                  o = ((this.visibleBottom - this.visibleTop) / 2 + h) / t.height;
                (i = s - o), (r = s + o);
              } else (i = (this.visibleTop - t.top - h) / t.height), (r = (this.visibleBottom - t.top + h) / t.height);
              (s = Bi(e, i)), (n = Bi(e, r));
            } else {
              let t,
                i,
                r = e.total * this.heightOracle.charWidth,
                h = o * this.heightOracle.charWidth;
              if (null != l) {
                let s = Li(e, l),
                  o = ((this.pixelViewport.right - this.pixelViewport.left) / 2 + h) / r;
                (t = s - o), (i = s + o);
              } else (t = (this.pixelViewport.left - h) / r), (i = (this.pixelViewport.right + h) / r);
              (s = Bi(e, t)), (n = Bi(e, i));
            }
            s > t.from && h(t.from, s, t, e), n < t.to && h(n, t.to, t, e);
          }
          return l;
        }
        gapSize(t, e, i, s) {
        ...
        updateLineGaps(t) {
          Di.same(t, this.lineGaps) || ((this.lineGaps = t), (this.lineGapDeco = pt.set(t.map((t) => t.draw(this, this.heightOracle.lineWrapping)))));
        }
        ...
        lineBlockAt(t) {
          return (
            ...
            Vi(this.heightMap.lineAt(t, gi.ByPos, this.heightOracle, 0, 0), this.scaler)
          );
        }
        lineBlockAtHeight(t) {
          return Vi(this.heightMap.lineAt(this.scaler.fromDOM(t), gi.ByHeight, this.heightOracle, 0, 0), this.scaler);
        }
        scrollAnchorAt(t) {
        ...
        elementAtHeight(t) {
          return Vi(this.heightMap.blockAt(this.scaler.fromDOM(t), this.heightOracle, 0, 0), this.scaler);
        }
        get docHeight() {
        ...
        return (
          s.RangeSet.spans(
            ...
            e,
            {
              span() {},
              point(t, e) {
                t > n && (o.push({ from: n, to: t }), (r += t - n)), (n = e);
              },
            },
            20
          ),
          n < e && (o.push({ from: n, to: e }), (r += e - n)),
          { total: r, ranges: o }
        );
      }
      function Bi({ total: t, ranges: e }, i) {
      ...
      const Pi = { toDOM: (t) => t, fromDOM: (t) => t, scale: 1 };
      class Hi {
        constructor(t, e, i) {
          let s = 0,
            o = 0,
          ...
          (this.viewports = i.map(({ from: i, to: o }) => {
            let n = e.lineAt(i, gi.ByPos, t, 0, 0).top,
              r = e.lineAt(o, gi.ByPos, t, 0, 0).bottom;
            return (s += r - n), { from: i, to: o, top: n, bottom: r, domTop: 0, domBottom: 0 };
          })),
            (this.scale = (7e6 - s) / (e.height - s));
          for (let t of this.viewports) (t.domTop = n + (t.top - o) * this.scale), (n = t.domBottom = t.domTop + (t.bottom - t.top)), (o = t.bottom);
        }
        toDOM(t) {
      ...
      function Vi(t, e) {
        ...
        let i = e.toDOM(t.top),
          s = e.toDOM(t.bottom);
        return new pi(t.from, t.length, i, s - i, Array.isArray(t._content) ? t._content.map((t) => Vi(t, e)) : t._content);
      }
      const Ni = s.Facet.define({ combine: (t) => t.join(" ") }),
        Fi = s.Facet.define({ combine: (t) => t.indexOf(!0) > -1 }),
        Wi = o.V.newName(),
        zi = o.V.newName(),
        Ki = o.V.newName(),
        Ii = { "&light": "." + zi, "&dark": "." + Ki };
      ...
      class Xi {
        constructor(t, e) {
          (this.points = t), (this.text = ""), (this.lineSeparator = e.facet(s.EditorState.lineSeparator));
        }
        append(t) {
          this.text += t;
        }
        ...
        readRange(t, e) {
          ...
          for (let s = t; ; ) {
            ...
            let n = H.get(s),
              r = H.get(o);
            (n && r ? n.breakAfter : (n ? n.breakAfter : w(s)) || (w(o) && ("BR" != s.nodeName || s.cmIgnore) && this.text.length > t)) &&
              this.lineBreak(),
              (s = o);
          }
        ...
        readTextNode(t) {
          ...
          for (let i = 0, s = this.lineSeparator ? null : /\r\n?|\n/g; ; ) {
            ...
            if (
              (this.lineSeparator
                ? ((n = e.indexOf(this.lineSeparator, i)), (r = this.lineSeparator.length))
                : (o = s.exec(e)) && ((n = o.index), (r = o[0].length)),
        ...
        findPointInside(t, e) {
          for (let i of this.points)
            (3 == t.nodeType ? i.node == t : t.contains(i.node)) && (i.pos = this.text.length + (ji(t, i.node, i.offset) ? e : 0));
        }
      }
      function ji(t, e, i) {
        for (;;) {
        ...
        constructor(t, e, i, o) {
          ...
          if (t.state.readOnly && e > -1) this.newSel = null;
            ...
            let e =
                n || r
                  ...
                  : (function (t) {
                      ...
                      return i && (e.push(new Gi(i, s)), (o == i && n == s) || e.push(new Gi(o, n))), e;
                    })(t),
              i = new Xi(e, t.state);
            ...
            let e = t.observer.selectionRange,
              i =
                (n && n.node == e.focusNode && n.offset == e.focusOffset) || !u(t.contentDOM, e.focusNode)
                  ? t.state.selection.main.head
                  : t.docView.posFromDOM(e.focusNode, e.focusOffset),
              o =
                (r && r.node == e.anchorNode && r.offset == e.anchorOffset) || !u(t.contentDOM, e.anchorNode)
                  ? t.state.selection.main.anchor
                  : t.docView.posFromDOM(e.anchorNode, e.anchorOffset),
              l = t.viewport;
            if ((Q.ios || Q.chrome) && t.state.selection.main.empty && i != o && (l.from > 0 || l.to < t.state.doc.length)) {
              let e = Math.min(i, o),
                s = Math.max(i, o),
                n = l.from - e,
                r = l.to - s;
      ...
      function $i(t, e) {
        ...
        if (e.bounds) {
          let { from: o, to: l } = e.bounds,
            h = n.from,
            a = null;
          (8 === r || (Q.android && e.text.length < l - o)) && ((h = n.to), (a = "end"));
          let c = (function (t, e, i, s) {
            ...
            return (
              "end" == s && (i -= r + Math.max(0, n - Math.min(r, l)) - n),
              r < n && t.length < e.length
                ? ((n -= i <= n && i >= r ? n - i : 0), (l = n + (l - r)), (r = n))
                : l < n && ((n -= i <= n && i >= l ? n - i : 0), (r = n + (r - l)), (l = n)),
              { from: n, toA: r, toB: l }
            );
          })(t.state.doc.sliceString(o, l, _i), e.text, h - o, a);
          c &&
            (Q.chrome && 13 == r && c.toB == c.from + 2 && e.text.slice(c.from, c.toB) == _i + _i && c.toB--,
            (i = { from: o + c.from, to: o + c.toA, insert: s.Text.of(e.text.slice(c.from, c.toB).split(_i)) }));
        } else o && ((!t.hasFocus && t.state.facet(ie)) || o.main.eq(n)) && (o = null);
        if (!i && !o) return !1;
        if (
          (!i && e.typeOver && !n.empty && o && o.main.empty
            ? (i = { from: n.from, to: n.to, insert: t.state.doc.slice(n.from, n.to) })
            : i && i.from >= n.from && i.to <= n.to && (i.from != n.from || i.to != n.to) && n.to - n.from - (i.to - i.from) <= 4
              ...
              : (Q.mac || Q.android) &&
                ...
                ? (o && 2 == i.insert.length && (o = s.EditorSelection.single(o.main.anchor - 1, o.main.head - 1)),
                ...
                : Q.chrome &&
                  ...
                  "\n " == i.insert.toString() &&
                  t.lineWrapping &&
                  (o && (o = s.EditorSelection.single(o.main.anchor - 1, o.main.head - 1)),
                  (i = { from: n.from, to: n.to, insert: s.Text.of([" "]) })),
          i)
        ) {
          if (Q.ios && t.inputState.flushIOSKey(i)) return !0;
          if (
            Q.android &&
            ((i.to == n.to &&
              ...
              1 == i.insert.length &&
              2 == i.insert.lines &&
              T(t.contentDOM, "Enter", 13)) ||
              (((i.from == n.from - 1 && i.to == n.to && 0 == i.insert.length) || (8 == r && i.insert.length < i.to - i.from && i.to > n.head)) &&
                T(t.contentDOM, "Backspace", 8)) ||
              (i.from == n.from && i.to == n.to + 1 && 0 == i.insert.length && T(t.contentDOM, "Delete", 46)))
          )
            return !0;
          let e,
            l = i.insert.toString();
              ...
              if (
                ...
                if (n.selection.ranges.length > 1 && t.inputState.composing >= 0 && e.to <= r.to && e.to >= r.to - 10) {
                  let a,
                    ...
                    d = i && xe(t, i.main.head);
                  if (d) {
                    let t = e.insert.length - (e.to - e.from);
                    a = { from: d.from, to: d.to - t };
                  } else a = t.state.doc.lineAt(r.head);
                  let u = r.to - e.to,
                    f = r.to - r.from;
                  o = n.changeByRange((i) => {
                    if (i.from == r.from && i.to == r.to) return { changes: l, range: h || i.map(l) };
                    let o = i.to - u,
                      d = o - c.length;
                    if (i.to - i.from != f || t.state.sliceDoc(d, o) != c || (i.to >= a.from && i.from <= a.to)) return { range: i };
                    let p = n.changes({ from: d, to: o, insert: e.insert }),
                      g = i.to - r.to;
                    return { changes: p, range: h ? s.EditorSelection.range(Math.max(0, h.anchor + g), Math.max(0, h.head + g)) : i.map(p) };
                  });
                } else o = { changes: l, selection: h && n.selection.replaceRange(h) };
              }
              let l = "input.type";
              return (
                (t.composing || (t.inputState.compositionPendingChange && t.inputState.compositionEndedAt > Date.now() - 50)) &&
                  ...
                  (l += ".compose"),
                  t.inputState.compositionFirstChange && ((l += ".start"), (t.inputState.compositionFirstChange = !1))),
                n.update(o, { userEvent: l, scrollIntoView: !0 })
              );
            })(t, i, o));
          return t.state.facet(Gt).some((e) => e(t, i.from, i.to, l, h)) || t.dispatch(h()), !0;
        }
        if (o && !o.main.eq(n)) {
          let e = !1,
            i = "select";
      ...
      const Qi = { childList: !0, characterData: !0, subtree: !0, attributes: !0, characterDataOldValue: !0 },
        Ji = Q.ie && Q.ie_version <= 11;
      class Zi {
        constructor(t) {
          (this.view = t),
            (this.active = !1),
            (this.selectionRange = new M()),
            ...
            (this.observer = new MutationObserver((e) => {
              ...
              e.some(
                (t) =>
                  ("childList" == t.type && t.removedNodes.length) || ("characterData" == t.type && t.oldValue.length > t.target.nodeValue.length)
              )
                ? this.flushSoon()
                : this.flush();
            })),
        ...
        onSelectionChange(t) {
          ...
          if (i.state.facet(ie) ? i.root.activeElement != this.dom : !f(i.dom, s)) return;
          ...
          o && o.ignoreEvent(t)
            ...
            : ((Q.ie && Q.ie_version <= 11) || (Q.android && Q.chrome)) &&
                ...
                s.focusNode &&
                g(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset)
              ? this.flushSoon()
              : this.flush(!1);
        }
        readSelectionRange() {
            ...
            e =
              (Q.safari &&
                ...
                (function (t) {
                  ...
                  return g(l.node, l.offset, n, r) && ([s, o, n, r] = [n, r, s, o]), { anchorNode: s, anchorOffset: o, focusNode: n, focusOffset: r };
                })(this.view)) ||
              d(t.root);
          ...
          return i &&
            ...
            (function (t, e) {
              ...
              for (s = Math.min(s, b(i)); ; )
                if (s) {
                  if (1 != i.nodeType) return !1;
                  let t = i.childNodes[s - 1];
                  "false" == t.contentEditable ? s-- : ((i = t), (s = b(i)));
                } else {
                  if (i == t) return !0;
                  (s = m(i)), (i = i.parentNode);
                }
        ...
        start() {
          this.active ||
            (this.observer.observe(this.dom, Qi), Ji && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), (this.active = !0));
        }
        stop() {
          this.active &&
            ((this.active = !1), this.observer.disconnect(), Ji && this.dom.removeEventListener("DOMCharacterDataModified", this.onCharData));
        }
        clear() {
          ...
          if (!this.delayedAndroidKey) {
            let t = () => {
              ...
              t &&
                ...
                !this.flush() && t.force && T(this.dom, t.key, t.keyCode));
            };
        ...
        readMutation(t) {
          ...
          if ((e.markDirty("attributes" == t.type), "attributes" == t.type && (e.flags |= 4), "childList" == t.type)) {
            let i = ts(e, t.previousSibling || t.target.previousSibling, -1),
              s = ts(e, t.nextSibling || t.target.nextSibling, 1);
            return { from: i ? e.posAfter(i) : e.posAtStart, to: s ? e.posBefore(s) : e.posAtEnd, typeOver: !1 };
          }
      ...
      class es {
        ...
        constructor(t = {}) {
          ...
          (this.dispatchTransactions = t.dispatchTransactions || (e && ((t) => t.forEach((t) => e(t, this)))) || ((t) => this.update(t))),
            ...
            (this._root =
              ...
              document),
            (this.viewState = new Oi(t.state || s.EditorState.create(t))),
            t.scrollTo && t.scrollTo.is(te) && (this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state)),
            (this.plugins = this.state.facet(oe).map((t) => new re(t)));
          for (let t of this.plugins) t.update(this);
          (this.observer = new Zi(this)),
            (this.inputState = new Ne(this)),
        ...
        dispatch(...t) {
          let e = 1 == t.length && t[0] instanceof s.Transaction ? t : 1 == t.length && Array.isArray(t[0]) ? t[0] : [this.state.update(...t)];
        ...
        update(t) {
          ...
          let e,
            ...
            n = this.state;
          for (let e of t) {
            if (e.startState != n) throw new RangeError("Trying to update state with a transaction that doesn't start from the previous state.");
            n = e.state;
          }
          ...
          let r = this.hasFocus,
            l = 0,
            h = null;
          t.some((t) => t.annotation(li))
            ? ((this.inputState.notifiedFocused = r), (l = 1))
            : r != this.inputState.notifiedFocused && ((this.inputState.notifiedFocused = r), (h = hi(n, r)), h || (l = 1));
          ...
          if (
            (a
              ? (this.observer.clearDelayedAndroidKey(),
                ...
                ((c && !this.state.doc.eq(n.doc)) || !this.state.selection.eq(n.selection)) && (c = null))
              : this.observer.clear(),
            n.facet(s.EditorState.phrases) != this.state.facet(s.EditorState.phrases))
          )
          ...
          try {
            ...
            for (let e of t) {
              if ((d && (d = d.map(e.changes)), e.scrollIntoView)) {
                ...
                d = new Zt(t.empty ? t : s.EditorSelection.cursor(t.head, t.head > t.anchor ? -1 : 1));
              }
              for (let t of e.effects) t.is(te) && (d = t.value.clip(this.state));
            }
            this.viewState.update(e, d),
              (this.bidiCache = os.update(this.bidiCache, e.changes)),
          ...
          if (
            (e.startState.facet(Ni) != e.state.facet(Ni) && (this.viewState.mustMeasureContent = !0),
            (i || o || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(),
            i && this.docViewUpdate(),
            !e.empty)
          )
            for (let t of this.state.facet(jt))
              try {
                t(e);
              } catch (t) {
                ee(this.state, t, "update listener");
              }
          (h || c) &&
            Promise.resolve().then(() => {
              h && this.state == h.startState && this.dispatch(h), c && !$i(this, c) && a.force && T(this.contentDOM, a.key, a.keyCode);
            });
        }
        setState(t) {
          ...
          try {
            ...
            (this.viewState = new Oi(t)), (this.plugins = t.facet(oe).map((t) => new re(t))), this.pluginMap.clear();
            for (let t of this.plugins) t.update(this);
        ...
        updatePlugins(t) {
          let e = t.startState.facet(oe),
            i = t.state.facet(oe);
          if (e != i) {
            let s = [];
            for (let o of i) {
              let i = e.indexOf(o);
              if (i < 0) s.push(new re(o));
              else {
          ...
          for (let t of this.plugins) {
            ...
            if (e && e.docViewUpdate)
              try {
                ...
                ee(this.state, t, "doc view update listener");
              }
          }
        }
        measure(t = !0) {
          ...
          try {
            for (let t = 0; ; t++) {
              if (n < 0)
                if (E(i)) (o = -1), (n = this.viewState.heightMap.height);
                else {
              ...
              let h = l.map((t) => {
                  try {
                    ...
                    return ee(this.state, t), ss;
                  }
                }),
                a = ve.create(this, this.state, []),
                c = !1;
              (a.flags |= r),
                e ? (e.flags |= r) : (e = a),
                (this.updateState = 2),
                a.empty ||
                  (this.updatePlugins(a), this.inputState.update(a), this.updateAttrs(), (c = this.docView.update(a)), c && this.docViewUpdate());
          ...
          if (e && !e.empty) for (let t of this.state.facet(jt)) t(e);
        }
        get themeClasses() {
          return Wi + " " + (this.state.facet(Fi) ? Ki : zi) + " " + this.state.facet(Ni);
        }
        updateAttrs() {
          let t = ns(this, le, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }),
            e = {
              spellcheck: "false",
              autocorrect: "off",
              autocapitalize: "off",
          ...
          this.state.readOnly && (e["aria-readonly"] = "true"), ns(this, he, e);
          let i = this.observer.ignore(() => {
            let i = ht(this.contentDOM, this.contentAttrs, e),
              s = ht(this.dom, this.editorAttrs, t);
            return i || s;
          });
        ...
        mountStyles() {
          ...
          let t = this.state.facet(es.cspNonce);
          o.V.mount(this.root, this.styleModules.concat(Yi).reverse(), t ? { nonce: t } : void 0);
        }
        readMeasured() {
        ...
        plugin(t) {
          ...
          return (
            (void 0 === e || (e && e.spec != t)) && this.pluginMap.set(t, (e = this.plugins.find((e) => e.spec == t) || null)),
        ...
        moveByChar(t, e, i) {
          return Ve(this, t, Pe(this, t, e, i));
        }
        moveByGroup(t, e) {
          return Ve(
            this,
            ...
            Pe(this, t, e, (e) =>
              (function (t, e, i) {
                ...
                return (t) => {
                  let e = o(t);
                  return n == s.CharCategory.Space && (n = e), n == e;
                };
              })(this, t.head, e)
            )
          );
        ...
        moveToLineBoundary(t, e, i = !0) {
          return (function (t, e, i, o) {
            let n = Le(t, e.head),
              r =
                o && n.type == ft.Text && (t.lineWrapping || n.widgetLineBreaks)
                  ? t.coordsAtPos(e.assoc < 0 && e.head > n.from ? e.head - 1 : e.head)
                  : null;
            if (r) {
              let e = t.dom.getBoundingClientRect(),
                o = t.textDirectionAt(n.from),
                l = t.posAtCoords({ x: i == (o == Mt.LTR) ? e.right - 1 : e.left + 1, y: (r.top + r.bottom) / 2 });
              if (null != l) return s.EditorSelection.cursor(l, i ? -1 : 1);
            }
        ...
        moveVertically(t, e, i) {
          return Ve(
            ...
            (function (t, e, i, o) {
              ...
              let u = a.left + h,
                f = null != o ? o : t.viewState.heightOracle.textHeight >> 1;
              for (let e = 0; ; e += 10) {
                let i = l + (f + e) * r,
                  o = Re(t, { x: u, y: i }, !1, r);
                if (i < a.top || i > a.bottom || (r < 0 ? o < n : o > n)) {
                  let e = t.docView.coordsForChar(o),
                    n = !e || i < e.top ? -1 : 1;
                  return s.EditorSelection.cursor(o, n, void 0, h);
                }
              }
            })(this, t, e, i)
          );
        ...
        coordsAtPos(t, e = 1) {
          ...
          let s = this.state.doc.lineAt(t),
            o = this.bidiSpans(s);
          return y(i, (o[Lt.find(o, t - s.from, -1, e)].dir == Mt.LTR) == e > 0);
        }
        coordsForChar(t) {
        ...
        textDirectionAt(t) {
          return !this.state.facet($t) || t < this.viewport.from || t > this.viewport.to
            ? this.textDirection
        ...
        bidiSpans(t) {
          if (t.length > is) return Wt(t.length);
          let e,
            i = this.textDirectionAt(t.from);
          for (let s of this.bidiCache) if (s.from == t.from && s.dir == i && (s.fresh || Pt(s.isolates, (e = fe(this, t))))) return s.order;
          e || (e = fe(this, t));
          let s = Ft(t.text, i, e);
          return this.bidiCache.push(new os(t.from, t.to, i, e, !0, s)), s;
        }
        get hasFocus() {
          var t;
          return (
            (this.dom.ownerDocument.hasFocus() ||
              (Q.safari && (null === (t = this.inputState) || void 0 === t ? void 0 : t.lastContextMenu) > Date.now() - 3e4)) &&
        ...
        setRoot(t) {
          this._root != t &&
            ((this._root = t), this.observer.setWindow((9 == t.nodeType ? t : t.ownerDocument).defaultView || window), this.mountStyles());
        }
        destroy() {
          for (let t of this.plugins) t.destroy(this);
          (this.plugins = []),
        ...
        static scrollIntoView(t, e = {}) {
          return te.of(new Zt("number" == typeof t ? s.EditorSelection.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
        }
        scrollSnapshot() {
          let { scrollTop: t, scrollLeft: e } = this.scrollDOM,
            i = this.viewState.scrollAnchorAt(t);
          return te.of(new Zt(s.EditorSelection.cursor(i.from), "start", "start", i.top - t, e, !0));
        }
        ...
        static theme(t, e) {
          let i = o.V.newName(),
            s = [Ni.of(i), me.of(qi(`.${i}`, t))];
          return e && e.dark && s.push(Fi.of(!0)), s;
        }
        static baseTheme(t) {
          return s.Prec.lowest(me.of(qi("." + Wi, t, Ii)));
        }
      ...
      (es.styleModule = me),
        (es.inputHandler = Gt),
        (es.scrollHandler = Jt),
        (es.focusChangeEffect = Ut),
        (es.perLineTextDirection = $t),
        (es.exceptionSink = Xt),
        (es.updateListener = jt),
        (es.editable = ie),
        (es.mouseSelectionStyle = _t),
        (es.dragMovesSelection = Yt),
        (es.clickAddsSelectionRange = qt),
        (es.decorations = ae),
        (es.outerDecorations = ce),
        (es.atomicRanges = de),
        (es.bidiIsolatedRanges = ue),
        (es.scrollMargins = pe),
        (es.darkTheme = Fi),
        (es.cspNonce = s.Facet.define({ combine: (t) => (t.length ? t[0] : "") })),
        (es.contentAttributes = he),
        (es.editorAttributes = le),
        (es.lineWrapping = es.contentAttributes.of({ class: "cm-lineWrapping" })),
        (es.announce = s.StateEffect.define());
      const is = 4096,
        ss = {};
      class os {
        ...
        static update(t, e) {
          ...
          let i = [],
            s = t.length ? t[t.length - 1].dir : Mt.LTR;
          for (let o = Math.max(0, t.length - 10); o < t.length; o++) {
            let n = t[o];
            n.dir != s || e.touchesRange(n.from, n.to) || i.push(new os(e.mapPos(n.from, 1), e.mapPos(n.to, -1), n.dir, n.isolates, !1, n.order));
          }
          return i;
        }
      }
      ...
      const rs = Q.mac ? "mac" : Q.windows ? "win" : Q.linux ? "linux" : "key";
      function ls(t, e, i) {
        return (
          e.altKey && (t = "Alt-" + t),
          e.ctrlKey && (t = "Ctrl-" + t),
      ...
      const hs = s.Prec.default(es.domEventHandlers({ keydown: (t, e) => gs(ds(e.state), t, e, "editor") })),
        as = s.Facet.define({ enables: hs }),
        cs = new WeakMap();
      function ds(t) {
        let e = t.facet(as),
          i = cs.get(e);
                      ...
                      o(i, !0),
                        c[i] ||
                          (c[i] = {
                            ...
                            run: [
                              (e) => {
                                let s = (fs = { view: e, prefix: i, scope: t });
                                return (
                                  setTimeout(() => {
                                    fs == s && (fs = null);
                                  }, ps),
                ...
                for (let s of t) {
                  ...
                  if (s.any)
                    for (let e of t) {
                      ...
                      for (let e in t) t[e].run.push(s.any);
                    }
                  let o = s[e] || s.key;
                  if (o)
                    for (let e of t)
                      n(e, o, s.run, s.preventDefault, s.stopPropagation),
                        s.shift && n(e, "Shift-" + o, s.shift, s.preventDefault, s.stopPropagation);
                }
                return i;
      ...
      function gs(t, e, i, o) {
        let a = (function (t) {
            var e =
              (!(
                (l && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
                (h && t.shiftKey && t.key && 1 == t.key.length) ||
                "Unidentified" == t.key
              ) &&
                t.key) ||
          ...
          c = (0, s.codePointAt)(a, 0),
          d = (0, s.codePointSize)(c) == a.length && " " != a,
          u = "",
          f = !1,
          p = !1,
          g = !1;
        fs && fs.view == i && fs.scope == o && ((u = fs.prefix + " "), Ie.indexOf(e.keyCode) < 0 && ((p = !0), (fs = null)));
        let m,
          w,
          v = new Set(),
          b = (t) => {
            if (t) {
              for (let s of t.run) if (!v.has(s) && (v.add(s), s(i, e))) return t.stopPropagation && (g = !0), !0;
              t.preventDefault && (t.stopPropagation && (g = !0), (p = !0));
            }
            return !1;
          },
          y = t[o];
        return (
          y &&
            (b(y[u + ls(a, e, !d)])
              ? (f = !0)
              : d && (e.altKey || e.metaKey || e.ctrlKey) && !(Q.windows && e.ctrlKey && e.altKey) && (m = n[e.keyCode]) && m != a
                ? (b(y[u + ls(m, e, !0)]) || (e.shiftKey && (w = r[e.keyCode]) != a && w != m && b(y[u + ls(w, e, !1)]))) && (f = !0)
                : d && e.shiftKey && b(y[u + ls(a, e, !0)]) && (f = !0),
            !f && b(y._any) && (f = !0)),
          p && (f = !0),
          f && g && e.stopPropagation(),
          f
        );
      }
      class ms {
        ...
        static forRange(t, e, i) {
          ...
          return (function (t, e, i) {
            ...
            let s = Math.max(i.from, t.viewport.from),
              ...
              f = Le(t, s),
              p = Le(t, o),
              g = f.type == ft.Text ? f : null,
              m = p.type == ft.Text ? p : null;
            if (
              (g && (t.lineWrapping || f.widgetLineBreaks) && (g = vs(t, s, g)),
              m && (t.lineWrapping || p.widgetLineBreaks) && (m = vs(t, o, m)),
              g && m && g.from == m.from)
            )
              return v(b(i.from, i.to, g));
            {
              let e = g ? b(i.from, null, g) : y(f, !1),
                ...
                o = [];
              return (
                (g || f).to < (m || p).from - (g && m ? 1 : 0) || (f.widgetLineBreaks > 1 && e.bottom + t.defaultLineHeight / 2 < s.top)
                  ? o.push(w(d, e.bottom, u, s.top))
                  : e.bottom < s.top && t.elementAtHeight((e.bottom + s.top) / 2).type == ft.Text && (e.bottom = s.top = (e.bottom + s.top) / 2),
                v(e).concat(o).concat(v(s))
              );
            }
            function w(t, i, s, o) {
              return new ms(e, t - h.left, i - h.top - 0.01, s - t, o - i + 0.01);
            }
            ...
            function b(e, i, s) {
              ...
              function h(e, i, h, a, c) {
                ...
                f &&
                  ...
                  c == Mt.LTR ? l.push(n && i ? d : f.left, n && a ? u : p.right) : l.push(!n && a ? d : p.left, !n && i ? u : f.right));
              }
              ...
              for (let s of t.visibleRanges)
                if (s.to > a && s.from < c)
                  for (let o = Math.max(s.from, a), n = Math.min(s.to, c); ; ) {
                    ...
                    if (((o = s.to + 1), o >= n)) break;
                  }
              return 0 == l.length && h(a, null == e, c, null == i, t.textDirection), { top: o, bottom: r, horizontal: l };
            }
            function y(t, e) {
      ...
      function ws(t) {
        ...
        return {
          left: (t.textDirection == Mt.LTR ? e.left : e.right - t.scrollDOM.clientWidth * t.scaleX) - t.scrollDOM.scrollLeft * t.scaleX,
      ...
      function vs(t, e, i) {
        ...
        return {
          from: Math.max(i.from, t.moveToLineBoundary(o, !1, !0).from),
          to: Math.min(i.to, t.moveToLineBoundary(o, !0, !0).from),
          type: ft.Text,
        };
      }
      class bs {
        ...
        update(t) {
          t.startState.facet(ys) != t.state.facet(ys) && this.setOrder(t.state),
            (this.layer.update(t, this.dom) || t.geometryChanged) && (this.scale(), t.view.requestMeasure(this.measureReq));
        }
        docViewUpdate(t) {
        ...
        draw(t) {
          if (
            ...
            let e = this.dom.firstChild,
              i = 0;
            for (let s of t)
              s.update && e && s.constructor && this.drawn[i].constructor && s.update(e, this.drawn[i])
                ? ((e = e.nextSibling), i++)
      ...
      const ys = s.Facet.define();
      function Ss(t) {
        return [ne.define((e) => new bs(e, t)), ys.of(t)];
      }
      const xs = !Q.ios,
        Ms = s.Facet.define({
          combine: (t) =>
      ...
      function Cs(t = {}) {
        return [Ms.of(t), Ds, Os, Rs, Qt.of(!0)];
      }
      function ks(t) {
        return t.facet(Ms);
      }
      function As(t) {
        return t.startState.facet(Ms) != t.state.facet(Ms);
      }
      const Ds = Ss({
        above: !0,
        markers(t) {
          ...
          for (let n of e.selection.ranges) {
            ...
            if (n.empty ? !r || xs : i.drawRangeCursor) {
              let e = r ? "cm-cursor cm-cursor-primary" : "cm-cursor cm-cursor-secondary",
                i = n.empty ? n : s.EditorSelection.cursor(n.head, n.head > n.anchor ? -1 : 1);
              for (let s of ms.forRange(t, e, i)) o.push(s);
            }
          }
          return o;
        },
        update(t, e) {
          ...
          let i = As(t);
          return i && Ts(t.state, e), t.docChanged || t.selectionSet || i;
        },
        mount(t, e) {
          Ts(e.state, t);
        },
      ...
      function Ts(t, e) {
        e.style.animationDuration = t.facet(Ms).cursorBlinkRate + "ms";
      }
      const Os = Ss({
          above: !1,
          markers: (t) =>
            t.state.selection.ranges.map((e) => (e.empty ? [] : ms.forRange(t, "cm-selectionBackground", e))).reduce((t, e) => t.concat(e)),
          update: (t, e) => t.docChanged || t.selectionSet || t.viewportChanged || As(t),
      ...
      xs && ((Es[".cm-line"].caretColor = "transparent !important"), (Es[".cm-content"] = { caretColor: "transparent !important" }));
      const Rs = s.Prec.highest(es.theme(Es)),
        Bs = s.StateEffect.define({ map: (t, e) => (null == t ? null : e.mapPos(t)) }),
        Ls = s.StateField.define({
          create: () => null,
          update: (t, e) => (null != t && (t = e.changes.mapPos(t)), e.effects.reduce((t, e) => (e.is(Bs) ? e.value : t), t)),
        }),
        Ps = ne.fromClass(
          class {
            constructor(t) {
            ...
            update(t) {
              var e;
              let i = t.state.field(Ls);
              null == i
                ? null != this.cursor && (null === (e = this.cursor) || void 0 === e || e.remove(), (this.cursor = null))
                : (this.cursor ||
                    ((this.cursor = this.view.scrollDOM.appendChild(document.createElement("div"))), (this.cursor.className = "cm-dropCursor")),
                  (t.startState.field(Ls) != i || t.docChanged || t.geometryChanged) && this.view.requestMeasure(this.measureReq));
            }
            readPos() {
              let { view: t } = this,
                e = t.state.field(Ls),
            ...
            setDropPos(t) {
              this.view.state.field(Ls) != t && this.view.dispatch({ effects: Bs.of(t) });
            }
          },
          {
            eventObservers: {
      ...
      function Vs(t, e, i, s, o) {
        e.lastIndex = 0;
        for (let n, r = t.iterRange(i, s), l = i; !r.next().done; l += r.value.length)
          if (!r.lineBreak) for (; (n = e.exec(r.value)); ) o(l + n.index, n);
      }
      class Ns {
        constructor(t) {
          ...
          for (let { from: e, to: s } of (function (t, e) {
            ...
            for (let { from: o, to: n } of i)
              (o = Math.max(t.state.doc.lineAt(o).from, o - e)),
                ...
                s.length && s[s.length - 1].to >= o ? (s[s.length - 1].to = n) : s.push({ from: o, to: n });
            return s;
          })(t, this.maxLength))
            Vs(t.state.doc, this.regexp, e, s, (e, s) => this.addMatch(s, t, e, i));
          return e.finish();
        }
        updateDeco(t, e) {
          let i = 1e9,
        ...
        updateRange(t, e, i, s) {
          for (let o of t.visibleRanges) {
            ...
            if (r > n) {
              ...
              if (i == s)
                for (this.regexp.lastIndex = l - i.from; (a = this.regexp.exec(i.text)) && a.index < h - i.from; )
                  this.addMatch(a, t, a.index + i.from, d);
              else Vs(t.state.doc, this.regexp, l, h, (e, i) => this.addMatch(i, t, e, d));
              e = e.update({ filterFrom: l, filterTo: h, filter: (t, e) => t < l || e > h, add: c });
            }
          }
          return e;
        }
      ...
      let Ks = null;
      const Is = s.Facet.define({
        combine(t) {
          let e = (0, s.combineConfig)(t, { render: null, specialChars: Ws, addSpecialChars: null });
          return (
            (e.replaceTabs = !(function () {
              var t;
              if (null == Ks && "undefined" != typeof document && document.body) {
                let e = document.body.style;
                Ks = null != (null !== (t = e.tabSize) && void 0 !== t ? t : e.MozTabSize);
              }
              return Ks || !1;
            })()) && (e.specialChars = new RegExp("\t|" + e.specialChars.source, Fs)),
            e.addSpecialChars && (e.specialChars = new RegExp(e.specialChars.source + "|" + e.addSpecialChars.source, Fs)),
            e
          );
        },
      });
              ...
              class {
                constructor(t) {
                  (this.view = t),
                    ...
                    (this.decorator = this.makeDecorator(t.state.facet(Is))),
                ...
                makeDecorator(t) {
                  return new Ns({
                    ...
                    decoration: (e, i, o) => {
                      let { doc: n } = i.state,
                        r = (0, s.codePointAt)(e[0], 0);
                      if (9 == r) {
                        let t = n.lineAt(o),
                          e = i.state.tabSize,
                          r = (0, s.countColumn)(t.text, e, o - t.from);
                        return pt.replace({ widget: new Xs(((e - (r % e)) * this.view.defaultCharacterWidth) / this.view.scaleX) });
                      }
                      return this.decorationCache[r] || (this.decorationCache[r] = pt.replace({ widget: new _s(t, r) }));
                    },
                    boundary: t.replaceTabs ? void 0 : /[^]/,
                  });
                }
                update(t) {
                  let e = t.state.facet(Is);
                  t.startState.facet(Is) != e
      ...
      const js = ne.fromClass(
        class {
          ...
          update(t) {
            let { view: e } = t,
              i = e.viewState.editorHeight * e.scaleY - e.defaultLineHeight - e.documentPadding.top - 0.5;
      ...
      function Gs() {
        return [
          ...
          he.of((t) => {
            var e;
            return (null === (e = t.plugin(js)) || void 0 === e ? void 0 : e.attrs) || null;
          }),
        ];
      }
      function Us() {
      ...
      const $s = pt.line({ class: "cm-activeLine" }),
        Qs = ne.fromClass(
          class {
            constructor(t) {
            ...
            getDeco(t) {
              ...
              for (let s of t.state.selection.ranges) {
                ...
                o.from > e && (i.push($s.range(o.from)), (e = o.from));
              }
              return pt.set(i);
            }
          },
      ...
      class Js extends ut {
        ...
        coordsAt(t) {
          let e = t.firstChild ? p(t.firstChild) : [];
          if (!e.length) return null;
          let i = window.getComputedStyle(t.parentNode),
            s = y(e[0], "rtl" != i.direction),
            o = parseInt(i.lineHeight);
          return s.bottom - s.top > 1.5 * o ? { left: s.left, right: s.right, top: s.top, bottom: s.top + o } : s;
        }
        ignoreEvent() {
          return !1;
        }
      ...
      function Zs(t) {
        return ne.fromClass(
          class {
            constructor(e) {
              (this.view = e), (this.placeholder = t ? pt.set([pt.widget({ widget: new Js(t), side: 1 }).range(0)]) : pt.none);
            }
            get decorations() {
      ...
      function io(t) {
        ...
        return es.mouseSelectionStyle.of((t, i) =>
          e(i)
            ? (function (t, e) {
                let i = eo(t, e),
                  o = t.state.selection;
                  ...
                  ? {
                      update(t) {
                        if (t.docChanged) {
                          ...
                          (i = { line: s.number, col: i.col, off: Math.min(i.off, s.length) }), (o = o.map(t.changes));
                        }
                      },
                      get(e, n, r) {
                        let l = eo(t, e);
                        ...
                        let h = (function (t, e, i) {
                          let o = Math.min(e.line, i.line),
                            ...
                            r = [];
                          if (e.off > to || i.off > to || e.col < 0 || i.col < 0) {
                            let l = Math.min(e.off, i.off),
                              h = Math.max(e.off, i.off);
                            for (let e = o; e <= n; e++) {
                              let i = t.doc.line(e);
                              i.length <= h && r.push(s.EditorSelection.range(i.from + l, i.to + h));
                            }
                          } else {
                            ...
                            for (let e = o; e <= n; e++) {
                              let i = t.doc.line(e),
                                o = (0, s.findColumn)(i.text, l, t.tabSize, !0);
                              if (o < 0) r.push(s.EditorSelection.cursor(i.to));
                              else {
                                let e = (0, s.findColumn)(i.text, h, t.tabSize);
                        ...
                        return h.length ? (r ? s.EditorSelection.create(h.concat(o.ranges)) : s.EditorSelection.create(h)) : o;
                      },
                    }
                  : null;
              })(t, i)
      ...
      const so = {
        ...
        oo = { style: "cursor: crosshair" };
      function no(t = {}) {
        let [e, i] = so[t.key || "Alt"],
          s = ne.fromClass(
            class {
              constructor(t) {
        ...
        update(t, e) {
          ...
          for (let i = 0; i < o.length; i++) {
            ...
            if (s) {
              ...
              if (l < 0) (n[i] = this.createTooltipView(s, i ? n[i - 1] : null)), r && (r[i] = !!s.above);
              else {
          ...
          for (let t of this.tooltipViews) n.indexOf(t) < 0 && (this.removeTooltipView(t), null === (i = t.destroy) || void 0 === i || i.call(t));
      ...
      const co = s.Facet.define({
          combine: (t) => {
            var e, i, s;
            return {
              position: Q.ios ? "absolute" : (null === (e = t.find((t) => t.position)) || void 0 === e ? void 0 : e.position) || "fixed",
              parent: (null === (i = t.find((t) => t.parent)) || void 0 === i ? void 0 : i.parent) || null,
              tooltipSpace: (null === (s = t.find((t) => t.tooltipSpace)) || void 0 === s ? void 0 : s.tooltipSpace) || ao,
            };
          },
        }),
        uo = new WeakMap(),
          ...
          class {
            ...
            createTooltip(t, e) {
              ...
              if ((i.dom.classList.add("cm-tooltip"), t.arrow && !i.dom.querySelector(".cm-tooltip > .cm-tooltip-arrow"))) {
                let t = document.createElement("div");
                (t.className = "cm-tooltip-arrow"), i.dom.insertBefore(t, s);
              }
              return (
            ...
            destroy() {
              ...
              this.parent && this.container.remove(),
                ...
                null === (i = this.intersectionObserver) || void 0 === i || i.disconnect(),
            ...
            readMeasure() {
              ...
              if ("fixed" == this.position && this.manager.tooltipViews.length) {
                ...
                if (Q.gecko) s = t.offsetParent != this.container.ownerDocument.body;
              ...
              if (s || "absolute" == this.position)
                ...
                } else ({ scaleX: e, scaleY: i } = this.view.viewState);
              return {
                editor: t,
            ...
            writeMeasure(t) {
              ...
              for (let l = 0; l < this.manager.tooltips.length; l++) {
                ...
                let f = h.arrow ? a.dom.querySelector(".cm-tooltip-arrow") : null,
                  p = f ? 7 : 0,
                  g = u.right - u.left,
                  m = null !== (e = uo.get(a)) && void 0 !== e ? e : u.bottom - u.top,
                  w = a.offset || go,
                  v = this.view.textDirection == Mt.LTR,
                  b =
                  ...
                  y = this.above[l];
                !h.strictSide &&
                  (y ? d.top - (u.bottom - u.top) - w.y < s.top : d.bottom + (u.bottom - u.top) + w.y > s.bottom) &&
                  y == s.bottom - d.bottom > d.top - s.top &&
                  (y = this.above[l] = !y);
                let S = (y ? d.top - s.top : s.bottom - d.bottom) - p;
                if (S < m && !1 !== a.resize) {
                  if (S < this.view.defaultLineHeight) {
                    c.style.top = ro;
                    continue;
                  }
                  uo.set(a, m), (c.style.height = (m = S) / n + "px");
                } else c.style.height && (c.style.height = "");
                let x = y ? d.top - m - p - w.y : d.bottom + p + w.y,
                  M = b + g;
                if (!0 !== a.overlap)
                  for (let t of r) t.left < M && t.right > b && t.top < x + m && t.bottom > x && (x = y ? t.top - m - 2 - p : t.bottom + p + 2);
                if (
                  ("absolute" == this.position
                    ? ((c.style.top = (x - t.parent.top) / n + "px"), (c.style.left = (b - t.parent.left) / o + "px"))
                    : ((c.style.top = x / n + "px"), (c.style.left = b / o + "px")),
                  f)
                ) {
                  let t = d.left + (v ? w.x : -w.x) - (b + 14 - 7);
                  f.style.left = t / o + "px";
                }
                !0 !== a.overlap && r.push({ left: b, top: x, right: M, bottom: x + m }),
        ...
        go = { x: 0, y: 0 },
        mo = s.Facet.define({ enables: [fo, po] }),
        wo = s.Facet.define({ combine: (t) => t.reduce((t, e) => t.concat(e), []) });
      class vo {
        static create(t) {
          return new vo(t);
        }
      ...
      class yo {
        ...
        startHover() {
          ...
          let s,
            o = 1;
          if (i instanceof tt) s = i.posAtStart;
          else {
          ...
          if (null == n ? void 0 : n.then) {
            ...
            n.then(
              (i) => {
                this.pending == e &&
                  ((this.pending = null),
                  !i || (Array.isArray(i) && !i.length) || t.dispatch({ effects: this.setHover.of(Array.isArray(i) ? i : [i]) }));
              },
              (e) => ee(t.state, e, "hover tooltip")
            );
          } else !n || (Array.isArray(n) && !n.length) || t.dispatch({ effects: this.setHover.of(Array.isArray(n) ? n : [n]) });
        }
        get tooltip() {
          let t = this.view.plugin(fo),
        ...
        mousemove(t) {
          ...
          if (
            (s.length &&
              ...
              !(function (t, e) {
                let i = t.getBoundingClientRect();
                return e.clientX >= i.left - So && e.clientX <= i.right + So && e.clientY >= i.top - So && e.clientY <= i.bottom + So;
              })(o.dom, t)) ||
            this.pending
          ) {
            let { pos: o } = s[0] || this.pending,
              n = null !== (i = null === (e = s[0]) || void 0 === e ? void 0 : e.end) && void 0 !== i ? i : o;
            (o == n
              ...
              : (function (t, e, i, s, o, n) {
                  ...
                  let h = t.posAtCoords({ x: s, y: o }, !1);
                  return h >= e && h <= i;
                })(this.view, o, n, t.clientX, t.clientY)) || (this.view.dispatch({ effects: this.setHover.of([]) }), (this.pending = null));
          }
        }
        mouseleave(t) {
          ...
          if (e.length) {
            let { tooltip: e } = this;
            e && e.dom.contains(t.relatedTarget) ? this.watchTooltipLeave(e.dom) : this.view.dispatch({ effects: this.setHover.of([]) });
          }
        }
        watchTooltipLeave(t) {
          let e = (i) => {
            t.removeEventListener("mouseleave", e),
              this.active.length && !this.view.dom.contains(i.relatedTarget) && this.view.dispatch({ effects: this.setHover.of([]) });
          };
      ...
      function xo(t, e = {}) {
        let i = s.StateEffect.define(),
          o = s.StateField.define({
            create: () => [],
            update(t, o) {
              if (
                t.length &&
                (e.hideOnChange && (o.docChanged || o.selection) ? (t = []) : e.hideOn && (t = t.filter((t) => !e.hideOn(o, t))), o.docChanged)
              ) {
                let e = [];
                for (let i of t) {
              ...
              for (let e of o.effects) e.is(i) && (t = e.value), e.is(ko) && (t = []);
              return t;
            },
            provide: (t) => wo.from(t),
          });
        return [o, ne.define((s) => new yo(s, t, o, i, e.hoverTime || 300)), bo];
      }
      function Mo(t, e) {
        let i = t.plugin(fo);
        if (!i) return null;
      ...
      function Co(t) {
        return t.facet(wo).some((t) => t);
      }
      const ko = s.StateEffect.define(),
        Ao = ko.of(null);
      function Do(t) {
        let e = t.plugin(fo);
        e && e.maybeMeasure();
      ...
      const Ro = ne.fromClass(
        class {
          constructor(t) {
            (this.input = t.state.facet(Po)), (this.specs = this.input.filter((t) => t)), (this.panels = this.specs.map((e) => e(t)));
            let e = t.state.facet(To);
            (this.top = new Bo(t, !0, e.topContainer)),
          ...
          update(t) {
            let e = t.state.facet(To);
            this.top.container != e.topContainer && (this.top.sync([]), (this.top = new Bo(t.view, !0, e.topContainer))),
              this.bottom.container != e.bottomContainer && (this.bottom.sync([]), (this.bottom = new Bo(t.view, !1, e.bottomContainer))),
              this.top.syncClasses(),
              this.bottom.syncClasses();
            let i = t.state.facet(Po);
            if (i != this.input) {
              let e = i.filter((t) => t),
                s = [],
                o = [],
      ...
      const Po = s.Facet.define({ enables: Ro });
      class Ho extends s.RangeValue {
        compare(t) {
          return this == t || (this.constructor == t.constructor && this.eq(t));
        }
        eq(t) {
      ...
      (Ho.prototype.elementClass = ""),
        (Ho.prototype.toDOM = void 0),
        (Ho.prototype.mapMode = s.MapMode.TrackBefore),
      ...
      const Vo = s.Facet.define(),
        ...
        Fo = s.Facet.define();
      function Wo(t) {
        return [Ko(), Fo.of(Object.assign(Object.assign({}, No), t))];
      }
      const zo = s.Facet.define({ combine: (t) => t.some((t) => t) });
      function Ko(t) {
        let e = [Io];
        return t && !1 === t.fixed && e.push(zo.of(!0)), e;
      }
      const Io = ne.fromClass(
        class {
          constructor(t) {
            (this.view = t),
              ...
              (this.gutters = t.state.facet(Fo).map((e) => new Xo(t, e)));
            for (let t of this.gutters) this.dom.appendChild(t.dom);
            (this.fixed = !t.state.facet(zo)),
          ...
          update(t) {
            ...
            t.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px"),
              this.view.state.facet(zo) != !this.fixed && ((this.fixed = !this.fixed), (this.dom.style.position = this.fixed ? "sticky" : "")),
              (this.prevViewport = t.view.viewport);
          }
          syncGutters(t) {
            let e = this.dom.nextSibling;
            t && this.dom.remove();
            let i = s.RangeSet.iter(this.view.state.facet(Vo), this.view.viewport.from),
              o = [],
              n = this.gutters.map((t) => new _o(t, this.view.viewport, -this.view.documentPadding.top));
            for (let t of this.view.viewportLineBlocks)
              if ((o.length && (o = []), Array.isArray(t.type))) {
                let e = !0;
                for (let s of t.type)
                  if (s.type == ft.Text && e) {
                    Yo(i, o, s.from);
                    ...
                    e = !1;
                  } else if (s.widget) for (let t of n) t.widget(this.view, s);
              } else if (t.type == ft.Text) {
                Yo(i, o, t.from);
          ...
          updateGutters(t) {
            let e = t.startState.facet(Fo),
              i = t.state.facet(Fo),
              o =
                t.docChanged ||
                t.heightChanged ||
                t.viewportChanged ||
                !s.RangeSet.eq(t.startState.facet(Vo), t.state.facet(Vo), t.view.viewport.from, t.view.viewport.to);
            if (e == i) for (let e of this.gutters) e.update(t) && (o = !0);
            else {
              o = !0;
              let s = [];
              for (let o of i) {
                let i = e.indexOf(o);
                i < 0 ? s.push(new Xo(this.view, o)) : (this.gutters[i].update(t), s.push(this.gutters[i]));
              }
      ...
      class _o {
        constructor(t, e, i) {
          (this.gutter = t), (this.height = i), (this.i = 0), (this.cursor = s.RangeSet.iter(t.markers, e.from));
        }
        addElement(t, e, i) {
          let { gutter: s } = this,
        ...
        line(t, e, i) {
          let s = [];
          Yo(this.cursor, s, e.from), i.length && (s = s.concat(i));
      ...
      class Xo {
        constructor(t, e) {
          ...
          (this.markers = qo(e.markers(t))),
            e.initialSpacer &&
              ((this.spacer = new jo(t, 0, 0, [e.initialSpacer(t)])),
              this.dom.appendChild(this.spacer.dom),
              (this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none"));
        }
        update(t) {
          let e = this.markers;
          if (((this.markers = qo(this.config.markers(t.view))), this.spacer && this.config.updateSpacer)) {
          ...
          return !s.RangeSet.eq(this.markers, e, i.from, i.to) || (!!this.config.lineMarkerChange && this.config.lineMarkerChange(t));
        }
        destroy() {
      ...
      function Qo(t, e) {
        return t.state.facet(Uo).formatNumber(e, t.state);
      }
      const Jo = Fo.compute([Uo], (t) => ({
        class: "cm-lineNumbers",
        renderEmptyElements: !1,
        markers: (t) => t.state.facet(Go),
        lineMarker: (t, e, i) => (i.some((t) => t.toDOM) ? null : new $o(Qo(t, t.state.doc.lineAt(e.from).number))),
        widgetMarker: () => null,
        lineMarkerChange: (t) => t.startState.facet(Uo) != t.state.facet(Uo),
        initialSpacer: (t) => new $o(Qo(t, tn(t.state.doc.lines))),
        updateSpacer(t, e) {
          let i = Qo(e.view, tn(e.view.state.doc.lines));
          return i == t.number ? t : new $o(i);
        },
        domEventHandlers: t.facet(Uo).domEventHandlers,
      }));
      function Zo(t = {}) {
        return [Uo.of(t), Ko(), Jo];
      }
      function tn(t) {
        let e = 9;
        for (; e < t; ) e = 10 * e + 9;
      ...
      const en = new (class extends Ho {
          constructor() {
            super(...arguments), (this.elementClass = "cm-activeLineGutter");
          }
        })(),
        sn = Vo.compute(["selection"], (t) => {
          let e = [],
            i = -1;
          for (let s of t.selection.ranges) {
            let o = t.doc.lineAt(s.head).from;
            o > i && ((i = o), e.push(en.range(o)));
          }
      ...
      const an = rn(new Ns({ regexp: /\s+$/g, decoration: pt.mark({ class: "cm-trailingSpace" }), boundary: /\S/ }));
      function cn() {
        return an;
      }
      const dn = { HeightMap: wi, HeightOracle: ui, MeasuredHeights: fi, QueryType: gi, ChangedRange: we, computeOrder: Ft, moveVisually: Kt };
    },
    4434: (t, e, i) => {
      i.d(e, { V: () => r });
      const s = "undefined" == typeof Symbol ? "__ͼ" : Symbol.for("ͼ"),
        o = "undefined" == typeof Symbol ? "__styleSet" + Math.floor(1e8 * Math.random()) : Symbol("styleSet"),
        n = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : {};
      class r {
        constructor(t, e) {
          this.rules = [];
          let { finish: i } = e || {};
          ...
          function o(t, e, n, r) {
            ...
            (l.length || a) && n.push((!i || h || r ? t : t.map(i)).join(", ") + " {" + l.join(" ") + "}");
          }
          for (let e in t) o(s(e), t[e], this.rules);
        }
        getRules() {
        ...
        static newName() {
          let t = n[s] || 1;
          return (n[s] = t + 1), "ͼ" + t.toString(36);
        }
        static mount(t, e, i) {
          let s = t[o],
            n = i && i.nonce;
          s ? n && s.setNonce(n) : (s = new h(t, n)), s.mount(Array.isArray(e) ? e : [e]);
        }
      }
      let l = new Map();
      class h {
        constructor(t, e) {
          ...
          if (!t.head && t.adoptedStyleSheets && s.CSSStyleSheet) {
            let e = l.get(i);
            if (e) return (t.adoptedStyleSheets = [e.sheet, ...t.adoptedStyleSheets]), (t[o] = e);
            (this.sheet = new s.CSSStyleSheet()), (t.adoptedStyleSheets = [this.sheet, ...t.adoptedStyleSheets]), l.set(i, this);
          } else {
            (this.styleTag = i.createElement("style")), e && this.styleTag.setAttribute("nonce", e);
            let s = t.head || t;
            s.insertBefore(this.styleTag, s.firstChild);
          }
          (this.modules = []), (t[o] = this);
        }
        mount(t) {
          let e = this.sheet,
            i = 0,
          ...
          for (let o = 0; o < t.length; o++) {
            let n = t[o],
              r = this.modules.indexOf(n);
            if ((r < s && r > -1 && (this.modules.splice(r, 1), s--, (r = -1)), -1 == r)) {
              if ((this.modules.splice(s++, 0, n), e)) for (let t = 0; t < n.rules.length; t++) e.insertRule(n.rules[t], i++);
            } else {
              for (; s < r; ) i += this.modules[s++].rules.length;
              (i += n.rules.length), s++;
            }
          }
          if (!e) {
