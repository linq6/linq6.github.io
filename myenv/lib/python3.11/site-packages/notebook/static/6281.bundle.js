...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [6281],
  {
    81779: (e, t, n) => {
      ...
      var d = n(12930);
      function l(e) {
        var t = { options: { directed: e.isDirected(), multigraph: e.isMultigraph(), compound: e.isCompound() }, nodes: o(e), edges: s(e) };
    ...
    86281: (e, t, n) => {
            ...
            for (const r of n)
              if (
                ...
                if (!c[r].externalConnections && e.children(r) && e.children(r).length > 0) {
                  ...
                  const a = new l.k({ multigraph: !0, compound: !0 })
                  ...
                  d.l.warn("Old graph before copy", i.c(e)),
                    u(r, e, a, r),
                    e.setNode(r, { clusterNode: !0, id: r, clusterData: c[r].clusterData, labelText: c[r].labelText, graph: a }),
        ...
        x = {
          rect: (e, t) => {
            ...
            const n = e
              ...
              i = (0, d.m)((0, d.c)().flowchart.htmlLabels),
              l = n.insert("g").attr("class", "cluster-label"),
              c =
                "markdown" === t.labelType
                  ? (0, o.a)(l, t.labelText, { style: t.labelStyle, useHtmlLabels: i })
                  : l.node().appendChild((0, a.c)(t.labelText, t.labelStyle, void 0, !0));
            let h = c.getBBox();
            ...
            t.width <= h.width + g ? (t.diff = (h.width - t.width) / 2 - t.padding / 2) : (t.diff = -t.padding / 2),
              ...
              i
                ? l.attr("transform", "translate(" + (t.x - h.width / 2) + ", " + (t.y - t.height / 2) + ")")
                : l.attr("transform", "translate(" + t.x + ", " + (t.y - t.height / 2) + ")");
          ...
          roundedWithTitle: (e, t) => {
            const n = e.insert("g").attr("class", t.classes).attr("id", t.id),
              ...
              l = n.append("rect"),
              o = i.node().appendChild((0, a.c)(t.labelText, t.labelStyle, void 0, !0));
            let c = o.getBBox();
            if ((0, d.m)((0, d.c)().flowchart.htmlLabels)) {
            ...
            t.width <= c.width + t.padding ? (t.diff = (c.width + 0 * t.padding - t.width) / 2) : (t.diff = -t.padding / 2),
              ...
              i.attr(
                ...
                "translate(" +
                  (t.x - c.width / 2) +
                  ", " +
                  (t.y - t.height / 2 - t.padding / 3 + ((0, d.m)((0, d.c)().flowchart.htmlLabels) ? 5 : 3)) +
                  ")"
              );
      ...
      const E = async (e, t, n, l, o) => {
          ...
          const g = h.insert("g").attr("class", "clusters"),
            f = h.insert("g").attr("class", "edgePaths"),
            u = h.insert("g").attr("class", "edgeLabels"),
            w = h.insert("g").attr("class", "nodes");
          await Promise.all(
            t.nodes().map(async function (e) {
              ...
              if ((d.l.info("(Insert) Node XXX" + e + ": " + JSON.stringify(t.node(e))), r && r.clusterNode)) {
                ...
                const i = await E(w, r.graph, n, l, t.node(e)),
                  o = i.elem;
                (0, a.u)(r, o),
                  (r.diff = i.diff || 0),
                ...
                t.children(e).length > 0
                  ...
                  : (d.l.info("Node - the non recursive path", e, r.id, r), await (0, a.e)(w, t.node(e), s));
            })
          ),
          ...
          let v = 0;
          return (
            ((e) => m(e, e.children()))(t).forEach(function (e) {
              const n = t.node(e);
            ...
            t.edges().forEach(function (e) {
              ...
              const i = (0, a.g)(f, e, r, c, n, t, l);
              (0, a.h)(r, i);
            }),
            t.nodes().forEach(function (e) {
              const n = t.node(e);
              d.l.info(e, n.type, n.diff), "group" === n.type && (v = n.diff);
            }),
            { elem: h, diff: v }
          );
        },
        N = async (e, t, n, r, l) => {
          (0, a.a)(e, n, r, l),
            ...
            (g = {}),
            (c = {}),
            d.l.warn("Graph at first:", JSON.stringify(i.c(t))),
            ((e, t) => {
              e
                  ...
                  e.edges().forEach(function (t) {
                    ...
                    if ((d.l.warn("Fix XXX", c, "ids:", t.v, t.w, "Translating: ", c[t.v], " --- ", c[t.w]), c[t.v] && c[t.w] && c[t.v] === c[t.w])) {
                      ...
                      (l.label = ""),
                        ...
                        (l.fromCluster = t.v),
                        (o.toCluster = t.v),
                        e.setEdge(r, a, l, t.name + "-cyclic-special"),
                        e.setEdge(a, i, o, t.name + "-cyclic-special");
                    } else
                      (c[t.v] || c[t.w]) &&
                        (d.l.warn("Fixing and trixing - removing XXX", t.v, t.w, t.name),
                        (r = v(t.v)),
            ...
            d.l.warn("Graph after:", JSON.stringify(i.c(t))),
            await E(e, t, r, l);
        };
    },
  },
