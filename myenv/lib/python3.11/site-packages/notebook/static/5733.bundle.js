...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [5733],
  {
    65733: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var _jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1323),
      ...
      class ExperimentalRenderedJavascript extends _jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_0__.RenderedJavaScript {
        render(e) {
          const _ = this.translator.load("jupyterlab"),
            r = () => {
              try {
                const _ = e.data[this.mimeType];
                return _ && evalInContext(_, this.node, document, window), Promise.resolve();
              } catch (e) {
          ...
          if (!e.trusted) {
            ...
            e.textContent = _.__("Are you sure that you want to run arbitrary Javascript within your JupyterLab session?");
            const t = document.createElement("button");
            return (
              (t.textContent = _.__("Run")),
      ...
      const rendererFactory = {
          ...
          createRenderer: (e) => new ExperimentalRenderedJavascript(e),
        },
        extension = {
        ...
        __WEBPACK_DEFAULT_EXPORT__ = extension;
    },
  },
]);
