  ...
  [4105],
  {
    74105: function (t, e, r) {
        ...
        a =
          ...
          function (t, e, r) {
            if (r || 2 === arguments.length)
              for (var i, o = 0, n = e.length; o < n; o++) (!i && o in e) || (i || (i = Array.prototype.slice.call(e, 0, o)), (i[o] = e[o]));
                ...
                if (!this.isEscaped && (t.options.enableAssistiveMml || e)) {
                  var r = t.adaptor,
                    i = t
                      ...
                      .replace(/\n */g, "")
                      .replace(/<!--.*?-->/g, ""),
                    o = r.firstChild(r.body(r.parse(i, "text/html"))),
                    n = r.node("mjx-assistive-mml", { unselectable: "on", display: this.display ? "block" : "inline" }, [o]);
        ...
        return (
          (e = (function (t) {
            function e() {
              ...
              var i = t.apply(this, a([], s(e), !1)) || this,
                o = i.constructor,
                n = o.ProcessBits;
              return (
                n.has("assistive-mml") || n.allocate("assistive-mml"),
                (i.visitor = new h(i.mmlFactory)),
                (i.options.MathItem = f(i.options.MathItem)),
                "addStyles" in i && i.addStyles(o.assistiveStyles),
                i
              );
            }
            return (
              ...
              (e.prototype.assistiveMml = function () {
                ...
                if (!this.processed.isSet("assistive-mml")) {
                  try {
                    for (var r = l(this.math), i = r.next(); !i.done; i = r.next()) i.value.assistiveMml(this);
                  } catch (e) {
                    t = { error: e };
                  } finally {
                    try {
          ...
          (e.OPTIONS = n(n({}, t.OPTIONS), {
            ...
            renderActions: (0, p.expandable)(n(n({}, t.OPTIONS.renderActions), { assistiveMml: [u.STATE.ASSISTIVEMML] })),
          })),
          (e.assistiveStyles = {
            "mjx-assistive-mml": {
      ...
      (e.LimitedMmlVisitor = h),
        (0, u.newState)("ASSISTIVEMML", 153),
        (e.AssistiveMmlMathItemMixin = f),
        (e.AssistiveMmlMathDocumentMixin = y),
        (e.AssistiveMmlHandler = function (t) {
          return (t.documentClass = y(t.documentClass)), t;
        });
    },
    35659: function (t, e, r) {
      var i,
        o =
          (this && this.__extends) ||
          ((i = function (t, e) {
      ...
      var n = r(72666),
        s = (function (t) {
          function e(e) {
            return void 0 === e && (e = null), e || (e = new n.MmlFactory()), t.call(this, e) || this;
          }
          return (
            o(e, t),
        ...
        })(r(93281).AbstractVisitor);
      e.MmlVisitor = s;
    },
    24616: function (t, e, r) {
      var i,
        o =
          (this && this.__extends) ||
          ((i = function (t, e) {
        ...
        return (
          ...
          (r.prototype.visitInferredMrowNode = function (t, e) {
            var r,
              ...
              o = [];
            try {
              for (var s = n(t.childNodes), a = s.next(); !a.done; a = s.next()) {
                var l = a.value;
          ...
          (r.prototype.visitDefault = function (t, e) {
            var r = t.kind,
              i = s(t.isToken || 0 === t.childNodes.length ? ["", ""] : ["\n", e], 2),
              o = i[0],
              n = i[1],
              a = this.childNodeMml(t, e + "  ", o);
            return e + "<" + r + this.getAttributes(t) + ">" + (a.match(/\S/) ? o + a + n : "") + "</" + r + ">";
          }),
          ...
          (r.prototype.getAttributes = function (t) {
            ...
            try {
              for (var l = n(Object.keys(s)), u = l.next(); !u.done; u = l.next()) {
                var c = u.value,
                  p = String(s[c]);
                void 0 !== p && i.push(c + '="' + this.quoteHTML(p) + '"');
              }
            } catch (t) {
              e = { error: t };
            } finally {
          ...
          (r.prototype.getDataAttributes = function (t) {
            ...
            if (void 0 !== n) {
              var s = !0;
              if (n === l.TEXCLASS.OP && t.isKind("mi")) {
                var a = t.getText();
                s = !(a.length > 1 && a.match(u.MmlMi.operatorName));
              }
              s && this.setDataAttribute(e, "texclass", n < 0 ? "NONE" : l.TEXCLASSNAMES[n]);
            }
            return t.getProperty("scriptlevel") && !1 === t.getProperty("useHeight") && this.setDataAttribute(e, "smallmatrix", "true"), e;
          }),
      ...
      var s = r(85403),
        a = (function () {
          function t(e) {
            ...
            try {
              for (var n = i(e.getKinds()), s = n.next(); !s.done; s = n.next()) {
                var a = s.value,
