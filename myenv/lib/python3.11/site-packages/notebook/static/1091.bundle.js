    ...
    4306: (e, t, n) => {
      function i(e) {
        ...
        var t = {},
          ...
          i = !1;
        for (var l in e)
          if (l != n && e.hasOwnProperty(l))
            for (var d = (t[l] = []), S = e[l], c = 0; c < S.length; c++) {
              var I = S[c];
              d.push(new o(I, e)), (I.indent || I.dedent) && (i = !0);
            }
        return {
          name: n.name,
          startState: function () {
      ...
      function a(e) {
        return function (t, n) {
          if (n.pending) {
            ...
            return 0 == n.pending.length && (n.pending = null), (t.pos += i.text.length), i.token;
          }
          for (var r = e[n.state], o = 0; o < r.length; o++) {
            var a = r[o],
              s = (!a.data.sol || t.sol()) && t.match(a.regex);
            if (s) {
              a.data.next
                ? (n.state = a.data.next)
                : a.data.push
                  ? ((n.stack || (n.stack = [])).push(n.state), (n.state = a.data.push))
                  : a.data.pop && n.stack && n.stack.length && (n.state = n.stack.pop()),
                a.data.indent && n.indent.push(t.indentation() + t.indentUnit),
                a.data.dedent && n.indent.pop();
              var l = a.token;
              if ((l && l.apply && (l = l(s)), s.length > 2 && a.token && "string" != typeof a.token)) {
                n.pending = [];
                for (var d = 2; d < s.length; d++) s[d] && n.pending.push({ text: s[d], token: a.token[d - 1] });
                return t.backUp(s[0].length - (s[1] ? s[1].length : 0)), l[0];
              }
        ...
        return function (n, i) {
          ...
          e: for (;;) {
            for (var a = 0; a < o.length; a++) {
              var s = o[a];
              if (s.data.dedent && !1 !== s.data.dedentIfLineStart) {
                var l = s.regex.exec(i);
                if (l && l[0]) {
                  r--, (s.next || s.push) && (o = e[s.next || s.push]), (i = i.slice(l[0].length));
                  continue e;
                }
              }
            }
