...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    75343: (t, e, s) => {
      s.d(e, { D: () => l, S: () => c, a: () => h, b: () => a, c: () => o, d: () => w, p: () => r, s: () => P });
      var i = s(24028),
        n = (function () {
          var t = function (t, e, s, i) {
            ...
            C = [1, 35],
            $ = [1, 31],
            A = [1, 4, 5, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28, 32, 34, 36, 37, 41, 44, 45, 46, 47, 50],
            D = [1, 4, 5, 13, 14, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28, 32, 34, 36, 37, 41, 44, 45, 46, 47, 50],
            v = [4, 5, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28, 32, 34, 36, 37, 41, 44, 45, 46, 47, 50],
            L = {
              trace: function () {},
              yy: {},
              symbols_: {
              ...
              performAction: function (t, e, s, i, n, r, o) {
                var a = r.length - 1;
                switch (n) {
                  case 3:
                  ...
                  case 14:
                    ...
                    break;
                  case 18:
                    this.$ = { stmt: "state", id: r[a - 3], type: "default", description: "", doc: r[a - 1] };
                    break;
                  case 19:
                    var c = r[a],
                      l = r[a - 2].trim();
                    ...
                    break;
                  case 20:
                    this.$ = { stmt: "state", id: r[a - 3], type: "default", description: r[a - 5], doc: r[a - 1] };
                    break;
                  case 21:
                  ...
                  case 24:
                    ...
                    break;
                  case 25:
                    this.$ = { stmt: "state", id: r[a - 1].trim(), note: { position: r[a - 2].trim(), text: r[a].trim() } };
                    break;
                  case 28:
                  ...
                  case 42:
                  case 43:
                    this.$ = { stmt: "state", id: r[a - 2].trim(), classes: [r[a].trim()], type: "default", description: "" };
                }
              },
              table: [
                { 3: 1, 4: e, 5: s, 6: i },
                ...
                for (var f, m, g, _, S, T, k, b, E, x = {}; ; ) {
                  if (
                    ...
                    this.defaultActions[m]
                      ...
                      : (null == f &&
                          ((E = void 0),
                          "number" != typeof (E = s.pop() || h.lex() || 1) &&
                            (E instanceof Array && (E = (s = E).pop()), (E = this.symbols_[E] || E)),
                          (f = E)),
                        (g = r[m] && r[m][f])),
                    void 0 === g || !g.length || !g[0])
                  ) {
                    var C;
                    for (S in ((b = []), r[m])) this.terminals_[S] && S > 2 && b.push("'" + this.terminals_[S] + "'");
                    (C = h.showPosition
                      ? "Parse error on line " +
                        (a + 1) +
                        ":\n" +
                      ...
                      this.parseError(C, { text: h.match, token: this.terminals_[f] || f, line: h.yylineno, loc: p, expected: b });
                  }
                  ...
                  switch (g[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        y && (x._$.range = [n[n.length - (T || 1)].range[0], n[n.length - 1].range[1]]),
                        void 0 !== (_ = this.performAction.apply(x, [o, c, a, u.yy, g[1], i, n].concat(l))))
                      )
                        return _;
                      T && ((e = e.slice(0, -1 * T * 2)), (i = i.slice(0, -1 * T)), (n = n.slice(0, -1 * T))),
            ...
            I = {
              ...
              performAction: function (t, e, s, i) {
                switch (s) {
                  ...
                  case 33:
                  case 36:
                    return this.popState(), (e.yytext = e.yytext.slice(0, -8).trim()), 24;
                  case 34:
                  case 37:
                    return this.popState(), (e.yytext = e.yytext.slice(0, -8).trim()), 25;
                  case 35:
                  case 38:
                    return this.popState(), (e.yytext = e.yytext.slice(0, -10).trim()), 26;
                  case 43:
                  ...
                  case 63:
                    return this.popState(), (e.yytext = e.yytext.substr(2).trim()), 30;
                  case 64:
                    return this.popState(), (e.yytext = e.yytext.slice(0, -8).trim()), 30;
                  case 65:
                  case 66:
                    return 6;
                  case 67:
                  ...
                  case 69:
                    return 23;
                  case 70:
                    return (e.yytext = e.yytext.trim()), 13;
                  case 71:
                    return 14;
                  case 72:
                    return 27;
              ...
              conditions: {
                ...
                struct: { rules: [9, 10, 22, 26, 32, 39, 40, 41, 42, 51, 52, 53, 54, 68, 69, 70, 71, 72], inclusive: !1 },
                ...
                STATE: { rules: [9, 10, 33, 34, 35, 36, 37, 38, 43, 44, 48, 49, 50], inclusive: !1 },
          ...
          return (L.lexer = I), (O.prototype = L), (L.Parser = O), new O();
        })();
      n.parser = n;
      const r = n,
        o = "TB",
      ...
      const E = (t) => JSON.parse(JSON.stringify(t)),
        x = (t, e, s) => {
          if (e.stmt === c) x(t, e.state1, !0), x(t, e.state2, !1);
          else if ((e.stmt === a && ("[*]" === e.id ? ((e.id = s ? t.id + "_start" : t.id + "_end"), (e.start = s)) : (e.id = e.id.trim())), e.doc)) {
            const t = [];
            let s,
              n = [];
            for (s = 0; s < e.doc.length; s++)
              if (e.doc[s].type === h) {
                const i = E(e.doc[s]);
                (i.doc = E(n)), t.push(i), (n = []);
              } else n.push(e.doc[s]);
            if (t.length > 0 && n.length > 0) {
              const s = { stmt: a, id: (0, i.G)(), type: "divider", doc: E(n) };
              t.push(E(s)), (e.doc = t);
            }
            e.doc.forEach((t) => x(e, t, !0));
          }
        },
        C = function (t, e = l, s = null, n = null, r = null, o = null, a = null, c = null) {
          const h = null == t ? void 0 : t.trim();
          void 0 === T.states[h]
            ? (i.l.info("Adding state ", h, n),
              (T.states[h] = { id: h, descriptions: [], type: e, doc: s, note: r, classes: [], styles: [], textStyles: [] }))
            : (T.states[h].doc || (T.states[h].doc = s), T.states[h].type || (T.states[h].type = e)),
            n &&
              (i.l.info("Setting state description", h, n),
              "string" == typeof n && I(h, n.trim()),
              "object" == typeof n && n.forEach((t) => I(h, t.trim()))),
            r && ((T.states[h].note = r), (T.states[h].note.text = i.e.sanitizeText(T.states[h].note.text, (0, i.c)()))),
            o && (i.l.info("Setting state classes", h, o), ("string" == typeof o ? [o] : o).forEach((t) => N(h, t.trim()))),
            a && (i.l.info("Setting state styles", h, a), ("string" == typeof a ? [a] : a).forEach((t) => R(h, t.trim()))),
            c && (i.l.info("Setting state styles", h, a), ("string" == typeof c ? [c] : c).forEach((t) => B(h, t.trim())));
        },
        $ = function (t) {
          (S = { root: { relations: [], states: {}, documents: {} } }), (T = S.root), (k = 0), (_ = {}), t || (0, i.t)();
        },
        A = function (t) {
          return T.states[t];
        };
      ...
      const L = function (t, e, s) {
          if ("object" == typeof t)
            !(function (t, e, s) {
              let n = D(t.id.trim()),
                r = v(t.id.trim(), t.type),
                o = D(e.id.trim()),
                a = v(e.id.trim(), e.type);
              C(n, r, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles),
                C(o, a, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles),
                T.relations.push({ id1: n, id2: o, relationTitle: i.e.sanitizeText(s, (0, i.c)()) });
            })(t, e, s);
          else {
            const n = D(t.trim()),
              r = v(t),
              o = (function (t = "") {
                let e = t;
                return t === p && (k++, (e = `end${k}`)), e;
              })(e.trim()),
              a = (function (t = "", e = l) {
                return t === p ? "end" : e;
              })(e);
            C(n, r), C(o, a), T.relations.push({ id1: n, id2: o, title: i.e.sanitizeText(s, (0, i.c)()) });
          }
        },
        I = function (t, e) {
          const s = T.states[t],
        ...
        w = {
          ...
          logDocuments: function () {
            i.l.info("Documents = ", S);
          },
          getRootDoc: () => g,
          setRootDoc: (t) => {
            i.l.info("Setting root doc", t), (g = t);
          },
          getRootDocV2: () => (x({ id: "root" }, { id: "root", doc: g }, !0), { id: "root", doc: g }),
          extract: (t) => {
            let e;
            (e = t.doc ? t.doc : t),
              i.l.info(e),
              ...
              e.forEach((t) => {
                switch (t.stmt) {
                  case a:
                    C(t.id.trim(), t.type, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles);
                    break;
                  case c:
