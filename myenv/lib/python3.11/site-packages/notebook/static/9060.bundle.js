...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [9060],
  {
    19060: (r, n, t) => {
      function u(r, n) {
        return r.skipToEnd(), (n.cur = s), "error";
      }
      function e(r, n) {
      ...
      function c(r, n) {
        ...
        n.cur = o;
        var e = Number(t[0]);
        return e >= 100 && e < 400 ? "atom" : "error";
      }
      function o(r, n) {
        return r.skipToEnd(), (n.cur = s), null;
      }
      function i(r, n) {
        return r.eatWhile(/\S/), (n.cur = a), "string.special";
      }
      function a(r, n) {
        return r.match(/^HTTP\/\d\.\d$/) ? ((n.cur = s), "keyword") : u(r, n);
      }
      function s(r) {
      ...
      const T = {
        ...
        token: function (r, n) {
          var t = n.cur;
          return t != s && t != k && r.eatSpace() ? null : t(r, n);
        },
