...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [8285, 4498],
  {
        ...
        return (
          (e = (function (t) {
            function e() {
              ...
              var i = t.apply(this, l([], a(n), !1)) || this;
              i.safe = new i.options.SafeClass(i, i.options.safeOptions);
              var f = i.constructor.ProcessBits;
              f.has("safe") || f.allocate("safe");
              try {
                for (var c = s(i.inputJax), u = c.next(); !u.done; u = c.next()) {
                  var p = u.value;
                  p.name.match(/MathML/)
                    ? ((p.mathml.filterAttribute = i.safe.mmlAttribute.bind(i.safe)), (p.mathml.filterClassList = i.safe.mmlClassList.bind(i.safe)))
                    : p.name.match(/TeX/) && p.postFilters.add(i.sanitize.bind(p), -5.5);
                }
              } catch (t) {
                e = { error: t };
              } finally {
            ...
            return (
              ...
              (e.prototype.sanitize = function (t) {
                (t.math.root = this.parseOptions.root), t.document.safe.sanitize(t.math, t.document);
              }),
              e
            );
          })(t)),
          (e.OPTIONS = i(i({}, t.OPTIONS), { safeOptions: i({}, f.Safe.OPTIONS), SafeClass: f.Safe })),
          e
        );
      }
      (e.SafeMathDocumentMixin = c),
        (e.SafeHandler = function (t) {
          return (t.documentClass = c(t.documentClass)), t;
        });
    },
    35230: function (t, e, r) {
      var n =
          (this && this.__values) ||
          function (t) {
            var e = "function" == typeof Symbol && Symbol.iterator,
      ...
      e.SafeMethods = {
        ...
        filterStyles: function (t, e) {
          ...
          try {
            var f = l.node("div", { style: e }),
              c = l.node("div");
            try {
              for (var u = n(Object.keys(s.safeStyles)), p = u.next(); !p.done; p = u.next()) {
                var h = p.value;
                if (s.styleParts[h])
                  try {
                    for (var y = ((i = void 0), n(["Top", "Right", "Bottom", "Left"])), d = y.next(); !d.done; d = y.next()) {
                      var v,
                        m = h + d.value;
                      (v = this.filterStyle(t, m, f)) && l.setStyle(c, m, v);
                    }
                  } catch (t) {
                    i = { error: t };
                  } finally {
                    try {
                      d && !d.done && (a = y.return) && a.call(y);
                    } finally {
                      if (i) throw i.error;
                    }
                  }
                else (v = this.filterStyle(t, h, f)) && l.setStyle(c, h, v);
              }
            } catch (t) {
              r = { error: t };
            } finally {
        ...
        filterStyle: function (t, e, r) {
          ...
          if (
            ...
            return null;
          var o = e.replace(/Top|Right|Left|Bottom/, "");
          return t.options.safeStyles[e] || t.options.safeStyles[o] ? this.filterStyleValue(t, e, n, r) : null;
        },
        filterStyleValue: function (t, e, r, n) {
          var o = t.options.styleLengths[e];
          if (!o) return r;
          if ("string" != typeof o) return this.filterStyleLength(t, e, r);
          var i = this.filterStyleLength(t, o, t.adaptor.getStyle(n, o));
          return i ? (t.adaptor.setStyle(n, o, i), t.adaptor.getStyle(n, e)) : null;
        },
        filterStyleLength: function (t, e, r) {
          if (!r.match(/^(.+)(em|ex|ch|rem|px|mm|cm|in|pt|pc|%)$/)) return null;
          var n = (0, i.length2em)(r, 1),
            a = t.options.styleLengths[e],
            l = o(Array.isArray(a) ? a : [-t.options.lengthMax, t.options.lengthMax], 2),
            s = l[0],
            f = l[1];
        ...
        filterSizeMultiplier: function (t, e) {
          var r = o(t.options.scriptsizemultiplierRange || [-1 / 0, 1 / 0], 2),
            n = r[0],
            i = r[1];
          return Math.min(i, Math.max(n, parseFloat(e))).toString();
        },
        filterScriptLevel: function (t, e) {
          var r = o(t.options.scriptlevelRange || [-1 / 0, 1 / 0], 2),
            n = r[0],
            i = r[1];
        ...
        l = (function () {
          function t(t, e) {
            (this.filterAttributes = new Map([
              ...
              (this.filterMethods = n({}, a.SafeMethods)),
          ...
          return (
            ...
            (t.prototype.sanitizeNode = function (t) {
              ...
              try {
                for (var i = o(Object.keys(n)), a = i.next(); !a.done; a = i.next()) {
                  var l = a.value,
            ...
            (t.OPTIONS = {
              ...
              safeProtocols: (0, i.expandable)({ http: !0, https: !0, file: !0, javascript: !1, data: !1 }),
              ...
              styleParts: (0, i.expandable)({ border: !0, padding: !0, margin: !0, outline: !0 }),
    ...
    4498: function (t, e) {
      ...
      var i = {}.constructor;
      function a(t) {
        return "object" == typeof t && null !== t && (t.constructor === i || t.constructor === l);
      }
      (e.isObject = a),
        (e.APPEND = "[+]"),
        (e.REMOVE = "[-]"),
      ...
      function c(t) {
        var e,
          ...
          o = {};
        try {
          for (var i = r(f(t)), p = i.next(); !p.done; p = i.next()) {
            var h = p.value,
              y = Object.getOwnPropertyDescriptor(t, h),
              d = y.value;
            Array.isArray(d) ? (y.value = u([], d, !1)) : a(d) && (y.value = c(d)), y.enumerable && (o[h] = y);
          }
        } catch (t) {
          e = { error: t };
        } finally {
          try {
            p && !p.done && (n = i.return) && n.call(i);
          } finally {
            if (e) throw e.error;
          }
        }
        return Object.defineProperties(t.constructor === l ? s({}) : {}, o);
      }
      function u(t, i, s) {
        var p, h;
        void 0 === s && (s = !0);
        var y = function (r) {
          if (s && void 0 === t[r] && t.constructor !== l)
            return (
              "symbol" == typeof r && (r = r.toString()), e.OPTIONS.optionError('Invalid option "'.concat(r, '" (no default value).'), r), "continue"
            );
          var p = i[r],
            h = t[r];
          if (!a(p) || null === h || ("object" != typeof h && "function" != typeof h))
            Array.isArray(p) ? ((t[r] = []), u(t[r], p, !1)) : a(p) ? (t[r] = c(p)) : (t[r] = p);
          else {
            var y = f(p);
            Array.isArray(h) &&
            ((1 === y.length && (y[0] === e.APPEND || y[0] === e.REMOVE) && Array.isArray(p[y[0]])) ||
              (2 === y.length && y.sort().join(",") === e.APPEND + "," + e.REMOVE && Array.isArray(p[e.APPEND]) && Array.isArray(p[e.REMOVE])))
              ? (p[e.REMOVE] &&
                  (h = t[r] =
                    h.filter(function (t) {
                      return p[e.REMOVE].indexOf(t) < 0;
                    })),
                p[e.APPEND] && (t[r] = o(o([], n(h), !1), n(p[e.APPEND]), !1)))
              : u(h, p, s);
          }
        };
        try {
          for (var d = r(f(i)), v = d.next(); !v.done; v = d.next()) y(v.value);
        } catch (t) {
          p = { error: t };
        } finally {
          try {
      ...
      function p(t) {
        ...
        var a = {};
        try {
          for (var l = r(o), s = l.next(); !s.done; s = l.next()) {
            var f = s.value;
            t.hasOwnProperty(f) && (a[f] = t[f]);
          }
        } catch (t) {
          e = { error: t };
        } finally {
      ...
      (e.Expandable = l),
        ...
        (e.selectOptionsFromKeys = function (t, e) {
          return p.apply(void 0, o([t], n(Object.keys(e)), !1));
        }),
        (e.separateOptions = function (t) {
          for (var e, n, o, i, a = [], l = 1; l < arguments.length; l++) a[l - 1] = arguments[l];
          var s = [];
          try {
            for (var f = r(a), c = f.next(); !c.done; c = f.next()) {
              var u = c.value,
                p = {},
                h = {};
              try {
                for (var y = ((o = void 0), r(Object.keys(t || {}))), d = y.next(); !d.done; d = y.next()) {
                  var v = d.value;
                  (void 0 === u[v] ? h : p)[v] = t[v];
                }
              } catch (t) {
                o = { error: t };
              } finally {
                try {
                  d && !d.done && (i = y.return) && i.call(y);
                } finally {
                  if (o) throw o.error;
                }
              }
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        (e.length2em = function (t, r, n, o) {
          ...
          var a = parseFloat(i[1] || "1"),
            l = i[2];
          return e.UNITS.hasOwnProperty(l)
            ? (a * e.UNITS[l]) / o / n
            : e.RELUNITS.hasOwnProperty(l)
              ? a * e.RELUNITS[l]
              : "%" === l
                ? (a / 100) * r
                : a * r;
