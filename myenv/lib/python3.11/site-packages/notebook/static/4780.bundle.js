  ...
  [4780],
  {
    14780: (e, n, t) => {
      ...
      function I(e, n, t, r) {
        ...
        let u = 0;
        return function (r) {
          return b(r) ? (e.enter(t), o(r)) : n(r);
        };
        function o(r) {
          return b(r) && u++ < i ? (e.consume(r), o) : (e.exit(t), n(r));
        }
      }
      const w = {
          tokenize: function (e) {
        ...
        z = {
          tokenize: function (e, n, t) {
            return function (n) {
              return b(n) ? I(e, r, "linePrefix")(n) : r(n);
            };
            function r(e) {
          ...
          tokenize: function (e) {
            const n = this,
              t = e.attempt(
                ...
                e.attempt(this.parser.constructs.flowInitial, r, I(e, e.attempt(this.parser.constructs.flow, r, e.attempt(D, r)), "linePrefix"))
              );
            return t;
            function r(r) {
      ...
      function U(e, n, t) {
        ...
        const f = {
            consume: function (e) {
              F(e) ? (r.line++, (r.column = 1), (r.offset += -3 === e ? 2 : 1), b()) : -1 !== e && (r.column++, r.offset++),
          ...
          d = {
            ...
            write: function (e) {
              return (
                ...
                null !== o[o.length - 1] ? [] : (v(n, 0), (d.events = V(u, d.events, d)), d.events)
              );
            },
          };
        let h,
              ...
              return function (t) {
                return (
                  (h = (function () {
                    ...
                    return {
                      restore: function () {
                        (r = e), (d.previous = n), (d.currentConstruct = t), (d.events.length = i), (c = u), b();
                      },
                      from: i,
                    };
                  })()),
      ...
      const Q = {
          ...
          tokenize: function (e, n, t) {
            ...
            function o(n) {
              return n === r ? (e.consume(n), i++, o) : (e.exit("thematicBreakSequence"), b(n) ? I(e, u, "whitespace")(n) : u(n));
            }
          },
        },
        N = {
          ...
          tokenize: function (e, n, t) {
            ...
            return function (n) {
              ...
              if ("listUnordered" === i ? !r.containerState.marker || n === r.containerState.marker : x(n)) {
                if ((r.containerState.type || ((r.containerState.type = i), e.enter(i, { _container: !0 })), "listUnordered" === i))
                  return e.enter("listItemPrefix"), 42 === n || 45 === n ? e.check(Q, t, s)(n) : s(n);
            ...
            function a(n) {
              return b(n) ? (e.enter("listItemPrefixWhitespace"), e.consume(n), e.exit("listItemPrefixWhitespace"), f) : t(n);
            }
            function f(t) {
            ...
            tokenize: function (e, n, t) {
              ...
              return (
                ...
                e.check(
                  ...
                  function (t) {
                    return r.containerState.furtherBlankLines || !b(t)
              ...
              function i(i) {
                return (
                  ...
                  (r.interrupt = void 0),
                  I(e, e.attempt(N, n, t), "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(i)
                );
              }
            },
          },
          ...
          tokenize: function (e, n, t) {
            ...
            return I(
              ...
              function (e) {
                ...
                return !b(e) && i && "listItemPrefixWhitespace" === i[1].type ? n(e) : t(e);
              },
        ...
        Y = {
          ...
          continuation: {
            tokenize: function (e, n, t) {
              const r = this;
              return function (n) {
                return b(n) ? I(e, i, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(n) : i(n);
              };
              function i(r) {
                return e.attempt(Y, n, t)(r);
              }
            },
          },
          exit: function (e) {
      ...
      const ee = {
          ...
          tokenize: function (e, n, t) {
            ...
            return function (n) {
              return (
                e.enter("definition"),
                (function (n) {
                  return J.call(r, e, u, t, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(n);
                })(n)
              );
            };
            function u(n) {
            ...
            function l(n) {
              return b(n) ? I(e, a, "whitespace")(n) : a(n);
            }
            function a(u) {
        ...
        ne = {
          tokenize: function (e, n, t) {
            return function (n) {
              return v(n) ? K(e, r)(n) : t(n);
            };
            function r(n) {
              return G(e, i, t, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(n);
            }
            function i(n) {
              return b(n) ? I(e, u, "whitespace")(n) : u(n);
            }
            function u(e) {
              return null === e || F(e) ? n(e) : t(e);
            }
        ...
        ie = {
          ...
          tokenize: function (e, n, t) {
            ...
            function i(n) {
              return 35 === n && r++ < 6 ? (e.consume(n), i) : null === n || v(n) ? (e.exit("atxHeadingSequence"), u(n)) : t(n);
            }
            function u(t) {
              return 35 === t
            ...
            function c(n) {
              return null === n || 35 === n || v(n) ? (e.exit("atxHeadingText"), u(n)) : (e.consume(n), c);
            }
          },
          resolve: function (e, n) {
            ...
            return (
              ...
              i > u &&
                ...
                (r = { type: "chunkText", start: e[u][1].start, end: e[i][1].end, contentType: "text" }),
                s(e, u, i - u + 1, [
                  ["enter", t, n],
                  ["enter", r, n],
                  ["exit", r, n],
        ...
        ue = {
          ...
          tokenize: function (e, n, t) {
            ...
            function u(n) {
              return n === i ? (e.consume(n), u) : (e.exit("setextHeadingLineSequence"), b(n) ? I(e, o, "lineSuffix")(n) : o(n));
            }
            function o(r) {
          ...
          resolveTo: function (e, n) {
            ...
            const o = { type: "setextHeading", start: Object.assign({}, e[r][1].start), end: Object.assign({}, e[e.length - 1][1].end) };
            return (
        ...
        se = {
          ...
          tokenize: function (e, n, t) {
            ...
            function l(c) {
              return 33 === c
                ...
                : 47 === c
                  ? (e.consume(c), (u = !0), m)
                  : 63 === c
                    ? (e.consume(c), (i = 3), r.interrupt ? n : R)
                    : h(c)
            ...
            function a(u) {
              return 45 === u
                ...
                : 91 === u
                  ...
                  : h(u)
                    ? (e.consume(u), (i = 4), r.interrupt ? n : R)
                    : t(u);
            }
            function f(i) {
              return 45 === i ? (e.consume(i), r.interrupt ? n : R) : t(i);
            }
            function d(i) {
              return i === "CDATA[".charCodeAt(c++) ? (e.consume(i), 6 === c ? (r.interrupt ? n : _) : d) : t(i);
            }
            function m(n) {
              return h(n) ? (e.consume(n), (o = String.fromCharCode(n)), g) : t(n);
            }
            function g(c) {
              if (null === c || 47 === c || 62 === c || v(c)) {
                const s = 47 === c,
                  l = o.toLowerCase();
                return s || u || !ce.includes(l)
                  ? oe.includes(o.toLowerCase())
                    ? ((i = 6), s ? (e.consume(c), x) : r.interrupt ? n(c) : _(c))
                    : ((i = 7), r.interrupt && !r.parser.lazy[r.now().line] ? t(c) : u ? k(c) : y(c))
                  : ((i = 1), r.interrupt ? n(c) : _(c));
              }
              return 45 === c || p(c) ? (e.consume(c), (o += String.fromCharCode(c)), g) : t(c);
            }
            function x(i) {
              return 62 === i ? (e.consume(i), r.interrupt ? n : _) : t(i);
            }
            function k(n) {
              return b(n) ? (e.consume(n), k) : T(n);
            }
            function y(n) {
              return 47 === n ? (e.consume(n), T) : 58 === n || 95 === n || h(n) ? (e.consume(n), S) : b(n) ? (e.consume(n), y) : T(n);
            }
            function S(n) {
              return 45 === n || 46 === n || 58 === n || 95 === n || p(n) ? (e.consume(n), S) : E(n);
            }
            function E(n) {
              return 61 === n ? (e.consume(n), A) : b(n) ? (e.consume(n), E) : y(n);
            }
            function A(n) {
            ...
            function w(n) {
              return null === n || 34 === n || 39 === n || 47 === n || 60 === n || 61 === n || 62 === n || 96 === n || v(n)
                ? E(n)
                : (e.consume(n), w);
            }
            function C(e) {
              return 47 === e || 62 === e || b(e) ? y(e) : t(e);
            }
            function T(n) {
              return 62 === n ? (e.consume(n), z) : t(n);
            }
            function z(n) {
              return null === n || F(n) ? _(n) : b(n) ? (e.consume(n), z) : t(n);
            }
            function _(n) {
              return 45 === n && 2 === i
                ? (e.consume(n), P)
            ...
            function B(n) {
              return e.check(ae, D, q)(n);
            }
            function D(n) {
              return e.enter("lineEnding"), e.consume(n), e.exit("lineEnding"), L;
            }
            function L(n) {
              return null === n || F(n) ? B(n) : (e.enter("htmlFlowData"), _(n));
            }
            function P(n) {
              return 45 === n ? (e.consume(n), R) : _(n);
            }
            function M(n) {
              return 47 === n ? (e.consume(n), (o = ""), O) : _(n);
            }
            function O(n) {
              if (62 === n) {
                const t = o.toLowerCase();
                return ce.includes(t) ? (e.consume(n), H) : _(n);
              }
              return h(n) && o.length < 8 ? (e.consume(n), (o += String.fromCharCode(n)), O) : _(n);
            }
            function j(n) {
              return 93 === n ? (e.consume(n), R) : _(n);
            }
            function R(n) {
              return 62 === n ? (e.consume(n), H) : 45 === n && 2 === i ? (e.consume(n), R) : _(n);
            }
            function H(n) {
              return null === n || F(n) ? (e.exit("htmlFlowData"), q(n)) : (e.consume(n), H);
            }
            function q(t) {
        ...
        de = {
          ...
          tokenize: function (e, n, t) {
                ...
                tokenize: function (e, n, t) {
                  ...
                  function o(n) {
                    return (
                      ...
                      b(n) ? I(e, s, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(n) : s(n)
                    );
                  }
                  function s(n) {
                  ...
                  function l(n) {
                    return n === u
                      ? (i++, e.consume(n), l)
                      : i >= c
                        ? (e.exit("codeFencedFenceSequence"), b(n) ? I(e, a, "whitespace")(n) : a(n))
                        : t(n);
                  }
                  function a(r) {
            ...
            function s(n) {
              return n === u ? (c++, e.consume(n), s) : c < 3 ? t(n) : (e.exit("codeFencedFenceSequence"), b(n) ? I(e, l, "whitespace")(n) : l(n));
            }
            function l(t) {
              return null === t || F(t)
            ...
            function m(n) {
              return o > 0 && b(n) ? I(e, g, "linePrefix", o + 1)(n) : g(n);
            }
            function g(n) {
      ...
      const me = {
        ...
        ke = {
          ...
          resolveTo: function (e, n) {
            ...
            const a = {
              ...
              f = { type: "label", start: Object.assign({}, e[r][1].start), end: Object.assign({}, e[i][1].end) },
              d = { type: "labelText", start: Object.assign({}, e[r + c + 2][1].end), end: Object.assign({}, e[i - 2][1].start) };
            return (
              (u = [
                ["enter", a, n],
                ["enter", f, n],
        ...
        ye = {
          tokenize: function (e, n, t) {
            ...
            function u(n) {
              return v(n) ? K(e, c)(n) : l(n);
            }
            function o(e) {
              return t(e);
            }
            function c(n) {
              return 34 === n || 39 === n || 40 === n ? G(e, s, t, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(n) : l(n);
            }
            function s(n) {
              return v(n) ? K(e, l)(n) : l(n);
            }
            function l(r) {
        ...
        Fe = {
          tokenize: function (e, n, t) {
            const r = this;
            return function (n) {
              return J.call(r, e, i, u, "reference", "referenceMarker", "referenceString")(n);
            };
            function i(e) {
      ...
      function be(e) {
        return null === e || v(e) || E(e) ? 1 : S(e) ? 2 : void 0;
      }
      const Se = {
        name: "attention",
        tokenize: function (e, n) {
            ...
            if ("enter" === e[d][0] && "attentionSequence" === e[d][1].type && e[d][1]._close)
              for (t = d; t--; )
                if (
                  ...
                  Ee(h, -c),
                    Ee(p, c),
                    (u = { type: c > 1 ? "strongSequence" : "emphasisSequence", start: h, end: Object.assign({}, e[t][1].end) }),
                    (o = { type: c > 1 ? "strongSequence" : "emphasisSequence", start: Object.assign({}, e[d][1].start), end: p }),
                    (i = {
                      type: c > 1 ? "strongText" : "emphasisText",
                      start: Object.assign({}, e[t][1].end),
                      end: Object.assign({}, e[d][1].start),
                    }),
                    (r = { type: c > 1 ? "strong" : "emphasis", start: Object.assign({}, u.start), end: Object.assign({}, o.end) }),
      ...
      const Ae = {
          ...
          tokenize: function (e, n, t) {
            ...
            function C(n) {
              return F(n) ? ((o = C), j(n)) : b(n) ? (e.consume(n), C) : O(n);
            }
            function T(n) {
              return 45 === n || p(n) ? (e.consume(n), T) : 47 === n || 62 === n || v(n) ? z(n) : t(n);
            }
            function z(n) {
              return 47 === n
                ? (e.consume(n), O)
            ...
            function _(n) {
              return 45 === n || 46 === n || 58 === n || 95 === n || p(n) ? (e.consume(n), _) : B(n);
            }
            function B(n) {
              return 61 === n ? (e.consume(n), D) : F(n) ? ((o = B), j(n)) : b(n) ? (e.consume(n), B) : z(n);
            }
            function D(n) {
              return null === n || 60 === n || 61 === n || 62 === n || 96 === n
                ? t(n)
            ...
            function L(n) {
              return n === i ? (e.consume(n), (i = void 0), M) : null === n ? t(n) : F(n) ? ((o = L), j(n)) : (e.consume(n), L);
            }
            function P(n) {
            ...
            function M(e) {
              return 47 === e || 62 === e || v(e) ? z(e) : t(e);
            }
            function O(r) {
              return 62 === r ? (e.consume(r), e.exit("htmlTextData"), e.exit("htmlText"), n) : t(r);
            }
            function j(n) {
              return e.exit("htmlTextData"), e.enter("lineEnding"), e.consume(n), e.exit("lineEnding"), R;
            }
            function R(n) {
              return b(n) ? I(e, H, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(n) : H(n);
            }
            function H(n) {
        ...
        we = { 42: N, 43: N, 45: N, 48: N, 49: N, 50: N, 51: N, 52: N, 53: N, 54: N, 55: N, 56: N, 57: N, 62: Y },
        Ce = { 91: ee },
        Te = { [-2]: te, [-1]: te, 32: te },
        ze = { 35: ie, 42: Q, 45: [ue, Q], 60: se, 61: ue, 95: Q, 96: de, 126: de },
        _e = { 38: me, 92: ge },
        Be = {
          [-5]: xe,
          [-4]: xe,
      ...
      function qe(e) {
        return Ue(e && e.line) + ":" + Ue(e && e.column);
      }
      function Ve(e) {
          ...
          return (
            ...
            (function (e) {
              ...
              return function (e) {
                ...
                const u = { stack: [t], tokenStack: [], config: n, enter: a, exit: d, buffer: l, resume: h, setData: i, getData: c },
                  o = [];
                let s = -1;
                for (; ++s < e.length; )
                ...
                for (s = -1; ++s < e.length; ) {
                  const t = n[e[s][0]];
                  Qe.call(t, e[s][1].type) && t[e[s][1].type].call(Object.assign({ sliceSerialize: e[s][2].sliceSerialize }, u), e[s][1]);
                }
                if (u.tokenStack.length > 0) {
                  const e = u.tokenStack[u.tokenStack.length - 1];
                  (e[1] || Ze).call(u, void 0, e[0]);
                }
                for (
                  t.position = {
              ...
              function r(e, n, t) {
                ...
                for (; ++c <= t; ) {
                  ...
                  if (
                    ...
                    "listItemPrefix" === n[1].type &&
                      ((r = { type: "listItem", _spread: !1, start: Object.assign({}, n[1].start), end: void 0 }),
              ...
              function d(e, n) {
                ...
                if (!r) throw new Error("Cannot close `" + e.type + "` (" + He({ start: e.start, end: e.end }) + "): it’s not open");
                return r[0].type !== e.type && (n ? n.call(this, e, r[0]) : (r[1] || Ze).call(this, e, r[0])), (t.position.end = $e(e.end)), t;
              }
              function h() {
                return (function (e, n) {
              ...
              (function (e) {
                ...
                (function (e) {
                  const n = (function (e) {
                    ...
                    t = { defined: [], lazy: {}, constructs: n, content: i(w), document: i(C), flow: i(P), string: i(O), text: i(j) };
                  return t;
                  function i(e) {
                    return function (n) {
                      return U(t, e, n);
                    ...
                    (function () {
                      ...
                      return function (i, u, o) {
                        ...
                        for (i = t + i.toString(u), a = 0, t = "", r && (65279 === i.charCodeAt(0) && a++, (r = void 0)); a < i.length; ) {
                          if (((Me.lastIndex = a), (s = Me.exec(i)), (f = s && void 0 !== s.index ? s.index : i.length), (d = i.charCodeAt(f)), !s)) {
                            t = i.slice(a);
                            break;
                          }
        ...
        throw e
          ? new Error(
              "Cannot close `" +
                ...
                n.type +
                "`, " +
                He({ start: n.start, end: n.end }) +
                ") is open"
            )
          : new Error("Cannot close document, a token (`" + n.type + "`, " + He({ start: n.start, end: n.end }) + ") is still open");
      }
      var Je = t(11464);
      function Ge(e) {
        const n = (function (e) {
      ...
      function un(e, n, t) {
        ...
        const i = e.append("text"),
          u = tn(i, 1, n);
        on(u, [{ content: t, type: "normal" }]);
        const o = null == (r = u.node()) ? void 0 : r.getBoundingClientRect();
        return o && i.remove(), o;
      }
      function on(e, n) {
        e.text(""),
      ...
      const cn = (
        ...
        if ((i.l.info("createText", n, t, r, u, o, c, l), o)) {
          const r = (function (e) {
              const { children: n } = Ne(e);
              return n
                .map(function e(n) {
                  return "text" === n.type
                    ? n.value.replace(/\n/g, "<br/>")
                    : "strong" === n.type
                      ? `<strong>${n.children.map(e).join("")}</strong>`
                      : "emphasis" === n.type
                        ? `<em>${n.children.map(e).join("")}</em>`
                        : "paragraph" === n.type
                          ? `<p>${n.children.map(e).join("")}</p>`
            ...
            o = (function (e, n, t, r, i = !1) {
              ...
              var l, a;
              o.html(`\n    <span class="${s} ${r}" ` + (n.labelStyle ? 'style="' + n.labelStyle + '"' : "") + ">" + c + "</span>"),
                (l = o),
          ...
          const t = (function (e, n, t, r = !1) {
            ...
            for (const n of t) {
              const t = (n) => rn(i, 1.1, n) <= e,
                r = t(n) ? [n] : en(n, t);
              for (const e of r) on(tn(o, c, 1.1), e), c++;
            }
            if (r) {
