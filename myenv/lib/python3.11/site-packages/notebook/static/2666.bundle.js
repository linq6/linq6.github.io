  ...
  [2666],
  {
    81885: (t, e, r) => {
      ...
      e.MML =
        ...
        (o[l.MmlMi.prototype.kind] = l.MmlMi),
        (o[p.MmlMn.prototype.kind] = p.MmlMn),
        (o[u.MmlMo.prototype.kind] = u.MmlMo),
        (o[a.MmlMtext.prototype.kind] = a.MmlMtext),
        (o[c.MmlMspace.prototype.kind] = c.MmlMspace),
        (o[s.MmlMs.prototype.kind] = s.MmlMs),
        ...
        (o[_.MmlMphantom.prototype.kind] = _.MmlMphantom),
        (o[O.MmlMfenced.prototype.kind] = O.MmlMfenced),
        (o[g.MmlMenclose.prototype.kind] = g.MmlMenclose),
        (o[v.MmlMaction.prototype.kind] = v.MmlMaction),
        (o[k.MmlMsub.prototype.kind] = k.MmlMsub),
        (o[k.MmlMsup.prototype.kind] = k.MmlMsup),
        (o[k.MmlMsubsup.prototype.kind] = k.MmlMsubsup),
        (o[j.MmlMunder.prototype.kind] = j.MmlMunder),
        (o[j.MmlMover.prototype.kind] = j.MmlMover),
        (o[j.MmlMunderover.prototype.kind] = j.MmlMunderover),
        ...
        (o[A.MmlMtable.prototype.kind] = A.MmlMtable),
        (o[w.MmlMlabeledtr.prototype.kind] = w.MmlMlabeledtr),
        (o[w.MmlMtr.prototype.kind] = w.MmlMtr),
        (o[N.MmlMtd.prototype.kind] = N.MmlMtd),
        (o[x.MmlMaligngroup.prototype.kind] = x.MmlMaligngroup),
        (o[T.MmlMalignmark.prototype.kind] = T.MmlMalignmark),
        (o[C.MmlMglyph.prototype.kind] = C.MmlMglyph),
        (o[I.MmlSemantics.prototype.kind] = I.MmlSemantics),
        (o[I.MmlAnnotation.prototype.kind] = I.MmlAnnotation),
        (o[I.MmlAnnotationXML.prototype.kind] = I.MmlAnnotationXML),
        (o[E.TeXAtom.prototype.kind] = E.TeXAtom),
        (o[L.MathChoice.prototype.kind] = L.MathChoice),
        (o[n.TextNode.prototype.kind] = n.TextNode),
        (o[n.XMLNode.prototype.kind] = n.XMLNode),
        o);
    },
    72666: function (t, e, r) {
      var o,
        n =
          (this && this.__extends) ||
          ((o = function (t, e) {
      ...
      var i = r(28792),
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.defaultNodes = l.MML),
            e
          );
        })(i.AbstractNodeFactory);
      e.MmlFactory = p;
    },
    66612: function (t, e, r) {
      var o,
        n =
          (this && this.__extends) ||
          ((o = function (t, e) {
      ...
      var l = r(83045),
        ...
        u = (function (t) {
          ...
          return (
            ...
            (e.defaults = i(i({}, l.AbstractMmlLayoutNode.defaults), { groupalign: p.INHERIT })),
            e
          );
        })(l.AbstractMmlLayoutNode);
      e.MmlMaligngroup = u;
    },
    81755: function (t, e, r) {
      var o,
        n =
          (this && this.__extends) ||
          ((o = function (t, e) {
      ...
      var l = r(83045),
        p = (function (t) {
          ...
          return (
            ...
            (e.defaults = i(i({}, l.AbstractMmlNode.defaults), { edge: "left" })),
            e
          );
        })(l.AbstractMmlNode);
      e.MmlMalignmark = p;
    },
    75833: function (t, e, r) {
      var o,
        n =
          (this && this.__extends) ||
          ((o = function (t, e) {
          ...
          return (
            ...
            (e.prototype.setInheritedAttributes = function (t, e, r, o) {
              var n = e ? 0 : Math.max(0, Math.min(r, 2)) + 1,
                i = this.childNodes[n] || this.factory.create("mrow");
              this.parent.replaceChild(i, this), i.setInheritedAttributes(t, e, r, o);
            }),
            (e.defaults = i({}, l.AbstractMmlBaseNode.defaults)),
            e
          );
      ...
      var l = r(83045),
        p = (function (t) {
          function e() {
            ...
            return (e.texclass = l.TEXCLASS.ORD), e;
          }
          return (
            n(e, t),
            Object.defineProperty(e.prototype, "kind", {
      ...
      var l = r(83045),
        p = (function (t) {
          ...
          return (
            ...
            (e.defaults = i({}, l.AbstractMmlLayoutNode.defaults)),
            e
          );
        })(l.AbstractMmlLayoutNode);
      e.MmlMphantom = p;
    },
    39655: function (t, e, r) {
      var o,
        n =
          (this && this.__extends) ||
          ((o = function (t, e) {
        ...
        u = (function (t) {
          ...
          return (
            ...
            (e.prototype.setChildInheritedAttributes = function (t, e, r, o) {
              ...
              null != n && ((n = n.toString()).match(/^\s*[-+]/) ? (r += parseInt(n)) : (r = parseInt(n)), (o = !1));
            ...
            (e.defaults = i(i({}, l.AbstractMmlLayoutNode.defaults), {
              scriptlevel: p.INHERIT,
              displaystyle: p.INHERIT,
              scriptsizemultiplier: 1 / Math.sqrt(2),
              scriptminsize: "8px",
              mathbackground: p.INHERIT,
              mathcolor: p.INHERIT,
              dir: p.INHERIT,
      ...
      var i = (function (t) {
        ...
        return (
          ...
          (e.prototype.create = function (t, e, r) {
            return void 0 === e && (e = {}), void 0 === r && (r = []), this.node[t](e, r);
          }),
          e
        );
