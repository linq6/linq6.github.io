    ...
    65850: (O, Q, $) => {
      $.r(Q),
        $.d(Q, {
          ...
          esLint: () => N,
          javascript: () => E,
          javascriptLanguage: () => j,
          jsxLanguage: () => G,
          localCompletionSource: () => f,
          scopeCompletionSource: () => h,
          snippets: () => m,
          tsxLanguage: () => R,
          typescriptLanguage: () => q,
          typescriptSnippets: () => b,
        });
      var i = $(49906),
        e = $(92209);
      const a = [
        ...
        Z = new i.IK({ start: !1, shift: (O, Q) => (3 == Q || 4 == Q || 307 == Q ? O : 308 == Q), strict: !1 }),
        S = new i.Jq(
          (O, Q) => {
            let { next: $ } = O;
            (125 == $ || -1 == $ || Q.context) && O.acceptToken(305);
          },
        ...
        t = new i.Jq(
          (O, Q) => {
            let $,
              { next: i } = O;
            a.indexOf(i) > -1 ||
              ((47 != i || (47 != ($ = O.peek(1)) && 42 != $)) && (125 == i || 59 == i || -1 == i || Q.context || O.acceptToken(304)));
          },
          { contextual: !0 }
        ),
        r = new i.Jq(
          (O, Q) => {
            let { next: $ } = O;
            if ((43 == $ || 45 == $) && (O.advance(), $ == O.next)) {
              O.advance();
              let $ = !Q.context && Q.canShift(1);
              O.acceptToken($ ? 1 : 2);
            }
          },
          { contextual: !0 }
        ...
        o = (0, e.styleTags)({
          "get set async static": e.tags.modifier,
          "for while do if else switch try catch finally return throw break continue default case": e.tags.controlKeyword,
          "in of await yield void typeof delete instanceof": e.tags.operatorKeyword,
          "let var const using function class extends": e.tags.definitionKeyword,
          "import export from": e.tags.moduleKeyword,
          "with debugger as new": e.tags.keyword,
          TemplateString: e.tags.special(e.tags.string),
          super: e.tags.atom,
          BooleanLiteral: e.tags.bool,
          this: e.tags.self,
          null: e.tags.null,
          Star: e.tags.modifier,
          VariableName: e.tags.variableName,
          "CallExpression/VariableName TaggedTemplateExpression/VariableName": e.tags.function(e.tags.variableName),
          VariableDefinition: e.tags.definition(e.tags.variableName),
          Label: e.tags.labelName,
          PropertyName: e.tags.propertyName,
          PrivatePropertyName: e.tags.special(e.tags.propertyName),
          "CallExpression/MemberExpression/PropertyName": e.tags.function(e.tags.propertyName),
          "FunctionDeclaration/VariableDefinition": e.tags.function(e.tags.definition(e.tags.variableName)),
          "ClassDeclaration/VariableDefinition": e.tags.definition(e.tags.className),
          PropertyDefinition: e.tags.definition(e.tags.propertyName),
          PrivatePropertyDefinition: e.tags.definition(e.tags.special(e.tags.propertyName)),
          UpdateOp: e.tags.updateOperator,
          "LineComment Hashbang": e.tags.lineComment,
          BlockComment: e.tags.blockComment,
          Number: e.tags.number,
          String: e.tags.string,
          Escape: e.tags.escape,
          ArithOp: e.tags.arithmeticOperator,
          LogicOp: e.tags.logicOperator,
          BitOp: e.tags.bitwiseOperator,
          CompareOp: e.tags.compareOperator,
          RegExp: e.tags.regexp,
          Equals: e.tags.definitionOperator,
          Arrow: e.tags.function(e.tags.punctuation),
          ": Spread": e.tags.punctuation,
          "( )": e.tags.paren,
          "[ ]": e.tags.squareBracket,
          "{ }": e.tags.brace,
          "InterpolationStart InterpolationEnd": e.tags.special(e.tags.brace),
          ".": e.tags.derefOperator,
          ", ;": e.tags.separator,
          "@": e.tags.meta,
          TypeName: e.tags.typeName,
          TypeDefinition: e.tags.definition(e.tags.typeName),
          "type enum interface implements namespace module declare": e.tags.definitionKeyword,
          "abstract global Privacy readonly override": e.tags.modifier,
          "is keyof unique infer": e.tags.operatorKeyword,
          JSXAttributeValue: e.tags.attributeValue,
          JSXText: e.tags.content,
          "JSXStartTag JSXStartCloseTag JSXSelfCloseEndTag JSXEndTag": e.tags.angleBracket,
          "JSXIdentifier JSXNameSpacedName": e.tags.tagName,
          "JSXAttribute/JSXIdentifier JSXAttribute/JSXNameSpacedName": e.tags.attributeName,
          "JSXBuiltin/JSXIdentifier": e.tags.standard(e.tags.tagName),
        }),
        n = {
          __proto__: null,
          export: 16,
        ...
        P = i.WQ.deserialize({
          ...
          tokenizers: [
            ...
            new i.RA("j~RQYZXz{^~^O's~~aP!P!Qd~iO't~~", 25, 310),
          ],
          ...
          specialized: [
            { term: 314, get: (O) => n[O] || -1 },
            { term: 330, get: (O) => l[O] || -1 },
            { term: 68, get: (O) => g[O] || -1 },
          ],
          tokenPrec: 12827,
        });
      ...
      const m = [
          ...
          (0, s.Gn)("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", { label: "for", detail: "loop", type: "keyword" }),
          (0, s.Gn)("for (let ${name} of ${collection}) {\n\t${}\n}", { label: "for", detail: "of loop", type: "keyword" }),
          ...
          (0, s.Gn)('import {${names}} from "${module}"\n${}', { label: "import", detail: "named", type: "keyword" }),
          (0, s.Gn)('import ${name} from "${module}"\n${}', { label: "import", detail: "default", type: "keyword" }),
        ],
        b = m.concat([
          (0, s.Gn)("interface ${name} {\n\t${}\n}", { label: "interface", detail: "definition", type: "keyword" }),
          (0, s.Gn)("type ${name} = ${type}", { label: "type", detail: "definition", type: "keyword" }),
          (0, s.Gn)("enum ${name} {\n\t${}\n}", { label: "enum", detail: "definition", type: "keyword" }),
        ]),
        d = new c.NodeWeakMap(),
        x = new Set(["Script", "Block", "FunctionExpression", "FunctionDeclaration", "ArrowFunction", "MethodDeclaration", "ForStatement"]);
      function w(O) {
        return (Q, $) => {
          let i = Q.node.getChild("VariableDefinition");
          return i && $(i, O), !0;
        };
      }
      const y = ["FunctionDeclaration"],
        U = {
      ...
      function _(O, Q) {
        ...
        let i = [],
          e = !0;
        function a(Q, $) {
          let e = O.sliceString(Q.from, Q.to);
          i.push({ label: e, type: $ });
        }
        return (
          Q.cursor(c.IterMode.IncludeAnonymous).iterate((Q) => {
            if (e) e = !1;
            else if (Q.name) {
              let O = U[Q.name];
              if ((O && O(Q, a)) || x.has(Q.name)) return !1;
            } else if (Q.to - Q.from > 8192) {
              for (let $ of _(O, Q.node)) i.push($);
              return !1;
            }
          }),
          d.set(Q, i),
      ...
      function f(O) {
        let Q = (0, p.syntaxTree)(O.state).resolveInner(O.pos, -1);
        if (v.indexOf(Q.name) > -1) return null;
        let $ = "VariableName" == Q.name || (Q.to - Q.from < 20 && W.test(O.state.sliceDoc(Q.from, Q.to)));
        if (!$ && !O.explicit) return null;
        let i = [];
        for (let $ = Q; $; $ = $.parent) x.has($.name) && (i = i.concat(_(O.state.doc, $)));
        return { options: i, from: $ ? Q.from : O.pos, validFor: W };
      }
      function u(O, Q, $) {
        var i;
        let e = [];
        for (;;) {
          let a,
            Z = Q.firstChild;
          if ("VariableName" == (null == Z ? void 0 : Z.name)) return e.push(O(Z)), { path: e.reverse(), name: $ };
          if (
            "MemberExpression" != (null == Z ? void 0 : Z.name) ||
            "PropertyName" != (null === (i = a = Z.lastChild) || void 0 === i ? void 0 : i.name)
          )
            return null;
          e.push(O(a)), (Q = Z);
        }
      ...
      function T(O) {
        let Q = (Q) => O.state.doc.sliceString(Q.from, Q.to),
          $ = (0, p.syntaxTree)(O.state).resolveInner(O.pos, -1);
        return "PropertyName" == $.name
          ? u(Q, $.parent, Q($))
          : ("." != $.name && "?." != $.name) || "MemberExpression" != $.parent.name
            ? v.indexOf($.name) > -1
              ? null
              : "VariableName" == $.name || ($.to - $.from < 20 && W.test(Q($)))
                ? { path: [], name: Q($) }
      ...
      function h(O) {
        ...
        return ($) => {
          ...
          if (!i) return null;
          let e = O;
          for (let O of i.path) if (((e = e[O]), !e)) return null;
          let a = Q.get(e);
          return (
            a ||
              Q.set(
                ...
                (a = (function (O, Q) {
                  let $ = [],
                    i = new Set();
                  for (let e = 0; ; e++) {
                    for (let a of (Object.getOwnPropertyNames || Object.keys)(O)) {
                      if (!/^[a-zA-Z_$\xaa-\uffdc][\w$\xaa-\uffdc]*$/.test(a) || i.has(a)) continue;
                      let Z;
                      i.add(a);
                      try {
                        Z = O[a];
                      ...
                      $.push({
                        label: a,
                        type: "function" == typeof Z ? (/^[A-Z]/.test(a) ? "class" : Q ? "function" : "method") : Q ? "variable" : "property",
                        boost: -e,
                      });
                    }
            ...
            { from: $.pos - i.name.length, options: a, validFor: W }
          );
        };
      }
      const j = p.LRLanguage.define({
          name: "javascript",
          parser: P.configure({
            props: [
              p.indentNodeProp.add({
                IfStatement: (0, p.continuedIndent)({ except: /^\s*({|else\b)/ }),
                TryStatement: (0, p.continuedIndent)({ except: /^\s*({|catch\b|finally\b)/ }),
                LabeledStatement: p.flatIndent,
                SwitchBody: (O) => {
                  let Q = O.textAfter,
                    $ = /^\s*\}/.test(Q),
                    i = /^\s*(case|default)\b/.test(Q);
                  return O.baseIndent + ($ ? 0 : i ? 1 : 2) * O.unit;
                },
                Block: (0, p.delimitedIndent)({ closing: "}" }),
                ArrowFunction: (O) => O.baseIndent + O.unit,
                "TemplateString BlockComment": () => null,
                "Statement Property": (0, p.continuedIndent)({ except: /^{/ }),
                JSXElement(O) {
                ...
                "JSXOpenTag JSXSelfClosingTag": (O) => O.column(O.node.from) + O.unit,
              }),
              p.foldNodeProp.add({
                "Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression ObjectType": p.foldInside,
        ...
        k = { test: (O) => /^JSX/.test(O.name), facet: (0, p.defineLanguageFacet)({ commentTokens: { block: { open: "{/*", close: "*/}" } } }) },
        q = j.configure({ dialect: "ts" }, "typescript"),
        G = j.configure({ dialect: "jsx", props: [p.sublanguageProp.add((O) => (O.isTop ? [k] : void 0))] }),
        R = j.configure({ dialect: "jsx ts", props: [p.sublanguageProp.add((O) => (O.isTop ? [k] : void 0))] }, "typescript");
      let C = (O) => ({ label: O, type: "keyword" });
      const z =
          "break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield"
            .split(" ")
            .map(C),
        V = z.concat(["declare", "implements", "private", "protected", "public"].map(C));
      function E(O = {}) {
        let Q = O.jsx ? (O.typescript ? R : G) : O.typescript ? q : j,
          $ = O.typescript ? b.concat(V) : m.concat(z);
        return new p.LanguageSupport(Q, [j.data.of({ autocomplete: (0, s.eC)(v, (0, s.Mb)($)) }), j.data.of({ autocomplete: f }), O.jsx ? A : []]);
      }
      function I(O, Q, $ = O.length) {
        for (let i = null == Q ? void 0 : Q.firstChild; i; i = i.nextSibling)
          if ("JSXIdentifier" == i.name || "JSXBuiltin" == i.name || "JSXNamespacedName" == i.name || "JSXMemberExpression" == i.name)
            return O.sliceString(i.from, Math.min(i.to, $));
        return "";
      }
      const J = "object" == typeof navigator && /Android\b/.test(navigator.userAgent),
        A = X.EditorView.inputHandler.of((O, Q, $, i, e) => {
          if ((J ? O.composing : O.compositionStarted) || O.state.readOnly || Q != $ || (">" != i && "/" != i) || !j.isActiveAt(O.state, Q, -1))
            return !1;
          let a = e(),
            { state: Z } = a,
            S = Z.changeByRange((O) => {
              ...
              let $,
                { head: e } = O,
                a = (0, p.syntaxTree)(Z).resolveInner(e - 1, -1);
              if (("JSXStartTag" == a.name && (a = a.parent), Z.doc.sliceString(e - 1, e) != i || ("JSXAttributeValue" == a.name && a.to > e)));
              else {
                if (">" == i && "JSXFragmentTag" == a.name) return { range: O, changes: { from: e, insert: "</>" } };
                if ("/" == i && "JSXStartCloseTag" == a.name) {
                  ...
                  if (
                    i &&
                    O.from == e - 2 &&
                    (($ = I(Z.doc, i.firstChild, e)) || "JSXFragmentTag" == (null === (Q = i.firstChild) || void 0 === Q ? void 0 : Q.name))
                  ) {
                    let O = `${$}>`;
                    return { range: Y.EditorSelection.cursor(e + O.length, -1), changes: { from: e, insert: O } };
                  }
                } else if (">" == i) {
                  let Q = (function (O) {
                    for (;;) {
                      if ("JSXOpenTag" == O.name || "JSXSelfClosingTag" == O.name || "JSXFragmentTag" == O.name) return O;
                      if ("JSXEscape" == O.name || !O.parent) return null;
                      O = O.parent;
                    }
                  })(a);
                  if (Q && "JSXOpenTag" == Q.name && !/^\/?>|^<\//.test(Z.doc.sliceString(e, e + 2)) && ($ = I(Z.doc, Q, e)))
                    return { range: O, changes: { from: e, insert: `</${$}>` } };
                }
              }
              return { range: O };
            });
          return !S.changes.empty && (O.dispatch([a, Z.update(S, { userEvent: "input.complete", scrollIntoView: !0 })]), !0);
        });
      function N(O, Q) {
        return (
          Q ||
            ...
            O.getRules().forEach((O, $) => {
              O.meta.docs.recommended && (Q.rules[$] = 2);
            })),
          ($) => {
            let { state: i } = $,
              e = [];
            for (let { from: $, to: a } of j.findRegions(i)) {
              let Z = i.doc.lineAt($),
                S = { line: Z.number - 1, col: $ - Z.from, pos: $ };
              for (let Z of O.verify(i.sliceDoc($, a), Q)) e.push(B(Z, i.doc, S));
            }
            return e;
          }
        );
      ...
      function L(O, Q, $, i) {
        return $.line(O + i.line).from + Q + (1 == O ? i.col - 1 : -1);
      }
      function B(O, Q, $) {
        let i = L(O.line, O.column, Q, $),
          e = {
            from: i,
            to: null != O.endLine && 1 != O.endColumn ? L(O.endLine, O.endColumn, Q, $) : i,
            message: O.message,
            source: O.ruleId ? "eslint:" + O.ruleId : "eslint",
            severity: 1 == O.severity ? "warning" : "error",
          };
        if (O.fix) {
          let { range: Q, text: a } = O.fix,
            Z = Q[0] + $.pos - i,
            S = Q[1] + $.pos - i;
          e.actions = [
            {
              name: "fix",
              apply(O, Q) {
                O.dispatch({ changes: { from: Q + Z, to: Q + S, insert: a }, scrollIntoView: !0 });
              },
            },
          ];
        }
