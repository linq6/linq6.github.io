...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    12552: (O, r, e) => {
      e.r(r), e.d(r, { globalCompletion: () => G, localCompletionSource: () => y, python: () => E, pythonLanguage: () => v });
      var a = e(49906),
        i = e(92209);
      const x = new Set([27, 51, 52, 265, 67, 129, 58, 59, 246, 64, 65, 74, 62, 63, 150, 151, 154]);
      function Q(O) {
        return 10 == O || 13 == O;
      }
      const o = new a.Jq(
          (O, r) => {
            let e;
            if (O.next < 0) O.acceptToken(201);
            else if (r.context.depth < 0) Q(O.next) && O.acceptToken(200, 1);
            else if (((e = O.peek(-1)) < 0 || Q(e)) && r.canShift(199)) {
              let r = 0;
              for (; 32 == O.next || 9 == O.next; ) O.advance(), r++;
              (10 != O.next && 13 != O.next && 35 != O.next) || O.acceptToken(199, -r);
            } else Q(O.next) && O.acceptToken(198, 1);
          },
          { contextual: !0 }
        ),
        S = new a.Jq((O, r) => {
          ...
          if (10 == a || 13 == a) {
            ...
            r != e && 10 != O.next && 13 != O.next && 35 != O.next && (r < e ? O.acceptToken(197, -a) : O.acceptToken(196));
          }
        });
      function t(O, r) {
        (this.parent = O), (this.depth = r), (this.hash = (O ? (O.hash + O.hash) << 8 : 0) + r + (r << 4));
      }
      const T = new t(null, 0),
        s = new a.IK({
          start: T,
          reduce: (O, r) => (O.depth < 0 && x.has(r) ? O.parent : O),
          shift: (O, r, e, a) =>
            196 == r
              ? new t(
                  O,
                  (function (O) {
                    let r = 0;
                    for (let e = 0; e < O.length; e++) r += 9 == O.charCodeAt(e) ? 8 - (r % 8) : 1;
                    return r;
                  })(a.read(a.pos, e.pos))
                )
              : 197 == r
        ...
        n = new a.Jq((O) => {
          ...
          if (!/\w/.test(String.fromCharCode(O.next)))
            for (let r = 0; ; r++) {
              let e = O.peek(r);
              if (32 != e && 9 != e) return void (40 != e && 46 != e && 10 != e && 13 != e && 35 != e && O.acceptToken(1));
            }
        });
      function l(O, r, e, i, x) {
        return new a.Jq((a) => {
          let Q = a.pos;
          for (; !(a.next < 0); )
            if (123 == a.next) {
              if (123 != a.peek(1)) {
                if (a.pos == Q) return void a.acceptToken(i, 1);
                break;
              }
              a.advance(2);
            } else if (92 == a.next) a.advance(), a.next >= 0 && a.advance();
            else {
              if (a.next == O && (1 == r || (a.peek(1) == O && a.peek(2) == O))) {
                if (a.pos == Q) return void a.acceptToken(x, r);
                break;
              }
              a.advance();
            }
          a.pos > Q && a.acceptToken(e);
        });
      }
      const P = l(39, 1, 202, 2, 203),
        p = l(34, 1, 204, 3, 205),
        q = l(39, 3, 206, 4, 207),
        m = l(34, 3, 208, 5, 209),
        $ = (0, i.styleTags)({
        ...
        X = a.WQ.deserialize({
          ...
          tokenizers: [n, S, o, P, p, q, m, 0, 1, 2, 3, 4, 5, 6],
          topRules: { Script: [0, 7] },
          specialized: [{ term: 229, get: (O) => w[O] || -1 }],
          tokenPrec: 7205,
        });
      var c = e(17592),
        W = e(79352),
        d = e(56318);
      const Y = new W.NodeWeakMap(),
        f = new Set(["Script", "Body", "FunctionDefinition", "ClassDefinition", "LambdaExpression", "ForStatement", "MatchClause"]);
      function b(O) {
        return (r, e, a) => {
          if (a) return !1;
      ...
      const V = {
        FunctionDefinition: b("function"),
        ClassDefinition: b("class"),
        ForStatement(O, r, e) {
          if (e)
            for (let e = O.node.firstChild; e; e = e.nextSibling)
              if ("VariableName" == e.name) r(e, "variable");
              else if ("in" == e.name) break;
        },
        ImportStatement(O, r) {
          var e, a;
          let { node: i } = O,
            x = "from" == (null === (e = i.firstChild) || void 0 === e ? void 0 : e.name);
          for (let O = i.getChild("import"); O; O = O.nextSibling)
            "VariableName" == O.name &&
              "as" != (null === (a = O.nextSibling) || void 0 === a ? void 0 : a.name) &&
              r(O, x ? "variable" : "namespace");
        },
        AssignStatement(O, r) {
          for (let e = O.node.firstChild; e; e = e.nextSibling)
            if ("VariableName" == e.name) r(e, "variable");
            else if (":" == e.name || "AssignOp" == e.name) break;
        },
        ParamList(O, r) {
          for (let e = null, a = O.node.firstChild; a; a = a.nextSibling)
            "VariableName" != a.name || (e && /\*|AssignOp/.test(e.name)) || r(a, "variable"), (e = a);
        },
        CapturePattern: b("variable"),
      ...
      function g(O, r) {
        ...
        return (
          r.cursor(W.IterMode.IncludeAnonymous).iterate((r) => {
            if (r.name) {
              let O = V[r.name];
              if ((O && O(r, x, i)) || (!i && f.has(r.name))) return !1;
              i = !1;
            } else if (r.to - r.from > 8192) {
              for (let e of g(O, r.node)) a.push(e);
              return !1;
            }
          }),
          Y.set(r, a),
      ...
      const u = /^[\w\xa1-\uffff][\w\d\xa1-\uffff]*$/,
        R = ["String", "FormatString", "Comment", "PropertyName"];
      function y(O) {
        let r = (0, c.syntaxTree)(O.state).resolveInner(O.pos, -1);
        if (R.indexOf(r.name) > -1) return null;
        let e = "VariableName" == r.name || (r.to - r.from < 20 && u.test(O.state.sliceDoc(r.from, r.to)));
        if (!e && !O.explicit) return null;
        let a = [];
        for (let e = r; e; e = e.parent) f.has(e.name) && (a = a.concat(g(O.state.doc, e)));
        return { options: a, from: e ? r.from : O.pos, validFor: u };
      }
      const Z = [
          "__annotations__",
          "__builtins__",
        ...
        h = [
          ...
          (0, d.Gn)("import ${module}", { label: "import", detail: "statement", type: "keyword" }),
          (0, d.Gn)("from ${module} import ${names}", { label: "from", detail: "import", type: "keyword" }),
        ],
        G = (0, d.eC)(R, (0, d.Mb)(Z.concat(h)));
      function _(O, r) {
        let e = O.baseIndentFor(r),
          a = O.lineAt(O.pos, -1),
          i = a.from + a.text.length;
        return (/^\s*($|#)/.test(a.text) && O.node.to < i + 100 && !/\S/.test(O.state.sliceDoc(i, O.node.to)) && O.lineIndent(O.pos, -1) <= e) ||
          (/^\s*(else:|elif |except |finally:)/.test(O.textAfter) && O.lineIndent(O.pos, -1) > e)
          ? null
          : e + O.unit;
      }
      const v = c.LRLanguage.define({
        name: "python",
        parser: X.configure({
          props: [
            c.indentNodeProp.add({
              Body: (O) => {
                var r;
                return null !== (r = _(O, O.node)) && void 0 !== r ? r : O.continue();
              },
              ...
              "TupleExpression ComprehensionExpression ParamList ArgList ParenthesizedExpression": (0, c.delimitedIndent)({ closing: ")" }),
              "DictionaryExpression DictionaryComprehensionExpression SetExpression SetComprehensionExpression": (0, c.delimitedIndent)({
                closing: "}",
              }),
              "ArrayExpression ArrayComprehensionExpression": (0, c.delimitedIndent)({ closing: "]" }),
              "String FormatString": () => null,
              Script: (O) => {
                if (O.pos + /\s*/.exec(O.textAfter)[0].length >= O.node.to) {
                  let r = null;
                  for (let e = O.node, a = e.to; (e = e.lastChild), e && e.to == a; ) "Body" == e.type.name && (r = e);
                  if (r) {
                    let e = _(O, r);
                    if (null != e) return e;
                  }
            ...
            c.foldNodeProp.add({
              "ArrayExpression DictionaryExpression SetExpression TupleExpression": c.foldInside,
      ...
      function E() {
        return new c.LanguageSupport(v, [v.data.of({ autocomplete: y }), v.data.of({ autocomplete: G })]);
      }
    },
  },
]);
