    ...
    48479: (e, t, r) => {
      function a(e) {
        ...
        function h(e, s) {
          ...
          if (o.hexNumber && (("0" == l && e.match(/^[xX][0-9a-fA-F]+/)) || (("x" == l || "X" == l) && e.match(/^'[0-9a-fA-F]*'/)))) return "number";
          if (o.binaryNumber && ((("b" == l || "B" == l) && e.match(/^'[01]+'/)) || ("0" == l && e.match(/^b[01]*/)))) return "number";
          if (l.charCodeAt(0) > 47 && l.charCodeAt(0) < 58)
            return e.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/), o.decimallessFloat && e.match(/^\.(?!\.)/), "number";
          if ("?" == l && (e.eatSpace() || e.eol() || e.eat(";"))) return "macroName";
          if ("'" == l || ('"' == l && o.doubleQuote)) return (s.tokenize = b(l)), s.tokenize(e, s);
          if (
            ((o.nCharCast && ("n" == l || "N" == l)) || (o.charsetCast && "_" == l && e.match(/[a-z][a-z0-9]*/i))) &&
            ("'" == e.peek() || '"' == e.peek())
          )
            return "keyword";
          if (o.escapeConstant && ("e" == l || "E" == l) && ("'" == e.peek() || ('"' == e.peek() && o.doubleQuote)))
            return (
          ...
          if ((o.commentHash && "#" == l) || ("-" == l && e.eat("-") && (!o.commentSpaceRequired || e.eat(" ")))) return e.skipToEnd(), "comment";
          ...
          if ("." != l) {
            ...
            if ("{" == l && (e.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || e.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/))) return "number";
            e.eatWhile(/^[_\w\d]/);
        ...
        function f(e) {
          return function (t, r) {
            var a = t.match(/^.*?(\/\*|\*\/)/);
            return a ? ("/*" == a[1] ? (r.tokenize = f(e + 1)) : (r.tokenize = e > 1 ? f(e - 1) : h)) : t.skipToEnd(), "comment";
          };
        }
        function _(e, t, r) {
        ...
        return {
          ...
          token: function (e, t) {
            if ((e.sol() && t.context && null == t.context.align && (t.context.align = !1), t.tokenize == h && e.eatSpace())) return null;
