...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [8381],
  {
    68381: (T, O, E) => {
      function I(T) {
        for (var O = {}, E = T.split(" "), I = 0; I < E.length; ++I) O[E[I]] = !0;
        return O;
      }
      E.r(O), E.d(O, { pig: () => C });
      var N =
        ...
        L = /[*+\-%<>=&?:\/!|]/;
      function r(T, O, E) {
        return (O.tokenize = E), E(T, O);
      }
      function U(T, O) {
        for (var E, I = !1; (E = T.next()); ) {
          if ("/" == E && I) {
            O.tokenize = n;
            break;
          }
      ...
      function n(T, O) {
        ...
        return '"' == I || "'" == I
          ? r(
              ...
              ((E = I),
              function (T, O) {
                for (var I, N = !1, A = !1; null != (I = T.next()); ) {
                  if (I == E && !N) {
                    A = !0;
                    break;
                  }
              ...
              : "/" == I
                ...
                : "-" == I
                  ...
                  : L.test(I)
                    ? (T.eatWhile(L), "operator")
                    : (T.eatWhile(/[\w\$_]/),
                      S && S.propertyIsEnumerable(T.current().toUpperCase()) && !T.eat(")") && !T.eat(".")
                        ? "keyword"
                        : R && R.propertyIsEnumerable(T.current().toUpperCase())
                          ? "builtin"
                          : t && t.propertyIsEnumerable(T.current().toUpperCase())
                            ? "type"
                            : "variable");
      }
      const C = {
        name: "pig",
        startState: function () {
          return { tokenize: n, startOfLine: !0 };
        },
        token: function (T, O) {
          return T.eatSpace() ? null : O.tokenize(T, O);
        },
        languageData: { autocomplete: (N + e + A).split(" ") },
      };
    },
  },
]);
