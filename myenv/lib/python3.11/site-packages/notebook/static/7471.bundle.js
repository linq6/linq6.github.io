          ...
          return (
            ...
            (e.action = function (t, e) {
              var r,
                ...
                u = !0,
                c = e[0];
              if (1 === e.length || "boolean" == typeof e[1]) 2 === e.length && (u = e[1]), (a = (r = s(this.methodActions(t), 2))[0]), (l = r[1]);
                ...
                if ("string" == typeof e[2]) {
                  ...
                  var p = s(e.slice(1), 2),
                    h = p[0],
                    f = p[1];
                  (a = (n = s(this.methodActions(h, f), 2))[0]), (l = n[1]);
                } else 3 === e.length && (u = e[2]), (a = (o = s(this.methodActions(e[1]), 2))[0]), (l = o[1]);
              else 4 === e.length && (u = e[3]), (a = (i = s(e.slice(1), 2))[0]), (l = i[1]);
        ...
        g = (function () {
          function t(e, r, n) {
            var o = this,
              i = this.constructor;
            (this.document = e),
              (this.options = (0, l.userOptions)((0, l.defaultOptions)({}, i.OPTIONS), n)),
            ...
            var s = this.options.InputJax || [new v()];
            Array.isArray(s) || (s = [s]),
              (this.inputJax = s),
              (this.adaptor = r),
          ...
          return (
            ...
            (t.prototype.rerender = function (t) {
              return void 0 === t && (t = h.STATE.RERENDER), this.state(t - 1), this.render(), this;
            }),
            (t.prototype.convert = function (t, e) {
              ...
              return (
                ...
                this.outputJax.options.mtextInheritFont && (y.outputData.mtextFamily = f),
                this.outputJax.options.merrorInheritFont && (y.outputData.merrorFamily = f),
                y.convert(this, i),
            ...
            (t.prototype.compile = function () {
              ...
              if (!this.processed.isSet("compile")) {
                var o = [];
                try {
                  for (var s = i(this.math), a = s.next(); !a.done; a = s.next()) {
                    var l = a.value;
            ...
            (t.prototype.typesetError = function (t, e) {
              (t.typesetRoot = this.adaptor.node("mjx-container", { class: "MathJax mjx-output-error", jax: this.outputJax.name }, [
                ...
                t.display && this.adaptor.setAttributes(t.typesetRoot, { style: { display: "block", margin: "1em 0", "text-align": "center" } }),
            ...
            (t.prototype.updateDocument = function () {
              ...
              if (!this.processed.isSet("updateDocument")) {
                try {
                  for (var r = i(this.math.reversed()), n = r.next(); !n.done; n = r.next()) n.value.updateDocument(this);
                } catch (e) {
                  t = { error: e };
                } finally {
                  try {
            ...
            (t.prototype.state = function (t, e) {
              ...
              void 0 === e && (e = !1);
              try {
                for (var o = i(this.math), s = o.next(); !s.done; s = o.next()) s.value.state(t, e);
              } catch (t) {
                r = { error: t };
              } finally {
                try {
              ...
              return (
                t < h.STATE.INSERTED && this.processed.clear("updateDocument"),
                t < h.STATE.TYPESET && (this.processed.clear("typeset"), this.processed.clear("getMetrics")),
                t < h.STATE.COMPILED && this.processed.clear("compile"),
                this
              );
            }),
              ...
              return (
                ...
                t.inputJax &&
                  this.inputJax.forEach(function (e) {
                    return e.reset.apply(e, a([], s(t.inputJax), !1));
                  }),
                t.outputJax && (r = this.outputJax).reset.apply(r, a([], s(t.outputJax), !1)),
                this
              );
            }),
            ...
            (t.prototype.clearMathItemsWithin = function (t) {
              ...
              return (e = this.math).remove.apply(e, a([], s(r), !1)), r;
            }),
            ...
            (t.OPTIONS = {
              ...
              renderActions: (0, l.expandable)({
                find: [h.STATE.FINDMATH, "findMath", "", !1],
                compile: [h.STATE.COMPILED],
                metrics: [h.STATE.METRICS, "getMetrics", "", !1],
                typeset: [h.STATE.TYPESET],
                update: [h.STATE.INSERTED, "updateDocument", !1],
              }),
            }),
    ...
    99331: function (t, e, r) {
      ...
      var l = r(13139),
        ...
        d = (function (t) {
          function e(e, r, n) {
            var o = this,
              i = s((0, u.separateOptions)(n, h.HTMLDomStrings.OPTIONS), 2),
              a = i[0],
              l = i[1];
            return (
              ((o = t.call(this, e, r, a) || this).domStrings = o.options.DomStrings || new h.HTMLDomStrings(l)),
          ...
          return (
              ...
              try {
                for (var u = a(n[t]), c = u.next(); !c.done; c = u.next()) {
                  var p = c.value,
                    ...
                    f = h[0],
                    d = h[1];
                  if (e <= d && "#text" === l.kind(f)) return { node: f, n: Math.max(e, 0), delim: r };
                  e -= d;
                }
              } catch (t) {
                o = { error: t };
            ...
            (e.prototype.findMath = function (t) {
              var e, r, n, o, i, l, c, p, h;
              if (!this.processed.isSet("findMath")) {
                (this.adaptor.document = this.document),
                  (t = (0, u.userOptions)({ elements: this.options.elements || [this.adaptor.body(this.document)] }, t));
                try {
                  for (var f = a(this.adaptor.getElements(t.elements, this.document)), d = f.next(); !d.done; d = f.next()) {
                    var y = d.value,
                      v = s([null, null], 2),
                      m = v[0],
                      x = v[1];
                    try {
                      for (var b = ((n = void 0), a(this.inputJax)), g = b.next(); !g.done; g = b.next()) {
                        var _ = g.value,
                          w = new this.options.MathList();
                        if (_.processStrings) {
                          null === m && ((m = (i = s(this.domStrings.find(y), 2))[0]), (x = i[1]));
                          try {
                            for (var S = ((l = void 0), a(_.findMath(m))), O = S.next(); !O.done; O = S.next()) {
                              var T = O.value;
                          ...
                          try {
                            for (var E = ((p = void 0), a(_.findMath(y))), M = E.next(); !M.done; M = E.next()) {
                              T = M.value;
            ...
            (e.prototype.updateDocument = function () {
              return (
                this.processed.isSet("updateDocument") ||
                  (this.addPageElements(), this.addStyleSheet(), t.prototype.updateDocument.call(this), this.processed.set("updateDocument")),
                this
              );
            }),
            ...
            (e.prototype.findSheet = function (t, e) {
              ...
              if (e)
                try {
                  for (var o = a(this.adaptor.tags(t, "style")), i = o.next(); !i.done; i = o.next()) {
                    var s = i.value;
            ...
            (e.prototype.removeFromDocument = function (t) {
              ...
              if ((void 0 === t && (t = !1), this.processed.isSet("updateDocument")))
                try {
                  for (var n = a(this.math), o = n.next(); !o.done; o = n.next()) {
                    var i = o.value;
            ...
            (e.OPTIONS = i(i({}, l.AbstractMathDocument.OPTIONS), {
              renderActions: (0, u.expandable)(
                i(i({}, l.AbstractMathDocument.OPTIONS.renderActions), { styles: [f.STATE.INSERTED + 1, "", "updateStyleSheet", !1] })
              ),
      ...
      var o = r(4498),
        i = (function () {
          function t(t) {
            void 0 === t && (t = null);
            var e = this.constructor;
            (this.options = (0, o.userOptions)((0, o.defaultOptions)({}, e.OPTIONS), t)), this.init(), this.getPatterns();
          }
          return (
            ...
            (t.prototype.handleText = function (t, e) {
              return e || this.extendString(t, this.adaptor.value(t)), this.adaptor.next(t);
            }),
            ...
            (t.prototype.handleContainer = function (t, e) {
              ...
              var r = this.adaptor.getAttribute(t, "class") || "",
                ...
                i = t;
              return (
                !this.adaptor.firstChild(t) || this.adaptor.getAttribute(t, "data-MJX") || (!o && this.skipHtmlTags.exec(n))
            ...
            (t.prototype.find = function (t) {
              var e, r;
              this.init();
              for (var o = this.adaptor.next(t), i = !1, s = this.options.includeHtmlTags; t && t !== o; ) {
                ...
                "#text" === a
                  ...
                  : s.hasOwnProperty(a)
                    ...
                    : a
                      ? ((t = (e = n(this.handleContainer(t, i), 2))[0]), (i = e[1]))
                      : (t = this.handleOther(t, i)),
                  !t && this.stack.length && (this.pushString(), (t = (r = n(this.stack.pop(), 2))[0]), (i = r[1]));
              }
              this.pushString();
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.prototype.handlesDocument = function (t) {
              ...
              return t instanceof e.window.Document || t instanceof e.window.HTMLElement || t instanceof e.window.DocumentFragment;
            }),
                ...
                if (this.inputJax.processStrings) {
                  ...
                  if (e === this.end.node)
                    this.end.n && this.end.n < this.adaptor.value(this.end.node).length && this.adaptor.split(this.end.node, this.end.n),
                      this.start.n && (e = this.adaptor.split(this.start.node, this.start.n)),
                    ...
                    this.adaptor.insert(this.typesetRoot, e),
                      this.end.n < this.adaptor.value(e).length && this.adaptor.split(e, this.end.n),
          ...
          (t.allocate = function () {
            ...
            try {
              for (var s = o(n), a = s.next(); !a.done; a = s.next()) {
                ...
                if (this.next === t.MAXBIT) throw new Error("Maximum number of bits already allocated");
          ...
          (e.prototype.execute = function () {
            ...
            try {
              for (var o = i(this), l = o.next(); !l.done; l = o.next()) {
                var u = l.value;
                if (!1 === u.item.apply(u, a([], s(r), !1))) return !1;
              }
            } catch (e) {
              t = { error: e };
            } finally {
            ...
            return new Promise(function (e, o) {
              !(function i() {
                for (var l; ++r < n.length; ) {
                  var u = (l = n[r]).item.apply(l, a([], s(t), !1));
    ...
    6811: function (t, e) {
                ...
                return (function (i) {
                  ...
                  for (; s; )
                    try {
                      if (
                        ((r = 1),
                        n && (o = 2 & i[0] ? n.return : i[0] ? n.throw || ((o = n.return) && o.call(n), 0) : n.next) && !(o = o.call(n, i[1])).done)
                      )
                        return o;
      ...
      var a = (function () {
        function t() {
          ...
          (this.list = new s(e.END)), (this.list.next = this.list.prev = this.list), this.push.apply(this, o([], n(t), !1));
        }
        return (
          ...
          (t.prototype.unshift = function () {
            for (var t, e, r = [], n = 0; n < arguments.length; n++) r[n] = arguments[n];
            try {
              for (var o = i(r.slice(0).reverse()), a = o.next(); !a.done; a = o.next()) {
                var l = a.value,
                  u = new s(l);
          ...
          (t.prototype.remove = function () {
            ...
            for (var c = this.list.next; c.data !== e.END; ) {
              var p = c.next;
              s.has(c.data) && ((c.prev.next = c.next), (c.next.prev = c.prev), (c.next = c.prev = null)), (c = p);
            }
          }),
          (t.prototype.clear = function () {
          ...
          (t.prototype.insert = function (t, r) {
            ...
            for (var n = new s(t), o = this.list.next; o.data !== e.END && r(o.data, n.data); ) o = o.next;
