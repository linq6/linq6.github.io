  ...
  [7154],
  {
    72901: function (t, e) {
      ...
      var o = (function () {
        function t(t) {
          ...
          try {
            for (var a = r(Object.keys(t)), o = a.next(); !o.done; o = a.next()) {
              var i = o.value;
        ...
        return (
          (t.prototype.create = function (t) {
            ...
            return (this.node[t] || this.node[this.defaultKind]).apply(void 0, a([], n(e), !1));
          }),
          (t.prototype.setNodeClass = function (t, e) {
            this.nodeMap.set(t, e);
            var r = this,
              o = this.nodeMap.get(t);
            this.node[t] = function () {
              for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
              return new (o.bind.apply(o, a([void 0, r], n(t), !1)))();
            };
          }),
    ...
    12443: function (t, e, r) {
      ...
      var i = o(r(53972)),
        s = (function () {
          function t() {
            (this.mmlFactory = null), (this.factory = { node: t.createNode, token: t.createToken, text: t.createText, error: t.createError });
          }
          return (
            ...
            (t.prototype.create = function (t) {
              for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
              var o = (this.factory[t] || this.factory.node).apply(void 0, a([this, e[0]], n(e.slice(1)), !1));
      ...
      !(function (t) {
        (t.variable = function (t, e) {
          ...
          (t.digit = function (t, e) {
            ...
            a ? ((r = t.create("token", "mn", o, a[0].replace(/[{}]/g, ""))), (t.i += a[0].length - 1)) : (r = t.create("token", "mo", o, e)),
              t.Push(r);
          }),
          ...
          (t.environment = function (t, e, r, o) {
            var i = o[0],
              s = t.itemFactory.create("begin").setProperties({ name: e, end: i });
            (s = r.apply(void 0, a([t, s], n(o.slice(1)), !1))), t.Push(s);
          });
      })(i || (i = {})),
        (e.default = i);
    },
    55661: function (t, e, r) {
      var n =
          (this && this.__read) ||
          function (t, e) {
            var r = "function" == typeof Symbol && t[Symbol.iterator];
    ...
    28027: (t, e) => {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        ((r = e.TexConstant || (e.TexConstant = {})).Variant = {
          NORMAL: "normal",
          BOLD: "bold",
          ITALIC: "italic",
        ...
        (r.Form = { PREFIX: "prefix", INFIX: "infix", POSTFIX: "postfix" }),
        (r.LineBreak = { AUTO: "auto", NEWLINE: "newline", NOBREAK: "nobreak", GOODBREAK: "goodbreak", BADBREAK: "badbreak" }),
        (r.LineBreakStyle = { BEFORE: "before", AFTER: "after", DUPLICATE: "duplicate", INFIXLINBREAKSTYLE: "infixlinebreakstyle" }),
        (r.IndentAlign = { LEFT: "left", CENTER: "center", RIGHT: "right", AUTO: "auto", ID: "id", INDENTALIGN: "indentalign" }),
        (r.IndentShift = { INDENTSHIFT: "indentshift" }),
        (r.LineThickness = { THIN: "thin", MEDIUM: "medium", THICK: "thick" }),
        (r.Notation = {
          LONGDIV: "longdiv",
          ACTUARIAL: "actuarial",
        ...
        (r.Align = { TOP: "top", BOTTOM: "bottom", CENTER: "center", BASELINE: "baseline", AXIS: "axis", LEFT: "left", RIGHT: "right" }),
        (r.Lines = { NONE: "none", SOLID: "solid", DASHED: "dashed" }),
        (r.Side = { LEFT: "left", RIGHT: "right", LEFTOVERLAP: "leftoverlap", RIGHTOVERLAP: "rightoverlap" }),
        (r.Width = { AUTO: "auto", FIT: "fit" }),
        (r.Actiontype = { TOGGLE: "toggle", STATUSLINE: "statusline", TOOLTIP: "tooltip", INPUT: "input" }),
        (r.Overflow = { LINBREAK: "linebreak", SCROLL: "scroll", ELIDE: "elide", TRUNCATE: "truncate", SCALE: "scale" }),
        (r.Unit = { EM: "em", EX: "ex", PX: "px", IN: "in", CM: "cm", MM: "mm", PT: "pt", PC: "pc" });
    },
    32742: function (t, e, r) {
      var n,
        a,
        o =
          (this && this.__extends) ||
      ...
      function b(t, e) {
        var r = t.stack.env.font ? { mathvariant: t.stack.env.font } : {},
          n = f.MapHandler.getMap("remap").lookup(e),
          a = (0, v.getRange)(e),
          o = a ? a[3] : "mo",
          i = t.create("token", o, r, n ? n.char : e);
        a[4] && i.attributes.set("mathvariant", a[4]),
          "mo" === o && (d.default.setProperty(i, "fixStretchy", !0), t.configuration.addNode("fixStretchy", i)),
          t.Push(i);
      }
      new m.CharacterMap("remap", null, { "-": "−", "*": "∗", "`": "‘" }), (e.Other = b);
      var A = (function (t) {
        function e() {
          return (null !== t && t.apply(this, arguments)) || this;
        }
      ...
      (e.BaseTags = A),
        (e.BaseConfiguration = p.Configuration.create("base", {
          ...
          items:
            ((a = {}),
            (a[y.StartItem.prototype.kind] = y.StartItem),
            (a[y.StopItem.prototype.kind] = y.StopItem),
            (a[y.OpenItem.prototype.kind] = y.OpenItem),
            (a[y.CloseItem.prototype.kind] = y.CloseItem),
            (a[y.PrimeItem.prototype.kind] = y.PrimeItem),
            (a[y.SubsupItem.prototype.kind] = y.SubsupItem),
            (a[y.OverItem.prototype.kind] = y.OverItem),
            (a[y.LeftItem.prototype.kind] = y.LeftItem),
            (a[y.Middle.prototype.kind] = y.Middle),
            (a[y.RightItem.prototype.kind] = y.RightItem),
            (a[y.BeginItem.prototype.kind] = y.BeginItem),
            (a[y.EndItem.prototype.kind] = y.EndItem),
            (a[y.StyleItem.prototype.kind] = y.StyleItem),
            (a[y.PositionItem.prototype.kind] = y.PositionItem),
            (a[y.CellItem.prototype.kind] = y.CellItem),
            (a[y.MmlItem.prototype.kind] = y.MmlItem),
            (a[y.FnItem.prototype.kind] = y.FnItem),
            (a[y.NotItem.prototype.kind] = y.NotItem),
            (a[y.NonscriptItem.prototype.kind] = y.NonscriptItem),
            (a[y.DotsItem.prototype.kind] = y.DotsItem),
            (a[y.ArrayItem.prototype.kind] = y.ArrayItem),
            (a[y.EqnArrayItem.prototype.kind] = y.EqnArrayItem),
            (a[y.EquationItem.prototype.kind] = y.EquationItem),
            a),
          options: {
            maxMacros: 1e3,
            baseURL:
              ...
              function (t) {
                ...
                try {
                  for (var a = u(n.getList("nonscript")), o = a.next(); !o.done; o = a.next()) {
                    ...
                    } else i.isKind("mrow") && (i.parent.replaceChild(i.childNodes[0], i), n.removeFromList("mrow", [i]));
                  }
                } catch (t) {
                  e = { error: t };
                } finally {
    ...
    31201: function (t, e, r) {
        ...
        m = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkItem = function (e) {
              if (e.isKind("stop")) {
                var r = this.toMml();
                return this.global.isInner || (r = this.factory.configuration.tags.finalize(r, this.env)), [[this.factory.create("mml", r)], !0];
              }
          ...
          (e.prototype.checkItem = function (e) {
            ...
            if (e.isKind("mml")) {
              if (this.getProperty("primes"))
                if (2 !== n) h.default.setChild(r, 2, this.getProperty("primes"));
                else {
            ...
            if (t.prototype.checkItem.call(this, e)[1]) {
              ...
              throw new (p.default.bind.apply(p.default, i([void 0, s[0], s[1]], o(s.splice(2)), !1)))();
            }
            return null;
          }),
          (e.errors = Object.assign(Object.create(d.BaseItem.errors), {
      ...
      var S = (function (t) {
        ...
        return (
          ...
          (e.prototype.checkItem = function (e) {
            if (e.isKind("over")) throw new p.default("AmbiguousUseOf", "Ambiguous use of %1", e.getName());
            if (e.isClose) {
              var r = this.create("node", "mfrac", [this.getProperty("num"), this.toMml(!1)]);
              return (
                null != this.getProperty("thickness") && h.default.setAttribute(r, "linethickness", this.getProperty("thickness")),
      ...
      var P = (function (t) {
        ...
        return (
          ...
          (e.prototype.checkItem = function (e) {
            ...
            if (e.isKind("middle")) {
              ...
              return (
                ...
                this.Push(
                  this.create("node", "TeXAtom", [], { texClass: c.TEXCLASS.CLOSE }),
                  this.create("token", "mo", r, e.getProperty("delim")),
                  this.create("node", "TeXAtom", [], { texClass: c.TEXCLASS.OPEN })
                ),
                (this.env = {}),
                [[this], !0]
              );
          ...
          (e.errors = Object.assign(Object.create(d.BaseItem.errors), { stop: ["ExtraLeftMissingRight", "Extra \\left or missing \\right"] })),
          e
        );
      })(d.BaseItem);
      e.LeftItem = P;
      ...
      var O = (function (t) {
        ...
        return (
          ...
          (e.prototype.checkItem = function (e) {
            if (e.isKind("end")) {
              if (e.getName() !== this.getName()) throw new p.default("EnvBadEnd", "\\begin{%1} ended with \\end{%2}", this.getName(), e.getName());
              return this.getProperty("end") ? d.BaseItem.fail : [[this.factory.create("mml", this.toMml())], !0];
            }
            if (e.isKind("stop")) throw new p.default("EnvMissingEnd", "Missing \\end{%1}", this.getName());
            return t.prototype.checkItem.call(this, e);
          }),
          e
        );
      ...
      var E = (function (t) {
        ...
        return (
          ...
          (e.prototype.checkItem = function (e) {
            if (e.isClose) throw new p.default("MissingBoxFor", "Missing box for %1", this.getName());
            if (e.isFinal) {
              var r = e.toMml();
              switch (this.getProperty("move")) {
                ...
                case "horizontal":
                  return [[this.factory.create("mml", this.getProperty("left")), e, this.factory.create("mml", this.getProperty("right"))], !0];
              }
            }
            return t.prototype.checkItem.call(this, e);
          }),
          ...
          (e.prototype.checkItem = function (e) {
            ...
            if (r) {
              ...
              if (!e.isKind("fn")) {
                ...
                if (
                  (h.default.isType(n, "mstyle") && n.childNodes.length && h.default.isType(n.childNodes[0].childNodes[0], "mspace")) ||
              ...
              return [[r, this.create("token", "mo", { texClass: c.TEXCLASS.NONE }, u.entities.ApplyFunction), e], !0];
            }
      ...
      var w = (function (t) {
        ...
        return (
          ...
          (e.prototype.checkItem = function (t) {
            ...
            if (
              t.isKind("mml") &&
              (h.default.isType(t.First, "mo") || h.default.isType(t.First, "mi") || h.default.isType(t.First, "mtext")) &&
              ((e = t.First),
              1 === (r = h.default.getText(e)).length && !h.default.getProperty(e, "movesupsub") && 1 === h.default.getChildren(e).length)
            )
              return (
                this.remap.contains(r)
                  ? ((n = this.create("text", this.remap.lookup(r).char)), h.default.setChild(e, 0, n))
        ...
        return (
          ...
          (e.prototype.checkItem = function (e) {
            if (e.isClose && !e.isKind("over")) {
              ...
              if (e.getProperty("isCR")) return this.EndEntry(), this.EndRow(), this.clearEnv(), d.BaseItem.fail;
          ...
          (e.prototype.createMml = function () {
            ...
            return (
              ...
              4 === this.frame.length
                ...
                : this.frame.length &&
                  (this.arraydef.rowlines && (this.arraydef.rowlines = this.arraydef.rowlines.replace(/none( none)+$/, "none")),
                  h.default.setAttribute(e, "frame", ""),
                  (e = this.create("node", "menclose", [e], { notation: this.frame.join(" ") })),
                  ("none" === (this.arraydef.columnlines || "none") && "none" === (this.arraydef.rowlines || "none")) ||
                    h.default.setAttribute(e, "data-padding", 0)),
              (this.getProperty("open") || this.getProperty("close")) &&
                (e = f.default.fenced(this.factory.configuration, this.getProperty("open"), e, this.getProperty("close"))),
              e
            );
          }),
          (e.prototype.EndEntry = function () {
            ...
            this.hfill.length &&
              ...
              this.hfill[this.hfill.length - 1] === this.Size() &&
                h.default.setAttribute(t, "columnalign", h.default.getAttribute(t, "columnalign") ? "center" : "left")),
              this.row.push(t),
              this.Clear(),
              (this.hfill = []);
          }),
          ...
          (e.prototype.checkLines = function () {
            ...
            if (this.getProperty("rowspacing")) {
              for (var e = this.arraydef.rowspacing.split(/ /); e.length < this.table.length; ) e.push(this.getProperty("rowspacing") + "em");
          ...
          (e.prototype.addRowSpacing = function (t) {
            if (this.arraydef.rowspacing) {
              ...
              for (var n = this.getProperty("rowspacing"); e.length < this.table.length; ) e.push(f.default.Em(n));
              (e[this.table.length - 1] = f.default.Em(Math.max(0, n + f.default.dimen2em(t)))), (this.arraydef.rowspacing = e.join(" "));
            }
          }),
          e
        );
    ...
    23430: function (t, e, r) {
      ...
      new s.RegExpMap("letter", c.default.variable, /[a-z]/i),
        ...
        new s.CharacterMap("mathchar0mo", c.default.mathchar0mo, {
          surd: "√",
          coprod: ["∐", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigvee: ["⋁", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigwedge: ["⋀", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          biguplus: ["⨄", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigcap: ["⋂", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigcup: ["⋃", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          int: ["∫", { texClass: f.TEXCLASS.OP }],
          intop: ["∫", { texClass: f.TEXCLASS.OP, movesupsub: !0, movablelimits: !0 }],
          iint: ["∬", { texClass: f.TEXCLASS.OP }],
          iiint: ["∭", { texClass: f.TEXCLASS.OP }],
          prod: ["∏", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          sum: ["∑", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigotimes: ["⨂", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigoplus: ["⨁", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          bigodot: ["⨀", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          oint: ["∮", { texClass: f.TEXCLASS.OP }],
          bigsqcup: ["⨆", { texClass: f.TEXCLASS.OP, movesupsub: !0 }],
          smallint: ["∫", { largeop: !1 }],
          triangleleft: "◃",
          triangleright: "▹",
          bigtriangleup: "△",
        ...
        new s.CommandMap(
          "macros",
          {
            ...
            Space: ["Rule", "blank"],
            nonscript: "Nonscript",
            big: ["MakeBig", f.TEXCLASS.ORD, 0.85],
            Big: ["MakeBig", f.TEXCLASS.ORD, 1.15],
            bigg: ["MakeBig", f.TEXCLASS.ORD, 1.45],
            Bigg: ["MakeBig", f.TEXCLASS.ORD, 1.75],
            bigl: ["MakeBig", f.TEXCLASS.OPEN, 0.85],
            Bigl: ["MakeBig", f.TEXCLASS.OPEN, 1.15],
            biggl: ["MakeBig", f.TEXCLASS.OPEN, 1.45],
            Biggl: ["MakeBig", f.TEXCLASS.OPEN, 1.75],
            bigr: ["MakeBig", f.TEXCLASS.CLOSE, 0.85],
            Bigr: ["MakeBig", f.TEXCLASS.CLOSE, 1.15],
            biggr: ["MakeBig", f.TEXCLASS.CLOSE, 1.45],
            Biggr: ["MakeBig", f.TEXCLASS.CLOSE, 1.75],
            bigm: ["MakeBig", f.TEXCLASS.REL, 0.85],
            Bigm: ["MakeBig", f.TEXCLASS.REL, 1.15],
            biggm: ["MakeBig", f.TEXCLASS.REL, 1.45],
            Biggm: ["MakeBig", f.TEXCLASS.REL, 1.75],
        ...
        new s.EnvironmentMap(
          ...
          c.default.environment,
          {
            ...
            eqnarray: ["EqnArray", null, !0, !0, "rcl", p.default.cols(0, h.MATHSPACE.thickmathspace), ".5em"],
          },
          u.default
        ),
    ...
    76914: function (t, e, r) {
      ...
      var u = i(r(31201)),
        ...
        b = r(4498),
        A = {},
        S = { fontfamily: 1, fontsize: 1, fontweight: 1, fontstyle: 1, color: 1, background: 1, id: 1, class: 1, href: 1, style: 1 };
      function P(t, e) {
        var r = t.stack.env,
          n = r.inRoot;
        r.inRoot = !0;
        var a = new f.default(e, r, t.configuration),
          o = a.mml(),
          i = a.stack.global;
      ...
      (A.Open = function (t, e) {
        ...
        (A.Superscript = function (t, e) {
          ...
          if (
            (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup") && c.default.getChildAt(a, a.sup)) ||
          ...
          (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup")) ||
            (i
              ? ((!c.default.isType(a, "munderover") || c.default.isType(a, "mover") || c.default.getChildAt(a, a.over)) &&
                  (a = t.create("node", "munderover", [a], { movesupsub: !0 })),
                (l = a.over))
              : (l = (a = t.create("node", "msubsup", [a])).sup)),
            t.Push(t.itemFactory.create("subsup", a).setProperties({ position: l, primes: n, movesupsub: i }));
        }),
        (A.Subscript = function (t, e) {
          ...
          if (
            (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup") && c.default.getChildAt(a, a.sub)) ||
            (c.default.isType(a, "munderover") &&
              !c.default.isType(a, "mover") &&
          ...
          (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup")) ||
            (i
              ? ((!c.default.isType(a, "munderover") || c.default.isType(a, "mover") || c.default.getChildAt(a, a.under)) &&
                  (a = t.create("node", "munderover", [a], { movesupsub: !0 })),
                (l = a.under))
        ...
        (A.Prime = function (t, e) {
          var r = t.stack.Prev();
          if ((r || (r = t.create("node", "mi")), c.default.isType(r, "msubsup") && !c.default.isType(r, "msup") && c.default.getChildAt(r, r.sup)))
            throw new p.default("DoubleExponentPrime", "Prime causes double exponent: use braces to clarify");
          var n = "";
          t.i--;
          do {
        ...
        (A.MathFont = function (t, e, r) {
          var a = t.GetArgument(e),
            o = new f.default(a, n(n({}, t.stack.env), { font: r, multiLetterIdentifiers: /^[a-zA-Z]+/, noAutoOP: !0 }), t.configuration).mml();
        ...
        (A.SetStyle = function (t, e, r, n, a) {
          (t.stack.env.style = r),
            (t.stack.env.level = a),
            t.Push(t.itemFactory.create("style").setProperty("styles", { displaystyle: n, scriptlevel: a }));
        }),
        (A.SetSize = function (t, e, r) {
          (t.stack.env.size = r), t.Push(t.itemFactory.create("style").setProperty("styles", { mathsize: (0, g.em)(r) }));
        }),
        ...
        (A.NamedOp = function (t, e, r) {
          ...
          var n = t.create("token", "mo", { movablelimits: !0, movesupsub: !0, form: h.TexConstant.Form.PREFIX, texClass: m.TEXCLASS.OP }, r);
          t.Push(n);
        }),
        (A.Limits = function (t, e, r) {
          var n = t.stack.Prev(!0);
          if (!n || (c.default.getTexClass(c.default.getCoreMO(n)) !== m.TEXCLASS.OP && null == c.default.getProperty(n, "movesupsub")))
          ...
          c.default.isType(n, "munderover") && !r
            ...
            : c.default.isType(n, "msubsup") && r && ((a = t.create("node", "munderover")), c.default.copyChildren(n, a), (n = o.Last = a)),
        ...
        (A.Over = function (t, e, r, n) {
          ...
          r || n
            ...
            : e.match(/withdelims$/) && (a.setProperty("open", t.GetDelimiter(e)), a.setProperty("close", t.GetDelimiter(e))),
            e.match(/^\\above/) ? a.setProperty("thickness", t.GetDimen(e)) : (e.match(/^\\atop/) || r || n) && a.setProperty("thickness", 0),
            t.Push(a);
        }),
        (A.Frac = function (t, e) {
          var r = t.ParseArg(e),
        ...
        (A.Sqrt = function (t, e) {
          ...
          var a = new f.default(n, t.stack.env, t.configuration).mml();
          (a = r ? t.create("node", "mroot", [a, P(t, r)]) : t.create("node", "msqrt", [a])), t.Push(a);
        }),
        (A.Root = function (t, e) {
          var r = t.GetUpTo(e, "\\of"),
            n = t.ParseArg(e),
            a = t.create("node", "mroot", [n, P(t, r)]);
          t.Push(a);
        }),
        (A.MoveRoot = function (t, e, r) {
          if (!t.stack.env.inRoot) throw new p.default("MisplacedMoveRoot", "%1 can appear only within a root", t.currentCS);
          if (t.stack.global[r]) throw new p.default("MultipleMoveRoot", "Multiple use of %1", t.currentCS);
          var n = t.GetArgument(e);
          if (!n.match(/-?[0-9]+/)) throw new p.default("IntegerArg", "The argument to %1 must be an integer", t.currentCS);
          "-" !== (n = parseInt(n, 10) / 15 + "em").substr(0, 1) && (n = "+" + n), (t.stack.global[r] = n);
        }),
        (A.Accent = function (t, e, r, a) {
          var o = t.ParseArg(e),
            i = n(n({}, d.default.getFontDef(t)), { accent: !0, mathaccent: !0 }),
          ...
          (c.default.isType(u, "mo") || c.default.getProperty(u, "movablelimits")) && c.default.setProperties(u, { movablelimits: !1 });
          var p = t.create("node", "munderover");
          c.default.setChild(p, 0, o), c.default.setChild(p, 1, null), c.default.setChild(p, 2, l);
        ...
        (A.UnderOver = function (t, e, r, n) {
          var a = c.default.createEntity(r),
            ...
            s = t.ParseArg(e);
          t.Push(d.default.underOver(t, s, o, i, n));
        }),
        ...
        (A.Overunderset = function (t, e) {
          ...
          var o = t.create("node", "munderover", [a, n, r], { accent: !1, accentunder: !1 });
          t.Push(o);
        }),
        (A.TeXAtom = function (t, e, r) {
          ...
          if (r === m.TEXCLASS.OP) {
            ...
            l
              ? ((i.mathvariant = h.TexConstant.Variant.NORMAL), (a = t.create("token", "mi", i, l[1])))
              : ((o = new f.default(s, t.stack.env, t.configuration).mml()), (a = t.create("node", "TeXAtom", [o], i))),
        ...
        (A.MmlToken = function (t, e) {
          ...
          if (!r || !r.isToken) throw new p.default("NotMathMLToken", "%1 is not a token element", n);
          for (; "" !== a; ) {
            var l = a.match(/^([a-z]+)\s*=\s*('[^']*'|"[^"]*"|[^ ,]*)\s*,?\s*/i);
            if (!l) throw new p.default("InvalidMathMLAttr", "Invalid MathML attribute: %1", a);
            ...
            u && ("true" === u.toLowerCase() ? (u = !0) : "false" === u.toLowerCase() && (u = !1), (i[l[1]] = u), s.push(l[1])),
              (a = a.substr(l[0].length));
          }
          s.length && (i["mjx-keep-attrs"] = s.join(" "));
          var f = t.create("text", o);
          r.appendChild(f), c.default.setProperties(r, i), t.Push(r);
        }),
        ...
        (A.rule = function (t, e) {
          var r = t.GetBrackets(e),
            n = t.GetDimen(e),
            a = t.GetDimen(e),
            o = t.create("node", "mspace", [], { width: n, height: a, mathbackground: t.stack.env.color || "black" });
          r &&
            ((o = t.create("node", "mpadded", [o], { voffset: r })),
            r.match(/^\-/)
              ? (c.default.setAttribute(o, "height", r), c.default.setAttribute(o, "depth", "+" + r.substr(1)))
        ...
        (A.MakeBig = function (t, e, r, n) {
          var a = String((n *= 1.411764705882353)).replace(/(\.\d\d\d).+/, "$1") + "em",
            ...
            i = t.create("token", "mo", { minsize: a, maxsize: a, fence: !0, stretchy: !0, symmetric: !0 }, o),
        ...
        (A.FrameBox = function (t, e) {
          var r = t.GetBrackets(e),
            n = t.GetBrackets(e) || "c",
            a = d.default.internalMath(t, t.GetArgument(e));
          r && (a = [t.create("node", "mpadded", a, { width: r, "data-align": (0, b.lookup)(n, { l: "left", r: "right" }, "center") })]);
          var o = t.create("node", "TeXAtom", [t.create("node", "menclose", a, { notation: "box" })], { texClass: m.TEXCLASS.ORD });
          t.Push(o);
        }),
        (A.Not = function (t, e) {
        ...
        (A.Matrix = function (t, e, r, n, a, o, i, s, l, u) {
          var c = t.GetNext();
          if ("" === c) throw new p.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          "{" === c ? t.i++ : ((t.string = c + "}" + t.string.slice(t.i + 1)), (t.i = 0));
          var f = t.itemFactory.create("array").setProperty("requireClose", !0);
          (f.arraydef = { rowspacing: i || "4pt", columnspacing: o || "1em" }),
        ...
        (A.Entry = function (t, e) {
          ...
          if (r.getProperty("isCases") || n) {
            for (
              ...
              var c = a.charAt(s);
              if ("{" === c) o++, s++;
              else if ("}" === c) 0 === o ? (l = 0) : (0 == --o && i < 0 && (i = s - t.i), s++);
              else {
                if ("&" === c && 0 === o) throw new p.default("ExtraAlignTab", "Extra alignment tab in \\cases text");
                if ("\\" === c) {
                  var f = a.substr(s);
                  f.match(/^((\\cr)[^a-zA-Z]|\\\\)/) || (u && f.match(u)) ? (l = 0) : (s += 2);
                } else s++;
              }
            }
        ...
        (A.CrLaTeX = function (t, e, r) {
          var n;
          if ((void 0 === r && (r = !1), !r && ("*" === t.string.charAt(t.i) && t.i++, "[" === t.string.charAt(t.i)))) {
            var a = t.GetBrackets(e, ""),
              o = s(d.default.matchDimen(a), 2),
              i = o[0],
              l = o[1];
            if (a && !i) throw new p.default("BracketMustBeDimension", "Bracket argument to %1 must be a dimension", t.currentCS);
            n = i + l;
          }
          t.Push(t.itemFactory.create("cell").setProperties({ isCR: !0, name: e, linebreak: !0 }));
          var c,
            f = t.stack.Top();
          f instanceof u.ArrayItem
            ? n && f.addRowSpacing(n)
            : (n && ((c = t.create("node", "mspace", [], { depth: n })), t.Push(c)),
              (c = t.create("node", "mspace", [], { linebreak: h.TexConstant.LineBreak.NEWLINE })),
              t.Push(c));
        }),
        (A.HLine = function (t, e, r) {
          null == r && (r = "solid");
          var n = t.stack.Top();
          if (!(n instanceof u.ArrayItem) || n.Size()) throw new p.default("Misplaced", "Misplaced %1", t.currentCS);
          if (n.table.length) {
            for (var a = n.arraydef.rowlines ? n.arraydef.rowlines.split(/ /) : []; a.length < n.table.length; ) a.push("none");
            (a[n.table.length - 1] = r), (n.arraydef.rowlines = a.join(" "));
          } else n.frame.push("top");
        }),
        (A.HFill = function (t, e) {
          var r = t.stack.Top();
          if (!(r instanceof u.ArrayItem)) throw new p.default("UnsupportedHFill", "Unsupported use of %1", t.currentCS);
          r.hfill.push(r.Size());
        }),
        (A.BeginEnd = function (t, e) {
          var r = t.GetArgument(e);
          if (r.match(/\\/i)) throw new p.default("InvalidEnv", "Invalid environment name '%1'", r);
        ...
        (A.Array = function (t, e, r, n, a, o, i, s, l) {
          ...
          return (
            (c.arraydef = { columnalign: a, columnspacing: o || "1em", rowspacing: i || "4pt" }),
            u.match(/[|:]/) &&
        ...
        (A.Equation = function (t, e, r) {
          return t.Push(e), d.default.checkEqnEnv(t), t.itemFactory.create("equation", r).setProperty("name", e.getName());
        }),
        ...
        (A.HandleLabel = function (t, e) {
          ...
          if ("" !== r && !t.tags.refUpdate) {
            if (t.tags.label) throw new p.default("MultipleCommand", "Multiple %1", t.currentCS);
            if (((t.tags.label = r), (t.tags.allLabels[r] || t.tags.labels[r]) && !t.options.ignoreDuplicateLabels))
        ...
        (A.HandleRef = function (t, e, r) {
          ...
          a || (t.tags.refUpdate || (t.tags.redo = !0), (a = new y.Label()));
          var o = a.tag;
          r && (o = t.tags.formatTag(o));
          var i = t.create("node", "mrow", d.default.internalMath(t, o), { href: t.tags.formatUrl(a.id, t.options.baseURL), class: "MathJax_ref" });
          t.Push(i);
        }),
    ...
    56780: (t, e) => {
      Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        (e.length2em = function (t, r, n, a) {
          ...
          var o = t.match(/^\s*([-+]?(?:\.\d+|\d+(?:\.\d*)?))?(pt|em|ex|mu|px|pc|in|mm|cm|%)?/);
          if (!o) return r;
        ...
        (e.em = function (t) {
          return Math.abs(t) < 0.001 ? "0" : t.toFixed(3).replace(/\.?0+$/, "") + "em";
        }),
        (e.emRounded = function (t, e) {
          return (
            void 0 === e && (e = 16), (t = (Math.round(t * e) + 0.05) / e), Math.abs(t) < 0.001 ? "0em" : t.toFixed(3).replace(/\.?0+$/, "") + "em"
          );
        }),
        (e.px = function (t, r, n) {
          return (
