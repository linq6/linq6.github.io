    ...
    21605: (t, e) => {
      Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        (e.protoItem = function (t, e, r, n, o, i, a) {
          return void 0 === a && (a = null), { open: t, math: e, close: r, n, start: { n: o }, end: { n: i }, display: a };
        });
      var r = (function () {
    ...
    27582: function (t, e, r) {
      ...
      var b = (function (t) {
        function e(r) {
          void 0 === r && (r = {});
          var n = this,
            o = a((0, l.separateOptions)(r, e.OPTIONS, c.FindTeX.OPTIONS), 3),
            i = o[0],
            s = o[1],
            u = o[2];
          (n = t.call(this, s) || this).findTeX = n.options.FindTeX || new c.FindTeX(u);
          var f = n.options.packages,
            d = (n.configuration = e.configure(f)),
            h = (n._parseOptions = new y.default(d, [n.options, v.TagsFactory.OPTIONS]));
          return (
            (0, l.userOptions)(h.options, i),
            d.config(n),
            e.tags(h, d),
        ...
        return (
          ...
          (e.configure = function (t) {
            var e = new m.ParserConfiguration(t, ["tex"]);
            return e.init(), e;
          }),
          (e.tags = function (t, e) {
          ...
          (e.prototype.compile = function (t, e) {
            ...
            try {
              var i = new d.default(this.latex, { display: o, isInner: !1 }, this.parseOptions);
            ...
            return (
              ...
              (null == n ? void 0 : n.indentalign) && f.default.setAttribute(r, "indentalign", n.indentalign),
          ...
          (e.NAME = "TeX"),
          (e.OPTIONS = i(i({}, u.AbstractInputJax.OPTIONS), {
            FindTeX: null,
            packages: ["base"],
      ...
      !(function (t) {
        (t.cleanStretchy = function (t) {
          var e,
            ...
            o = t.data;
          try {
            for (var i = n(o.getList("fixStretchy")), a = i.next(); !a.done; a = i.next()) {
              var u = a.value;
              if (s.default.getProperty(u, "fixStretchy")) {
                var l = s.default.getForm(u);
                l && l[3] && l[3].stretchy && s.default.setAttribute(u, "stretchy", !1);
                var c = u.parent;
                if (!(s.default.getTexClass(u) || (l && l[2]))) {
                  var p = o.nodeFactory.create("node", "TeXAtom", [u]);
                  c.replaceChild(p, u), p.inheritAttributesFrom(u);
                }
                s.default.removeProperties(u, "fixStretchy");
              }
            }
          } catch (t) {
            e = { error: t };
          ...
          (t.cleanAttributes = function (t) {
            t.data.root.walkTree(function (t, e) {
              var r,
                ...
                i = t.attributes;
              if (i) {
                var a = new Set((i.get("mjx-keep-attrs") || "").split(/ /));
                delete i.getAllAttributes()["mjx-keep-attrs"];
                try {
                  for (var s = n(i.getExplicitNames()), u = s.next(); !u.done; u = s.next()) {
                    var l = u.value;
                    a.has(l) || i.attributes[l] !== t.attributes.getInherited(l) || delete i.attributes[l];
                  }
                } catch (t) {
                  r = { error: t };
                } finally {
          ...
          (t.combineRelations = function (t) {
            var o,
              ...
              c = [];
            try {
              for (var p = n(t.data.getList("mo")), f = p.next(); !f.done; f = p.next()) {
                var d = f.value;
                if (
                  !d.getProperty("relationsCombined") &&
                  d.parent &&
                  (!d.parent || s.default.isType(d.parent, "mrow")) &&
                  s.default.getTexClass(d) === a.TEXCLASS.REL
                ) {
                  for (
                    var h = d.parent, y = void 0, v = h.childNodes, m = v.indexOf(d) + 1, b = s.default.getProperty(d, "variantForm");
                    m < v.length && (y = v[m]) && s.default.isType(y, "mo") && s.default.getTexClass(y) === a.TEXCLASS.REL;

                  ) {
                    if (b !== s.default.getProperty(y, "variantForm") || !r(d, y)) {
                      null == d.attributes.getExplicit("rspace") && s.default.setAttribute(d, "rspace", "0pt"),
                        null == y.attributes.getExplicit("lspace") && s.default.setAttribute(y, "lspace", "0pt");
                      break;
                    }
                    s.default.appendChildren(d, s.default.getChildren(y)), e(["stretchy", "rspace"], d, y);
                    try {
                      for (var g = ((u = void 0), n(y.getPropertyNames())), T = g.next(); !T.done; T = g.next()) {
                        var E = T.value;
                        d.setProperty(E, y.getProperty(E));
                      }
                    } catch (t) {
                      u = { error: t };
                    } finally {
                    ...
                    v.splice(m, 1), c.push(y), (y.parent = null), y.setProperty("relationsCombined", !0);
                  }
        ...
        var e = function (t, e, r) {
          ...
          r = function (t, e) {
            ...
            try {
              for (var c = n(u), p = c.next(); !p.done; p = c.next()) {
                var f = p.value;
          ...
          o = function (t, e, r) {
            var o,
              ...
              a = [];
            try {
              for (var u = n(t.getList("m" + e + r)), l = u.next(); !l.done; l = u.next()) {
                var c = l.value,
                  p = c.childNodes;
                if (!p[c[e]] || !p[c[r]]) {
                  var f = c.parent,
                    d = p[c[e]]
                      ...
                      : t.nodeFactory.create("node", "m" + r, [p[c.base], p[c[r]]]);
                  s.default.copyAttributes(c, d), f ? f.replaceChild(d, c) : (t.root = d), a.push(c);
                }
              }
            } catch (t) {
              o = { error: t };
        ...
        var i = function (t, e, r) {
          var o,
            ...
            a = [];
          try {
            for (var u = n(t.getList(e)), l = u.next(); !l.done; l = u.next()) {
              var c = l.value;
              if (!c.attributes.get("displaystyle")) {
                var p = c.childNodes[c.base],
                  f = p.coreMO();
                if (p.getProperty("movablelimits") && !f.attributes.getExplicit("movablelimits")) {
                  var d = t.nodeFactory.create("node", r, c.childNodes);
                  s.default.copyAttributes(c, d), c.parent ? c.parent.replaceChild(d, c) : (t.root = d), a.push(c);
                }
              }
            }
          } catch (t) {
          ...
          return (
            ...
            (e.prototype.addPattern = function (t, e, r) {
              var n = i(e, 2),
                o = n[0],
                a = n[1];
              t.push((0, s.quotePattern)(o)), (this.end[o] = [a, r, this.endPattern(a)]);
            }),
            (e.prototype.endPattern = function (t, e) {
              return new RegExp((e || (0, s.quotePattern)(t)) + "|\\\\(?:[a-zA-Z]|.)|[{}]", "g");
            }),
            (e.prototype.findEnd = function (t, e, r, n) {
              for (var o, a = i(n, 3), s = a[0], l = a[1], c = a[2], p = (c.lastIndex = r.index + r[0].length), f = 0; (o = c.exec(t)); ) {
                if ((o[1] || o[0]) === s && 0 === f)
                  return (0, u.protoItem)(r[0], t.substr(p, o.index - p), o[0], e, r.index, o.index + o[0].length, l);
                "{" === o[0] ? f++ : "}" === o[0] && f && f--;
              }
              return null;
            }),
            (e.prototype.findMathInString = function (t, e, r) {
              ...
              for (this.start.lastIndex = 0; (n = this.start.exec(r)); ) {
                if (void 0 !== n[this.env] && this.env) {
                  var i = "\\\\end\\s*(\\{" + (0, s.quotePattern)(n[this.env]) + "\\})";
                  (o = this.findEnd(r, e, n, ["{" + n[this.env] + "}", !0, this.endPattern(null, i)])) &&
                    ((o.math = o.open + o.math + o.close), (o.open = o.close = ""));
                } else if (void 0 !== n[this.sub] && this.sub) {
                  var a = n[this.sub];
                  (i = n.index + n[this.sub].length),
                    (o = 2 === a.length ? (0, u.protoItem)("", a.substr(1), "", e, n.index, i) : (0, u.protoItem)("", a, "", e, n.index, i, !1));
            ...
            (e.prototype.findMath = function (t) {
              var e = [];
              if (this.hasPatterns) for (var r = 0, n = t.length; r < n; r++) this.findMathInString(e, r, t[r]);
              return e;
            }),
            (e.OPTIONS = {
              inlineMath: [["\\(", "\\)"]],
