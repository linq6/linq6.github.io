  ...
  [9022],
  {
    89022: (e, t, n) => {
      ...
      function u(e, t) {
          ...
          return (
            (t.tokenize =
              ...
              function (e, t) {
                ...
                return (a || (!i && "`" != n)) && (t.tokenize = u), "string";
              })),
            t.tokenize(e, t)
          );
        if (/[\d\.]/.test(l))
        ...
        e.eatWhile(/[\w\$_\xa1-\uffff]/);
        var f = e.current();
        return i.propertyIsEnumerable(f)
          ? (("case" != f && "default" != f) || (r = "case"), "keyword")
      ...
      const s = {
        ...
        startState: function (e) {
          return { tokenize: null, context: new l(-e, 0, "top", !1), indented: 0, startOfLine: !0 };
        },
        token: function (e, t) {
          var n = t.context;
          if (
            (e.sol() && (null == n.align && (n.align = !1), (t.indented = e.indentation()), (t.startOfLine = !0), "case" == n.type && (n.type = "}")),
            e.eatSpace())
          )
            return null;
          r = null;
          var i = (t.tokenize || u)(e, t);
          return (
            "comment" == i ||
                      ...
                      : (("}" == r && "}" == n.type) || r == n.type) &&
                        (function (e) {
                          if (e.context.prev) {
                            ...
                            (")" != t && "]" != t && "}" != t) || (e.indented = e.context.indented), (e.context = e.context.prev);
                          }
                        })(t),
              (t.startOfLine = !1)),
            i
        ...
        indent: function (e, t, n) {
          if (e.tokenize != u && null != e.tokenize) return null;
          var r = e.context,
            i = t && t.charAt(0);
