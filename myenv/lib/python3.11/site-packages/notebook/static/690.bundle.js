...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    60690: (e, t, n) => {
      n.r(t), n.d(t, { MIME_TYPE: () => d, MIME_TYPES_JSONL: () => l, RenderedJSON: () => p, default: () => m, rendererFactory: () => c });
      var r = n(20005),
        o = n(90646),
        s = n(63485),
        i = n(78156),
      ...
      class p extends s.Widget {
        ...
        async renderModel(e) {
          const { Component: t } = await Promise.all([n.e(9752), n.e(998), n.e(4576), n.e(5536), n.e(2209)]).then(n.bind(n, 69752));
          let r;
          ...
          return (
            null === this._rootDOM && (this._rootDOM = (0, a.s)(this.node)),
            new Promise((e, n) => {
              this._rootDOM.render(i.createElement(t, { data: r, metadata: o, translator: this.translator, forwardedRef: () => e() }));
            })
          );
        }
        onBeforeDetach(e) {
          this._rootDOM && (this._rootDOM.unmount(), (this._rootDOM = null));
        }
      }
      const c = { safe: !0, mimeTypes: [d, ...l], createRenderer: (e) => new p(e) },
        m = [
          {
            ...
            rank: 0,
            dataType: "json",
            documentWidgetFactoryOptions: { name: "JSON", primaryFileType: "json", fileTypes: ["json", "notebook", "geojson"], defaultFor: ["json"] },
          },
          {
