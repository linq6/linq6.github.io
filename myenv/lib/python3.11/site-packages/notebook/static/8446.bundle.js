    ...
    8446: (e, r, t) => {
      ...
      function s(e, r) {
        ...
        var n,
          u = e.next();
        if (('"' != u && "'" != u) || !r.inParams) {
          if (/[\[\]{}\(\),;\.]/.test(u)) return "(" == u && t ? (r.inParams = !0) : ")" == u && (r.inParams = !1), null;
          if (/\d/.test(u)) return e.eatWhile(/[\w\.]/), "number";
          if ("#" == u) return e.eat("*") ? l(e, r, c) : "#" == u && e.match(/ *\[ *\[/) ? l(e, r, f) : (e.skipToEnd(), "comment");
        ...
        return l(
          ...
          ((n = u),
          function (e, r) {
            for (var t, a = !1, o = !1; null != (t = e.next()); ) {
              if (t == n && !a) {
                o = !0;
                break;
              }
