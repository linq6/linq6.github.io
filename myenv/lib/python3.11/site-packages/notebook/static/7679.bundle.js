      ...
      const l = {
        ...
        token: function (e, t) {
          var n = (function (e, t) {
            ...
            return (
              " " == n || "\t" == n
                ? ((t.label = !1), 0 == t.commandMode ? (t.commandMode = 1) : (t.commandMode < 0 || 2 == t.commandMode) && (t.commandMode = 0))
                : "." != n && t.commandMode > 0 && (t.commandMode = ":" == n ? -1 : 2),
              ("(" !== n && "\t" !== n) || (t.label = !1),
              ";" === n
                ? (e.skipToEnd(), "comment")
                : e.match(/^[-+]?\d+(\.\d+)?([eE][-+]?\d+)?/)
