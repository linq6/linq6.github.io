  ...
  [2386],
  {
    42386: (e, t, r) => {
      ...
      function o(e, t) {
        var r,
          o = e.next();
        if ("#" == o && t.startOfLine) return e.skipToEnd(), "meta";
        if ('"' == o || "'" == o)
          return (
            (t.tokenize =
              ((r = o),
        ...
        if ("(" == o && e.eat("*")) return (t.tokenize = l), l(e, t);
        if ("{" == o) return (t.tokenize = s), s(e, t);
        if (/[\[\]\(\),;\:\.]/.test(o)) return null;
        if (/\d/.test(o)) return e.eatWhile(/[\w\.]/), "number";
        if ("/" == o && e.eat("/")) return e.skipToEnd(), "comment";
        if (i.test(o)) return e.eatWhile(i), "operator";
        e.eatWhile(/[\w\$_]/);
        var u = e.current();
        return n.propertyIsEnumerable(u) ? "keyword" : a.propertyIsEnumerable(u) ? "atom" : "variable";
      }
      function l(e, t) {
