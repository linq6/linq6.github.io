...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  ...
  {
    41198: (t, e, s) => {
      s.r(e), s.d(e, { IPropertyInspectorProvider: () => c, SideBarPropertyInspectorProvider: () => a });
      var n = s(90646),
        r = s(14576),
        o = s(81997),
        i = s(63485);
      const c = new (s(20998).Token)(
      ...
      class h extends i.Widget {
        ...
        register(t) {
          if (this._inspectors.has(t)) throw new Error("Widget is already registered");
          const e = new l.PropertyInspector(t);
          return (
        ...
        _onInspectorAction(t, e) {
          ...
          switch (e) {
            case "content":
              ...
              break;
            case "dispose":
              s && (this._tracker.remove(s), this._inspectors.delete(s));
              break;
            case "show-panel":
              n === s && this.showPanel();
              break;
      ...
      class a extends h {
        constructor({ shell: t, placeholder: e, translator: s }) {
          super(), (this._labshell = t), (this.translator = s || n.nullTranslator), (this._trans = this.translator.load("jupyterlab"));
          const r = (this.layout = new i.SingletonLayout());
          if (e) this._placeholder = e;
          else {
            const t = document.createElement("div"),
              e = document.createElement("div");
            (e.textContent = this._trans.__("No properties to inspect.")),
              (e.className = "jp-PropertyInspector-placeholderContent"),
              t.appendChild(e),
              (this._placeholder = new i.Widget({ node: t })),
              this._placeholder.addClass("jp-PropertyInspector-placeholder");
          }
          (r.widget = this._placeholder), this._labshell.currentChanged.connect(this._onShellCurrentChanged, this), this._onShellCurrentChanged();
        }
        setContent(t) {
          const e = this.layout;
          e.widget && (e.widget.removeClass("jp-PropertyInspector-content"), e.removeWidget(e.widget)),
        ...
        _onShellCurrentChanged() {
          ...
          (null == e ? void 0 : e.node.contains(t.node)) ? this.refresh() : this.setContent(null);
        }
      }
      var l;
      !(function (t) {
        t.PropertyInspector = class {
          constructor(t) {
            (this._isDisposed = !1), (this._content = null), (this._owner = null), (this._onAction = new o.Signal(this)), (this._owner = t);
          }
          get owner() {
            return this._owner;
          }
          ...
          render(t) {
            this._isDisposed ||
              (t instanceof i.Widget ? (this._content = t) : (this._content = r.ReactWidget.create(t)), this._onAction.emit("content"));
          }
          dispose() {
            this._isDisposed || ((this._isDisposed = !0), (this._content = null), (this._owner = null), o.Signal.clearData(this));
          }
        };
      })(l || (l = {}));
    },
