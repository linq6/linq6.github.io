(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [9799],
  {
    56318: (t, e, s) => {
      "use strict";
      s.d(e, { GA: () => $, Gn: () => C, Mb: () => a, TK: () => o, eC: () => l, vQ: () => O });
      var i = s(89843),
        n = s(3546),
        r = s(17592);
      class o {
        ...
        tokenBefore(t) {
          let e = (0, r.syntaxTree)(this.state).resolveInner(this.pos, -1);
        ...
        matchBefore(t) {
          let e = this.state.doc.lineAt(this.pos),
            s = Math.max(e.from, this.pos - 250),
            i = e.text.slice(s - e.from, this.pos - e.from),
            n = i.search(
              (function (t, e) {
                var s;
                let { source: i } = t,
                  ...
                  r = "$" != i[i.length - 1];
                return n || r
                  ? new RegExp(`${n ? "^" : ""}(?:${i})${r ? "$" : ""}`, null !== (s = t.flags) && void 0 !== s ? s : t.ignoreCase ? "i" : "")
                  : t;
              })(t, !1)
            );
      ...
      function h(t) {
        let e = Object.keys(t).join(""),
          s = /\w/.test(e);
        return s && (e = e.replace(/\w/g, "")), `[${s ? "\\w" : ""}${e.replace(/[^\w\s]/g, "\\$&")}]`;
      }
      function a(t) {
        let e = t.map((t) => ("string" == typeof t ? { label: t } : t)),
          [s, i] = e.every((t) => /^\w+$/.test(t.label))
            ? [/\w*$/, /\w+$/]
            : (function (t) {
                ...
                for (let { label: i } of t) {
                  e[i[0]] = !0;
                  for (let t = 1; t < i.length; t++) s[i[t]] = !0;
                }
                let i = h(e) + h(s) + "*$";
      ...
      function l(t, e) {
        return (s) => {
          for (let e = (0, r.syntaxTree)(s.state).resolveInner(s.pos, -1); e; e = e.parent) {
      ...
      const c = i.Annotation.define();
      "object" == typeof navigator && navigator.platform;
      const f = n.EditorView.baseTheme({
      ...
      class u {
        constructor(t, e, s, i) {
          (this.field = t), (this.line = e), (this.from = s), (this.to = i);
        }
      }
      class p {
        constructor(t, e, s) {
          (this.field = t), (this.from = e), (this.to = s);
        }
        map(t) {
          let e = t.mapPos(this.from, -1, i.MapMode.TrackDel),
            s = t.mapPos(this.to, 1, i.MapMode.TrackDel);
          return null == e || null == s ? null : new p(this.field, e, s);
        }
      }
      class d {
        constructor(t, e) {
        ...
        instantiate(t, e) {
          ...
          for (let n of this.lines) {
            if (s.length) {
              ...
              i.push(e + s.length - h), (n = s + n.slice(h));
            }
            s.push(n), (e += n.length + 1);
          }
          let h = this.fieldPositions.map((t) => new p(t.field, i[t.line] + t.from, i[t.line] + t.to));
          return { text: s, ranges: h };
        }
        static parse(t) {
          let e,
            s = [],
          ...
          for (let r of t.split(/\r\n?|\n/)) {
            for (; (e = /[#$]\{(?:(\d+)(?::([^}]*))?|([^}]*))\}/.exec(r)); ) {
              let t = e[1] ? +e[1] : null,
                o = e[2] || e[3] || "",
                h = -1;
              for (let e = 0; e < s.length; e++) (null != t ? s[e].seq == t : o && s[e].name == o) && (h = e);
              if (h < 0) {
                let e = 0;
                for (; e < s.length && (null == t || (null != s[e].seq && s[e].seq < t)); ) e++;
                s.splice(e, 0, { seq: t, name: o }), (h = e);
                for (let t of n) t.field >= h && t.field++;
              }
              n.push(new u(h, i.length, e.index, e.index + o.length)), (r = r.slice(0, e.index) + o + r.slice(e.index + e[0].length));
            }
            for (let t; (t = /\\([{}])/.exec(r)); ) {
              r = r.slice(0, t.index) + t[1] + r.slice(t.index + t[0].length);
              for (let e of n) e.line == i.length && e.from > t.index && (e.from--, e.to--);
            }
            i.push(r);
          }
          return new d(i, n);
      ...
      let g = n.Decoration.widget({
          widget: new (class extends n.WidgetType {
            toDOM() {
        ...
        m = n.Decoration.mark({ class: "cm-snippetField" });
      class k {
        constructor(t, e) {
          (this.ranges = t), (this.active = e), (this.deco = n.Decoration.set(t.map((t) => (t.from == t.to ? g : m).range(t.from, t.to))));
        }
        map(t) {
          let e = [];
          ...
          return new k(e, this.active);
        }
        selectionInsideField(t) {
          return t.ranges.every((t) => this.ranges.some((e) => e.field == this.active && e.from <= t.from && e.to >= t.to));
        }
      }
      const x = i.StateEffect.define({ map: (t, e) => t && t.map(e) }),
        b = i.StateEffect.define(),
        v = i.StateField.define({
          create: () => null,
          update(t, e) {
            for (let s of e.effects) {
              if (s.is(x)) return s.value;
              if (s.is(b) && t) return new k(t.ranges, s.value);
            }
            return t && e.docChanged && (t = t.map(e.changes)), t && e.selection && !t.selectionInsideField(e.selection) && (t = null), t;
          },
          provide: (t) => n.EditorView.decorations.from(t, (t) => (t ? t.deco : n.Decoration.none)),
        });
      function y(t, e) {
      ...
      function S(t) {
        let e = d.parse(t);
        return (t, s, n, r) => {
          let { text: o, ranges: h } = e.instantiate(t.state, n),
            a = {
              changes: { from: n, to: r, insert: i.Text.of(o) },
              scrollIntoView: !0,
              annotations: s ? [c.of(s), i.Transaction.userEvent.of("input.complete")] : void 0,
            };
          if ((h.length && (a.selection = y(h, 0)), h.some((t) => t.field > 0))) {
            let e = new k(h, 0),
              s = (a.effects = [x.of(e)]);
            void 0 === t.state.field(v, !1) && s.push(i.StateEffect.appendConfig.of([v, A, I, f]));
          }
      ...
      function w(t) {
        return ({ state: e, dispatch: s }) => {
          ...
          let n = i.active + t,
            r = t > 0 && !i.ranges.some((e) => e.field == n + t);
          return s(e.update({ selection: y(i.ranges, n), effects: x.of(r ? null : new k(i.ranges, n)), scrollIntoView: !0 })), !0;
        };
      }
      const P = [
          { key: "Tab", run: w(1), shift: w(-1) },
          { key: "Escape", run: ({ state: t, dispatch: e }) => !!t.field(v, !1) && (e(t.update({ effects: x.of(null) })), !0) },
        ],
        T = i.Facet.define({ combine: (t) => (t.length ? t[0] : P) }),
        A = i.Prec.highest(n.keymap.compute([T], (t) => t.facet(T)));
      function C(t, e) {
        return Object.assign(Object.assign({}, e), { apply: S(t) });
      }
      const I = n.EditorView.domEventHandlers({
          mousedown(t, e) {
            let s,
              i = e.state.field(v, !1);
            if (!i || null == (s = e.posAtCoords({ x: t.clientX, y: t.clientY }))) return !1;
            let n = i.ranges.find((t) => t.from <= s && t.to >= s);
            return !(
              !n ||
              n.field == i.active ||
              (e.dispatch({
                selection: y(i.ranges, n.field),
                effects: x.of(i.ranges.some((t) => t.field > n.field) ? new k(i.ranges, n.field) : null),
                scrollIntoView: !0,
              }),
              0)
            );
        ...
        R = { brackets: ["(", "[", "{", "'", '"'], before: ")]}:;>", stringPrefixes: [] },
        E = i.StateEffect.define({
          map(t, e) {
            let s = e.mapPos(t, -1, i.MapMode.TrackAfter);
            return null == s ? void 0 : s;
          },
        }),
        N = new (class extends i.RangeValue {})();
      (N.startSide = 1), (N.endSide = -1);
      const D = i.StateField.define({
        create: () => i.RangeSet.empty,
        update(t, e) {
          if (((t = t.map(e.changes)), e.selection)) {
            let s = e.state.doc.lineAt(e.selection.main.head);
            t = t.update({ filter: (t) => t >= s.from && t <= s.to });
          }
          for (let s of e.effects) s.is(E) && (t = t.update({ add: [N.range(s.value, s.value + 1)] }));
          return t;
        },
      });
      function O() {
      ...
      const z = "()[]{}<>";
      function B(t) {
        for (let e = 0; e < 8; e += 2) if (z.charCodeAt(e) == t) return z.charAt(e + 1);
        return (0, i.fromCodePoint)(t < 128 ? t : t + 1);
      }
      function F(t, e) {
        return t.languageDataAt("closeBrackets", e)[0] || R;
      }
      const L = "object" == typeof navigator && /Android\b/.test(navigator.userAgent),
        M = n.EditorView.inputHandler.of((t, e, s, n) => {
          if ((L ? t.composing : t.compositionStarted) || t.state.readOnly) return !1;
          let r = t.state.selection.main;
          if (n.length > 2 || (2 == n.length && 1 == (0, i.codePointSize)((0, i.codePointAt)(n, 0))) || e != r.from || s != r.to) return !1;
          let o = (function (t, e) {
            let s = F(t, t.selection.main.head),
              n = s.brackets || R.brackets;
            for (let r of n) {
              let o = B((0, i.codePointAt)(r, 0));
              if (e == r) return o == r ? G(t, r, n.indexOf(r + r + r) > -1, s) : U(t, r, o, s.before || R.before);
              if (e == o && j(t, t.selection.main.from)) return W(t, 0, o);
            }
            return null;
          })(t.state, n);
        ...
        $ = [
          {
            ...
            run: ({ state: t, dispatch: e }) => {
              ...
              let s = F(t, t.selection.main.head).brackets || R.brackets,
                n = null,
                r = t.changeByRange((e) => {
                  if (e.empty) {
                    let n = (function (t, e) {
                    ...
                    for (let r of s)
                      if (r == n && V(t.doc, e.head) == B((0, i.codePointAt)(r, 0)))
                        return { changes: { from: e.head - r.length, to: e.head + r.length }, range: i.EditorSelection.cursor(e.head - r.length) };
                  }
                  return { range: (n = e) };
                });
              return n || e(t.update(r, { scrollIntoView: !0, userEvent: "delete.backward" })), !n;
            },
          },
        ];
      function j(t, e) {
        let s = !1;
        return (
          t.field(D).between(0, t.doc.length, (t) => {
            t == e && (s = !0);
          }),
          s
        );
          ...
          o = t.changeByRange((o) => {
            if (!o.empty)
              return {
                ...
                effects: E.of(o.to + e.length),
                range: i.EditorSelection.range(o.anchor + e.length, o.head + e.length),
              };
            let h = V(t.doc, o.head);
            return !h || /\s/.test(h) || n.indexOf(h) > -1
              ? { changes: { insert: e + s, from: o.head }, effects: E.of(o.head + e.length), range: i.EditorSelection.cursor(o.head + e.length) }
              : { range: (r = o) };
          });
        return r ? null : t.update(o, { scrollIntoView: !0, userEvent: "input.type" });
      }
      function W(t, e, s) {
        let n = null,
          r = t.changeByRange((e) =>
            e.empty && V(t.doc, e.head) == s
              ? { changes: { from: e.head, to: e.head + s.length, insert: s }, range: i.EditorSelection.cursor(e.head + s.length) }
              : (n = { range: e })
          );
        return n ? null : t.update(r, { scrollIntoView: !0, userEvent: "input.type" });
      }
      function G(t, e, s, n) {
        let o = n.stringPrefixes || R.stringPrefixes,
          h = null,
          a = t.changeByRange((n) => {
            if (!n.empty)
              return {
            ...
            let a,
              ...
              c = V(t.doc, l);
            if (c == e) {
              if (_(t, l)) return { changes: { insert: e + e, from: l }, effects: E.of(l + e.length), range: i.EditorSelection.cursor(l + e.length) };
              if (j(t, l)) {
                let n = s && t.sliceDoc(l, l + 3 * e.length) == e + e + e ? e + e + e : e;
                return { changes: { from: l, to: l + n.length, insert: n }, range: i.EditorSelection.cursor(l + n.length) };
              }
            } else {
              if (s && t.sliceDoc(l - 2 * e.length, l) == e + e && (a = q(t, l - 2 * e.length, o)) > -1 && _(t, a))
                return { changes: { insert: e + e + e + e, from: l }, effects: E.of(l + e.length), range: i.EditorSelection.cursor(l + e.length) };
              if (
                t.charCategorizer(l)(c) != i.CharCategory.Word &&
                q(t, l, o) > -1 &&
                !(function (t, e, s, i) {
                  let n = (0, r.syntaxTree)(t).resolveInner(e, -1),
                    o = i.reduce((t, e) => Math.max(t, e.length), 0);
                  for (let r = 0; r < 5; r++) {
                    let r = t.sliceDoc(n.from, Math.min(n.to, n.from + s.length + o)),
                      h = r.indexOf(s);
                    if (!h || (h > -1 && i.indexOf(r.slice(0, h)) > -1)) {
                      let e = n.firstChild;
                      for (; e && e.from == n.from && e.to - e.from > s.length + h; ) {
                        if (t.sliceDoc(e.to - s.length, e.to) == s) return !1;
                        e = e.firstChild;
                      }
                      return !0;
                    }
                ...
                return { changes: { insert: e + e, from: l }, effects: E.of(l + e.length), range: i.EditorSelection.cursor(l + e.length) };
            }
            return { range: (h = n) };
          });
        return h ? null : t.update(a, { scrollIntoView: !0, userEvent: "input.type" });
      }
      function _(t, e) {
        let s = (0, r.syntaxTree)(t).resolveInner(e + 1);
      ...
      function q(t, e, s) {
        ...
        for (let r of s) {
          let s = e - r.length;
          if (t.sliceDoc(s, e) == r && n(t.sliceDoc(s - 1, s)) != i.CharCategory.Word) return s;
        }
        return -1;
      }
    },
    49906: (t, e, s) => {
      "use strict";
      s.d(e, { IK: () => I, Jq: () => g, RA: () => d, WQ: () => R });
      var i = s(79352),
        n = s(27061);
      class r {
        constructor(t, e, s, i, n, r, o, h, a, l = 0, c) {
          (this.p = t),
            (this.stack = e),
            (this.state = s),
            (this.reducePos = i),
        ...
        static start(t, e, s = 0) {
          ...
          return new r(t, [], e, s, s, 0, [], 0, i ? new o(i, i.start) : null, 0, null);
        }
        get context() {
        ...
        reduce(t) {
          ...
          let o = this.stack.length - 3 * (s - 1) - (262144 & t ? 6 : 0),
            h = o ? this.stack[o - 2] : this.p.ranges[0].from,
            a = this.reducePos - h;
          a >= 2e3 &&
            !(null === (e = this.p.parser.nodeSet.types[i]) || void 0 === e ? void 0 : e.isAnonymous) &&
            (h == this.p.lastBigReductionStart
              ? (this.p.bigReductionCount++, (this.p.lastBigReductionSize = a))
              : this.p.lastBigReductionSize < a &&
                ((this.p.bigReductionCount = 1), (this.p.lastBigReductionStart = h), (this.p.lastBigReductionSize = a)));
        ...
        storeNode(t, e, s, i = 4, n = !1) {
          if (0 == t && (!this.stack.length || this.stack[this.stack.length - 1] < this.buffer.length + this.bufferBase)) {
            ...
            if (
              (0 == i && t.parent && ((i = t.bufferBase - t.parent.bufferBase), (t = t.parent)),
            ...
            if (n > 0 && 0 != this.buffer[n - 4])
              for (; n > 0 && this.buffer[n - 2] > s; )
                (this.buffer[n] = this.buffer[n - 4]),
                  ...
                  (n -= 4),
                  i > 4 && (i -= 4);
            (this.buffer[n] = t), (this.buffer[n + 1] = e), (this.buffer[n + 2] = s), (this.buffer[n + 3] = i);
        ...
        shift(t, e, s, i) {
          if (131072 & t) this.pushState(65535 & t, this.pos);
            ...
            let n = t,
              { parser: r } = this.p;
            (i > this.pos || e <= r.maxNode) && ((this.pos = i), r.stateFlag(n, 1) || (this.reducePos = i)),
              this.pushState(n, s),
        ...
        apply(t, e, s, i) {
          65536 & t ? this.reduce(t) : this.shift(t, e, s, i);
        }
        useNode(t, e) {
        ...
        recoverByInsert(t) {
          ...
          if (e.length > 8 || this.stack.length >= 120) {
            let s = [];
            for (let i, n = 0; n < e.length; n += 2) (i = e[n + 1]) != this.state && this.p.parser.hasAction(i, t) && s.push(e[n], i);
          ...
          for (let t = 0; t < e.length && s.length < 4; t += 2) {
            ...
            let n = this.split();
            n.pushState(i, this.pos),
              n.storeNode(0, n.pos, n.pos, 4, !0),
              n.shiftContext(e[t], this.pos),
                  ...
                  t.allActions(i, (e) => {
                    if (393216 & e);
                      ...
                      if (s > 1) {
                        let i = 65535 & e,
                          n = this.stack.length - 3 * s;
                        if (n >= 0 && t.getGoto(this.stack[n], i, !1) >= 0) return (s << 19) | 65536 | i;
                      }
                    } else {
                      let t = s(e, n + 1);
                      if (null != t) return t;
      ...
      class u {
          ...
          if (i >= 0 && i < this.chunk.length) (e = this.pos + t), (s = this.chunk.charCodeAt(i));
            ...
            if (((e = i), e >= this.chunk2Pos && e < this.chunk2Pos + this.chunk2.length)) s = this.chunk2.charCodeAt(e - this.chunk2Pos);
              ...
              (this.chunk2 = this.input.chunk((this.chunk2Pos = e))),
                e + this.chunk2.length > i.to && (this.chunk2 = this.chunk2.slice(0, i.to - e)),
        ...
        reset(t, e) {
          if ((e ? ((this.token = e), (e.start = t), (e.lookAhead = t + 1), (e.value = e.extended = -1)) : (this.token = f), this.pos != t)) {
      ...
      class p {
        ...
        token(t, e) {
          let { parser: s } = e.p;
          m(this.data, t, e, this.id, s.data, s.tokenPrecTable);
        }
      }
      p.prototype.contextual = p.prototype.fallback = p.prototype.extend = !1;
      class d {
        constructor(t, e, s) {
          (this.precTable = e), (this.elseToken = s), (this.data = "string" == typeof t ? l(t) : t);
        }
        token(t, e) {
          let s = t.pos,
            i = 0;
      ...
      d.prototype.contextual = p.prototype.fallback = p.prototype.extend = !1;
      class g {
        constructor(t, e = {}) {
      ...
      function m(t, e, s, i, n, r) {
        ...
        t: for (; 0 != (h & t[o]); ) {
          let s = t[o + 1];
          for (let i = o + 3; i < s; i += 2)
            if ((t[i + 1] & h) > 0) {
              let s = t[i];
              if (a.allows(s) && (-1 == e.token.value || e.token.value == s || x(s, e.token.value, n, r))) {
                e.acceptToken(s);
                break;
              }
            }
          let i = e.next,
            l = 0,
            c = t[o + 2];
          if (!(e.next < 0 && c > l && 65535 == t[s + 3 * c - 3] && 65535 == t[s + 3 * c - 3])) {
            for (; l < c; ) {
              let n = (l + c) >> 1,
                r = s + n + (n << 1),
                h = t[r],
      ...
      function k(t, e, s) {
        for (let i, n = e; 65535 != (i = t[n]); n++) if (i == s) return n - e;
        return -1;
      }
      function x(t, e, s, i) {
        let n = k(s, i, e);
        return n < 0 || k(s, i, t) < n;
      }
      const b = void 0 !== n && n.env && /\bparse\b/.test(n.env.LOG);
      let v = null;
      function y(t, e, s) {
      ...
      class S {
        ...
        nodeAt(t) {
          ...
          for (;;) {
            ...
            let r = s.children[n],
              o = this.start[e] + s.positions[n];
            if (o > t) return (this.nextStart = o), null;
            if (r instanceof i.Tree) {
              if (o == t) {
                if (o < this.safeFrom) return null;
                let t = o + r.length;
                if (t <= this.safeTo) {
                  let e = r.prop(i.NodeProp.lookAhead);
      ...
      class w {
        ...
        getActions(t) {
          ...
          for (let i = 0; i < n.length; i++) {
            ...
            if (
              (!s || a.fallback) &&
              ((a.contextual || l.start != t.pos || l.mask != r || l.context != o) &&
                (this.updateCachedToken(l, a, t), (l.mask = r), (l.context = o)),
              l.lookAhead > l.end + 25 && (h = Math.max(l.lookAhead, h)),
              0 != l.value)
            ) {
              let i = e;
              if (
          ...
          return (
            ...
            s ||
              ...
              ((s = new c()), (s.value = t.p.parser.eofTerm), (s.start = s.end = t.pos), (e = this.addActions(t, s.value, s.end, e))),
            (this.mainToken = s),
            this.actions
          );
        }
            ...
            for (let i = 0; i < e.specialized.length; i++)
              if (e.specialized[i] == t.value) {
                ...
                if (n >= 0 && s.p.parser.dialect.allows(n >> 1)) {
                  0 == (1 & n) ? (t.value = n >> 1) : (t.extended = n >> 1);
                  break;
                }
              }
        ...
        putAction(t, e, s, i) {
          for (let e = 0; e < i; e += 3) if (this.actions[e] == t) return i;
        ...
        addActions(t, e, s, i) {
          let { state: n } = t,
            ...
            { data: o } = r;
          for (let t = 0; t < 2; t++)
            for (let h = r.stateSlot(n, t ? 2 : 1); ; h += 3) {
              if (65535 == o[h]) {
                if (1 != o[h + 1]) {
                  0 == i && 2 == o[h + 1] && (i = this.putAction(E(o, h + 2), e, s, i));
                  break;
                }
                h = E(o, h + 2);
              }
              o[h] == e && (i = this.putAction(E(o, h + 1), e, s, i));
            }
          return i;
        }
      }
      class P {
        constructor(t, e, s, i) {
          ...
          (this.stacks = [r.start(this, t.top[0], n)]),
            (this.fragments = s.length && this.stream.end - n > 4 * t.bufferLength ? new S(s, t.nodeSet) : null);
        }
        get parsedPos() {
        ...
        advance() {
          let t,
            ...
            i = this.minStackPos,
            n = (this.stacks = []);
          if (this.bigReductionCount > 300 && 1 == s.length) {
            let [t] = s;
          ...
          for (let r = 0; r < s.length; r++) {
            let o = s[r];
            for (;;) {
              if (((this.tokens.mainToken = null), o.pos > i)) n.push(o);
              else {
                if (this.advanceStack(o, n, s)) continue;
                {
                  t || ((t = []), (e = [])), t.push(o);
          ...
          if (!n.length) {
            ...
            if (this.parser.strict)
              throw (
                (b && t && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")),
                new SyntaxError("No parse at " + i))
              );
            this.recovering || (this.recovering = 5);
          }
          if (this.recovering && t) {
            let s = null != this.stoppedAt && t[0].pos > this.stoppedAt ? t[0] : this.runRecovery(t, e, n);
            if (s) return b && console.log("Force-finish " + this.stackID(s)), this.stackToTree(s.forceAll());
          }
          if (this.recovering) {
            let t = 1 == this.recovering ? 1 : 3 * this.recovering;
            if (n.length > t) for (n.sort((t, e) => e.score - t.score); n.length > t; ) n.pop();
            n.some((t) => t.reducePos > i) && this.recovering--;
          } else if (n.length > 1) {
            t: for (let t = 0; t < n.length - 1; t++) {
              let e = n[t];
              for (let s = t + 1; s < n.length; s++) {
                let i = n[s];
                if (e.sameState(i) || (e.buffer.length > 500 && i.buffer.length > 500)) {
                  if (!((e.score - i.score || e.buffer.length - i.buffer.length) > 0)) {
                    n.splice(t--, 1);
                    continue t;
                  }
                  n.splice(s--, 1);
        ...
        advanceStack(t, e, s) {
          ...
          if (this.fragments) {
            ...
            for (let h = this.fragments.nodeAt(n); h; ) {
              let n = this.parser.nodeSet.types[h.type.id] == h.type ? r.getGoto(t.state, h.type.id) : -1;
              if (n > -1 && h.length && (!e || (h.prop(i.NodeProp.contextHash) || 0) == s))
                return t.useNode(h, n), b && console.log(o + this.stackID(t) + ` (via reuse of ${r.getName(h.type.id)})`), !0;
              if (!(h instanceof i.Tree) || 0 == h.children.length || h.positions[0] > 0) break;
              let a = h.children[0];
              if (!(a instanceof i.Tree && 0 == h.positions[0])) break;
              h = a;
            }
          }
          let h = r.stateSlot(t.state, 4);
          if (h > 0) return t.reduce(h), b && console.log(o + this.stackID(t) + ` (via always-reduce ${r.getName(65535 & h)})`), !0;
          if (t.stack.length >= 9e3) for (; t.stack.length > 6e3 && t.forceReduce(); );
          ...
          for (let i = 0; i < a.length; ) {
            ...
            if (
              (u.apply(h, l, p ? p.start : u.pos, c),
              b &&
                console.log(
                  o +
                    this.stackID(u) +
                    ` (via ${0 == (65536 & h) ? "shift" : `reduce of ${r.getName(65535 & h)}`} for ${r.getName(l)} @ ${n}${u == t ? "" : ", split"})`
                ),
              f)
            )
              return !0;
            u.pos > n ? e.push(u) : s.push(u);
          }
          return !1;
        }
        advanceFully(t, e) {
        ...
        runRecovery(t, e, s) {
          ...
          for (let r = 0; r < t.length; r++) {
            ...
            if (o.deadEnd) {
              if (n) continue;
              if (((n = !0), o.restart(), b && console.log(l + this.stackID(o) + " (restarted)"), this.advanceFully(o, s))) continue;
            }
            let c = o.split(),
              f = l;
            for (
              let t = 0;
              c.forceReduce() && t < 10 && (b && console.log(f + this.stackID(c) + " (via force-reduce)"), !this.advanceFully(c, s));
              t++
            )
              b && (f = this.stackID(c) + " -> ");
            for (let t of o.recoverByInsert(h)) b && console.log(l + this.stackID(t) + " (via recover-insert)"), this.advanceFully(t, s);
            this.stream.end > o.pos
              ? (a == o.pos && (a++, (h = 0)),
                o.recoverByDelete(h, a),
                b && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(h)})`),
                T(o, s))
        ...
        stackID(t) {
          let e = (v || (v = new WeakMap())).get(t);
          return e || v.set(t, (e = String.fromCodePoint(this.nextStackID++))), e + t;
        }
      }
      function T(t, e) {
      ...
      class R extends i.Parser {
        constructor(t) {
          ...
          for (let s = 0; s < t.repeatNodeCount; s++) e.push("");
          ...
          if (t.nodeProps)
            for (let e of t.nodeProps) {
              let t = e[0];
              "string" == typeof t && (t = i.NodeProp[t]);
              for (let s = 1; s < e.length; ) {
                let i = e[s++];
                if (i >= 0) r(i, t, e[s++]);
                else {
                  let n = e[s + -i];
                  for (let o = -i; o > 0; o--) r(e[s++], t, n);
                  s++;
                }
              }
            }
          ...
          (this.specializers = this.specializerSpecs.map(N)),
            (this.states = l(t.states, Uint32Array)),
            (this.data = l(t.stateData)),
            (this.goto = l(t.goto)),
            (this.maxTerm = t.maxTerm),
            (this.tokenizers = t.tokenizers.map((t) => ("number" == typeof t ? new p(o, t) : t))),
        ...
        getGoto(t, e, s = !1) {
          ...
          for (let n = i[e + 1]; ; ) {
            let e = i[n++],
              ...
              o = i[n++];
            if (r && s) return o;
            for (let s = n + (e >> 1); n < s; n++) if (i[n] == t) return o;
            if (r) return -1;
          }
        }
        hasAction(t, e) {
          let s = this.data;
          for (let i = 0; i < 2; i++)
            for (let n, r = this.stateSlot(t, i ? 2 : 1); ; r += 3) {
              if (65535 == (n = s[r])) {
                if (1 != s[r + 1]) {
                  if (2 == s[r + 1]) return E(s, r + 2);
                  break;
                }
                n = s[(r = E(s, r + 2))];
              }
              if (n == e || 0 == n) return E(s, r + 1);
            }
          return 0;
        }
        stateSlot(t, e) {
        ...
        allActions(t, e) {
          let s = this.stateSlot(t, 4),
            i = s ? e(s) : void 0;
          for (let s = this.stateSlot(t, 1); null == i; s += 3) {
          ...
          return (
            ...
            t.specializers &&
              ...
              (e.specializerSpecs = this.specializerSpecs.map((s, i) => {
                ...
                if (!n) return s;
                let r = Object.assign(Object.assign({}, s), { external: n.to });
                return (e.specializers[i] = N(r)), r;
              }))),
        ...
        parseDialect(t) {
          ...
          for (let t = 0; t < e.length; t++)
            if (!s[t]) for (let s, n = this.dialects[e[t]]; 65535 != (s = this.data[n++]); ) (i || (i = new Uint8Array(this.maxTerm + 1)))[s] = 1;
          return new A(t, s, i);
        }
    ...
    27061: (t) => {
      ...
      var h,
        ...
        c = -1;
      function f() {
        l && h && ((l = !1), h.length ? (a = h.concat(a)) : (c = -1), a.length && u());
      }
      function u() {
        if (!l) {
          var t = o(f);
      ...
      (i.nextTick = function (t) {
        ...
        a.push(new p(t, e)), 1 !== a.length || l || o(u);
      }),
