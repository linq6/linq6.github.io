    ...
    51647: (t, e, o) => {
      ...
      class a extends r.Widget {
        constructor(t) {
          ...
          const s = this._rendermime.preferredMimeType(t.bundle, "any");
          s &&
            ((this._content = this._rendermime.createRenderer(s)),
            this._content
              .renderModel(o)
              .then(() => this._setGeometry())
              .catch((t) => console.error("tooltip rendering failed", t)),
            this._content.addClass("jp-Tooltip-content"),
            e.addWidget(this._content));
        }
        dispose() {
          this._content && (this._content.dispose(), (this._content = null)), super.dispose();
        }
        handleEvent(t) {
        ...
        onUpdateRequest(t) {
          this.isHidden && this.show(), this._setGeometry(), super.onUpdateRequest(t);
        }
        _evtScroll(t) {
        ...
        _setGeometry() {
          const t = this._position ? this._position : this._getTokenPosition();
          if (!t) return;
          const e = this._editor,
            o = e.getCoordinateForPosition(t);
          if (!o) return;
          const s = window.getComputedStyle(this.node),
            n = parseInt(s.paddingLeft, 10) || 0,
            r = e.host.closest(".jp-MainAreaWidget > .lm-Widget") || e.host;
          i.HoverBox.setGeometry({
            ...
            privilege: "below",
            outOfViewDisplay: { top: "stick-inside", bottom: "stick-inside" },
            style: s,
          });
        }
      }
