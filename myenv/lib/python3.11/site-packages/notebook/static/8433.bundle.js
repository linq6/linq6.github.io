    ...
    28433: (t, a, n) => {
      ...
      function e(t) {
        ...
        var a = t.sol(),
          n = t.next();
        if ("\\" === n)
          return t.match("fB") || t.match("fR") || t.match("fI") || t.match("u") || t.match("d") || t.match("%") || t.match("&")
            ? "string"
            : t.match("m[")
              ...
              : t.match("s+") || t.match("s-")
                ...
                : t.match("(") || t.match("*(")
                  ? (t.eatWhile(/[\w-]/), "string")
                  : "string";
        if (a && ("." === n || "'" === n) && t.eat("\\") && t.eat('"')) return t.skipToEnd(), "comment";
        if (a && "." === n) {
          if (t.match("B ") || t.match("I ") || t.match("R ")) return "attribute";
          if (t.match("TH ") || t.match("SH ") || t.match("SS ") || t.match("HP ")) return t.skipToEnd(), "quote";
