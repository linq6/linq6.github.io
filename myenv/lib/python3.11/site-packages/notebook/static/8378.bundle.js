...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT = self.webpackChunk_JUPYTERLAB_CORE_OUTPUT || []).push([
  [8378],
  {
    18378: (e, t, r) => {
      function n(e, t) {
        for (var r = void 0 !== (t = t || {}).prefix ? t.prefix : "^", n = void 0 !== t.suffix ? t.suffix : "\\b", o = 0; o < e.length; o++)
          e[o] instanceof RegExp ? (e[o] = e[o].source) : (e[o] = e[o].replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
        return new RegExp(r + "(" + e.join("|") + ")" + n, "i");
      }
      r.r(t), r.d(t, { powerShell: () => h });
      var o = "(?=[^A-Za-z\\d\\-_]|$)",
        i = /[\w\-:]/,
        a = n(
          [
      ...
      function m(e, t) {
        ...
        if (e.eat(")")) return (t.bracketNesting -= 1), "punctuation";
        for (var n in p) if (e.match(p[n])) return n;
        var o = e.next();
        if ("'" === o)
          return (function (e, t) {
            for (var r; null != (r = e.peek()); ) if ((e.next(), "'" === r && !e.eat("'"))) return (t.tokenize = m), "string";
            return "error";
          })(e, t);
        if ("$" === o) return b(e, t);
        if ('"' === o) return S(e, t);
        if ("<" === o && e.eat("#")) return (t.tokenize = v), v(e, t);
        if ("#" === o) return e.skipToEnd(), "comment";
        if ("@" === o) {
          var a = e.eat(/["']/);
          if (a && e.eol()) return (t.tokenize = k), (t.startQuote = a[0]), k(e, t);
          if (e.eol()) return "error";
          if (e.peek().match(/[({]/)) return "punctuation";
          if (e.peek().match(i)) return b(e, t);
        }
        return "error";
      }
      function S(e, t) {
        for (var r; null != (r = e.peek()); ) {
          if ("$" === r) return (t.tokenize = f), "string";
          if ((e.next(), "`" !== r)) {
            if ('"' === r && !e.eat('"')) return (t.tokenize = m), "string";
          } else e.next();
        }
        return "error";
      }
      ...
      function P(e, t) {
        return (t.tokenize = k), (t.startQuote = '"'), k(e, t);
      }
      function g(e, t) {
        return d(e, t, P);
      }
      ...
      function b(e, t) {
        ...
        return e.eat("{")
          ? ((t.tokenize = C), C(e, t))
          : null != r && r.match(i)
            ? (e.eatWhile(i), (t.tokenize = m), "variable")
            : ((t.tokenize = m), "error");
      }
      function C(e, t) {
      ...
      function k(e, t) {
        var r = t.startQuote;
        if (e.sol() && e.match(new RegExp(r + "@"))) t.tokenize = m;
        else if ('"' === r)
          for (; !e.eol(); ) {
            var n = e.peek();
      ...
      const h = {
        name: "powershell",
        startState: function () {
          return { returnStack: [], bracketNesting: 0, tokenize: m };
        },
        token: function (e, t) {
