  ...
  [5573],
  {
    5573: (e, o, t) => {
      ...
      const g = (e) => {
          const o = e.model;
          if (!o) return !1;
          const t = Array.from(o.cells);
          let n = 0,
            a = 0;
          for (const e of t) "code" === e.type && (n++, e.trusted && a++);
          return a === n;
        },
        h = ({ notebook: e, translator: o }) => {
          const t = o.load("notebook"),
            [n, a] = (0, b.useState)(g(e)),
            s = () => {
              const o = g(e);
              a(o);
            };
          return (
            (0, b.useEffect)(
              () => (
                e.modelContentChanged.connect(s),
                e.activeCellChanged.connect(s),
                s(),
                () => {
                  e.modelContentChanged.disconnect(s), e.activeCellChanged.disconnect(s);
                }
              )
            ),
            p().createElement(
              "button",
              {
                ...
                style: n ? { cursor: "help" } : { cursor: "pointer" },
                onClick: () =>
                  !n &&
                  (async () => {
      ...
      var m;
      !(function (e) {
        e.create = ({ notebook: e, translator: o }) => n.ReactWidget.create(p().createElement(h, { notebook: e, translator: o }));
      })(m || (m = {}));
      ...
      const S = {
          ...
          activate: (e, o, t, s, r) => {
            ...
            r &&
              r.addFactory("TopBar", "checkpoint", (e) => {
                const o = new k.Widget({ node: l });
            ...
            s && s.currentChanged.connect(d),
              new u.Poll({ auto: !0, factory: () => d(), frequency: { interval: 2e3, backoff: !1 }, standby: "when-hidden" });
          },
        },
        w = {
          ...
          activate: (e, o, t) => {
            const { commands: n } = e,
              a = (t = null != t ? t : l.nullTranslator).load("notebook"),
              s = "notebook:close-and-halt";
            n.addCommand(s, {
              ...
              o.fileMenu.closeAndCleaners.add({ id: s, rank: 0 });
          },
        },
        T = {
          ...
          activate: (e, o, t) => {
            const { serviceManager: n } = e,
              ...
              r = async () => {
                ...
                a.hasChildNodes() || a.appendChild(s),
                  await u.sessionContext.ready,
                  u.sessionContext.kernelChanged.disconnect(r),
                  u.sessionContext.kernelChanged.connect(r);
                const k =
                    null !==
                      (i =
                        null === (t = null === (e = u.sessionContext.session) || void 0 === e ? void 0 : e.kernel) || void 0 === t
                          ? void 0
                          : t.name) && void 0 !== i
                      ? i
                      : "",
            ...
            t &&
              t.addFactory("TopBar", "kernelLogo", (e) => {
                const o = new k.Widget({ node: a });
                return o.addClass("jp-NotebookKernelLogo"), o;
              }),
              e.started.then(() => {
                o.currentChanged.connect(r);
              });
          },
        },
        x = {
          ...
          activate: (e, o, t) => {
            const n = t.load("notebook"),
              s = new k.Widget();
            s.addClass("jp-NotebookKernelStatus"), e.shell.add(s, "menu", { rank: 10010 });
            const r = (e) => {
        ...
        _ = {
          ...
          activate: async (e, o, t) => {
            ...
            const a = (e) => {
                if (!n) return;
                const { outputArea: o } = e;
                if (void 0 !== e.model.getMetadata("scrolled")) return;
                const { node: t } = o,
                  a = t.scrollHeight > 1.3 * (parseFloat(t.style.fontSize.replace("px", "")) || 14) * 100;
                e.toggleClass("jp-mod-outputsScrolled", a);
              },
              s = {},
              r = (e) => {
                if ("code" === e.model.type) {
                  const o = e,
                    t = o.model.id;
                  a(o), s[t] && o.outputArea.model.changed.disconnect(s[t]), (s[t] = () => a(o)), o.outputArea.model.changed.connect(s[t]);
                }
              };
            if (
              (o.widgetAdded.connect((e, o) => {
                var t;
                o.sessionContext.ready.then(() => {
                  o.content.widgets.forEach(r);
                }),
                  null === (t = o.model) ||
                    void 0 === t ||
                    t.cells.changed.connect((e, t) => {
                      o.content.widgets.forEach(r);
                    });
              }),
              t)
              ...
              const o = t.load(_.id),
                a = (e) => {
                  n = e.get("autoScrollOutputs").composite;
                };
              Promise.all([o, e.restored])
                .then(([e]) => {
                  a(e),
                    e.changed.connect((e) => {
                      a(e);
        ...
        I = {
          ...
          activate: (e, o, t) => {
            o.currentChanged.connect(async () => {
              o.currentWidget instanceof c.NotebookPanel && t && o.add(t, "right", { type: "Property Inspector" });
            });
          },
        },
        E = {
        ...
        j = {
          ...
          activate: (e, o, t) => {
            o.currentChanged.connect(async () => {
              ...
              const a = m.create({ notebook: n, translator: t });
              o.add(a, "menu", { rank: 11e3 });
            });
          },
        },
        A = [
          ...
          w,
          {
            ...
            activate: (e, o, t, n) => {
              const { commands: a, shell: s } = e,
                r = (t = null != t ? t : l.nullTranslator).load("notebook");
              a.addCommand(N.openEditNotebookMetadata, {
                label: r.__("Edit Notebook Metadata"),
                execute: async () => {
                  const e = "application:toggle-panel",
                    o = { side: "right", title: "Show Notebook Tools", id: "notebook-tools" };
                  a.isToggled(e, o) ||
                    (await a.execute(e, o).then((e) => {
                      n &&
                        (null == n ? void 0 : n.layout).widgets.forEach((e) => {
                ...
                o && o.addItem({ command: N.openEditNotebookMetadata, category: "Notebook Operations" });
            },
          },
          T,
          x,
